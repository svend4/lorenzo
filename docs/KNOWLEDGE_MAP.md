...
|--------|--------|------|---------------|
| `obsidian` | 521 | 517,606 | 993 |
| `02-anthropic-vacancies` | 357 | 311,673 | 873 |
| `nautilus` | 255 | 148,523 | 582 |
| `anthropic-vacancies` | 111 | 30,884 | 278 |
| `04-ai-collaborations` | 17 | 26,545 | 1561 |
...
| `01-svyazi` | 16 | 11,675 | 729 |
| `05-habr-projects` | 10 | 9,361 | 936 |
| `ai-collaborations` | 30 | 8,207 | 273 |
| `contacts` | 15 | 3,151 | 210 |
| `03-technology-combinations` | 7 | 3,111 | 444 |
| `glossary` | 4 | 2,282 | 570 |
| `autofilled` | 13 | 1,710 | 131 |
| `templates` | 6 | 724 | 120 |
| `badges` | 1 | 59 | 59 |
