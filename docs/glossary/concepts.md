...
<!-- summary -->
> Документ создан на основе исследования. Ссылки ведут на связанные материалы. Ключевые понятия и паттерны Кто ссылается на этот документ (4) Кто ссылается на этот документ (4)
