...
|----------|----------------|-------------------|
| `READING_TIME` | 737 | `02-methodology.md`, `06-security-privacy.md`, `QA.md`, `110-вопрос-fallback-ratio-как-критический-или-осмыслен.md` +733 |
| `READABILITY` | 730 | `00-intro-part2.md`, `02-methodology.md`, `06-security-privacy.md`, `QA.md` +726 |
| `SEARCH` | 693 | `02-methodology.md`, `06-security-privacy.md`, `QA.md`, `110-вопрос-fallback-ratio-как-критический-или-осмыслен.md` +689 |
| `OUTLINE` | 692 | `00-intro-part2.md`, `02-methodology.md`, `06-security-privacy.md`, `08-conclusions.md` +688 |
| `TABLES` | 476 | `00-intro-part2.md`, `03-component-catalog.md`, `06-security-privacy.md`, `QA.md` +472 |
...
| `ENTITIES` | 54 | `QA.md`, `354-существующий-landscape-collaborators-твоя-working-.md`, `QA.md`, `QA.md` +50 |
