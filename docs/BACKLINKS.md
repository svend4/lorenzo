...
|----------|----------------|-------------------|
| `READABILITY` | 686 | `00-intro-part2.md`, `02-methodology.md`, `06-security-privacy.md`, `QA.md` +682 |
...
| `OUTLINE` | 668 | `00-intro-part2.md`, `02-methodology.md`, `06-security-privacy.md`, `08-conclusions.md` +664 |
| `SEARCH` | 659 | `02-methodology.md`, `06-security-privacy.md`, `QA.md`, `110-вопрос-fallback-ratio-как-критический-или-осмыслен.md` +655 |
| `TABLES` | 453 | `00-intro-part2.md`, `03-component-catalog.md`, `06-security-privacy.md`, `QA.md` +449 |
...
| `README` | 266 | `00-intro.md`, `01-интегральный-анализ-профиля-svend4.md`, `02-общий-план-развития-nautilus-portal-protocol.md`, `03-portal-protocol-md.md` +262 |
...
| `03-component-catalog` | 75 | `04-ensembles-overview.md`, `07-mvp-planning.md`, `09-architectural-gaps.md`, `10-second-order-ensembles.md` +71 |
...
| `GLOSSARY` | 43 | `03-local-first.md`, `04-sozialrecht-domain.md`, `CHANGELOG_AUTO.md`, `CITATION_INDEX.md` +39 |
...
| `HEALTH` | 40 | `BROKEN_LINKS.md`, `CHANGELOG_AUTO.md`, `CITATION_INDEX.md`, `COMPONENT_MATRIX.md` +36 |
...
| `ENTITIES` | 38 | `354-существующий-landscape-collaborators-твоя-working-.md`, `CHANGELOG_AUTO.md`, `CITATION_INDEX.md`, `COMPONENT_MATRIX.md` +34 |
