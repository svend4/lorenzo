...
|----------|----------------|-------------------|
| `READABILITY` | 708 | `00-intro-part2.md`, `02-methodology.md`, `06-security-privacy.md`, `QA.md` +704 |
| `READING_TIME` | 686 | `02-methodology.md`, `06-security-privacy.md`, `QA.md`, `110-вопрос-fallback-ratio-как-критический-или-осмыслен.md` +682 |
| `OUTLINE` | 679 | `00-intro-part2.md`, `02-methodology.md`, `06-security-privacy.md`, `08-conclusions.md` +675 |
| `SEARCH` | 671 | `02-methodology.md`, `06-security-privacy.md`, `QA.md`, `110-вопрос-fallback-ratio-как-критический-или-осмыслен.md` +667 |
| `TABLES` | 458 | `00-intro-part2.md`, `03-component-catalog.md`, `06-security-privacy.md`, `QA.md` +454 |
...
| `README` | 269 | `00-intro.md`, `01-интегральный-анализ-профиля-svend4.md`, `02-общий-план-развития-nautilus-portal-protocol.md`, `03-portal-protocol-md.md` +265 |
...
| `HEALTH` | 36 | `BROKEN_LINKS.md`, `CHANGELOG_AUTO.md`, `CITATION_INDEX.md`, `COMPONENT_MATRIX.md` +32 |
...
| **.claude** | 56 | 0 |
| **01-svyazi** | 383 | 182 |
| **02-anthropic-vacancies** | 7104 | 4971 |
| **03-technology-combinations** | 97 | 59 |
| **04-ai-collaborations** | 286 | 177 |
| **05-habr-projects** | 273 | 160 |
| **ai-collaborations** | 323 | 374 |
| **anthropic-vacancies** | 1273 | 1394 |
| **autofilled** | 234 | 206 |
| **badges** | 12 | 7 |
| **contacts** | 242 | 183 |
| **glossary** | 205 | 214 |
