...
<!-- summary -->
> **Файлов с входящими ссылками:** 2837
...
|----------|----------------|-------------------|
| `READING_TIME` | 742 | `02-methodology.md`, `06-security-privacy.md`, `QA.md`, `110-вопрос-fallback-ratio-как-критический-или-осмыслен.md` +738 |
| `READABILITY` | 735 | `00-intro-part2.md`, `02-methodology.md`, `06-security-privacy.md`, `QA.md` +731 |
| `SEARCH` | 698 | `02-methodology.md`, `06-security-privacy.md`, `QA.md`, `110-вопрос-fallback-ratio-как-критический-или-осмыслен.md` +694 |
| `OUTLINE` | 693 | `00-intro-part2.md`, `02-methodology.md`, `06-security-privacy.md`, `08-conclusions.md` +689 |
| `TABLES` | 481 | `00-intro-part2.md`, `03-component-catalog.md`, `06-security-privacy.md`, `QA.md` +477 |
...
| `README` | 296 | `QA.md`, `00-intro.md`, `01-интегральный-анализ-профиля-svend4.md`, `02-общий-план-развития-nautilus-portal-protocol.md` +292 |
...
| `HEALTH` | 56 | `QA.md`, `QA.md`, `QA.md`, `QA.md` +52 |
| `ENTITIES` | 55 | `QA.md`, `354-существующий-landscape-collaborators-твоя-working-.md`, `QA.md`, `QA.md` +51 |
...
| `INDEX` | 35 | `README.md`, `ABBREVIATIONS.md`, `CHANGELOG_AUTO.md`, `CONTACTS.md` +31 |
...
| **.github** | 4 | 0 |
| **01-svyazi** | 386 | 183 |
| **02-anthropic-vacancies** | 7118 | 4972 |
| **03-technology-combinations** | 99 | 61 |
| **04-ai-collaborations** | 492 | 372 |
