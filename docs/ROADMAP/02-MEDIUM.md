...
<!-- summary -->
> Лучше работает на корпусе с >1000 документов Естественная декомпозиция «о чём вообще» → «в каком документе» → «какой пассаж» Можно остановиться на любом уровне (для UI: показать секцию или весь док)
