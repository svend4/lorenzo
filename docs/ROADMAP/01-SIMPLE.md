...
<!-- summary -->
> > Документ содержит описание рисков и ограничений. Изучите их перед принятием архитектурных решений. Проверенные паттерны, низкий риск, измеримый прирост value.
