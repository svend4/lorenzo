...
|-----|--------|----------------|-------|
| `https://github.com/svend4/nautilus/issues` | 34 | ⭐⭐⭐⭐⭐ | `github.com` |
...
| `https://github.com/svend4/info1` | 11 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/mcp` | 10 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/AnastasiyaW/knowledge-space` | 10 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/svend4/data70` | 9 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/svend4/meta` | 9 | ⭐⭐⭐⭐⭐ | `github.com` |
...
| `https://github.com/spbmolot` | 6 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/svend4/nautilus/commits/main` | 5 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/spbmolot/ngt-memory` | 5 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/kksudo/agentfs` | 5 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/svend4/info7` | 5 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/camel-ai/camel` | 5 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/svend4/info40` | 5 | ⭐⭐⭐⭐⭐ | `github.com` |
...
| `https://github.com/zodigancode` | 5 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/tagir_analyzes` | 5 | ⭐⭐⭐⭐⭐ | `github.com` |
...
| `https://habr.com/ru/articles/1007122/` | 6 | ⭐⭐⭐⭐ | `habr.com` |
...
Цитируется в 34 файлах, авторитетность: 5
...
Цитируется в 7 файлах, авторитетность: 5

- `docs/02-anthropic-vacancies/323-appendix-c-sample-ingit-mcp-server-tool-specificat.md`
- `docs/02-anthropic-vacancies/341-приложение-c-образец-спецификаций-инструментов-ing.md`
- `docs/LINKS.md`
- `docs/TABLES.md`
- `docs/obsidian/02-anthropic-vacancies/323-appendix-c-sample-ingit-mcp-server-tool-specificat.md`
- ... и ещё 2
