...
Документов: **1094** | Слов всего: **666,518** | Время чтения всей базы: **55ч 2мин**
...
| `docs/CONCEPTS.md` | ~56 мин | 13121 | 📕 Очень долго |
...
| `docs/DUPLICATES.md` | ~9 мин | 2288 | 📙 Долго |
...
- `docs/CONCEPTS.md` — ~56 мин, 13121 слов
