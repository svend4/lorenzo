...
Документов: **1113** | Слов всего: **681,711** | Время чтения всей базы: **56ч 21мин**
...
- `docs/TABLES.md` — ~3ч 6мин, 44292 слов
- `docs/02-anthropic-vacancies/01-интегральный-анализ-профиля-svend4.md` — ~1ч 32мин, 17509 слов
- `docs/CONCEPTS.md` — ~56 мин, 13147 слов
- `docs/PARAGRAPH_QUALITY.md` — ~56 мин, 12467 слов
