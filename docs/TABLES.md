...
| **ADR** | "ADR-004: Temporal Metadata as First-Class Concept" | 42 |
| **AGENTS** | типология + готовая к развёртыванию категория Type 1 | 11 |
| **AI** | это инфраструктурный слой для AI-managed virtual companies | 2221 |
| **AIRI** | серьёзная research лаборатория (Артём Шелманов и команда) | 15 |
| **ANP** | Agent Network Protocol | 4 |
| **API** ⭐ | Application Programming Interface — интерфейс программирования приложений | 235 |
| **BSL** ⭐ | Business Source License — бизнес-лицензия с открытым кодом | 49 |
...
| **CLI** ⭐ | Command Line Interface — интерфейс командной строки | 45 |
| **CRDT** ⭐ | Conflict-free Replicated Data Type — структура данных без конфликтов слияния | 49 |
...
| **FAQ** ⭐ | Frequently Asked Questions — часто задаваемые вопросы | 21 |
| **FDE** | это исполнительская роль на чужую продуктовую повестку | 10 |
| **GDPR** ⭐ | General Data Protection Regulation — европейский регламент защиты данных | 49 |
| **GG** | они публичные) | 1 |
| **GUI** | -3 months effort | 13 |
| **HEAD** | 7 commits) | 1 |
| **HMP** | на когнитивной устойчивости и этике | 84 |
...
| **JWT** ⭐ | JSON Web Token — токен аутентификации | 3 |
| **KPI** | сколько полезных коллабораций, проектов, выступлений, mentorship‑пар или hiring‑контактов возникло из рекомендаций систе | 19 |
| **KSV** | потому что у них нет точных русских эквивалентов в контексте немецкой социально-правовой системы | 27 |
| **LAYER** | функциональная категория Type 4 | 44 |
| **LCI** | Lyapunov Coherence Index, target π | 21 |
| **LLM** ⭐ | Large Language Model — большая языковая модель | 308 |
| **LOC** | продублирована с разными строками в разных частях | 50 |
| **MCP** ⭐ | Model Context Protocol — протокол контекста для AI-инструментов | 750 |
| **MIT** ⭐ | Massachusetts Institute of Technology License — разрешительная лицензия | 223 |
| **ML** | несколько моделей → voting/averaging | 53 |
| **MMORPG** | это общее пространство , в котором вы видите аватары коллег, можете подойти к ним, стоять рядом, работать вместе в одной | 41 |
| **MRR** | это уже leverage для любого следующего шага, включая разговор с Anthropic Institute о grant/partnership | 2 |
| **MUST** | - Возвращать пустой список, если ничего не найдено (не None, не exception) - Ограничить результат разумным числом (SHOUL | 79 |
| **MVP** ⭐ | Minimum Viable Product — минимально жизнеспособный продукт | 232 |
| **NDA** | intermediate view (placeholder'ы, но с consistent identifiers для longitudinal анализа) | 1 |
| **NGT** | граф памяти](#глава-11-ngt-граф-памяти) | 247 |
| **NLP** ⭐ | Natural Language Processing — обработка естественного языка | 0 |
| **NPP** | **федеративная модель**, где каждый | 89 |
| **OASIS** | до 1M agents simulation) | 3 |
| **ODT** | не только текст | 1 |
| **OKWF** | конкретная архитектура](#применение-к-okwf-конкретная-архитектура) | 284 |
| **OPTIONAL** | ключевые слова | 9 |
| **OS** | неуточнено | 125 |
| **OSS** ⭐ | Open Source Software — программное обеспечение с открытым кодом | 210 |
...
| **PII** ⭐ | Personally Identifiable Information — персональные данные | 31 |
| **PROTOCOL** | иначе future разработчики будут gадать | 211 |
| **PURE** | LLM-based User Profile Management for Recommender System» | 5 |
| **QA** | демон-критик (adversarial, rigorous) | 263 |
| **RAG** ⭐ | Retrieval-Augmented Generation — генерация с поиском по базе знаний | 428 |
| **README** | 550+ строк production-качества: установка, конфигурация для всех 6 платформ (включая детализацию /etc/fstab для CIFS, AD | 448 |
| **REQUIRED** | откуда пришло | 22 |
| **ROI** | 10 sec queries vs 2 hour manual search | 16 |
| **SDK** ⭐ | Software Development Kit — набор инструментов разработчика | 54 |
| **SENTINEL** | неуточнено; LiteLLM — MIT вне enterprise‑директорий; Auto AI Router — Apache 2 | 143 |
| **SF** | DC, Canberra) | 18 |
| **SGB** ⭐ | Sozialgesetzbuch — Социальный кодекс Германии | 325 |
...
| **URL** | я разберусь с любым вариантом именования | 69 |
...
| **XII** | legally binding reference с нормативной силой | 36 |
| **YAML** ⭐ | YAML Ain't Markup Language — формат конфигурационных файлов | 106 |
| **ZINC** | - Ночью агент крутит эксперименты с промптами - Роутер геометрически выбирает, какой экс | 27 |
...
|-------------|------------|
| **AI** | 2221 — _это инфраструктурный слой для AI-managed virtual companies_ |
| **MCP** | 750 — _Model Context Protocol — протокол контекста для AI-инструмен_ |
| **README** | 448 — _550+ строк production-качества: установка, конфигурация для _ |
| **RAG** | 428 — _Retrieval-Augmented Generation — генерация с поиском по базе_ |
| **SGB** | 325 — _Sozialgesetzbuch — Социальный кодекс Германии_ |
| **LLM** | 308 — _Large Language Model — большая языковая модель_ |
| **OKWF** | 284 — _конкретная архитектура](#применение-к-okwf-конкретная-архите_ |
| **QA** | 263 — _демон-критик (adversarial, rigorous)_ |
| **NGT** | 247 — _граф памяти](#глава-11-ngt-граф-памяти)_ |
| **API** | 235 — _Application Programming Interface — интерфейс программирован_ |
| **MVP** | 232 — _Minimum Viable Product — минимально жизнеспособный продукт_ |
| **MIT** | 223 — _Massachusetts Institute of Technology License — разрешительн_ |
| **PROTOCOL** | 211 — _иначе future разработчики будут gадать_ |
| **OSS** | 210 — _Open Source Software — программное обеспечение с открытым ко_ |
...
### 10. Изменившиеся файлы (83) — топ по Δ слов
...
### 23. Временные оценки из документов
...
### 25. Файлы с низким покрытием (< 3 признаков) — 87 файлов
...
### 28. Где сосредоточена каждая тема
...
### 29. История коммитов (последние 15)
...
### 30. Текущее состояние репозитория
...
### 31. Файлы с ≥50% пустых секций (приоритет)
...
### 37. Ко-встречаемость проектов (топ пары)
...
| Svyazi ↔ knowledge-space | 52 |
| AgentFS ↔ NGT | 52 |
| Svyazi ↔ AI Factory | 51 |
| CardIndex ↔ Yodoca | 49 |
| AgentFS ↔ Yodoca | 49 |
| NGT ↔ AI Factory | 48 |
...
### 46. Топ биграмм (устойчивые словосочетания)
...
| **30** | с обратных ссылок **Файлов с входящими ссылками:** 504 ## Топ-30 самых цитируемы | `BACKLINKS` |
| **20** | svyazi/04-ensembles-overview.md` +44 \| ## Файлы → проекты Топ-20 файлов с наибо | `CROSSREFS` |
| **15** | ствия (0 сл., строка 57) ### `WORD_FREQ.md` (1 из 9) - ## Топ-15 слов по раздела | `EMPTY_SECTIONS` |
| **50** | ключевым терминам архитектуры). **Всего файлов:** 475 ## Топ-50 самых важных фай | `PRIORITIES` |
...
### 64. Индекс ссылок
_Файл: `docs/LINKS.md` | 2 колонок, 137 строк_
...
### 67. Документы, требующие улучшения (6)
...
### 76. Центральность узлов (влиятельность)
...
### 77. Топ-20 по объёму (важные и изолированные)
...
| Скрипты обработки | ✅ 126 скриптов | 4 LLM-скриптов, MCP=✅ |
...
### 87. Топ навигационных документов
...
### 96. Самые оптимистичные документы
...
### 97. Самые скептичные / риск-ориентированные
_Файл: `docs/SENTIMENT.md` | 3 колонок, 10 строк_
...
### 101. Svyazi 2.0 — Архитектура системы
...
### 102. Svyazi 2.0 — Архитектура системы
...
### 103. Svyazi 2.0 — Архитектура системы
...
### 104. Svyazi 2.0 — Архитектура системы
...
### 106. Без метаданных (нет summary или тегов) — 150 файлов
...
### 107. Короткие (< 100 слов, заготовки) — 39 файлов
...
### 108. Сводная таблица по разделам
...
### 111. Точная дата (188)
_Файл: `docs/TIMELINE.md` | 3 колонок, 29 строк_
...
### 119. Топ файлов по богатству словаря (STTR)
...
### 120. Файлы с бедным словарём (требуют доработки)
