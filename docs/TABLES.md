...
### 179. Без метаданных (нет summary или тегов) — 169 файлов
...
| `2026 год` | es / / `2026/04/25` / 10 / dates / / `в 2026 году` / 8 / dates / / `2026-04-22` / 8 / dates / / `март 2026` | `docs/TABLES.md` |
...
| `docs/templates/tech-radar-entry.md` | -5 | — | — |
