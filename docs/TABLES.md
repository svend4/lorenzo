...
- [root (179 таблиц)](#root-179-таблиц)
  ...
  - [13. Изменившиеся файлы (83) — топ по Δ слов](#13-изменившиеся-файлы-83-топ-по-δ-слов)
  ...
  - [22. Согласованность терминов](#22-согласованность-терминов)
  ...
  - [33. Файлы с низким покрытием (< 3 признаков) — 25 файлов](#33-файлы-с-низким-покрытием-3-признаков-25-файлов)
  - [34. Матрица сходства секций](#34-матрица-сходства-секций)
  - [35. Топ-40 кросс-секционных концептов](#35-топ-40-кросс-секционных-концептов)
  - [36. Детальная карта концептов](#36-детальная-карта-концептов)
  - [37. Карта плотности тем](#37-карта-плотности-тем)
  - [38. Наиболее раскрытые темы](#38-наиболее-раскрытые-темы)
  - [39. Где сосредоточена каждая тема](#39-где-сосредоточена-каждая-тема)
  - [40. Python-зависимости](#40-python-зависимости)
  - [41. OSS-проекты (Svyazi 2.0)](#41-oss-проекты-svyazi-20)
  - [42. Зависимости](#42-зависимости)
  - [43. История коммитов (последние 15)](#43-история-коммитов-последние-15)
  - [44. Текущее состояние репозитория](#44-текущее-состояние-репозитория)
  - [45. Сводка](#45-сводка)
  - [46. Активность по секциям](#46-активность-по-секциям)
  - [47. Ключевые слова изменений](#47-ключевые-слова-изменений)
  - [48. Итого](#48-итого)
  - [49. Файлы с ≥50% пустых секций (приоритет)](#49-файлы-с-50-пустых-секций-приоритет)
  - [50. Люди и авторы (7)](#50-люди-и-авторы-7)
  - [51. Проекты (22)](#51-проекты-22)
  - [52. Организации (9)](#52-организации-9)
  - [53. Технологии и стандарты (24)](#53-технологии-и-стандарты-24)
  - [54. GitHub репозитории (15)](#54-github-репозитории-15)
  - [55. Ко-встречаемость проектов (топ пары)](#55-ко-встречаемость-проектов-топ-пары)
  - [56. Словарь сносок](#56-словарь-сносок)
  - [57. Топ совместных упоминаний](#57-топ-совместных-упоминаний)
  - [58. Типы проблем](#58-типы-проблем)
  - [59. Метрики](#59-метрики)
  - [60. Структура репозитория](#60-структура-репозитория)
  - [61. Числовые значения (‰)](#61-числовые-значения)
  - [62. Концентрация тем](#62-концентрация-тем)
  - [63. Метрики репозитория](#63-метрики-репозитория)
  - [64. Аналитика и отчёты](#64-аналитика-и-отчёты)
  - [65. Ключевые документы](#65-ключевые-документы)
  - [66. LLM-обогащение (Ступень 3)](#66-llm-обогащение-ступень-3)
  - [67. Топ слов по охвату файлов](#67-топ-слов-по-охвату-файлов)
  - [68. Топ биграмм (устойчивые словосочетания)](#68-топ-биграмм-устойчивые-словосочетания)
  - [69. Корпус](#69-корпус)
  - [70. Метрики качества](#70-метрики-качества)
  - [71. По секциям](#71-по-секциям)
  - [72. Ключевые концепты](#72-ключевые-концепты)
  - [73. Топ сущностей](#73-топ-сущностей)
  - [74. Количество (216)](#74-количество-216)
  - [75. Количество (216)](#75-количество-216)
  - [76. Количество (216)](#76-количество-216)
  - [77. Количество (216)](#77-количество-216)
  - [78. Количество (216)](#78-количество-216)
  - [79. Количество (216)](#79-количество-216)
  - [80. Количество (216)](#80-количество-216)
  - [81. Количество (216)](#81-количество-216)
  - [82. Текущие метрики](#82-текущие-метрики)
  - [83. Распределение](#83-распределение)
  - [84. Файлы с неожиданным языком](#84-файлы-с-неожиданным-языком)
  - [85. Смешанные файлы (MIX)](#85-смешанные-файлы-mix)
  - [86. По секциям](#86-по-секциям)
  - [87. Индекс ссылок](#87-индекс-ссылок)
  - [88. Качество по разделам](#88-качество-по-разделам)
  - [89. Топ-15 лучших документов](#89-топ-15-лучших-документов)
  - [90. Документы, требующие улучшения (6)](#90-документы-требующие-улучшения-6)
  - [91. Легенда](#91-легенда)
  - [92. Карта пробелов знаний](#92-карта-пробелов-знаний)
  - [93. 👤 People (20)](#93-people-20)
  - [94. 👤 People (20)](#94-people-20)
  - [95. 👤 People (20)](#95-people-20)
  - [96. 👤 People (20)](#96-people-20)
  - [97. 👤 People (20)](#97-people-20)
  - [98. Топ-20 ко-упоминаемых пар](#98-топ-20-ко-упоминаемых-пар)
  - [99. Центральность узлов (влиятельность)](#99-центральность-узлов-влиятельность)
  - [100. Структура документации](#100-структура-документации)
  - [101. Ключевые документы](#101-ключевые-документы)
  - [102. Архитектура компонентов](#102-архитектура-компонентов)
  - [103. Топ-20 по объёму (важные и изолированные)](#103-топ-20-по-объёму-важные-и-изолированные)
  - [104. Типы проблем](#104-типы-проблем)
  - [105. Корпусная статистика](#105-корпусная-статистика)
  - [106. Топ файлов по доле пассива](#106-топ-файлов-по-доле-пассива)
  - [107. Состояние компонентов](#107-состояние-компонентов)
  - [108. Метрики качества](#108-метрики-качества)
  - [109. Все документы](#109-все-документы)
  - [110. Список чтения](#110-список-чтения)
  - [111. Contents](#111-contents)
  - [112. Все документы](#112-все-документы)
  - [113. Общая статистика](#113-общая-статистика)
  - [114. По секциям](#114-по-секциям)
  - [115. Ключевые проекты](#115-ключевые-проекты)
  - [116. Рекомендуемое чтение](#116-рекомендуемое-чтение)
  - [117. Реестр](#117-реестр)
  - [118. Упоминания рисков в документах](#118-упоминания-рисков-в-документах)
  - [119. Итоговая статистика](#119-итоговая-статистика)
  - [120. Ключевые вехи](#120-ключевые-вехи)
  - [121. Документация — 48/48 (100%) 🟢 GO](#121-документация-4848-100-go)
  - [122. Документация — 48/48 (100%) 🟢 GO](#122-документация-4848-100-go)
  - [123. Документация — 48/48 (100%) 🟢 GO](#123-документация-4848-100-go)
  - [124. Документация — 48/48 (100%) 🟢 GO](#124-документация-4848-100-go)
  - [125. Документация — 48/48 (100%) 🟢 GO](#125-документация-4848-100-go)
  - [126. Результаты поиска](#126-результаты-поиска)
  - [127. Тональность по разделам](#127-тональность-по-разделам)
  - [128. Самые оптимистичные документы](#128-самые-оптимистичные-документы)
  - [129. Самые скептичные / риск-ориентированные](#129-самые-скептичные-риск-ориентированные)
  - [130. Распределение тональности](#130-распределение-тональности)
  - [131. Топ-20 самых похожих пар](#131-топ-20-самых-похожих-пар)
  - [132. Мета-документы](#132-мета-документы)
  - [133. Svyazi 2.0 — Архитектура системы](#133-svyazi-20-архитектура-системы)
  - [134. Svyazi 2.0 — Архитектура системы](#134-svyazi-20-архитектура-системы)
  - [135. Svyazi 2.0 — Архитектура системы](#135-svyazi-20-архитектура-системы)
  - [136. Svyazi 2.0 — Архитектура системы](#136-svyazi-20-архитектура-системы)
  - [137. Svyazi 2.0 — Архитектура системы](#137-svyazi-20-архитектура-системы)
  - [138. Категории](#138-категории)
  - [139. Авторы](#139-авторы)
  - [140. 🤖 Авто-импортированные файлы (846)](#140-авто-импортированные-файлы-846)
  - [141. Без метаданных (нет summary или тегов) — 164 файлов](#141-без-метаданных-нет-summary-или-тегов-164-файлов)
  - [142. Короткие (< 100 слов, заготовки) — 90 файлов](#142-короткие-100-слов-заготовки-90-файлов)
  - [143. Сводная таблица по разделам](#143-сводная-таблица-по-разделам)
  - [144. Топ-20 файлов по объёму](#144-топ-20-файлов-по-объёму)
  - [145. 🟢 ADOPT](#145-adopt)
  - [146. 🟢 ADOPT](#146-adopt)
  - [147. 🟢 ADOPT](#147-adopt)
  - [148. 🟢 ADOPT](#148-adopt)
  - [149. Точная дата (1135)](#149-точная-дата-1135)
  - [150. Точная дата (1135)](#150-точная-дата-1135)
  - [151. Точная дата (1135)](#151-точная-дата-1135)
  - [152. Точная дата (1135)](#152-точная-дата-1135)
  - [153. Точная дата (1135)](#153-точная-дата-1135)
  - [154. Точная дата (1135)](#154-точная-дата-1135)
  - [155. Точная дата (1135)](#155-точная-дата-1135)
  - [156. Сводка](#156-сводка)
  - [157. Корпусная статистика](#157-корпусная-статистика)
  - [158. Топ файлов по богатству словаря (STTR)](#158-топ-файлов-по-богатству-словаря-sttr)
  - [159. Файлы с бедным словарём (требуют доработки)](#159-файлы-с-бедным-словарём-требуют-доработки)
  - [160. Топ-20 слов](#160-топ-20-слов)
  - [161. Глобальный топ-50 слов](#161-глобальный-топ-50-слов)
  - [162. 01-svyazi (9,507 слов)](#162-01-svyazi-9507-слов)
  - [163. 01-svyazi (9,507 слов)](#163-01-svyazi-9507-слов)
  - [164. 01-svyazi (9,507 слов)](#164-01-svyazi-9507-слов)
  - [165. 01-svyazi (9,507 слов)](#165-01-svyazi-9507-слов)
  - [166. 01-svyazi (9,507 слов)](#166-01-svyazi-9507-слов)
  - [167. 01-svyazi (9,507 слов)](#167-01-svyazi-9507-слов)
  - [168. 01-svyazi (9,507 слов)](#168-01-svyazi-9507-слов)
  - [169. 01-svyazi (9,507 слов)](#169-01-svyazi-9507-слов)
  - [170. 01-svyazi (9,507 слов)](#170-01-svyazi-9507-слов)
  - [171. 01-svyazi (9,507 слов)](#171-01-svyazi-9507-слов)
  - [172. 01-svyazi (9,507 слов)](#172-01-svyazi-9507-слов)
  - [173. 01-svyazi (9,507 слов)](#173-01-svyazi-9507-слов)
  - [174. 01-svyazi (9,507 слов)](#174-01-svyazi-9507-слов)
  - [175. 01-svyazi (9,507 слов)](#175-01-svyazi-9507-слов)
  - [176. 01-svyazi (9,507 слов)](#176-01-svyazi-9507-слов)
  - [177. 01-svyazi (9,507 слов)](#177-01-svyazi-9507-слов)
  - [178. 01-svyazi (9,507 слов)](#178-01-svyazi-9507-слов)
  - [179. 01-svyazi (9,507 слов)](#179-01-svyazi-9507-слов)
