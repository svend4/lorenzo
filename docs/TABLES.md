...
| **BSL** ⭐ | Business Source License — бизнес-лицензия с открытым кодом | 86 |
...
| **EN** | «was created», «is used», «has been» -  | 442 | | 450 |
| **ERROR** | MCP SDK not installed | 3 |
| **FAQ** ⭐ | Frequently Asked Questions — часто задаваемые вопросы | 70 |
...
| **GDPR** ⭐ | General Data Protection Regulation — европейский регламент защиты данных | 108 |
| **GG** | они публичные) | 3 |
...
| **KPI** | сколько полезных коллабораций, проектов, выступлений, mentorship‑пар или hiring‑контактов возникло из рекомендаций систе | 81 |
...
| **LLM** ⭐ | Large Language Model — большая языковая модель | 625 |
...
| **MVP** ⭐ | Minimum Viable Product — минимально жизнеспособный продукт | 351 |
...
| **OKWF** | конкретная архитектура](#применение-к-okwf-конкретная-архитектура) | 525 |
...
| **QA** | демон-критик (adversarial, rigorous) | 334 |
| **RAG** ⭐ | Retrieval-Augmented Generation — генерация с поиском по базе знаний | 784 |
| **README** | 550+ строк production-качества: установка, конфигурация для всех 6 платформ (включая детализацию /etc/fstab для CIFS, AD | 1894 |
| **REGISTRY** | реестр артефактов Lorenzo](docs/REGISTRY | 31 |
| **REQUIRED** | откуда пришло | 35 |
| **RFC** | более ранняя версия, 18 разделов + комментарий о дизайн-решениях | | 159 |
...
| **YAML** ⭐ | YAML Ain't Markup Language — формат конфигурационных файлов | 177 |
...
| **README** | 1894 — _550+ строк production-качества: установка, конфигурация для _ |
...
| **LLM** | 625 — _Large Language Model — большая языковая модель_ |
| **SGB** | 557 — _Sozialgesetzbuch — Социальный кодекс Германии_ |
| **OKWF** | 525 — _конкретная архитектура](#применение-к-okwf-конкретная-архите_ |
| **EN** | 450 — _«was created», «is used», «has been» -  | 442 |_ |
...
| **MVP** | 351 — _Minimum Viable Product — минимально жизнеспособный продукт_ |
| **MIT** | 343 — _Massachusetts Institute of Technology License — разрешительн_ |
| **QA** | 334 — _демон-критик (adversarial, rigorous)_ |
...
### 15. Изменившиеся файлы (75) — топ по Δ слов
...
| `CONCEPTS` | 13439 | 420.4 | 0.3% | H2 | 🔴 Сложный |
...
| `GRAPH` | 137 | 45.7 | 24.82% | H2 | 🔴 Сложный |
...
| `YiJing` | 25 | `docs/02-anthropic-vacancies/` |
...
| `GPU` | 12 | `docs/habr-unique-projects/` |
...
_Файл: `docs/EMPTY_SECTIONS.md` | 4 колонок, 147 строк_
...
| [https://github.com/svend4/info1](https://github.com/svend4/info1) | 9 |
...
| **5.0.6** | 6` \\\\\| азработка : версии HMP-0001 → HMP-0005 (март 2026, версия 5.0.6) - Док | `TABLES` |
...
| **9** | ode/session_01R8BfHH65xW6pXJw2RvvLiW ### ✨ Новые функции - Sprint 9-11 — skills  | `CHANGELOG` |
...
_Файл: `docs/LANGUAGE_STATS.md` | 3 колонок, 695 строк_
...
|--------|---------------|--------|------|---------|----------------|
| ✅ | **Svyazi** | 315 | 298193 | ≥5ф/2000сл | `CROSSREFS.md`, `README.md` |
| ✅ | **local-first** | 175 | 152138 | ≥2ф/300сл | `CONTACTS.md`, `PARAGRAPH_QUALITY.md` |
| ✅ | **self-improvement** | 155 | 11725 | ≥1ф/100сл | `READING_LIST.md`, `CONTACTS.md` |
| ✅ | **Yodoca** | 142 | 183100 | ≥2ф/300сл | `CROSSREFS.md`, `CONTACTS.md` |
| ✅ | **CardIndex** | 139 | 178668 | ≥3ф/500сл | `CROSSREFS.md`, `CONTACTS.md` |
| ✅ | **knowledge-space** | 103 | 156018 | ≥3ф/500сл | `CROSSREFS.md`, `CONTACTS.md` |
| ✅ | **AgentFS** | 102 | 154673 | ≥3ф/500сл | `CROSSREFS.md`, `CONTACTS.md` |
| ✅ | **NGT Memory** | 94 | 61684 | ≥2ф/300сл | `CROSSREFS.md`, `CONTACTS.md` |
| ✅ | **mclaude** | 90 | 136358 | ≥2ф/200сл | `CROSSREFS.md`, `CONTACTS.md` |
| ✅ | **Rufler** | 86 | 140230 | ≥2ф/200сл | `CROSSREFS.md`, `CONTACTS.md` |
| ✅ | **LiteParse** | 82 | 134126 | ≥2ф/300сл | `CROSSREFS.md`, `CONTACTS.md` |
| ✅ | **AI Factory** | 74 | 54000 | ≥2ф/200сл | `CROSSREFS.md`, `CONTACTS.md` |
| ✅ | **SENTINEL** | 69 | 53210 | ≥2ф/200сл | `CROSSREFS.md`, `CONTACTS.md` |
| ✅ | **AutoResearch** | 67 | 127963 | ≥1ф/100сл | `CROSSREFS.md`, `PARAGRAPH_QUALITY.md` |
| ✅ | **CRDT** | 65 | 123815 | ≥1ф/100сл | `PARAGRAPH_QUALITY.md`, `LANGUAGE_STATS.md` |
| ✅ | **Evidence Envelope** | 45 | 21018 | ≥2ф/200сл | `QA.md`, `EMPTY_SECTIONS.md` |
| ✅ | **Sozialrecht** | 43 | 131515 | ≥1ф/200сл | `PARAGRAPH_QUALITY.md`, `LLM_SUMMARIES.md` |
| ✅ | **Card Envelope** | 31 | 18387 | ≥2ф/200сл | `QA.md`, `TABLES.md` |
| ✅ | **Memory Write Policy** | 22 | 16580 | ≥2ф/200сл | `TABLES.md`, `SITEMAP.md` |
| ✅ | **privacy by design** | 22 | 15240 | ≥1ф/100сл | `TABLES.md`, `MISSING.md` |
| ✅ | **Review Record** | 20 | 15542 | ≥1ф/100сл | `QA.md`, `TABLES.md` |
| ✅ | **бюджетный роутинг** | 18 | 22291 | ≥2ф/300сл | `QA.md`, `TABLES.md` |
...
| **NGT** | 1073 | 📦 Проект |
| **Yodoca** | 1053 | 📦 Проект |
| **CardIndex** | 996 | 📦 Проект |
| **AgentFS** | 944 | 📦 Проект |
| **knowledge-space** | 895 | 📦 Проект |
| **Rufler** | 817 | 📦 Проект |
| **mclaude** | 816 | 📦 Проект |
| **MemNet** | 796 | 📦 Проект |
| **LiteParse** | 792 | 📦 Проект |
| **AI Factory** | 677 | 📦 Проект |
| **SENTINEL** | 630 | 📦 Проект |
| **Lorenzo (svend4)** | 610 | 👤 Автор |
| **Cowork** | 568 | 📦 Проект |
| **Андрей (kksudo)** | 565 | 👤 Автор |
| **Lorenzo** | 564 | 📦 Проект |
| **ingit** | 547 | 📦 Проект |
| **Виталий (spbmolot)** | 514 | 👤 Автор |
| **Wikontic** | 422 | 📦 Проект |
...
| Тип | Кол-во |
|-----|--------|
| ⚪ Короткий абзац | 11199 |
| ✂️  Оборванный | 4878 |
| 📏 Длинное предложение | 255 |
| 🔁 Повтор начала | 3203 |
| ♊ Дубль | 625 |
...
| `docs/ABBREVIATIONS.md` | 0 | 🔴 Очень сложный | 893 | 6 | 148.8 |
| `docs/ACTION_ITEMS.md` | 0 | 🔴 Очень сложный | 5981 | 312 | 19.2 |
...
| `docs/DUPLICATES.md` | 0 | 🔴 Очень сложный | 2248 | 154 | 14.6 |
...
| `docs/HEADING_AUDIT.md` | 0 | 🔴 Очень сложный | 7618 | 4 | 1904.5 |
...
| `docs/KNOWLEDGE_MAP.md` | 0 | 🔴 Очень сложный | 196 | 22 | 8.9 |
| `docs/KPI.md` | 0 | 🔴 Очень сложный | 1070 | 124 | 8.6 |
...
| `docs/OUTLINE.md` | 0 | 🔴 Очень сложный | 50050 | 4126 | 12.1 |
| `docs/PARAGRAPH_QUALITY.md` | 0 | 🔴 Очень сложный | 12307 | 4 | 3076.8 |
| `docs/PASSIVE_VOICE.md` | 0 | 🔴 Очень сложный | 82 | 5 | 16.4 |
| `docs/PROGRESS.md` | 0 | 🔴 Очень сложный | 209 | 17 | 12.3 |
...
| `docs/READING_TIME.md` | 0 | 🔴 Очень сложный | 2358 | 4 | 589.5 |
| `docs/REGISTRY.md` | 0 | 🔴 Очень сложный | 906 | 87 | 10.4 |
| `docs/REPORT.md` | 0 | 🔴 Очень сложный | 355 | 27 | 13.1 |
...
| `docs/SCRIPTS_CATALOG.md` | 0 | 🔴 Очень сложный | 6127 | 635 | 9.6 |
...
| `docs/SITEMAP.md` | 0 | 🔴 Очень сложный | 7354 | 924 | 8.0 |
...
| `docs/TABLES.md` | 0 | 🔴 Очень сложный | 43792 | 4809 | 9.1 |
| `docs/TASKS_INDEX.md` | 0 | 🔴 Очень сложный | 793 | 12 | 66.1 |
| `docs/TECH_RADAR.md` | 0 | 🔴 Очень сложный | 330 | 22 | 15.0 |
| `docs/TIMELINE.md` | 0 | 🔴 Очень сложный | 1647 | 207 | 8.0 |
| `docs/VALIDATION.md` | 0 | 🔴 Очень сложный | 248 | 1 | 248.0 |
| `docs/VERSION_DIFF.md` | 0 | 🔴 Очень сложный | 1084 | 4 | 271.0 |
...
| `docs/templates/ensemble.md` | 0 | 🔴 Очень сложный | 71 | 9 | 7.9 |
...
| `docs/CHANGELOG.md` | 10.2 | 🔴 Очень сложный | 1109 | 68 | 16.3 |
...
| `docs/DIGEST_AUTO.md` | 18.3 | 🔴 Очень сложный | 201 | 22 | 9.1 |
...
| `docs/README.md` | 19.5 | 🔴 Очень сложный | 795 | 198 | 4.0 |
| `docs/CITATION_INDEX.md` | 19.6 | 🔴 Очень сложный | 435 | 51 | 8.5 |
...
| `docs/NAMED_ENTITIES.md` | 23.0 | 🔴 Очень сложный | 334 | 30 | 11.1 |
...
| `docs/EMPTY_SECTIONS.md` | 24.9 | 🔴 Очень сложный | 5441 | 986 | 5.5 |
...
| `docs/BADGES.md` | 28.8 | 🔴 Очень сложный | 28 | 10 | 2.8 |
...
### 113. Все документы
_Файл: `docs/READING_TIME.md` | 4 колонок, 1117 строк_

| Файл | Время | Слов | Категория |
|------|-------|------|-----------|
| `docs/OUTLINE.md` | ~3ч 40мин | 50799 | 📕 Очень долго |
| `docs/TABLES.md` | ~3ч 5мин | 43885 | 📕 Очень долго |
...
| `docs/PARAGRAPH_QUALITY.md` | ~56 мин | 12442 | 📕 Очень долго |
...
| `docs/HEADING_AUDIT.md` | ~35 мин | 7754 | 📕 Очень долго |
| `docs/05-habr-projects/memory/memnet.md` | ~31 мин | 6770 | 📕 Очень долго |
| `docs/SITEMAP.md` | ~30 мин | 7285 | 📕 Очень долго |
| `docs/SCRIPTS_CATALOG.md` | ~28 мин | 6155 | 📕 Очень долго |
| `docs/02-anthropic-vacancies/165-closing.md` | ~28 мин | 6136 | 📕 Очень долго |
| `docs/ACTION_ITEMS.md` | ~27 мин | 6027 | 📕 Очень долго |
| `docs/EMPTY_SECTIONS.md` | ~26 мин | 5544 | 📕 Очень долго |
...
| `docs/DUPLICATES.md` | ~9 мин | 2303 | 📙 Долго |
...
| `docs/TIMELINE.md` | ~7 мин | 1667 | 📘 Средне |
...
| `docs/VERSION_DIFF.md` | ~5 мин | 1108 | 📘 Средне |
...
| `docs/ABBREVIATIONS.md` | ~4 мин | 917 | 📘 Средне |
...
| `docs/README.md` | ~3 мин | 796 | 📘 Средне |
...
| `docs/DIGEST_AUTO.md` | ~1 мин | 223 | 📗 Быстро |
...
| `docs/SOURCE_MAP.md` | ~1 мин | 100 | 📗 Быстро |
...
### 149. analysis (9)
_Файл: `docs/SCRIPTS_CATALOG.md` | 3 колонок, 33 строк_
...
| [ACTION_ITEMS.md](docs/ACTION_ITEMS.md) | Задачи и риски (490) | 8117 |
...
| [BADGES.md](docs/BADGES.md) | — | 62 |
| [BROKEN_LINKS.md](docs/BROKEN_LINKS.md) | Сломанные ссылки (26) | 790 |
| [CHANGELOG.md](docs/CHANGELOG.md) | История изменений | 1345 |
...
| [CONCEPTS.md](docs/CONCEPTS.md) | Глоссарий понятий (888) | 13408 |
...
| [CONTRADICTIONS.md](docs/CONTRADICTIONS.md) | — | 1811 |
...
| [DIGEST_WEEKLY.md](docs/DIGEST_WEEKLY.md) | — | 202 |
| [DUPLICATES.md](docs/DUPLICATES.md) | — | 2706 |
| [EMPTY_SECTIONS.md](docs/EMPTY_SECTIONS.md) | — | 11968 |
...
| [GRAPH.md](docs/GRAPH.md) | Граф связей проектов | 2655 |
| [HEADING_AUDIT.md](docs/HEADING_AUDIT.md) | — | 9008 |
...
| [OUTLINE.md](docs/OUTLINE.md) | — | 34987 |
| [PARAGRAPH_QUALITY.md](docs/PARAGRAPH_QUALITY.md) | — | 15331 |
| [PASSIVE_VOICE.md](docs/PASSIVE_VOICE.md) | — | 408 |
| [PRIORITIES.md](docs/PRIORITIES.md) | Приоритеты (TF-IDF) | 3028 |
| [PROGRESS.md](docs/PROGRESS.md) | — | 313 |
...
| [README.md](docs/README.md) | Главная страница и навигация | 768 |
...
| [TIMELINE.md](docs/TIMELINE.md) | Временная шкала (800 маркеров) | 4335 |
| [VALIDATION.md](docs/VALIDATION.md) | — | 595 |
| [VERSION_DIFF.md](docs/VERSION_DIFF.md) | — | 4273 |
...
### 177. Короткие (< 100 слов, заготовки) — 88 файлов
...
### 190. Точная дата (2038)
_Файл: `docs/TIMELINE.md` | 3 колонок, 3 строк_

| Маркер | Контекст | Файл |
|--------|----------|------|
| `Q2 2024` | tes / / `февраль 2026` / 3 / dates / / `Q2 2024` / 3 / dates / / `февраля 2026` / 3 / dates / / `2024-06-15 | `docs/NAMED_ENTITIES.md` |
...
| `Q2 2024` | tes / / `февраль 2026` / 3 / dates / / `Q2 2024` / 3 / dates / / `2024-06-15` / 3 / dates / / `2025-11-12` | `docs/TABLES.md` |


### 191. Точная дата (2038)
_Файл: `docs/TIMELINE.md` | 3 колонок, 31 строк_
...
### 196. 📝 Изменённые файлы (382)
_Файл: `docs/VERSION_DIFF.md` | 4 колонок, 382 строк_
...
### 199. Файлы с бедным словарём (требуют доработки)
...
| 24 | **view** | 1,759 | `██░░░░░░░░░░░░░░░░░░` |
| 25 | **what** | 1,718 | `██░░░░░░░░░░░░░░░░░░` |
| 26 | **infrastructure** | 1,654 | `██░░░░░░░░░░░░░░░░░░` |
| 27 | **legal** | 1,649 | `██░░░░░░░░░░░░░░░░░░` |
| 28 | **memory** | 1,648 | `██░░░░░░░░░░░░░░░░░░` |
| 29 | **слов** | 1,647 | `██░░░░░░░░░░░░░░░░░░` |
| 30 | **architecture** | 1,614 | `██░░░░░░░░░░░░░░░░░░` |
| 31 | **источник** | 1,586 | `██░░░░░░░░░░░░░░░░░░` |
...
### 1. Универсальные (T1) — 8
_Файл: `docs/templates/README.md` | 2 колонок, 8 строк_
...
### 3. Универсальные (T1) — 8
_Файл: `docs/templates/README.md` | 2 колонок, 6 строк_
...
### 4. Универсальные (T1) — 8
_Файл: `docs/templates/README.md` | 2 колонок, 1 строк_
