...
| **ADR** | "ADR-004: Temporal Metadata as First-Class Concept" | 94 |
| **AGENTS** | типология + готовая к развёртыванию категория Type 1 | 15 |
| **AI** | это инфраструктурный слой для AI-managed virtual companies | 3829 |
| **AIRI** | серьёзная research лаборатория (Артём Шелманов и команда) | 25 |
| **ANP** | Agent Network Protocol | 6 |
| **API** ⭐ | Application Programming Interface — интерфейс программирования приложений | 378 |
| **BSL** ⭐ | Business Source License — бизнес-лицензия с открытым кодом | 83 |
| **CAMEL** | это другая значимая open-source framework, и сравнение их с Hermes будет показательным | 256 |
| **CI/CD** ⭐ | Continuous Integration / Continuous Deployment | 16 |
| **CLI** ⭐ | Command Line Interface — интерфейс командной строки | 77 |
| **CQRS** | Multiple read models from single event stream | 11 |
| **CRDT** ⭐ | Conflict-free Replicated Data Type — структура данных без конфликтов слияния | 133 |
| **DAO** | результат смешанный | 5 |
| **DR** | Трёхфазная методология Review | 13 |
| **DSL** | Non-programmers write legal automation | 44 |
| **EMEA** | RU/DE/EN на рабочем уровне, базирование в Германии, понимание европейского регуляторного контекста (что прямо читается ч | 52 |
| **ERROR** | MCP SDK not installed | 3 |
| **FAQ** ⭐ | Frequently Asked Questions — часто задаваемые вопросы | 43 |
| **FDE** | это исполнительская роль на чужую продуктовую повестку | 30 |
| **FRE** | 70-100 лёгкий, 50-70 средний, 30-50 сложный, <30 очень сложный | 16 |
| **GDPR** ⭐ | General Data Protection Regulation — европейский регламент защиты данных | 102 |
| **GG** | они публичные) | 3 |
| **GUI** | -3 months effort | 26 |
| **HEAD** | 7 commits) | 8 |
| **HMP** | на когнитивной устойчивости и этике | 112 |
...
| **IX** | 102 , sgg:86b:2 ), на прецеденты | 75 |
| **JWT** ⭐ | JSON Web Token — токен аутентификации | 5 |
| **KPI** | сколько полезных коллабораций, проектов, выступлений, mentorship‑пар или hiring‑контактов возникло из рекомендаций систе | 61 |
| **KSV** | потому что у них нет точных русских эквивалентов в контексте немецкой социально-правовой системы | 52 |
| **LAYER** | функциональная категория Type 4 | 72 |
| **LCI** | Lyapunov Coherence Index, target π | 38 |
| **LLM** ⭐ | Large Language Model — большая языковая модель | 550 |
| **LOC** | продублирована с разными строками в разных частях | 63 |
| **MCP** ⭐ | Model Context Protocol — протокол контекста для AI-инструментов | 1092 |
| **MIT** ⭐ | Massachusetts Institute of Technology License — разрешительная лицензия | 325 |
| **ML** | несколько моделей → voting/averaging | 101 |
| **MMORPG** | это общее пространство , в котором вы видите аватары коллег, можете подойти к ним, стоять рядом, работать вместе в одной | 92 |
...
| **MVP** ⭐ | Minimum Viable Product — минимально жизнеспособный продукт | 246 |
| **NDA** | intermediate view (placeholder'ы, но с consistent identifiers для longitudinal анализа) | 3 |
| **NGT** | граф памяти](#глава-11-ngt-граф-памяти) | 350 |
| **NLP** ⭐ | Natural Language Processing — обработка естественного языка | 1 |
| **NPP** | **федеративная модель**, где каждый | 165 |
| **OASIS** | до 1M agents simulation) | 4 |
| **ODT** | не только текст | 3 |
| **OKWF** | конкретная архитектура](#применение-к-okwf-конкретная-архитектура) | 483 |
| **OLAP** | analytics, 100M rows/sec) │ | 17 |
| **OLTP** | transactions) │ | 13 |
| **OPTIONAL** | ключевые слова | 15 |
| **OS** | неуточнено | 203 |
| **OSS** ⭐ | Open Source Software — программное обеспечение с открытым кодом | 267 |
| **OUTPUT** | - Draft Widerspruch (DOCX format) | 2 |
| **P2P** ⭐ | Peer-to-Peer — децентрализованная сеть | 41 |
...
| **PDA** | LLM как периферия]( | 21 |
| **PII** ⭐ | Personally Identifiable Information — персональные данные | 62 |
| **PROTOCOL** | иначе future разработчики будут gадать | 252 |
| **PURE** | LLM-based User Profile Management for Recommender System» | 9 |
| **QA** | демон-критик (adversarial, rigorous) | 237 |
| **RAG** ⭐ | Retrieval-Augmented Generation — генерация с поиском по базе знаний | 629 |
| **README** | 550+ строк production-качества: установка, конфигурация для всех 6 платформ (включая детализацию /etc/fstab для CIFS, AD | 609 |
...
| **SDK** ⭐ | Software Development Kit — набор инструментов разработчика | 70 |
| **SENTINEL** | неуточнено; LiteLLM — MIT вне enterprise‑директорий; Auto AI Router — Apache 2 | 215 |
| **SF** | DC, Canberra) | 36 |
| **SGB** ⭐ | Sozialgesetzbuch — Социальный кодекс Германии | 532 |
...
| **UI** | -2 months effort | 98 |
| **URL** | я разберусь с любым вариантом именования | 99 |
...
| **XII** | legally binding reference с нормативной силой | 72 |
| **YAML** ⭐ | YAML Ain't Markup Language — формат конфигурационных файлов | 157 |
| **ZINC** | - Ночью агент крутит эксперименты с промптами | 63 |
...
|-------------|------------|
| **AI** | 3829 — _это инфраструктурный слой для AI-managed virtual companies_ |
| **MCP** | 1092 — _Model Context Protocol — протокол контекста для AI-инструмен_ |
| **RAG** | 629 — _Retrieval-Augmented Generation — генерация с поиском по базе_ |
| **README** | 609 — _550+ строк production-качества: установка, конфигурация для _ |
| **LLM** | 550 — _Large Language Model — большая языковая модель_ |
| **SGB** | 532 — _Sozialgesetzbuch — Социальный кодекс Германии_ |
| **OKWF** | 483 — _конкретная архитектура](#применение-к-okwf-конкретная-архите_ |
| **API** | 378 — _Application Programming Interface — интерфейс программирован_ |
| **NGT** | 350 — _граф памяти](#глава-11-ngt-граф-памяти)_ |
| **MIT** | 325 — _Massachusetts Institute of Technology License — разрешительн_ |
| **OSS** | 267 — _Open Source Software — программное обеспечение с открытым ко_ |
| **CAMEL** | 256 — _это другая значимая open-source framework, и сравнение их с _ |
| **PROTOCOL** | 252 — _иначе future разработчики будут gадать_ |
| **MVP** | 246 — _Minimum Viable Product — минимально жизнеспособный продукт_ |
| **QA** | 237 — _демон-критик (adversarial, rigorous)_ |
...
| `https://github.com/kksudo/agentfs` | 3 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/spbmolot/ngt-memory` | 3 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/VitalyOborin/yodoca` | 3 | ⭐⭐⭐⭐⭐ | `github.com` |
...
### 13. Изменившиеся файлы (165) — топ по Δ слов
_Файл: `docs/COMPARE.md` | 4 колонок, 30 строк_

| Файл | Было | Стало | Δ |
|------|------|-------|---|
| `TABLES.md` | 15654 | 63650 | +47996 |
| `TIMELINE.md` | 1656 | 4196 | +2540 |
| `PARAGRAPH_QUALITY.md` | 4068 | 6438 | +2370 |
| `README.md` | 3693 | 2111 | -1582 |
| `SITEMAP.md` | 1449 | 2194 | +745 |
| `ACTION_ITEMS.md` | 5816 | 6518 | +702 |
| `CHANGELOG.md` | 197 | 895 | +698 |
| `README.md` | 54 | 646 | +592 |
| `WORD_FREQ.md` | 1262 | 1760 | +498 |
| `QA.md` | 1521 | 1028 | -493 |
| `LINKS.md` | 647 | 997 | +350 |
| `README.md` | 345 | 105 | -240 |
| `README.md` | 330 | 99 | -231 |
| `NAMED_ENTITIES.md` | 1377 | 1589 | +212 |
| `METRICS.md` | 331 | 475 | +144 |
| `DECISIONS.md` | 1773 | 1902 | +129 |
| `CODE_BLOCKS.md` | 3530 | 3658 | +128 |
| `COVERAGE.md` | 905 | 795 | -110 |
| `PRIORITIES.md` | 1046 | 1149 | +103 |
| `CONTRADICTIONS.md` | 1656 | 1557 | -99 |
| `CONTACTS.md` | 442 | 532 | +90 |
| `VOCABULARY.md` | 882 | 964 | +82 |
| `SEARCH.md` | 4040 | 4112 | +72 |
| `QA.md` | 292 | 226 | -66 |
| `COST.md` | 615 | 681 | +66 |
| `SCORING.md` | 322 | 387 | +65 |
| `CONCEPTS.md` | 11313 | 11376 | +63 |
| `SCHEDULE.md` | 271 | 332 | +61 |
| `BACKLINKS.md` | 288 | 347 | +59 |
| `QA.md` | 172 | 115 | -57 |
...
|-------|--------|------|-------------------|---------------|
| **AnastasiyaW** | knowledge-space, mclaude | knowledge/orchestration | 35 | Держать operational benchmark/gotcha cards в одной базе с reference cards или отдельным слоем? |
| **Antipozitive** | MemNet | memory | 21 | — |
| **Cutcode** | AIF Handoff | orchestration | 37 | — |
| **Dmitriila** | SENTINEL | security | 34 | — |
| **MiXaiLL76** | Auto AI Router | security | 21 | — |
| **Sonia_Black** | knowledge-space | knowledge | 14 | — |
| **VitalyOborin** | Yodoca | memory | 29 | Что сильнее влияет на качество памяти: отдельный consolidator, decay или строгая типизация записей? |
| **VladSpace** | Graph RAG | rag | 36 | — |
| **andrey_chuyan** | Svyazi | ingestion/CardIndex | 12 | Стоит ли расширять CardIndex до person/project/episode/evidence или лучше держать разные индексы? |
| **kksudo** | AgentFS | knowledge/filesystem | 44 | Что лучше класть в .agentos, а что выносить в machine-only state вне vault conventions? |
| **lee-to** | AI Factory | orchestration | 8 | — |
| **nlaik** | LiteParse / research-docs | rag | 19 | — |
| **spbmolot** | NGT Memory | memory | 44 | Где проходит практическая граница между полезной ассоциацией и ложной ко-активацией тем для community discovery? |
| **tagir_analyzes** | Legal RAG | rag | 11 | — |
| **zodigancode** | Rufler | orchestration | 22 | — |


### 24. GitHub репозитории
_Файл: `docs/CONTACTS.md` | 2 колонок, 42 строк_

| Репозиторий | Упоминается в файлах |
|-------------|---------------------|
| `github.com/github.com/AnastasiyaW` | 5 |
| `github.com/github.com/AnastasiyaW/knowledge-space` | 8 |
...
|---|-------|--------|------|-----------|--------|------|
| 1 | **kksudo** | AgentFS | knowledge/filesystem | 44 | 👁 Изучили | 143 |
| 2 | **spbmolot** | NGT Memory | memory | 44 | 👁 Изучили | 143 |
| 3 | **Cutcode** | AIF Handoff | orchestration | 37 | ⬜ Не начато | 115 |
| 4 | **VladSpace** | Graph RAG | rag | 36 | ⬜ Не начато | 112 |
| 5 | **AnastasiyaW** | knowledge-space, mclaude | knowledge/orchestration | 35 | ⬜ Не начато | 111 |
| 6 | **Dmitriila** | SENTINEL | security | 34 | ⬜ Не начато | 104 |
| 7 | **VitalyOborin** | Yodoca | memory | 29 | ⬜ Не начато | 93 |
| 8 | **zodigancode** | Rufler | orchestration | 22 | ⬜ Не начато | 70 |
| 9 | **Antipozitive** | MemNet | memory | 21 | ⬜ Не начато | 69 |
| 10 | **MiXaiLL76** | Auto AI Router | security | 21 | ⬜ Не начато | 65 |
| 11 | **nlaik** | LiteParse / research-docs | rag | 19 | ⬜ Не начато | 61 |
| 12 | **Sonia_Black** | knowledge-space | knowledge | 14 | ⬜ Не начато | 48 |
| 13 | **andrey_chuyan** | Svyazi | ingestion/CardIndex | 12 | ⬜ Не начато | 38 |
| 14 | **tagir_analyzes** | Legal RAG | rag | 11 | ⬜ Не начато | 37 |
...
|-----------|-----------|-------------------|
| `LiteParse` | 44 | `docs/04-ai-collaborations/` |
...
| `AIF` | 17 | `docs/04-ai-collaborations/` |
...
| `BSG` | 13 | `docs/02-anthropic-vacancies/` |
...
### 43. Точные дубли (одинаковое содержимое)
_Файл: `docs/DUPLICATES.md` | 2 колонок, 1 строк_

| Группа | Файлы |
|--------|-------|
| #1 | `docs/nautilus/infrastructure-layer-b-en/01-missing-middle-layer.md`, `docs/nautilus/infrastructure-layer-b-en/02-why-document-exists.md` |
...
| **15** | 78% \| 78% \| \| **root** \| 63 \| 17.4 \| 1.2 \| 70% \| 68% \| ## Топ-15 лучших | `METRICS` |
...
| https://habr.com/ru/articles/938626/, | 4 |
| https://habr.com/ru/articles/938626/` | 2 |
...
### 74. Документы, требующие улучшения (19)
_Файл: `docs/METRICS.md` | 3 колонок, 19 строк_
...
| `kksudo` | 30 | people |
| `spbmolot` | 29 | people |
| `anastasiyaw` | 20 | people |
| `vitalyoborin` | 17 | people |
...
| `yodoca` | 65 | projects |
| `agentfs` | 60 | projects |
| `knowledge-space` | 51 | projects |
| `LiteParse` | 43 | projects |
...
| Качество доков (METRICS) | 70.4/100 | 🟡 |
| Go/No-Go (SCORING) | 93.0/100 | 🟡 |


### 91. Все документы
_Файл: `docs/READABILITY.md` | 6 колонок, 524 строк_
...
| `docs/ACTION_ITEMS.md` | 0 | 🔴 Очень сложный | 4828 | 239 | 20.2 |
...
| `docs/CITATION_INDEX.md` | 0 | 🔴 Очень сложный | 94 | 5 | 18.8 |
...
| `docs/CONCEPTS.md` | 0 | 🔴 Очень сложный | 8354 | 447 | 18.7 |
| `docs/CONCEPT_GRAPH.md` | 0 | 🔴 Очень сложный | 56 | 3 | 18.7 |
| `docs/CONTACTS.md` | 0 | 🔴 Очень сложный | 201 | 12 | 16.8 |
| `docs/CONTACT_PRIORITY.md` | 0 | 🔴 Очень сложный | 156 | 7 | 22.3 |
| `docs/CONTENT_GAPS.md` | 0 | 🔴 Очень сложный | 246 | 30 | 8.2 |
| `docs/CONTRADICTIONS.md` | 0 | 🔴 Очень сложный | 1119 | 182 | 6.1 |
| `docs/COST.md` | 0 | 🔴 Очень сложный | 276 | 11 | 25.1 |
| `docs/COVERAGE.md` | 0 | 🔴 Очень сложный | 70 | 1 | 70.0 |
| `docs/CROSSREFS.md` | 0 | 🔴 Очень сложный | 242 | 6 | 40.3 |
| `docs/DECISIONS.md` | 0 | 🔴 Очень сложный | 1550 | 103 | 15.0 |
...
| `docs/DUPLICATES.md` | 0 | 🔴 Очень сложный | 178 | 11 | 16.2 |
| `docs/ENTITIES.md` | 0 | 🔴 Очень сложный | 146 | 1 | 146.0 |
...
| `docs/GRAPH.md` | 0 | 🔴 Очень сложный | 113 | 6 | 18.8 |
| `docs/HEALTH.md` | 0 | 🔴 Очень сложный | 68 | 2 | 34.0 |
| `docs/HEATMAP.md` | 0 | 🔴 Очень сложный | 106 | 33 | 3.2 |
| `docs/INDEX.md` | 0 | 🔴 Очень сложный | 489 | 63 | 7.8 |
| `docs/KPI.md` | 0 | 🔴 Очень сложный | 456 | 21 | 21.7 |
...
| `docs/SOURCE_MAP.md` | 0 | 🔴 Очень сложный | 67 | 5 | 13.4 |
| `docs/SPELLCHECK.md` | 0 | 🔴 Очень сложный | 13 | 1 | 13.0 |
| `docs/STATS.md` | 0 | 🔴 Очень сложный | 89 | 1 | 89.0 |
| `docs/TABLES.md` | 0 | 🔴 Очень сложный | 24439 | 2623 | 9.3 |
| `docs/TECH_RADAR.md` | 0 | 🔴 Очень сложный | 330 | 22 | 15.0 |
| `docs/TIMELINE.md` | 0 | 🔴 Очень сложный | 1672 | 196 | 8.5 |
| `docs/VALIDATION.md` | 0 | 🔴 Очень сложный | 148 | 1 | 148.0 |
| `docs/VERSION_DIFF.md` | 0 | 🔴 Очень сложный | 119 | 1 | 119.0 |
| `docs/WORD_CLOUD.md` | 0 | 🔴 Очень сложный | 87 | 7 | 12.4 |
| `docs/WORD_FREQ.md` | 0 | 🔴 Очень сложный | 371 | 1 | 371.0 |
...
| `docs/templates/project-component.md` | 0 | 🔴 Очень сложный | 79 | 9 | 8.8 |
| `docs/templates/research-note.md` | 0 | 🔴 Очень сложный | 54 | 10 | 5.4 |
...
| `docs/SITEMAP.md` | 1.4 | 🔴 Очень сложный | 1936 | 342 | 5.7 |
...
| `docs/CONSISTENCY.md` | 5.5 | 🔴 Очень сложный | 56 | 6 | 9.3 |
...
| `docs/STALENESS.md` | 20.3 | 🔴 Очень сложный | 123 | 6 | 20.5 |
...
| `docs/README.md` | 22.5 | 🔴 Очень сложный | 638 | 164 | 3.9 |
| `docs/NAMED_ENTITIES.md` | 23.8 | 🔴 Очень сложный | 324 | 30 | 10.8 |
| `docs/PRIORITIES.md` | 25.9 | 🔴 Очень сложный | 336 | 66 | 5.1 |
...
| `docs/COMPARE.md` | 40.9 | 🟠 Сложный | 79 | 5 | 15.8 |
...
| `docs/CONCEPTS.md` | ~35 мин | 8412 | 📕 Очень долго |
...
| `docs/PARAGRAPH_QUALITY.md` | ~24 мин | 5449 | 📕 Очень долго |
...
| `docs/ACTION_ITEMS.md` | ~22 мин | 4866 | 📕 Очень долго |
...
| `docs/SITEMAP.md` | ~8 мин | 1912 | 📙 Долго |
| `docs/TIMELINE.md` | ~8 мин | 1693 | 📙 Долго |
| `docs/02-anthropic-vacancies/186-appendix-c-sample-use-cases-in-detail.md` | ~7 мин | 1846 | 📘 Средне |
| `docs/DECISIONS.md` | ~7 мин | 1574 | 📘 Средне |
...
| `docs/READABILITY.md` | ~5 мин | 1136 | 📘 Средне |
...
| `docs/CONTRADICTIONS.md` | ~5 мин | 1143 | 📘 Средне |
...
| `docs/ABBREVIATIONS.md` | ~3 мин | 826 | 📘 Средне |
...
| `docs/CHANGELOG.md` | ~3 мин | 739 | 📘 Средне |
...
| `docs/README.md` | ~2 мин | 639 | 📗 Быстро |
...
| `docs/WORD_FREQ.md` | ~1 мин | 395 | 📗 Быстро |
...
| `docs/NAMED_ENTITIES.md` | ~1 мин | 344 | 📗 Быстро |
...
| `docs/COST.md` | ~1 мин | 236 | 📗 Быстро |
| `docs/HEATMAP.md` | ~1 мин | 124 | 📗 Быстро |
| `docs/VOCABULARY.md` | ~1 мин | 224 | 📗 Быстро |
...
| `docs/AUTHORS.md` | ~1 мин | 64 | 📗 Быстро |
...
| `docs/COMPLEXITY.md` | ~1 мин | 116 | 📗 Быстро |
| `docs/CONCEPT_GRAPH.md` | ~1 мин | 108 | 📗 Быстро |
| `docs/CONSISTENCY.md` | ~1 мин | 74 | 📗 Быстро |
| `docs/CONTENT_GAPS.md` | ~1 мин | 154 | 📗 Быстро |
...
| `docs/DUPLICATES.md` | ~1 мин | 219 | 📗 Быстро |
| `docs/ENTITIES.md` | ~1 мин | 165 | 📗 Быстро |
...
| `docs/METRICS.md` | ~1 мин | 150 | 📗 Быстро |
...
| `docs/SENTIMENT.md` | ~1 мин | 106 | 📗 Быстро |
| `docs/SIMILAR.md` | ~1 мин | 54 | 📗 Быстро |
| `docs/SOURCE_MAP.md` | ~1 мин | 89 | 📗 Быстро |
| `docs/STALENESS.md` | ~1 мин | 106 | 📗 Быстро |
| `docs/STATS.md` | ~1 мин | 62 | 📗 Быстро |
| `docs/TAGS.md` | ~1 мин | 71 | 📗 Быстро |
...
### 111. Мета-документы
_Файл: `docs/SITEMAP.md` | 3 колонок, 102 строк_

| Документ | Описание | Слов |
|----------|----------|------|
| [ABBREVIATIONS.md](docs/ABBREVIATIONS.md) | — | 1415 |
| [ACTION_ITEMS.md](docs/ACTION_ITEMS.md) | Задачи и риски (490) | 6518 |
| [ALERTS.md](docs/ALERTS.md) | — | 79 |
| [AUTHORS.md](docs/AUTHORS.md) | Авторы и контакты | 158 |
| [AUTOFILLED.md](docs/AUTOFILLED.md) | — | 102 |
| [BACKLINKS.md](docs/BACKLINKS.md) | — | 347 |
| [BROKEN_LINKS.md](docs/BROKEN_LINKS.md) | Сломанные ссылки (26) | 676 |
| [CHANGELOG.md](docs/CHANGELOG.md) | История изменений | 895 |
| [CHANGELOG_AUTO.md](docs/CHANGELOG_AUTO.md) | — | 353 |
| [CITATION_INDEX.md](docs/CITATION_INDEX.md) | — | 897 |
...
| [CONCEPTS.md](docs/CONCEPTS.md) | Глоссарий понятий (888) | 11376 |
| [CONCEPT_GRAPH.md](docs/CONCEPT_GRAPH.md) | — | 685 |
| [CONSISTENCY.md](docs/CONSISTENCY.md) | — | 275 |
| [CONTACTS.md](docs/CONTACTS.md) | Контакты (15 авторов) | 532 |
| [CONTACT_PRIORITY.md](docs/CONTACT_PRIORITY.md) | — | 413 |
| [CONTENT_GAPS.md](docs/CONTENT_GAPS.md) | — | 886 |
| [CONTRADICTIONS.md](docs/CONTRADICTIONS.md) | — | 1557 |
| [COST.md](docs/COST.md) | — | 681 |
| [COVERAGE.md](docs/COVERAGE.md) | — | 795 |
| [CROSSREFS.md](docs/CROSSREFS.md) | Перекрёстные ссылки проектов | 653 |
| [DECISIONS.md](docs/DECISIONS.md) | Ключевые решения (150) | 1902 |
...
| [DIGEST_WEEKLY.md](docs/DIGEST_WEEKLY.md) | — | 226 |
| [DUPLICATES.md](docs/DUPLICATES.md) | — | 266 |
...
| [README.md](docs/README.md) | Главная страница и навигация | 646 |
...
| [SOURCE_MAP.md](docs/SOURCE_MAP.md) | — | 2969 |
| [SPELLCHECK.md](docs/SPELLCHECK.md) | — | 143 |
| [STALENESS.md](docs/STALENESS.md) | — | 434 |
| [STATS.md](docs/STATS.md) | Детальная статистика | 494 |
| [TABLES.md](docs/TABLES.md) | — | 63650 |
| [TAGS.md](docs/TAGS.md) | Теги (316 файлов, 12 тем) | 600 |
| [TECH_RADAR.md](docs/TECH_RADAR.md) | — | 612 |
| [TIMELINE.md](docs/TIMELINE.md) | Временная шкала (800 маркеров) | 4196 |
| [VALIDATION.md](docs/VALIDATION.md) | — | 395 |
| [VERSION_DIFF.md](docs/VERSION_DIFF.md) | — | 464 |
| [VOCABULARY.md](docs/VOCABULARY.md) | — | 964 |
| [WORD_CLOUD.md](docs/WORD_CLOUD.md) | — | 194 |
| [WORD_FREQ.md](docs/WORD_FREQ.md) | Частотный анализ слов | 1760 |
...
### 122. 🤖 Авто-импортированные файлы (391)
...
### 123. Без метаданных (нет summary или тегов) — 82 файлов
...
### 124. Короткие (< 100 слов, заготовки) — 63 файлов
...
### 125. Сводная таблица по разделам
...
| `2026 год` | tes / / `2026/04/25` / 7 / dates / / `в 2026 году` / 6 / dates / / `март 2026` / 6 / dates / / `апреля 2026` | `docs/TABLES.md` |
