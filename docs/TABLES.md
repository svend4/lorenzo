...
| Аббревиатура | Расшифровка | Упоминаний |
|-------------|-------------|------------|
| **ACD** | Automated Capability Discovery — ещё один сильный кубик: модель в роли «учёного» систематически генерирует задачи для мо | 13 |
| **ADR** | "ADR-004: Temporal Metadata as First-Class Concept" | 223 |
| **AGENTS** | типология + готовая к развёртыванию категория Type 1 | 97 |
| **AI** | это инфраструктурный слой для AI-managed virtual companies | 5085 |
| **AIRI** | серьёзная research лаборатория (Артём Шелманов и команда) | 36 |
| **ANP** | Agent Network Protocol | 11 |
| **API** ⭐ | Application Programming Interface — интерфейс программирования приложений | 561 |
| **BSL** ⭐ | Business Source License — бизнес-лицензия с открытым кодом | 172 |
| **CAMEL** | это другая значимая open-source framework, и сравнение их с Hermes будет показательным | 350 |
| **CI/CD** ⭐ | Continuous Integration / Continuous Deployment | 22 |
| **CLI** ⭐ | Command Line Interface — интерфейс командной строки | 114 |
| **CRDT** ⭐ | Conflict-free Replicated Data Type — структура данных без конфликтов слияния | 129 |
| **DAO** | результат смешанный | 7 |
| **EMEA** | RU/DE/EN на рабочем уровне, базирование в Германии, понимание европейского регуляторного контекста (что прямо читается ч | 58 |
| **ERROR** | MCP SDK not installed | 7 |
| **FAQ** ⭐ | Frequently Asked Questions — часто задаваемые вопросы | 119 |
| **FDE** | это исполнительская роль на чужую продуктовую повестку | 29 |
...
| **GG** | они публичные) | 5 |
| **GUI** | -3 months effort | 32 |
| **HEAD** | 7 commits) | 11 |
| **HMP** | на когнитивной устойчивости и этике | 181 |
| **ID** | sgb:XII:90:4 (SGB XII, § 90, Abs | 15 |
| **II** | The Double-Triangle Architecture — formal описание дуальной структуры с вашей метафорой звезды Давида | 46 |
| **III** | Protocols Between Layers — три протокола с examples | 37 |
| **INPUT** | - Bescheid text (decoded by agent) | 5 |
| **IP** | AI-платформа, заказчик, сами фрилансеры? Сегодняшние legal frameworks не умеют отвечать на этот вопрос дёшево | 15 |
| **IV** | Nautilus Portal as Reference Implementation — как existing work serves как substrate | 40 |
| **IX** | 102 , sgg:86b:2 ), на прецеденты | 86 |
| **JWT** ⭐ | JSON Web Token — токен аутентификации | 10 |
| **KPI** | сколько полезных коллабораций, проектов, выступлений, mentorship‑пар или hiring‑контактов возникло из рекомендаций систе | 163 |
| **KSV** | потому что у них нет точных русских эквивалентов в контексте немецкой социально-правовой системы | 63 |
| **LAYER** | функциональная категория Type 4 | 133 |
| **LCI** | Lyapunov Coherence Index, target π | 48 |
| **LLM** ⭐ | Large Language Model — большая языковая модель | 692 |
| **LOC** | продублирована с разными строками в разных частях | 103 |
| **MCP** ⭐ | Model Context Protocol — протокол контекста для AI-инструментов | 1752 |
| **MIT** ⭐ | Massachusetts Institute of Technology License — разрешительная лицензия | 601 |
| **ML** | несколько моделей → voting/averaging | 124 |
| **MMORPG** | это общее пространство , в котором вы видите аватары коллег, можете подойти к ним, стоять рядом, работать вместе в одной | 85 |
| **MRR** | это уже leverage для любого следующего шага, включая разговор с Anthropic Institute о grant/partnership | 10 |
| **MUST** | - Возвращать пустой список, если ничего не найдено (не `None`, не exception) | 154 |
| **MVP** ⭐ | Minimum Viable Product — минимально жизнеспособный продукт | 519 |
| **NDA** | intermediate view (placeholder'ы, но с consistent identifiers для longitudinal анализа) | 5 |
| **NGT** | граф памяти > <!-- abstract-auto --> > **Абстракт** (авто) > > 🎯 **Проб | 669 |
| **NLP** ⭐ | Natural Language Processing — обработка естественного языка | 3 |
| **NPP** | **федеративная модель**, где каждый | 164 |
| **OASIS** | до 1M agents simulation) | 9 |
| **ODT** | не только текст | 5 |
| **OKWF** | конкретная архитектура](#применение-к-okwf-конкретная-архитектура) | 689 |
| **OPTIONAL** | ключевые слова | 21 |
| **OS** | неуточнено | 298 |
| **OSS** ⭐ | Open Source Software — программное обеспечение с открытым кодом | 507 |
| **OUTPUT** | - Draft Widerspruch (DOCX format) | 5 |
| **P2P** ⭐ | Peer-to-Peer — децентрализованная сеть | 48 |
| **PARC** | research center, became iconic несмотря на parent brand decline OpenAI — research org становящаяся product company, name | 7 |
| **PII** ⭐ | Personally Identifiable Information — персональные данные | 110 |
| **PROTOCOL** | иначе future разработчики будут gадать | 514 |
| **PURE** | LLM-based User Profile Management for Recommender System» | 12 |
| **QA** | демон-критик (adversarial, rigorous) | 499 |
| **RAG** ⭐ | Retrieval-Augmented Generation — генерация с поиском по базе знаний | 942 |
| **README** | 550+ строк production-качества: установка, конфигурация для всех 6 платформ (включая детализацию /etc/fstab для CIFS, AD | 2596 |
| **REQUIRED** | откуда пришло | 47 |
| **ROI** | 10 sec queries vs 2 hour manual search | 40 |
| **SDK** ⭐ | Software Development Kit — набор инструментов разработчика | 135 |
| **SENTINEL** | неуточнено; LiteLLM — MIT вне enterprise‑директорий; Auto AI Router — Apache 2 | 490 |
| **SF** | DC, Canberra) | 43 |
| **SGB** ⭐ | Sozialgesetzbuch — Социальный кодекс Германии | 833 |
| **SHOULD** | - Поддерживать case-insensitive matching для текстовых запросов | 74 |
| **SWE** | в Sales/Finance/Marketing/Legal зарплаты ниже и сильно варьируются по локации | 13 |
| **TF-IDF** ⭐ | Term Frequency–Inverse Document Frequency — метрика важности термина | 41 |
| **TODO** ⭐ | To Do — задача к выполнению | 10 |
| **TSU** | физика, MoME — математика; ZINC — software, гибридная архитектура — алгоритм; RISC-V — кремний, privacy — право; TinyML  | 21 |
| **TVCP** | Terminal Video Communication Platform, терминал видео коммуникация платформа, игры») — это необычное : Go + template + M | 5 |
| **UI** | -2 months effort | 137 |
| **URL** | я разберусь с любым вариантом именования | 175 |
| **VERIFY** | 6782 vs 6600] как метку | 5 |
| **VI** | Deployment Paths — humanities, project management, OSS, general | 9 |
| **VII** | Open Questions — governance, consent, economics, scale | 9 |
| **VIII** | Call to Action — что делать researchers, practitioners, founders | 7 |
| **VPS** | cron каждое утро обходит сайты Sozialgericht/BSG/KSV, генерирует Stellungnahme-черновики, обновляет статусы Aktenzeichen | 24 |
| **XII** | legally binding reference с нормативной силой | 84 |
| **YAML** ⭐ | YAML Ain't Markup Language — формат конфигурационных файлов | 233 |
| **ZINC** | - Ночью агент крутит эксперименты с промптами | 58 |
...
| Аббревиатура | Упоминаний |
|-------------|------------|
| **AI** | 5085 — _это инфраструктурный слой для AI-managed virtual companies_ |
| **README** | 2596 — _550+ строк production-качества: установка, конфигурация для _ |
| **MCP** | 1752 — _Model Context Protocol — протокол контекста для AI-инструмен_ |
| **RAG** | 942 — _Retrieval-Augmented Generation — генерация с поиском по базе_ |
| **SGB** | 833 — _Sozialgesetzbuch — Социальный кодекс Германии_ |
| **LLM** | 692 — _Large Language Model — большая языковая модель_ |
| **OKWF** | 689 — _конкретная архитектура](#применение-к-okwf-конкретная-архите_ |
| **NGT** | 669 — _граф памяти > <!-- abstract-auto --> > **Абстракт** (авто) >_ |
| **MIT** | 601 — _Massachusetts Institute of Technology License — разрешительн_ |
| **API** | 561 — _Application Programming Interface — интерфейс программирован_ |
| **MVP** | 519 — _Minimum Viable Product — минимально жизнеспособный продукт_ |
| **PROTOCOL** | 514 — _иначе future разработчики будут gадать_ |
| **OSS** | 507 — _Open Source Software — программное обеспечение с открытым ко_ |
| **QA** | 499 — _демон-критик (adversarial, rigorous)_ |
| **SENTINEL** | 490 — _неуточнено; LiteLLM — MIT вне enterprise‑директорий; Auto AI_ |
...
### 8. Безопа` | файл не существует |
_Файл: `docs/BROKEN_LINKS.md` | 4 колонок, 1 строк_

| `docs/DECISIONS.md` | Детали по топ-20 пробелам | `#детали-по-топ-20-пробелам` | якорь не найден |
| `docs/DECISIONS.md` | `LiteParse` (50 файлов) | `#liteparse-50-файлов` | якорь не найден |
| `docs/DECISIONS.md` | `BSL` (37 файлов) | `#bsl-37-файло  


### 9. Безопа` | файл не существует |
_Файл: `docs/BROKEN_LINKS.md` | 1 колонок, 4 строк_

| `docs/DUPLICATES.md` | https://github.com/spbmolot/…
 | `#типы-проблем` | якорь не найден |
| `docs/DUPLICATES.md` | По файлам | `#по-файлам` | якорь не найден |
| `docs/DUPLICATES.md` | `docs/CONCEPTS.md` (1443 пробл | `#docsconceptsmd-1443-проблем` | якорь не найден |
| `docs/DUPLICATES.md` | `docs/TABLES.md` (553 проблем) | `#docstablesmd-553-проблем` | якорь не найден |
| `docs/DUPLICATES.md` | !I…


### 10. 100% — `docs/VAL | `#корпусная-статистика` | якорь не найден
_Файл: `docs/BROKEN_LINKS.md` | 4 колонок, 0 строк_

| `docs/DUPLICATES.md` | Топ файлов по богатству словар | `#топ-файлов-по-богатству-словаря-sttr` | якорь не найден |
| `docs/DUPLICATES.md` | Файлы с бедным словарём (требу | `#файлы-с-бедным-словар…


### 11. Статистика коммитов
...
| URL | Файлов | Авторитетность | Домен |
|-----|--------|----------------|-------|
| `https://github.com/svend4/nautilus/issues` | 36 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/svend4/ingit` | 24 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/svend4/nautilus` | 20 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/svend4/pro2` | 14 | ⭐⭐⭐⭐⭐ | `github.com` |
...
| `https://habr.com/ru/articles/1006622/` | 9 | ⭐⭐⭐⭐ | `habr.com` |
...
| `https://github.com/kksudo` | 6 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/AnastasiyaW` | 6 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://habr.com/ru/articles/893356/` | 7 | ⭐⭐⭐⭐ | `habr.com` |
| `https://habr.com/ru/articles/1010478/` | 7 | ⭐⭐⭐⭐ | `habr.com` |
| `https://habr.com/ru/articles/1005776/` | 7 | ⭐⭐⭐⭐ | `habr.com` |
| `https://habr.com/ru/companies/yandex/articles/1019928/` | 7 | ⭐⭐⭐⭐ | `habr.com` |
| `https://habr.com/ru/articles/1009538/` | 7 | ⭐⭐⭐⭐ | `habr.com` |
| `https://habr.com/ru/articles/1027382/` | 7 | ⭐⭐⭐⭐ | `habr.com` |
| `https://habr.com/ru/articles/1009958/` | 7 | ⭐⭐⭐⭐ | `habr.com` |
| `https://habr.com/ru/articles/1017200/` | 7 | ⭐⭐⭐⭐ | `habr.com` |
| `https://habr.com/ru/articles/996144/` | 7 | ⭐⭐⭐⭐ | `habr.com` |
| `https://habr.com/ru/articles/943498/` | 7 | ⭐⭐⭐⭐ | `habr.com` |
| `https://habr.com/ru/articles/1024884/comments/` | 7 | ⭐⭐⭐⭐ | `habr.com` |
| `https://habr.com/ru/articles/1020598/` | 7 | ⭐⭐⭐⭐ | `habr.com` |
| `https://habr.com/ru/articles/1023446/` | 7 | ⭐⭐⭐⭐ | `habr.com` |
| `https://habr.com/ru/companies/airi/articles/855128/` | 7 | ⭐⭐⭐⭐ | `habr.com` |
| `https://habr.com/ru/articles/975414/` | 7 | ⭐⭐⭐⭐ | `habr.com` |
| `https://github.com/svend4?tab=repositories` | 5 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/svend4/` | 5 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/svend4/pro2/tree/6637d1299af963db66485aa5599346d41b...` | 5 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/svend4/pro2/tree/main/nautilus` | 5 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/svend4/pro2/blob/main/nautilus/README.md` | 5 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/svend4/nautilus/commits/main` | 5 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/svend4/nautilus.git` | 5 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/svend4/nautilus/branches` | 5 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/camel-ai/camel` | 5 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/nlaik` | 5 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/andrey_chuyan` | 5 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/Cutcode` | 5 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/Sonia_Black` | 5 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/MiXaiLL76` | 5 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/VitalyOborin` | 5 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/svend4/nautilus/blob/main/PORTAL-PROTOCOL` | 5 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/VladSpace` | 5 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/Antipozitive` | 5 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/Dmitriila` | 5 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/spbmolot` | 5 | ⭐⭐⭐⭐⭐ | `github.com` |
...
### 17. Изменившиеся файлы (374) — топ по Δ слов
...
### 27. Ключевые авторы проектов
_Файл: `docs/CONTACTS.md` | 5 колонок, 15 строк_

| Автор | Проект | Слой | Упомянут в файлах | Первый вопрос |
|-------|--------|------|-------------------|---------------|
| **AnastasiyaW** | knowledge-space, mclaude | knowledge/orchestration | 72 | Держать operational benchmark/gotcha cards в одной базе с reference cards или отдельным слоем? |
| **Antipozitive** | MemNet | memory | 42 | — |
| **Cutcode** | AIF Handoff | orchestration | 72 | — |
| **Dmitriila** | SENTINEL | security | 66 | — |
| **MiXaiLL76** | Auto AI Router | security | 64 | — |
| **Sonia_Black** | knowledge-space | knowledge | 31 | — |
| **VitalyOborin** | Yodoca | memory | 66 | Что сильнее влияет на качество памяти: отдельный consolidator, decay или строгая типизация записей? |
| **VladSpace** | Graph RAG | rag | 67 | — |
...
| **nlaik** | LiteParse / research-docs | rag | 43 | — |
| **spbmolot** | NGT Memory | memory | 125 | Где проходит практическая граница между полезной ассоциацией и ложной ко-активацией тем для community discovery? |
| **tagir_analyzes** | Legal RAG | rag | 38 | — |
| **zodigancode** | Rufler | orchestration | 55 | — |


### 28. GitHub репозитории
...
| `github.com/github.com/svend4/nautilus` | 84 |
...
### 29. Топ авторов по приоритету
_Файл: `docs/CONTACT_PRIORITY.md` | 7 колонок, 15 строк_

| # | Автор | Проект | Слой | Упоминаний | Статус | Балл |
|---|-------|--------|------|-----------|--------|------|
| 1 | **kksudo** | AgentFS | knowledge/filesystem | 130 | 👁 Изучили | 401 |
| 2 | **spbmolot** | NGT Memory | memory | 125 | 👁 Изучили | 386 |
| 3 | **AnastasiyaW** | knowledge-space, mclaude | knowledge/orchestration | 72 | ⬜ Не начато | 222 |
| 4 | **Cutcode** | AIF Handoff | orchestration | 72 | ⬜ Не начато | 220 |
| 5 | **VladSpace** | Graph RAG | rag | 67 | ⬜ Не начато | 205 |
| 6 | **VitalyOborin** | Yodoca | memory | 66 | ⬜ Не начато | 204 |
| 7 | **Dmitriila** | SENTINEL | security | 66 | ⬜ Не начато | 200 |
| 8 | **MiXaiLL76** | Auto AI Router | security | 64 | ⬜ Не начато | 194 |
| 9 | **zodigancode** | Rufler | orchestration | 55 | ⬜ Не начато | 169 |
| 10 | **nlaik** | LiteParse / research-docs | rag | 43 | ⬜ Не начато | 133 |
| 11 | **Antipozitive** | MemNet | memory | 42 | ⬜ Не начато | 132 |
...
| `LinkedIn` | 24 | `docs/obsidian/` |
| `MAY` | 24 | `docs/02-anthropic-vacancies/` |
| `KSV` | 24 | `docs/obsidian/` |
| `HIPAA` | 22 | `docs/obsidian/` |
| `HEALTH` | 21 | `docs/obsidian/` |
...
| `CRM` | 12 | `docs/obsidian/` |
| `EMEA` | 12 | `docs/obsidian/` |
| `ChatDev` | 12 | `docs/obsidian/` |
...
### 35. Временные оценки из документов
...
### 37. Файлы с низким покрытием (< 3 признаков) — 2 файлов
...
### 40. Где сосредоточена каждая тема
...
### 44. История коммитов (последние 15)
...
### 45. Текущее состояние репозитория
...
| **Wikontic** | 336 | 61 |
| **Firecrawl** | 197 | 24 |
| **agent-memory-mcp** | 99 | 36 |
| **MCP Tool Search** | 26 | 10 |
| **Shield** | 20 | 10 |
...
### 51. GitHub репозитории (15)
_Файл: `docs/ENTITIES.md` | 2 колонок, 15 строк_

| Репозиторий | Упоминаний |
|-------------|------------|
| [https://github.com/svend4/nautilus](https://github.com/svend4/nautilus) | 56 |
...
| [https://github.com/VitalyOborin/yodoca](https://github.com/VitalyOborin/yodoca) | 5 |
...
### 52. Ко-встречаемость проектов (топ пары)
...
| Svyazi ↔ knowledge-space | 112 |
| AgentFS ↔ CardIndex | 111 |
...
### 64. Топ биграмм (устойчивые словосочетания)
...
| **7** | v1.1 , формальная спецификация под текущую реальность репо (7 участников, 5 спос | `72-расписание-фазы-3` |
| **4** | fix run_all missing scripts _59617c5d_ _→ CHANGELOG_ - (4 файлов)](#кластер-26-m | `ACTION_ITEMS` |
| **50** | м` \| якорь не найден \| \| `docs/DECISIONS.md` \| `LiteParse` (50 файлов) \| `# | `BROKEN_LINKS` |
| **37** | -файлов` \| якорь не найден \| \| `docs/DECISIONS.md` \| `BSL` (37 файлов) \| `# | `BROKEN_LINKS` |
| **22** | зких файлов > - [Кластер 1 — cowork, ingit, yes, project (22 файлов)](#кластер-1 | `CLUSTERS` |
| **17** | айлов) - [Кластер 2 — professional, agent, colleague, type (17 файлов)](#кластер | `CLUSTERS` |
| **16** | ue-type-17-файлов) - [Кластер 3 — turn, view, cite, search (16 файлов)](#кластер | `CLUSTERS` |
| **15** | search-16-файлов) - [Кластер 4 — repo, passport, npp, json (15 файлов)](#кластер | `CLUSTERS` |
...
| **10** | nts (≈8 репо)](#кластер-4-archives-experiments-8-репо) - [Топ-10 репо, в которые | `00-intro` |
| **5** | sh/git), либо помочь с English README-драфтом для одного из топ-5, либо проработ | `00-intro` |
| **30** | ого прототипа. **Проекты:** Svyazi --- ## Содержание - [Топ-30 самых цитируемых  | `BACKLINKS` |
| **20** | а` \| файл не существует \| \| `docs/DECISIONS.md` \| Детали по топ-20 пробелам  | `BROKEN_LINKS` |
| **15** | 78% \| 78% \| \| **root** \| 63 \| 19.9 \| 1.2 \| 69% \| 69% \| ## Топ-15 лучших | `METRICS` |
| **50** | 6705_ ### [Приоритеты файлов](PRIORITIES.md) > > !TIP - Топ-50 самых важных файл | `OUTLINE` |
| **3** | **Файлов проанализировано:** 433 Для каждого документа — топ-3 похожих по словар | `SIMILAR` |
...
### 75. Качество по разделам
_Файл: `docs/METRICS.md` | 6 колонок, 6 строк_

| Раздел | Балл | Ссылок/1K слов | Код-блоков/1K | % с summary | % с тегами |
|--------|------|----------------|--------------|-------------|------------|
| **01-svyazi** | 71 | 31.8 | 0.5 | 100% | 93% |
| **02-anthropic-vacancies** | 77 | 53.1 | 0.7 | 100% | 100% |
| **03-technology-combinations** | 68 | 38.7 | 0.0 | 100% | 86% |
| **04-ai-collaborations** | 85 | 27.0 | 0.0 | 94% | 94% |
| **05-habr-projects** | 63 | 50.9 | 0.0 | 78% | 78% |
| **root** | 63 | 19.9 | 1.2 | 69% | 69% |


### 76. Топ-15 лучших документов
...
| `232-1-типология-из-пяти-типов-агентов-на` | 100 | 885 |
| `248-приложение-c-архитектура-быстрого-ст` | 100 | 3425 |
| `330-4-симбиотическая-архитектура` | 100 | 726 |
| `331-5-четыре-пути-интеграции-в-порядке-д` | 100 | 807 |
| `341-приложение-c-образец-спецификаций-ин` | 100 | 20414 |
| `342-что-такое-вариант-c-concept-document` | 100 | 11237 |
| `365-развёрнутый-анализ-внуковой-комбинац` | 100 | 4385 |
...
### 77. Документы, требующие улучшения (18)
...
### 79. Карта пробелов знаний
_Файл: `docs/MISSING.md` | 6 колонок, 25 строк_

| Статус | Тема / Проект | Файлов | Слов | Минимум | Примеры файлов |
|--------|---------------|--------|------|---------|----------------|
| ✅ | **Svyazi** | 274 | 302968 | ≥5ф/2000сл | `WORD_FREQ.md`, `SCHEDULE.md` |
| ✅ | **local-first** | 171 | 155213 | ≥2ф/300сл | `FOOTNOTES.md`, `READING_TIME.md` |
| ✅ | **Yodoca** | 167 | 196021 | ≥2ф/300сл | `WORD_FREQ.md`, `SCHEDULE.md` |
| ✅ | **AgentFS** | 154 | 109911 | ≥3ф/500сл | `WORD_FREQ.md`, `SCHEDULE.md` |
| ✅ | **CardIndex** | 144 | 130718 | ≥3ф/500сл | `WORD_FREQ.md`, `SCHEDULE.md` |
| ✅ | **self-improvement** | 142 | 21030 | ≥1ф/100сл | `FOOTNOTES.md`, `CONSISTENCY.md` |
| ✅ | **SENTINEL** | 123 | 90055 | ≥2ф/200сл | `SCHEDULE.md`, `FOOTNOTES.md` |
| ✅ | **knowledge-space** | 118 | 93543 | ≥3ф/500сл | `FOOTNOTES.md`, `BROKEN_LINKS.md` |
| ✅ | **NGT Memory** | 118 | 93632 | ≥2ф/300сл | `GLOSSARY.md`, `CONSISTENCY.md` |
| ✅ | **Rufler** | 117 | 79611 | ≥2ф/200сл | `FOOTNOTES.md`, `GLOSSARY.md` |
| ✅ | **LiteParse** | 108 | 79146 | ≥2ф/300сл | `TIMELINE.md`, `GLOSSARY.md` |
| ✅ | **mclaude** | 97 | 76568 | ≥2ф/200сл | `GLOSSARY.md`, `TABLES.md` |
| ✅ | **AI Factory** | 96 | 77489 | ≥2ф/200сл | `GLOSSARY.md`, `CONSISTENCY.md` |
| ✅ | **AutoResearch** | 59 | 48938 | ≥1ф/100сл | `GLOSSARY.md`, `CONTENT_GAPS.md` |
| ✅ | **Evidence Envelope** | 51 | 19592 | ≥2ф/200сл | `CONSISTENCY.md`, `TABLES.md` |
| ✅ | **Sozialrecht** | 45 | 131823 | ≥1ф/200сл | `READING_TIME.md`, `TABLES.md` |
| ✅ | **CRDT** | 43 | 38668 | ≥1ф/100сл | `FOOTNOTES.md`, `CONTENT_GAPS.md` |
| ✅ | **Card Envelope** | 30 | 15841 | ≥2ф/200сл | `TABLES.md`, `ACTION_ITEMS.md` |
| ✅ | **бюджетный роутинг** | 28 | 41037 | ≥2ф/300сл | `RISK_REGISTER.md`, `TABLES.md` |
| ✅ | **Memory Write Policy** | 23 | 13724 | ≥2ф/200сл | `QUESTIONS.md`, `TABLES.md` |
...
### 80. 👤 People (16)
_Файл: `docs/NAMED_ENTITIES.md` | 3 колонок, 16 строк_

| Сущность | Файлов | Тип |
|----------|--------|-----|
| `anthropic` | 399 | people |
| `claude` | 161 | people |
| `svend4` | 91 | people |
| `kksudo` | 52 | people |
| `spbmolot` | 47 | people |
| `vitalyoborin` | 25 | people |
| `anastasiyaw` | 23 | people |
...
| Сущность | Файлов | Тип |
|----------|--------|-----|
| `nautilus` | 181 | projects |
| `svyazi` | 122 | projects |
| `github` | 121 | projects |
| `ngt` | 80 | projects |
| `yodoca` | 75 | projects |
| `agentfs` | 73 | projects |
| `CardIndex` | 69 | projects |
| `lorenzo` | 63 | projects |
| `obsidian` | 57 | projects |
| `knowledge-space` | 53 | projects |
| `LiteParse` | 49 | projects |
| `notion` | 32 | projects |
| `PortalEntry` | 30 | projects |
| `AutoResearch` | 24 | projects |
| `MemNet` | 23 | projects |
| `VladSpace` | 21 | projects |
| `QueryResult` | 21 | projects |
| `wikontic` | 21 | projects |
| `gpt` | 19 | projects |
| `BaseAdapter` | 10 | projects |
| `gemini` | 10 | projects |
| `ingit` | 10 | projects |
| `OpenWhispr` | 9 | projects |
| `TypeScript` | 9 | projects |
...
| **AgentFS** ↔ **NGT** | 133 |
| **AgentFS** ↔ **Yodoca** | 125 |
| **Андрей (kksudo)** ↔ **Виталий (spbmolot)** | 116 |
| **Svyazi** ↔ **CardIndex** | 113 |
| **CardIndex** ↔ **NGT** | 113 |
| **Svyazi** ↔ **Андрей (kksudo)** | 110 |
| **CardIndex** ↔ **AgentFS** | 108 |
| **Svyazi** ↔ **SENTINEL** | 106 |
| **Svyazi** ↔ **Rufler** | 106 |
| **AgentFS** ↔ **SENTINEL** | 106 |
| **Svyazi** ↔ **Виталий (spbmolot)** | 103 |
| **Cowork** ↔ **Lorenzo (svend4)** | 102 |
| **Svyazi** ↔ **Lorenzo** | 101 |
| **AgentFS** ↔ **Rufler** | 101 |
| **NGT** ↔ **Rufler** | 101 |


### 86. Центральность узлов (влиятельность)
...
| **Yodoca** | 1485 | 📦 Проект |
| **AgentFS** | 1437 | 📦 Проект |
| **CardIndex** | 1252 | 📦 Проект |
| **Rufler** | 1148 | 📦 Проект |
| **knowledge-space** | 1143 | 📦 Проект |
| **SENTINEL** | 1136 | 📦 Проект |
| **Андрей (kksudo)** | 1105 | 👤 Автор |
| **LiteParse** | 1070 | 📦 Проект |
| **Виталий (spbmolot)** | 1012 | 👤 Автор |
| **mclaude** | 992 | 📦 Проект |
| **AI Factory** | 960 | 📦 Проект |
| **ingit** | 920 | 📦 Проект |
| **Cowork** | 902 | 📦 Проект |
| **Lorenzo** | 890 | 📦 Проект |
| **Lorenzo (svend4)** | 799 | 👤 Автор |
| **MemNet** | 722 | 📦 Проект |
| **Wikontic** | 580 | 📦 Проект |
| **Firecrawl** | 290 | 📦 Проект |


### 87. Структура документации
...
### 90. Топ-20 по объёму (важные и изолированные)
...
### 94. Все документы
_Файл: `docs/READABILITY.md` | 6 колонок, 1048 строк_
...
| # | Уровень | Документ | Слов | Предварительно прочитать |
|---|---------|----------|------|--------------------------|
| 1 | 🟢 Начало | [Svyazi[^svyazi] 2.0 — Исполнительное резюме](04-ai-collaborations/01-executive-summary.md) | 731 | — |
...
| 157 | 🟢 Начало | [Главные технические риски](obsidian/02-anthropic-vacancies/120-главные-технические-риски.md) | 119 | — |
...
| 343 | 🟢 Начало | [6. Refined InGit Scope with Cowork in Mind](obsidian/02-anthropic-vacancies/314-6-refined-ingit-scope-with-cowork-in-mind.md) | 569 | — |
...
| 361 | 🟢 Начало | [6. Уточнённый объём InGit с учётом Cowork](obsidian/02-anthropic-vacancies/332-6-уточнённый-объём-ingit-с-учётом-cowork.md) | 562 | — |
...
### 96. Все документы
_Файл: `docs/READING_TIME.md` | 4 колонок, 1004 строк_
...
### 99. Топ навигационных документов
...
### 101. Упоминания рисков в документах
...
### 110. Самые оптимистичные документы
...
### 111. Самые скептичные / риск-ориентированные
_Файл: `docs/SENTIMENT.md` | 3 колонок, 10 строк_
...
| Документ | Описание | Слов |
|----------|----------|------|
| [ABBREVIATIONS.md](ABBREVIATIONS.md) | — | 1421 |
| [ACTION_ITEMS.md](ACTION_ITEMS.md) | Задачи и риски (490) | 7144 |
| [ACTION_ITEMS.md](ACTION_ITEMS.md) | Задачи и риски (490) | 6725 |
| [ALERTS.md](ALERTS.md) | — | 79 |
| [AUTHORS.md](AUTHORS.md) | Авторы и контакты | 144 |
| [AUTHORS.md](AUTHORS.md) | Авторы и контакты | 179 |
| [AUTOFILLED.md](AUTOFILLED.md) | — | 115 |
| [BACKLINKS.md](BACKLINKS.md) | — | 459 |
| [BROKEN_LINKS.md](BROKEN_LINKS.md) | Сломанные ссылки (26) | 697 |
| [CHANGELOG.md](CHANGELOG.md) | История изменений | 945 |
| [CHANGELOG.md](CHANGELOG.md) | История изменений | 947 |
| [CHANGELOG_AUTO.md](CHANGELOG_AUTO.md) | — | 627 |
| [CITATION_INDEX.md](CITATION_INDEX.md) | — | 902 |
| [CLUSTERS.md](CLUSTERS.md) | Кластеры (384 → 120 групп) | 1612 |
| [CLUSTERS.md](CLUSTERS.md) | Кластеры (384 → 120 групп) | 1638 |
| [CODE_BLOCKS.md](CODE_BLOCKS.md) | — | 4855 |
| [CODE_BLOCKS.md](CODE_BLOCKS.md) | — | 4141 |
| [COMPARE.md](COMPARE.md) | Сравнение с предыдущим коммитом | 477 |
| [COMPARE.md](COMPARE.md) | Сравнение с предыдущим коммитом | 564 |
| [COMPLEXITY.md](COMPLEXITY.md) | Оценка читаемости | 591 |
| [COMPLEXITY.md](COMPLEXITY.md) | Оценка читаемости | 653 |
| [COMPONENT_MATRIX.md](COMPONENT_MATRIX.md) | — | 959 |
| [CONCEPTS.md](CONCEPTS.md) | Глоссарий понятий (888) | 11401 |
| [CONCEPTS.md](CONCEPTS.md) | Глоссарий понятий (888) | 11565 |
| [CONCEPT_GRAPH.md](CONCEPT_GRAPH.md) | — | 683 |
| [CONSISTENCY.md](CONSISTENCY.md) | — | 327 |
| [CONSISTENCY.md](CONSISTENCY.md) | — | 353 |
| [CONTACTS.md](CONTACTS.md) | Контакты (15 авторов) | 552 |
| [CONTACTS.md](CONTACTS.md) | Контакты (15 авторов) | 611 |
| [CONTACT_PRIORITY.md](CONTACT_PRIORITY.md) | — | 398 |
| [CONTENT_GAPS.md](CONTENT_GAPS.md) | — | 886 |
| [CONTRADICTIONS.md](CONTRADICTIONS.md) | — | 1558 |
| [COST.md](COST.md) | — | 554 |
| [COVERAGE.md](COVERAGE.md) | — | 311 |
| [CROSSREFS.md](CROSSREFS.md) | Перекрёстные ссылки проектов | 653 |
| [CROSSREFS.md](CROSSREFS.md) | Перекрёстные ссылки проектов | 689 |
| [DECISIONS.md](DECISIONS.md) | Ключевые решения (150) | 1944 |
| [DECISIONS.md](DECISIONS.md) | Ключевые решения (150) | 1925 |
| [DENSITY.md](DENSITY.md) | Карта плотности тем | 636 |
| [DENSITY.md](DENSITY.md) | Карта плотности тем | 719 |
| [DEPENDABOT.md](DEPENDABOT.md) | — | 159 |
| [DEPENDENCY_MAP.md](DEPENDENCY_MAP.md) | — | 1030 |
| [DIGEST.md](DIGEST.md) | — | 360 |
| [DIGEST_WEEKLY.md](DIGEST_WEEKLY.md) | — | 220 |
| [DUPLICATES.md](DUPLICATES.md) | — | 2341 |
| [DUPLICATES.md](DUPLICATES.md) | — | 124 |
| [ENTITIES.md](ENTITIES.md) | Именованные сущности | 728 |
| [ENTITIES.md](ENTITIES.md) | Именованные сущности | 780 |
| [FAQ.md](FAQ.md) | — | 836 |
| [FOOTNOTES.md](FOOTNOTES.md) | — | 261 |
| [GITHUB_ISSUES.md](GITHUB_ISSUES.md) | — | 1928 |
| [GLOSSARY.md](GLOSSARY.md) | Глоссарий проектов (33 записи) | 190 |
| [GLOSSARY.md](GLOSSARY.md) | Глоссарий проектов (33 записи) | 235 |
| [GRAPH.md](GRAPH.md) | Граф связей проектов | 2646 |
| [GRAPH.md](GRAPH.md) | Граф связей проектов | 2710 |
| [HEALTH.md](HEALTH.md) | Дашборд здоровья (75/100) | 179 |
| [HEALTH.md](HEALTH.md) | Дашборд здоровья (75/100) | 222 |
| [HEATMAP.md](HEATMAP.md) | — | 526 |
| [INDEX.md](INDEX.md) | — | 616 |
| [KEYWORD_INDEX.md](KEYWORD_INDEX.md) | — | 1115 |
| [KPI.md](KPI.md) | Числовые KPI (737 показателей) | 2328 |
| [KPI.md](KPI.md) | Числовые KPI (737 показателей) | 2388 |
| [KPI_HISTORY.md](KPI_HISTORY.md) | — | 98 |
| [LINKS.md](LINKS.md) | Внешние ссылки | 990 |
| [LINKS.md](LINKS.md) | Внешние ссылки | 979 |
| [LLM_SUMMARIES.md](LLM_SUMMARIES.md) | — | 226 |
| [METRICS.md](METRICS.md) | — | 451 |
| [MINDMAP.md](MINDMAP.md) | Майндмап в Mermaid | 228 |
| [MINDMAP.md](MINDMAP.md) | Майндмап в Mermaid | 286 |
| [MISSING.md](MISSING.md) | Пробелы знаний | 420 |
| [MISSING.md](MISSING.md) | Пробелы знаний | 481 |
| [NAMED_ENTITIES.md](NAMED_ENTITIES.md) | — | 1589 |
| [NARRATIVE.md](NARRATIVE.md) | — | 1046 |
| [NETWORK.md](NETWORK.md) | — | 403 |
| [ONBOARDING.md](ONBOARDING.md) | — | 606 |
| [ORPHANS.md](ORPHANS.md) | — | 97 |
| [OUTLINE.md](OUTLINE.md) | — | 16807 |
| [PARAGRAPH_QUALITY.md](PARAGRAPH_QUALITY.md) | — | 6705 |
| [PRIORITIES.md](PRIORITIES.md) | Приоритеты (TF-IDF) | 1199 |
| [PRIORITIES.md](PRIORITIES.md) | Приоритеты (TF-IDF) | 1242 |
| [PROGRESS.md](PROGRESS.md) | — | 278 |
| [QA.md](QA.md) | Вопросы и ответы | 224 |
...
| [QA.md](QA.md) | Вопросы и ответы | 1310 |
| [QA.md](QA.md) | Вопросы и ответы | 316 |
| [QA.md](QA.md) | Вопросы и ответы | 380 |
| [QA.md](QA.md) | Вопросы и ответы | 136 |
| [QA.md](QA.md) | Вопросы и ответы | 357 |
| [QA.md](QA.md) | Вопросы и ответы | 188 |
| [QA.md](QA.md) | Вопросы и ответы | 336 |
| [QUESTIONS.md](QUESTIONS.md) | Открытые вопросы (484) | 1609 |
| [QUESTIONS.md](QUESTIONS.md) | Открытые вопросы (484) | 1694 |
| [READABILITY.md](READABILITY.md) | — | 15848 |
| [READING_ORDER.md](READING_ORDER.md) | Рекомендуемый порядок чтения | 5947 |
| [READING_ORDER.md](READING_ORDER.md) | Рекомендуемый порядок чтения | 6042 |
| [READING_TIME.md](READING_TIME.md) | — | 5853 |
| [README.md](README.md) | Главная страница и навигация | 117 |
| [README.md](README.md) | Главная страница и навигация | 2128 |
| [README.md](README.md) | Главная страница и навигация | 48 |
| [README.md](README.md) | Главная страница и навигация | 111 |
| [README.md](README.md) | Главная страница и навигация | 42 |
| [README.md](README.md) | Главная страница и навигация | 12 |
| [README.md](README.md) | Главная страница и навигация | 25 |
| [README.md](README.md) | Главная страница и навигация | 673 |
| [README.md](README.md) | Главная страница и навигация | 18 |
| [README.md](README.md) | Главная страница и навигация | 66 |
| [README.md](README.md) | Главная страница и навигация | 44 |
| [README.md](README.md) | Главная страница и навигация | 90 |
| [README.md](README.md) | Главная страница и навигация | 71 |
| [README.md](README.md) | Главная страница и навигация | 1435 |
| [README.md](README.md) | Главная страница и навигация | 34 |
| [README.md](README.md) | Главная страница и навигация | 71 |
| [README.md](README.md) | Главная страница и навигация | 33 |
| [README.md](README.md) | Главная страница и навигация | 11 |
| [README.md](README.md) | Главная страница и навигация | 19 |
| [README.md](README.md) | Главная страница и навигация | 391 |
| [README.md](README.md) | Главная страница и навигация | 16 |
| [README.md](README.md) | Главная страница и навигация | 46 |
| [README.md](README.md) | Главная страница и навигация | 54 |
| [README.md](README.md) | Главная страница и навигация | 62 |
| [README.md](README.md) | Главная страница и навигация | 26 |
| [README.md](README.md) | Главная страница и навигация | 90 |
| [REPORT.md](REPORT.md) | — | 345 |
| [RISK_REGISTER.md](RISK_REGISTER.md) | — | 1038 |
| [SCHEDULE.md](SCHEDULE.md) | — | 318 |
| [SCORING.md](SCORING.md) | — | 373 |
| [SEARCH.md](SEARCH.md) | Поисковый индекс | 4397 |
| [SEE_ALSO.md](SEE_ALSO.md) | — | 217 |
...
| [SOURCE_MAP.md](SOURCE_MAP.md) | — | 2970 |
| [SPELLCHECK.md](SPELLCHECK.md) | — | 248 |
| [STALENESS.md](STALENESS.md) | — | 434 |
| [STATS.md](STATS.md) | Детальная статистика | 511 |
| [STATS.md](STATS.md) | Детальная статистика | 558 |
| [TABLES.md](TABLES.md) | — | 116145 |
| [TABLES.md](TABLES.md) | — | 64720 |
| [TAGS.md](TAGS.md) | Теги (316 файлов, 12 тем) | 586 |
| [TAGS.md](TAGS.md) | Теги (316 файлов, 12 тем) | 624 |
| [TECH_RADAR.md](TECH_RADAR.md) | — | 635 |
| [TIMELINE.md](TIMELINE.md) | Временная шкала (800 маркеров) | 4230 |
| [TIMELINE.md](TIMELINE.md) | Временная шкала (800 маркеров) | 1884 |
| [TOPIC_MODEL.md](TOPIC_MODEL.md) | — | 1051 |
| [VALIDATION.md](VALIDATION.md) | — | 467 |
| [VERSION_DIFF.md](VERSION_DIFF.md) | — | 464 |
| [VOCABULARY.md](VOCABULARY.md) | — | 947 |
| [WORD_CLOUD.md](WORD_CLOUD.md) | — | 244 |
| [WORD_FREQ.md](WORD_FREQ.md) | Частотный анализ слов | 1882 |
| [WORD_FREQ.md](WORD_FREQ.md) | Частотный анализ слов | 1895 |
...
| 30 | [Главные технические риски](obsidian/02-anthropic-vacancies/120-главные-технические-риски.md) | 119 |
...
| 8 | [Контакт: nlaik / LiteParse / research-docs](obsidian/contacts/nlaik.md) | 273 |
| 9 | [Контакт: Sonia_Black / knowledge-space](obsidian/contacts/sonia-black.md) | 265 |
...
| # | Документ | Слов |
|---|----------|------|
| 1 | [Продолжение исследования для Svyazi 2.0](obsidian/01-svyazi/00-intro-part2.md) | 23 |
...
| 41 | [Appendix A: Шаблон для header warning](obsidian/02-anthropic-vacancies/118-appendix-a-шаблон-для-header-warning.md) | 210 |
...
| 44 | [Главные технические риски](obsidian/02-anthropic-vacancies/120-главные-технические-риски.md) | 132 |
...
### 126. 🤖 Авто-импортированные файлы (782)
_Файл: `docs/SOURCE_MAP.md` | 3 колонок, 782 строк_

| Файл | Слов | Первый коммит |
|------|------|--------------|
| `docs/01-svyazi/00-intro-part2.md` | 6 | 2026-04-29 |
| `docs/02-anthropic-vacancies/250-bridging-the-gap-between-profession-wide-and-indiv.md` | 16 | 2026-04-29 |
| `docs/obsidian/01-svyazi/00-intro-part2.md` | 23 | — |
| `docs/obsidian/02-anthropic-vacancies/250-bridging-the-gap-between-profession-wide-and-indiv.md` | 48 | — |
| `docs/02-anthropic-vacancies/102-доступ-к-данным.md` | 65 | 2026-04-29 |
| `docs/02-anthropic-vacancies/121-appendix-c-история-изменений-методологии.md` | 78 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/102-доступ-к-данным.md` | 78 | — |
| `docs/obsidian/02-anthropic-vacancies/121-appendix-c-история-изменений-методологии.md` | 93 | — |
| `docs/02-anthropic-vacancies/16-history.md` | 104 | 2026-04-29 |
| `docs/02-anthropic-vacancies/362-когда-сомневаешься-escalate-к-max.md` | 106 | 2026-04-29 |
| `docs/02-anthropic-vacancies/361-когда-ты-honestly-не-знаешь.md` | 108 | 2026-04-29 |
| `docs/02-anthropic-vacancies/12-content-overview.md` | 113 | 2026-04-29 |
| `docs/02-anthropic-vacancies/31-content-overview.md` | 113 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/16-history.md` | 115 | — |
| `docs/02-anthropic-vacancies/120-главные-технические-риски.md` | 119 | 2026-04-29 |
| `docs/02-anthropic-vacancies/305-a-practical-path-to-layer-b-through-symbiotic-inte.md` | 122 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/362-когда-сомневаешься-escalate-к-max.md` | 122 | — |
| `docs/02-anthropic-vacancies/348-кому-ты-служишь-слоистая-модель.md` | 123 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/361-когда-ты-honestly-не-знаешь.md` | 123 | — |
| `docs/02-anthropic-vacancies/249-composite-skills-agent-md.md` | 125 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/12-content-overview.md` | 125 | — |
| `docs/obsidian/02-anthropic-vacancies/31-content-overview.md` | 125 | — |
| `docs/02-anthropic-vacancies/151-open-knowledge-work-foundation-md.md` | 126 | 2026-04-29 |
| `docs/02-anthropic-vacancies/187-слой-представительских-агентов-md.md` | 126 | 2026-04-29 |
| `docs/02-anthropic-vacancies/13-angle-perspective.md` | 127 | 2026-04-29 |
| `docs/02-anthropic-vacancies/105-review-methodology-md.md` | 128 | 2026-04-29 |
...
| `docs/02-anthropic-vacancies/166-representative-agent-layer-md.md` | 130 | 2026-04-29 |
| `docs/02-anthropic-vacancies/132-planned-v0-2-0.md` | 131 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/120-главные-технические-риски.md` | 132 | — |
| `docs/02-anthropic-vacancies/131-ограничения-текущей-версии-0-1-0-draft.md` | 133 | 2026-04-29 |
| `docs/02-anthropic-vacancies/304-ingit-as-cowork-native-workspace-substrate-md.md` | 133 | 2026-04-29 |
| `docs/02-anthropic-vacancies/344-системный-промпт-для-lorenzo-project.md` | 133 | 2026-04-29 |
| `docs/02-anthropic-vacancies/35-passports-info1-md.md` | 133 | 2026-04-29 |
...
| `docs/02-anthropic-vacancies/45-passports-pro2-md.md` | 137 | 2026-04-29 |
| `docs/02-anthropic-vacancies/347-твоя-миссия.md` | 138 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/348-кому-ты-служишь-слоистая-модель.md` | 138 | — |
| `docs/obsidian/02-anthropic-vacancies/105-review-methodology-md.md` | 139 | — |
| `docs/obsidian/02-anthropic-vacancies/187-слой-представительских-агентов-md.md` | 139 | — |
| `docs/02-anthropic-vacancies/154-table-of-contents.md` | 140 | 2026-04-29 |
| `docs/02-anthropic-vacancies/62-author-contact.md` | 140 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/13-angle-perspective.md` | 140 | — |
| `docs/obsidian/02-anthropic-vacancies/151-open-knowledge-work-foundation-md.md` | 140 | — |
| `docs/obsidian/02-anthropic-vacancies/249-composite-skills-agent-md.md` | 140 | — |
| `docs/obsidian/02-anthropic-vacancies/305-a-practical-path-to-layer-b-through-symbiotic-inte.md` | 141 | — |
| `docs/obsidian/02-anthropic-vacancies/132-planned-v0-2-0.md` | 143 | — |
| `docs/obsidian/02-anthropic-vacancies/166-representative-agent-layer-md.md` | 143 | — |
| `docs/obsidian/02-anthropic-vacancies/208-professional-colleague-agents-md.md` | 143 | — |
| `docs/obsidian/02-anthropic-vacancies/273-infrastructure-for-ai-collaborative-intellectual-w.md` | 143 | — |
| `docs/02-anthropic-vacancies/42-author-contact.md` | 145 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/134-the-double-triangle-architecture-md.md` | 145 | — |
| `docs/obsidian/02-anthropic-vacancies/55-passports-meta-md.md` | 145 | — |
| `docs/obsidian/02-anthropic-vacancies/35-passports-info1-md.md` | 146 | — |
| `docs/02-anthropic-vacancies/58-content-overview.md` | 147 | 2026-04-29 |
| `docs/02-anthropic-vacancies/359-твои-anti-patterns.md` | 148 | 2026-04-29 |
| `docs/02-anthropic-vacancies/38-content-overview.md` | 148 | 2026-04-29 |
| `docs/02-anthropic-vacancies/61-compatibility-level.md` | 148 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/45-passports-pro2-md.md` | 148 | — |
| `docs/02-anthropic-vacancies/27-15-glossary-of-examples.md` | 149 | 2026-04-29 |
| `docs/02-anthropic-vacancies/51-compatibility-level.md` | 149 | 2026-04-29 |
| `docs/02-anthropic-vacancies/03-portal-protocol-md.md` | 150 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/304-ingit-as-cowork-native-workspace-substrate-md.md` | 150 | — |
| `docs/obsidian/02-anthropic-vacancies/344-системный-промпт-для-lorenzo-project.md` | 150 | — |
| `docs/obsidian/02-anthropic-vacancies/347-твоя-миссия.md` | 150 | — |
| `docs/02-anthropic-vacancies/190-содержание.md` | 151 | 2026-04-29 |
| `docs/02-anthropic-vacancies/125-readme-mcp-md-инструкция-по-установке.md` | 152 | 2026-04-29 |
| `docs/02-anthropic-vacancies/41-compatibility-level.md` | 152 | 2026-04-29 |
| `docs/02-anthropic-vacancies/25-13-reference-implementation.md` | 153 | 2026-04-29 |
| `docs/02-anthropic-vacancies/65-readme-md.md` | 153 | 2026-04-29 |
| `docs/02-anthropic-vacancies/70-зачем-две-версии-параллельно.md` | 153 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/154-table-of-contents.md` | 153 | — |
| `docs/obsidian/02-anthropic-vacancies/363-твоя-identity-как-persistent-character.md` | 153 | — |
| `docs/obsidian/02-anthropic-vacancies/62-author-contact.md` | 153 | — |
| `docs/obsidian/02-anthropic-vacancies/42-author-contact.md` | 158 | — |
| `docs/obsidian/02-anthropic-vacancies/58-content-overview.md` | 159 | — |
| `docs/obsidian/02-anthropic-vacancies/359-твои-anti-patterns.md` | 160 | — |
| `docs/obsidian/02-anthropic-vacancies/38-content-overview.md` | 160 | — |
| `docs/obsidian/02-anthropic-vacancies/61-compatibility-level.md` | 160 | — |
| `docs/obsidian/02-anthropic-vacancies/03-portal-protocol-md.md` | 161 | — |
| `docs/obsidian/02-anthropic-vacancies/51-compatibility-level.md` | 161 | — |
| `docs/02-anthropic-vacancies/05-0-status-of-this-document.md` | 162 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/190-содержание.md` | 162 | — |
| `docs/obsidian/02-anthropic-vacancies/27-15-glossary-of-examples.md` | 163 | — |
| `docs/02-anthropic-vacancies/152-ai-coordinated-infrastructure-for-distributed-expe.md` | 164 | 2026-04-29 |
| `docs/02-anthropic-vacancies/188-ai-опосредованное-представительство-для-недопредст.md` | 164 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/41-compatibility-level.md` | 164 | — |
| `docs/obsidian/02-anthropic-vacancies/65-readme-md.md` | 164 | — |
| `docs/02-anthropic-vacancies/43-history.md` | 165 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/131-ограничения-текущей-версии-0-1-0-draft.md` | 165 | — |
| `docs/02-anthropic-vacancies/360-что-ты-всегда-делаешь.md` | 166 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/125-readme-mcp-md-инструкция-по-установке.md` | 166 | — |
| `docs/obsidian/02-anthropic-vacancies/25-13-reference-implementation.md` | 166 | — |
| `docs/02-anthropic-vacancies/135-a-formal-model-for-human-ai-collaboration-in-distr.md` | 167 | 2026-04-29 |
| `docs/02-anthropic-vacancies/169-table-of-contents.md` | 167 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/70-зачем-две-версии-параллельно.md` | 167 | — |
| `docs/02-anthropic-vacancies/106-tl-dr.md` | 168 | 2026-04-29 |
| `docs/02-anthropic-vacancies/49-angle-perspective.md` | 168 | 2026-04-29 |
| `docs/02-anthropic-vacancies/73-portal-protocol-md-v1-1.md` | 168 | 2026-04-29 |
| `docs/02-anthropic-vacancies/126-установка.md` | 169 | 2026-04-29 |
...
| `docs/02-anthropic-vacancies/129-примеры-запросов-в-claude.md` | 176 | 2026-04-29 |
| `docs/02-anthropic-vacancies/350-твои-языки-и-культурные-nuances.md` | 176 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/43-history.md` | 176 | — |
| `docs/02-anthropic-vacancies/127-подключение-к-claude-desktop.md` | 177 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/05-0-status-of-this-document.md` | 177 | — |
| `docs/02-anthropic-vacancies/326-содержание.md` | 178 | 2026-04-29 |
| `docs/02-anthropic-vacancies/339-приложение-a-дерево-решений-для-принимающих-ingit.md` | 179 | 2026-04-29 |
| `docs/02-anthropic-vacancies/36-essence.md` | 179 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/106-tl-dr.md` | 179 | — |
| `docs/02-anthropic-vacancies/75-0-status-of-this-document.md` | 180 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/126-установка.md` | 180 | — |
| `docs/obsidian/02-anthropic-vacancies/152-ai-coordinated-infrastructure-for-distributed-expe.md` | 180 | — |
| `docs/obsidian/02-anthropic-vacancies/169-table-of-contents.md` | 180 | — |
| `docs/obsidian/02-anthropic-vacancies/360-что-ты-всегда-делаешь.md` | 180 | — |
| `docs/obsidian/02-anthropic-vacancies/73-portal-protocol-md-v1-1.md` | 180 | — |
| `docs/obsidian/02-anthropic-vacancies/346-твоё-происхождение.md` | 181 | — |
| `docs/obsidian/02-anthropic-vacancies/49-angle-perspective.md` | 181 | — |
| `docs/obsidian/02-anthropic-vacancies/46-essence.md` | 183 | — |
| `docs/02-anthropic-vacancies/60-bridges.md` | 184 | 2026-04-29 |
| `docs/05-habr-projects/01-synthesis.md` | 184 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/231-содержание.md` | 184 | — |
| `docs/obsidian/02-anthropic-vacancies/137-table-of-contents.md` | 185 | — |
| `docs/obsidian/02-anthropic-vacancies/188-ai-опосредованное-представительство-для-недопредст.md` | 185 | — |
| `docs/obsidian/02-anthropic-vacancies/39-angle-perspective.md` | 186 | — |
| `docs/obsidian/02-anthropic-vacancies/52-author-contact.md` | 186 | — |
| `docs/02-anthropic-vacancies/351-что-ты-можешь-делать.md` | 187 | 2026-04-29 |
| `docs/02-anthropic-vacancies/47-native-format.md` | 187 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/135-a-formal-model-for-human-ai-collaboration-in-distr.md` | 187 | — |
| `docs/02-anthropic-vacancies/04-abstract.md` | 188 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/229-профессиональные-коллеги-агенты.md` | 188 | — |
| `docs/obsidian/02-anthropic-vacancies/59-angle-perspective.md` | 188 | — |
| `docs/02-anthropic-vacancies/253-table-of-contents.md` | 189 | 2026-04-29 |
| `docs/02-anthropic-vacancies/63-history.md` | 189 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/326-содержание.md` | 189 | — |
| `docs/obsidian/02-anthropic-vacancies/129-примеры-запросов-в-claude.md` | 190 | — |
| `docs/obsidian/02-anthropic-vacancies/36-essence.md` | 190 | — |
| `docs/02-anthropic-vacancies/203-благодарности.md` | 191 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/113-6-почему-это-валидный-паттерн-для-ai-assisted-work.md` | 191 | — |
| `docs/obsidian/02-anthropic-vacancies/127-подключение-к-claude-desktop.md` | 191 | — |
| `docs/02-anthropic-vacancies/91-16-mcp-extension-informative.md` | 192 | 2026-04-29 |
| `docs/obsidian/03-technology-combinations/04-sozialrecht-domain.md` | 192 | — |
| `docs/02-anthropic-vacancies/244-благодарности.md` | 193 | 2026-04-29 |
| `docs/02-anthropic-vacancies/251-ai-support-through-configurable-specialist-ensembl.md` | 193 | 2026-04-29 |
| `docs/02-anthropic-vacancies/57-native-format.md` | 193 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/71-критерии-выбора-для-фазы-3.md` | 193 | — |
| `docs/02-anthropic-vacancies/352-что-ты-не-можешь-делать-без-max-approval.md` | 194 | 2026-04-29 |
| `docs/02-anthropic-vacancies/56-essence.md` | 194 | 2026-04-29 |
| `docs/02-anthropic-vacancies/22-10-queryresult-structure.md` | 195 | 2026-04-29 |
| `docs/02-anthropic-vacancies/44-for-the-curious-philosophy.md` | 195 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/350-твои-языки-и-культурные-nuances.md` | 195 | — |
| `docs/obsidian/02-anthropic-vacancies/60-bridges.md` | 195 | — |
| `docs/obsidian/02-anthropic-vacancies/75-0-status-of-this-document.md` | 195 | — |
| `docs/02-anthropic-vacancies/211-table-of-contents.md` | 196 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/339-приложение-a-дерево-решений-для-принимающих-ingit.md` | 196 | — |
| `docs/02-anthropic-vacancies/167-ai-mediated-representation-for-underrepresented-ex.md` | 197 | 2026-04-29 |
| `docs/02-anthropic-vacancies/209-a-typology-of-ai-agents-on-the-principal-side-and-.md` | 197 | 2026-04-29 |
| `docs/02-anthropic-vacancies/185-appendix-b-domain-comparison-matrix.md` | 198 | 2026-04-29 |
| `docs/02-anthropic-vacancies/353-что-ты-не-можешь-делать-вообще.md` | 198 | 2026-04-29 |
| `docs/02-anthropic-vacancies/96-21-adr-003-five-onboarding-paths-as-equal-rank.md` | 198 | 2026-04-29 |
| `docs/02-anthropic-vacancies/320-references.md` | 199 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/04-abstract.md` | 199 | — |
| `docs/obsidian/02-anthropic-vacancies/47-native-format.md` | 199 | — |
| `docs/02-anthropic-vacancies/357-твоя-коммуникация-в-outreach.md` | 200 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/63-history.md` | 200 | — |
| `docs/02-anthropic-vacancies/09-4-passport-passport-md.md` | 201 | 2026-04-29 |
| `docs/02-anthropic-vacancies/298-что-этот-документ-не-решает.md` | 201 | 2026-04-29 |
| `docs/02-anthropic-vacancies/338-ссылки.md` | 201 | 2026-04-29 |
| `docs/02-anthropic-vacancies/53-history.md` | 201 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/351-что-ты-можешь-делать.md` | 201 | — |
| `docs/obsidian/05-habr-projects/01-synthesis.md` | 201 | — |
| `docs/obsidian/02-anthropic-vacancies/253-table-of-contents.md` | 202 | — |
| `docs/02-anthropic-vacancies/128-доступные-инструменты.md` | 204 | 2026-04-29 |
| `docs/02-anthropic-vacancies/54-for-the-curious-philosophy.md` | 204 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/203-благодарности.md` | 204 | — |
| `docs/02-anthropic-vacancies/130-отладка.md` | 205 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/56-essence.md` | 205 | — |
| `docs/obsidian/02-anthropic-vacancies/57-native-format.md` | 205 | — |
| `docs/02-anthropic-vacancies/308-table-of-contents.md` | 206 | 2026-04-29 |
| `docs/02-anthropic-vacancies/340-приложение-b-сравнительная-матрица.md` | 206 | 2026-04-29 |
| `docs/02-anthropic-vacancies/48-content-overview.md` | 206 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/244-благодарности.md` | 206 | — |
| `docs/obsidian/02-anthropic-vacancies/91-16-mcp-extension-informative.md` | 206 | — |
| `docs/obsidian/02-anthropic-vacancies/22-10-queryresult-structure.md` | 208 | — |
| `docs/obsidian/02-anthropic-vacancies/211-table-of-contents.md` | 209 | — |
| `docs/obsidian/02-anthropic-vacancies/44-for-the-curious-philosophy.md` | 209 | — |
| `docs/obsidian/02-anthropic-vacancies/118-appendix-a-шаблон-для-header-warning.md` | 210 | — |
| `docs/02-anthropic-vacancies/205-приложение-a-связь-с-сопроводительными-статьями.md` | 211 | 2026-04-29 |
| `docs/02-anthropic-vacancies/358-твоя-relationship-с-другими-ai.md` | 211 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/251-ai-support-through-configurable-specialist-ensembl.md` | 211 | — |
| `docs/02-anthropic-vacancies/124-конфигурация-для-claude-desktop.md` | 212 | 2026-04-29 |
| `docs/02-anthropic-vacancies/206-приложение-b-матрица-сравнения-областей.md` | 212 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/320-references.md` | 212 | — |
| `docs/obsidian/02-anthropic-vacancies/352-что-ты-не-можешь-делать-без-max-approval.md` | 212 | — |
| `docs/obsidian/02-anthropic-vacancies/53-history.md` | 212 | — |
| `docs/obsidian/02-anthropic-vacancies/185-appendix-b-domain-comparison-matrix.md` | 213 | — |
| `docs/obsidian/02-anthropic-vacancies/09-4-passport-passport-md.md` | 214 | — |
| `docs/obsidian/02-anthropic-vacancies/338-ссылки.md` | 214 | — |
| `docs/obsidian/02-anthropic-vacancies/353-что-ты-не-можешь-делать-вообще.md` | 214 | — |
| `docs/obsidian/02-anthropic-vacancies/357-твоя-коммуникация-в-outreach.md` | 214 | — |
| `docs/02-anthropic-vacancies/40-bridges.md` | 215 | 2026-04-29 |
| `docs/02-anthropic-vacancies/50-bridges.md` | 215 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/167-ai-mediated-representation-for-underrepresented-ex.md` | 215 | — |
| `docs/obsidian/02-anthropic-vacancies/96-21-adr-003-five-onboarding-paths-as-equal-rank.md` | 215 | — |
| `docs/02-anthropic-vacancies/202-12-заключение.md` | 216 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/128-доступные-инструменты.md` | 216 | — |
| `docs/obsidian/02-anthropic-vacancies/130-отладка.md` | 216 | — |
| `docs/obsidian/02-anthropic-vacancies/48-content-overview.md` | 216 | — |
| `docs/obsidian/02-anthropic-vacancies/298-что-этот-документ-не-решает.md` | 218 | — |
| `docs/obsidian/02-anthropic-vacancies/54-for-the-curious-philosophy.md` | 218 | — |
| `docs/02-anthropic-vacancies/224-acknowledgments.md` | 219 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/308-table-of-contents.md` | 219 | — |
| `docs/02-anthropic-vacancies/345-кто-ты.md` | 220 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/340-приложение-b-сравнительная-матрица.md` | 220 | — |
| `docs/02-anthropic-vacancies/349-твоя-личность.md` | 223 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/209-a-typology-of-ai-agents-on-the-principal-side-and-.md` | 224 | — |
| `docs/obsidian/02-anthropic-vacancies/124-конфигурация-для-claude-desktop.md` | 226 | — |
| `docs/obsidian/02-anthropic-vacancies/358-твоя-relationship-с-другими-ai.md` | 226 | — |
| `docs/obsidian/02-anthropic-vacancies/40-bridges.md` | 226 | — |
| `docs/obsidian/02-anthropic-vacancies/50-bridges.md` | 226 | — |
| `docs/obsidian/02-anthropic-vacancies/205-приложение-a-связь-с-сопроводительными-статьями.md` | 227 | — |
| `docs/obsidian/02-anthropic-vacancies/206-приложение-b-матрица-сравнения-областей.md` | 227 | — |
| `docs/obsidian/02-anthropic-vacancies/202-12-заключение.md` | 228 | — |
| `docs/obsidian/02-anthropic-vacancies/224-acknowledgments.md` | 230 | — |
| `docs/02-anthropic-vacancies/301-благодарности.md` | 231 | 2026-04-29 |
| `docs/02-anthropic-vacancies/103-appendix-b-change-log.md` | 232 | 2026-04-29 |
| `docs/02-anthropic-vacancies/26-14-adr-001-federation-over-merging.md` | 232 | 2026-04-29 |
| `docs/02-anthropic-vacancies/356-твой-workflow.md` | 232 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/345-кто-ты.md` | 232 | — |
| `docs/02-anthropic-vacancies/37-native-format.md` | 234 | 2026-04-29 |
| `docs/02-anthropic-vacancies/28-appendix-a-minimal-working-example.md` | 235 | 2026-04-29 |
| `docs/02-anthropic-vacancies/24-12-versioning-policy.md` | 237 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/349-твоя-личность.md` | 237 | — |
| `docs/02-anthropic-vacancies/94-19-adr-001-federation-over-merging.md` | 238 | 2026-04-29 |
| `docs/02-anthropic-vacancies/300-заключение.md` | 239 | 2026-04-29 |
| `docs/02-anthropic-vacancies/302-ссылки.md` | 239 | 2026-04-29 |
| `docs/02-anthropic-vacancies/149-appendix-b-summary-of-contributions.md` | 240 | 2026-04-29 |
| `docs/02-anthropic-vacancies/184-appendix-a-connection-to-companion-papers.md` | 240 | 2026-04-29 |
| `docs/02-anthropic-vacancies/97-22-glossary-of-reference-examples.md` | 240 | 2026-04-29 |
| `docs/02-anthropic-vacancies/21-9-query-flow.md` | 241 | 2026-04-29 |
| `docs/02-anthropic-vacancies/321-appendix-a-decision-tree-for-ingit-adopters.md` | 241 | 2026-04-29 |
| `docs/02-anthropic-vacancies/93-18-reference-implementation.md` | 243 | 2026-04-29 |
| `docs/02-anthropic-vacancies/95-20-adr-002-q6-as-first-class-protocol-concept.md` | 244 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/301-благодарности.md` | 244 | — |
| `docs/obsidian/02-anthropic-vacancies/356-твой-workflow.md` | 244 | — |
| `docs/02-anthropic-vacancies/182-acknowledgments.md` | 245 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/37-native-format.md` | 246 | — |
| `docs/02-anthropic-vacancies/355-существующие-документы-dhlab-твой-context.md` | 247 | 2026-04-29 |
| `docs/02-anthropic-vacancies/23-11-security-considerations.md` | 248 | 2026-04-29 |
| `docs/02-anthropic-vacancies/89-14-sdk-contract-informative.md` | 248 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/103-appendix-b-change-log.md` | 248 | — |
| `docs/obsidian/02-anthropic-vacancies/26-14-adr-001-federation-over-merging.md` | 249 | — |
| `docs/02-anthropic-vacancies/247-приложение-b-рамка-принятия-решений-когда-строить-.md` | 250 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/24-12-versioning-policy.md` | 250 | — |
| `docs/obsidian/02-anthropic-vacancies/28-appendix-a-minimal-working-example.md` | 250 | — |
| `docs/obsidian/02-anthropic-vacancies/302-ссылки.md` | 250 | — |
| `docs/02-anthropic-vacancies/289-инфраструктура-для-ai-совместной-интеллектуальной-.md` | 251 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/300-заключение.md` | 252 | — |
| `docs/obsidian/02-anthropic-vacancies/21-9-query-flow.md` | 254 | — |
| `docs/obsidian/02-anthropic-vacancies/149-appendix-b-summary-of-contributions.md` | 255 | — |
| `docs/obsidian/02-anthropic-vacancies/94-19-adr-001-federation-over-merging.md` | 255 | — |
| `docs/obsidian/02-anthropic-vacancies/182-acknowledgments.md` | 256 | — |
| `docs/obsidian/02-anthropic-vacancies/321-appendix-a-decision-tree-for-ingit-adopters.md` | 256 | — |
| `docs/03-technology-combinations/01-agent-routing.md` | 257 | 2026-04-29 |
| `docs/02-anthropic-vacancies/110-вопрос-fallback-ratio-как-критический-или-осмыслен.md` | 258 | 2026-04-29 |
| `docs/02-anthropic-vacancies/117-10-конкретный-план-применения-к-текущим-документам.md` | 258 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/184-appendix-a-connection-to-companion-papers.md` | 258 | — |
| `docs/obsidian/02-anthropic-vacancies/93-18-reference-implementation.md` | 258 | — |
| `docs/02-anthropic-vacancies/283-what-this-document-doesn-t-solve.md` | 259 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/97-22-glossary-of-reference-examples.md` | 259 | — |
| `docs/02-anthropic-vacancies/19-7-portalentry-structure.md` | 260 | 2026-04-29 |
| `docs/02-anthropic-vacancies/274-the-missing-middle-layer-between-chat-and-code.md` | 260 | 2026-04-29 |
| `docs/02-anthropic-vacancies/74-abstract.md` | 260 | 2026-04-29 |
| `docs/02-anthropic-vacancies/86-11-relevance-ranking.md` | 261 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/95-20-adr-002-q6-as-first-class-protocol-concept.md` | 261 | — |
| `docs/obsidian/02-anthropic-vacancies/89-14-sdk-contract-informative.md` | 262 | — |
| `docs/02-anthropic-vacancies/286-acknowledgments.md` | 263 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/355-существующие-документы-dhlab-твой-context.md` | 264 | — |
| `docs/obsidian/02-anthropic-vacancies/23-11-security-considerations.md` | 265 | — |
| `docs/obsidian/02-anthropic-vacancies/289-инфраструктура-для-ai-совместной-интеллектуальной-.md` | 268 | — |
| `docs/obsidian/03-technology-combinations/01-agent-routing.md` | 269 | — |
| `docs/02-anthropic-vacancies/285-closing.md` | 270 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/247-приложение-b-рамка-принятия-решений-когда-строить-.md` | 271 | — |
| `docs/obsidian/02-anthropic-vacancies/74-abstract.md` | 271 | — |
| `docs/02-anthropic-vacancies/146-acknowledgments.md` | 273 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/86-11-relevance-ranking.md` | 274 | — |
| `docs/obsidian/02-anthropic-vacancies/283-what-this-document-doesn-t-solve.md` | 276 | — |
| `docs/obsidian/02-anthropic-vacancies/286-acknowledgments.md` | 276 | — |
| `docs/obsidian/02-anthropic-vacancies/117-10-конкретный-план-применения-к-текущим-документам.md` | 277 | — |
| `docs/obsidian/02-anthropic-vacancies/19-7-portalentry-structure.md` | 277 | — |
| `docs/obsidian/02-anthropic-vacancies/110-вопрос-fallback-ratio-как-критический-или-осмыслен.md` | 278 | — |
| `docs/02-anthropic-vacancies/111-4-условия-применимости.md` | 279 | 2026-04-29 |
| `docs/02-anthropic-vacancies/322-appendix-b-comparison-matrix.md` | 279 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/274-the-missing-middle-layer-between-chat-and-code.md` | 280 | — |
| `docs/02-anthropic-vacancies/181-12-closing.md` | 281 | 2026-04-29 |
| `docs/02-anthropic-vacancies/189-аннотация.md` | 281 | 2026-04-29 |
| `docs/02-anthropic-vacancies/306-with-anthropic-s-cowork-platform.md` | 282 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/285-closing.md` | 285 | — |
| `docs/02-anthropic-vacancies/85-10-query-flow.md` | 287 | 2026-04-29 |
| `docs/02-anthropic-vacancies/324-ingit-как-cowork-интегрированная-подложка-рабочего.md` | 288 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/146-acknowledgments.md` | 288 | — |
| `docs/02-anthropic-vacancies/269-appendix-a-the-six-type-taxonomy-updated.md` | 289 | 2026-04-29 |
| `docs/02-anthropic-vacancies/290-почему-этот-документ-существует.md` | 291 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/322-appendix-b-comparison-matrix.md` | 291 | — |
| `docs/02-anthropic-vacancies/119-appendix-b-примеры-расхождений-и-их-разрешения.md` | 292 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/189-аннотация.md` | 292 | — |
| `docs/02-anthropic-vacancies/297-что-промышленность-вероятно-построит.md` | 293 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/181-12-closing.md` | 293 | — |
| `docs/02-anthropic-vacancies/92-17-versioning-policy.md` | 294 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/306-with-anthropic-s-cowork-platform.md` | 294 | — |
| `docs/02-anthropic-vacancies/287-references.md` | 295 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/111-4-условия-применимости.md` | 296 | — |
| `docs/02-anthropic-vacancies/267-acknowledgments.md` | 297 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/85-10-query-flow.md` | 300 | — |
| `docs/02-anthropic-vacancies/20-8-consensus-algorithm.md` | 302 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/324-ingit-как-cowork-интегрированная-подложка-рабочего.md` | 302 | — |
| `docs/05-habr-projects/02-collaboration-partners.md` | 303 | 2026-04-29 |
| `docs/02-anthropic-vacancies/17-5-compatibility-levels.md` | 304 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/269-appendix-a-the-six-type-taxonomy-updated.md` | 305 | — |
| `docs/02-anthropic-vacancies/204-ссылки.md` | 306 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/287-references.md` | 306 | — |
| `docs/obsidian/02-anthropic-vacancies/92-17-versioning-policy.md` | 307 | — |
| `docs/obsidian/02-anthropic-vacancies/290-почему-этот-документ-существует.md` | 309 | — |
| `docs/02-anthropic-vacancies/230-аннотация.md` | 310 | 2026-04-29 |
| `docs/02-anthropic-vacancies/271-appendix-c-configuration-template-example.md` | 310 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/267-acknowledgments.md` | 310 | — |
| `docs/obsidian/02-anthropic-vacancies/119-appendix-b-примеры-расхождений-и-их-разрешения.md` | 311 | — |
| `docs/obsidian/02-anthropic-vacancies/297-что-промышленность-вероятно-построит.md` | 311 | — |
| `docs/02-anthropic-vacancies/07-2-terminology.md` | 313 | 2026-04-29 |
| `docs/02-anthropic-vacancies/293-почему-это-не-было-построено.md` | 313 | 2026-04-29 |
| `docs/02-anthropic-vacancies/98-appendix-a-minimal-working-example.md` | 313 | 2026-04-29 |
| `docs/02-anthropic-vacancies/354-существующий-landscape-collaborators-твоя-working-.md` | 314 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/20-8-consensus-algorithm.md` | 315 | — |
| `docs/02-anthropic-vacancies/296-рекурсивное-прозрение.md` | 316 | 2026-04-29 |
| `docs/02-anthropic-vacancies/270-appendix-b-sub-agent-registry-schema-sketch.md` | 317 | 2026-04-29 |
| `docs/02-anthropic-vacancies/325-аннотация.md` | 317 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/17-5-compatibility-levels.md` | 317 | — |
| `docs/obsidian/02-anthropic-vacancies/204-ссылки.md` | 319 | — |
| `docs/obsidian/05-habr-projects/02-collaboration-partners.md` | 320 | — |
| `docs/02-anthropic-vacancies/183-references.md` | 322 | 2026-04-29 |
| `docs/02-anthropic-vacancies/307-abstract.md` | 323 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/230-аннотация.md` | 323 | — |
| `docs/02-anthropic-vacancies/242-11-призыв-к-сотрудничеству.md` | 325 | 2026-04-29 |
| `docs/02-anthropic-vacancies/282-what-industry-will-likely-build.md` | 325 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/271-appendix-c-configuration-template-example.md` | 325 | — |
| `docs/obsidian/02-anthropic-vacancies/325-аннотация.md` | 326 | — |
| `docs/02-anthropic-vacancies/114-7-реализация-в-проекте-nautilus.md` | 327 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/07-2-terminology.md` | 327 | — |
| `docs/obsidian/02-anthropic-vacancies/98-appendix-a-minimal-working-example.md` | 328 | — |
| `docs/obsidian/02-anthropic-vacancies/293-почему-это-не-было-построено.md` | 330 | — |
| `docs/02-anthropic-vacancies/116-9-checklist-применения-методологии.md` | 331 | 2026-04-29 |
| `docs/02-anthropic-vacancies/245-ссылки.md` | 331 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/270-appendix-b-sub-agent-registry-schema-sketch.md` | 331 | — |
| `docs/02-anthropic-vacancies/148-appendix-a-glossary.md` | 332 | 2026-04-29 |
| `docs/02-anthropic-vacancies/227-appendix-b-decision-framework-when-to-build-type-1.md` | 332 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/307-abstract.md` | 332 | — |
| `docs/obsidian/02-anthropic-vacancies/183-references.md` | 333 | — |
| `docs/02-anthropic-vacancies/168-abstract.md` | 334 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/296-рекурсивное-прозрение.md` | 334 | — |
| `docs/02-anthropic-vacancies/299-практические-рекомендации-для-текущего-проекта.md` | 335 | 2026-04-29 |
| `docs/02-anthropic-vacancies/291-двухслойный-стек-как-он-существует.md` | 338 | 2026-04-29 |
| `docs/02-anthropic-vacancies/82-7-portalentry-structure.md` | 338 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/242-11-призыв-к-сотрудничеству.md` | 339 | — |
| `docs/02-anthropic-vacancies/112-5-связь-с-существующими-методологиями.md` | 340 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/354-существующий-landscape-collaborators-твоя-working-.md` | 340 | — |
| `docs/obsidian/02-anthropic-vacancies/282-what-industry-will-likely-build.md` | 342 | — |
| `docs/obsidian/02-anthropic-vacancies/245-ссылки.md` | 344 | — |
| `docs/obsidian/02-anthropic-vacancies/116-9-checklist-применения-методологии.md` | 345 | — |
| `docs/obsidian/02-anthropic-vacancies/148-appendix-a-glossary.md` | 345 | — |
| `docs/obsidian/02-anthropic-vacancies/168-abstract.md` | 345 | — |
| `docs/obsidian/02-anthropic-vacancies/114-7-реализация-в-проекте-nautilus.md` | 346 | — |
| `docs/02-anthropic-vacancies/252-abstract.md` | 347 | 2026-04-29 |
| `docs/02-anthropic-vacancies/210-abstract.md` | 349 | 2026-04-29 |
| `docs/02-anthropic-vacancies/147-references.md` | 350 | 2026-04-29 |
| `docs/02-anthropic-vacancies/275-why-this-document-exists.md` | 350 | 2026-04-29 |
| `docs/02-anthropic-vacancies/225-references.md` | 351 | 2026-04-29 |
| `docs/02-anthropic-vacancies/337-благодарности.md` | 351 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/299-практические-рекомендации-для-текущего-проекта.md` | 352 | — |
| `docs/obsidian/02-anthropic-vacancies/227-appendix-b-decision-framework-when-to-build-type-1.md` | 353 | — |
| `docs/02-anthropic-vacancies/90-15-security-considerations.md` | 354 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/291-двухслойный-стек-как-он-существует.md` | 355 | — |
| `docs/obsidian/02-anthropic-vacancies/82-7-portalentry-structure.md` | 355 | — |
| `docs/02-anthropic-vacancies/79-4-passport-passport-md.md` | 357 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/112-5-связь-с-существующими-методологиями.md` | 357 | — |
| `docs/obsidian/02-anthropic-vacancies/252-abstract.md` | 358 | — |
| `docs/01-svyazi/08-conclusions.md` | 360 | 2026-04-29 |
| `docs/02-anthropic-vacancies/241-10-открытые-вопросы.md` | 364 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/210-abstract.md` | 364 | — |
| `docs/obsidian/02-anthropic-vacancies/225-references.md` | 364 | — |
| `docs/obsidian/02-anthropic-vacancies/337-благодарности.md` | 364 | — |
| `docs/obsidian/02-anthropic-vacancies/147-references.md` | 365 | — |
| `docs/02-anthropic-vacancies/246-приложение-a-сравнительная-таблица-пять-типов-аген.md` | 367 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/275-why-this-document-exists.md` | 368 | — |
| `docs/02-anthropic-vacancies/153-executive-summary.md` | 370 | 2026-04-29 |
| `docs/02-anthropic-vacancies/200-10-открытые-вопросы.md` | 370 | 2026-04-29 |
| `docs/02-anthropic-vacancies/80-5-compatibility-levels.md` | 370 | 2026-04-29 |
| `docs/obsidian/01-svyazi/08-conclusions.md` | 370 | — |
| `docs/obsidian/02-anthropic-vacancies/79-4-passport-passport-md.md` | 370 | — |
| `docs/02-anthropic-vacancies/281-the-recursive-insight.md` | 371 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/90-15-security-considerations.md` | 371 | — |
| `docs/02-anthropic-vacancies/243-12-заключение.md` | 375 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/241-10-открытые-вопросы.md` | 377 | — |
| `docs/02-anthropic-vacancies/278-why-this-hasn-t-been-built.md` | 378 | 2026-04-29 |
| `docs/02-anthropic-vacancies/06-1-introduction.md` | 380 | 2026-04-29 |
| `docs/02-anthropic-vacancies/333-7-практические-первые-шаги-в-этом-месяце.md` | 380 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/153-executive-summary.md` | 382 | — |
| `docs/obsidian/02-anthropic-vacancies/200-10-открытые-вопросы.md` | 383 | — |
| `docs/obsidian/02-anthropic-vacancies/80-5-compatibility-levels.md` | 383 | — |
| `docs/02-anthropic-vacancies/319-acknowledgments.md` | 384 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/281-the-recursive-insight.md` | 384 | — |
| `docs/obsidian/02-anthropic-vacancies/246-приложение-a-сравнительная-таблица-пять-типов-аген.md` | 385 | — |
| `docs/02-anthropic-vacancies/284-practical-recommendations-for-the-current-project.md` | 386 | 2026-04-29 |
| `docs/03-technology-combinations/03-local-first.md` | 386 | 2026-04-29 |
| `docs/02-anthropic-vacancies/136-abstract.md` | 388 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/243-12-заключение.md` | 389 | — |
| `docs/02-anthropic-vacancies/226-appendix-a-comparative-table-five-agent-types.md` | 392 | 2026-04-29 |
| `docs/02-anthropic-vacancies/81-6-adapter-interface.md` | 392 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/06-1-introduction.md` | 392 | — |
| `docs/obsidian/02-anthropic-vacancies/278-why-this-hasn-t-been-built.md` | 395 | — |
| `docs/obsidian/02-anthropic-vacancies/333-7-практические-первые-шаги-в-этом-месяце.md` | 397 | — |
| `docs/obsidian/03-technology-combinations/03-local-first.md` | 398 | — |
| `docs/02-anthropic-vacancies/197-7-управление-и-надзор.md` | 399 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/319-acknowledgments.md` | 399 | — |
| `docs/obsidian/02-anthropic-vacancies/136-abstract.md` | 401 | — |
| `docs/02-anthropic-vacancies/77-2-terminology.md` | 403 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/284-practical-recommendations-for-the-current-project.md` | 404 | — |
| `docs/obsidian/02-anthropic-vacancies/81-6-adapter-interface.md` | 405 | — |
| `docs/02-anthropic-vacancies/276-the-two-layer-stack-as-it-exists.md` | 406 | 2026-04-29 |
| `docs/02-anthropic-vacancies/84-9-consensus-algorithm.md` | 407 | 2026-04-29 |
| `docs/02-anthropic-vacancies/223-12-closing.md` | 409 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/226-appendix-a-comparative-table-five-agent-types.md` | 410 | — |
| `docs/02-anthropic-vacancies/222-11-call-for-collaboration.md` | 411 | 2026-04-29 |
| `docs/02-anthropic-vacancies/107-1-контекст-и-мотивация.md` | 412 | 2026-04-29 |
| `docs/02-anthropic-vacancies/115-8-ограничения-и-открытые-вопросы.md` | 412 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/197-7-управление-и-надзор.md` | 413 | — |
| `docs/02-anthropic-vacancies/201-11-призыв-к-сотрудничеству.md` | 414 | 2026-04-29 |
| `docs/02-anthropic-vacancies/268-references.md` | 416 | 2026-04-29 |
| `docs/02-anthropic-vacancies/292-что-отсутствует-слой-b.md` | 419 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/77-2-terminology.md` | 419 | — |
| `docs/obsidian/02-anthropic-vacancies/84-9-consensus-algorithm.md` | 420 | — |
| `docs/02-anthropic-vacancies/08-3-registry-nautilus-json.md` | 422 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/223-12-closing.md` | 423 | — |
| `docs/obsidian/02-anthropic-vacancies/276-the-two-layer-stack-as-it-exists.md` | 424 | — |
| `docs/02-anthropic-vacancies/18-6-adapter-interface.md` | 425 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/222-11-call-for-collaboration.md` | 427 | — |
| `docs/01-svyazi/02-methodology.md` | 428 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/115-8-ограничения-и-открытые-вопросы.md` | 429 | — |
| `docs/obsidian/02-anthropic-vacancies/107-1-контекст-и-мотивация.md` | 430 | — |
| `docs/obsidian/02-anthropic-vacancies/201-11-призыв-к-сотрудничеству.md` | 430 | — |
| `docs/obsidian/02-anthropic-vacancies/268-references.md` | 431 | — |
| `docs/02-anthropic-vacancies/266-13-closing.md` | 434 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/292-что-отсутствует-слой-b.md` | 434 | — |
| `docs/obsidian/02-anthropic-vacancies/08-3-registry-nautilus-json.md` | 435 | — |
| `docs/obsidian/02-anthropic-vacancies/18-6-adapter-interface.md` | 442 | — |
| `docs/02-anthropic-vacancies/179-10-open-questions.md` | 446 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/266-13-closing.md` | 446 | — |
| `docs/02-anthropic-vacancies/180-11-call-for-collaboration.md` | 447 | 2026-04-29 |
| `docs/02-anthropic-vacancies/265-12-call-for-collaboration.md` | 447 | 2026-04-29 |
| `docs/obsidian/01-svyazi/02-methodology.md` | 453 | — |
| `docs/obsidian/02-anthropic-vacancies/179-10-open-questions.md` | 459 | — |
| `docs/02-anthropic-vacancies/221-10-open-questions.md` | 460 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/180-11-call-for-collaboration.md` | 461 | — |
| `docs/obsidian/02-anthropic-vacancies/265-12-call-for-collaboration.md` | 463 | — |
| `docs/02-anthropic-vacancies/176-7-governance-and-oversight.md` | 472 | 2026-04-29 |
| `docs/02-anthropic-vacancies/76-1-introduction.md` | 473 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/221-10-open-questions.md` | 475 | — |
| `docs/02-anthropic-vacancies/277-what-s-missing-layer-b.md` | 477 | 2026-04-29 |
| `docs/02-anthropic-vacancies/108-2-формальный-workflow.md` | 479 | 2026-04-29 |
| `docs/02-anthropic-vacancies/315-7-practical-first-steps-this-month.md` | 483 | 2026-04-29 |
| `docs/02-anthropic-vacancies/87-12-onboarding-paths-normative.md` | 486 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/176-7-governance-and-oversight.md` | 486 | — |
| `docs/02-anthropic-vacancies/83-8-q6-space-normative.md` | 488 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/76-1-introduction.md` | 489 | — |
| `docs/02-anthropic-vacancies/196-6-этическая-рамка.md` | 492 | 2026-04-29 |
| `docs/04-ai-collaborations/08-что-это-продолжение-добавляет.md` | 492 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/277-what-s-missing-layer-b.md` | 492 | — |
| `docs/02-anthropic-vacancies/88-13-rest-api-contract-normative-for-portals.md` | 495 | 2026-04-29 |
| `docs/04-ai-collaborations/02-методика-и-рамка-отбора.md` | 495 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/108-2-формальный-workflow.md` | 496 | — |
| `docs/obsidian/04-ai-collaborations/08-что-это-продолжение-добавляет.md` | 535 | — |
| `docs/obsidian/04-ai-collaborations/02-методика-и-рамка-отбора.md` | 538 | — |
| `docs/02-anthropic-vacancies/109-3-принципы-консолидации-фаза-c.md` | 541 | 2026-04-29 |
| `docs/04-ai-collaborations/07-выводы.md` | 542 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/315-7-practical-first-steps-this-month.md` | 542 | — |
| `docs/obsidian/02-anthropic-vacancies/83-8-q6-space-normative.md` | 549 | — |
| `docs/obsidian/04-ai-collaborations/07-выводы.md` | 551 | — |
| `docs/obsidian/02-anthropic-vacancies/196-6-этическая-рамка.md` | 553 | — |
| `docs/obsidian/02-anthropic-vacancies/109-3-принципы-консолидации-фаза-c.md` | 560 | — |
| `docs/obsidian/02-anthropic-vacancies/88-13-rest-api-contract-normative-for-portals.md` | 561 | — |
| `docs/02-anthropic-vacancies/332-6-уточнённый-объём-ingit-с-учётом-cowork.md` | 562 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/87-12-onboarding-paths-normative.md` | 562 | — |
| `docs/02-anthropic-vacancies/294-существующие-приближения.md` | 565 | 2026-04-29 |
| `docs/02-anthropic-vacancies/314-6-refined-ingit-scope-with-cowork-in-mind.md` | 569 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/294-существующие-приближения.md` | 581 | — |
| `docs/obsidian/02-anthropic-vacancies/332-6-уточнённый-объём-ingit-с-учётом-cowork.md` | 581 | — |
| `docs/02-anthropic-vacancies/138-1-why-single-triangle-models-are-incomplete.md` | 583 | 2026-04-29 |
| `docs/02-anthropic-vacancies/279-existing-approximations.md` | 588 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/314-6-refined-ingit-scope-with-cowork-in-mind.md` | 589 | — |
| `docs/02-anthropic-vacancies/78-3-registry-nautilus-json.md` | 592 | 2026-04-29 |
| `docs/02-anthropic-vacancies/199-9-стратегия-поэтапного-развёртывания.md` | 596 | 2026-04-29 |
| `docs/02-anthropic-vacancies/335-9-риски-и-открытые-вопросы.md` | 596 | 2026-04-29 |
| `docs/02-anthropic-vacancies/160-6-governance-and-ethics.md` | 600 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/138-1-why-single-triangle-models-are-incomplete.md` | 601 | — |
| `docs/obsidian/02-anthropic-vacancies/279-existing-approximations.md` | 604 | — |
| `docs/obsidian/02-anthropic-vacancies/78-3-registry-nautilus-json.md` | 605 | — |
| `docs/obsidian/02-anthropic-vacancies/335-9-риски-и-открытые-вопросы.md` | 609 | — |
| `docs/02-anthropic-vacancies/163-9-call-for-partnership.md` | 610 | 2026-04-29 |
| `docs/02-anthropic-vacancies/175-6-ethical-framework.md` | 611 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/199-9-стратегия-поэтапного-развёртывания.md` | 612 | — |
| `docs/obsidian/02-anthropic-vacancies/160-6-governance-and-ethics.md` | 616 | — |
| `docs/02-anthropic-vacancies/34-appendix-b-change-log.md` | 620 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/175-6-ethical-framework.md` | 622 | — |
| `docs/02-anthropic-vacancies/193-3-что-делает-агента-представительским.md` | 625 | 2026-04-29 |
| `docs/02-anthropic-vacancies/195-5-архитектурная-спецификация.md` | 625 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/163-9-call-for-partnership.md` | 626 | — |
| `docs/02-anthropic-vacancies/155-1-problem-statement.md` | 632 | 2026-04-29 |
| `docs/02-anthropic-vacancies/198-8-риски-и-меры-противодействия.md` | 634 | 2026-04-29 |
| `docs/01-svyazi/14-limitations.md` | 636 | 2026-04-29 |
| `docs/02-anthropic-vacancies/178-9-phased-rollout-strategy.md` | 636 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/195-5-архитектурная-спецификация.md` | 636 | — |
| `docs/02-anthropic-vacancies/264-11-open-questions.md` | 638 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/34-appendix-b-change-log.md` | 638 | — |
| `docs/obsidian/02-anthropic-vacancies/193-3-что-делает-агента-представительским.md` | 644 | — |
| `docs/obsidian/02-anthropic-vacancies/155-1-problem-statement.md` | 645 | — |
| `docs/obsidian/01-svyazi/14-limitations.md` | 646 | — |
| `docs/04-ai-collaborations/01-executive-summary.md` | 647 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/178-9-phased-rollout-strategy.md` | 650 | — |
| `docs/obsidian/02-anthropic-vacancies/198-8-риски-и-меры-противодействия.md` | 651 | — |
| `docs/02-anthropic-vacancies/162-8-risk-analysis.md` | 653 | 2026-04-29 |
| `docs/02-anthropic-vacancies/317-9-risks-and-open-questions.md` | 653 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/264-11-open-questions.md` | 653 | — |
| `docs/obsidian/04-ai-collaborations/01-executive-summary.md` | 657 | — |
| `docs/02-anthropic-vacancies/327-1-открытие-cowork-и-почему-это-меняет-всё.md` | 662 | 2026-04-29 |
| `docs/02-anthropic-vacancies/161-7-phased-rollout-plan.md` | 663 | 2026-04-29 |
| `docs/02-anthropic-vacancies/174-5-architectural-specification.md` | 665 | 2026-04-29 |
| `docs/02-anthropic-vacancies/177-8-risks-and-mitigations.md` | 666 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/317-9-risks-and-open-questions.md` | 666 | — |
| `docs/02-anthropic-vacancies/64-for-the-curious-philosophy.md` | 667 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/162-8-risk-analysis.md` | 670 | — |
| `docs/02-anthropic-vacancies/280-the-specific-case-in-front-of-us.md` | 674 | 2026-04-29 |
| `docs/02-anthropic-vacancies/141-4-nautilus-portal-as-reference-substrate.md` | 675 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/174-5-architectural-specification.md` | 676 | — |
| `docs/02-anthropic-vacancies/220-9-relationship-to-other-agent-types.md` | 677 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/161-7-phased-rollout-plan.md` | 677 | — |
| `docs/02-anthropic-vacancies/310-2-what-cowork-provides-that-ingit-doesn-t-need-to-.md` | 678 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/177-8-risks-and-mitigations.md` | 678 | — |
| `docs/obsidian/02-anthropic-vacancies/327-1-открытие-cowork-и-почему-это-меняет-всё.md` | 678 | — |
| `docs/02-anthropic-vacancies/143-6-four-deployment-domains.md` | 679 | 2026-04-29 |
| `docs/02-anthropic-vacancies/172-3-what-makes-a-representative-agent.md` | 681 | 2026-04-29 |
| `docs/02-anthropic-vacancies/157-3-why-existing-solutions-fail.md` | 682 | 2026-04-29 |
| `docs/02-anthropic-vacancies/159-5-economic-model.md` | 682 | 2026-04-29 |
| `docs/02-anthropic-vacancies/156-2-target-populations.md` | 683 | 2026-04-29 |
| `docs/02-anthropic-vacancies/238-7-области-применения.md` | 683 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/64-for-the-curious-philosophy.md` | 683 | — |
| `docs/02-anthropic-vacancies/142-5-pattern-library-as-bridge-between-triangles.md` | 689 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/220-9-relationship-to-other-agent-types.md` | 691 | — |
| `docs/obsidian/02-anthropic-vacancies/280-the-specific-case-in-front-of-us.md` | 693 | — |
| `docs/02-anthropic-vacancies/295-конкретный-случай-перед-нами.md` | 694 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/156-2-target-populations.md` | 696 | — |
| `docs/obsidian/02-anthropic-vacancies/141-4-nautilus-portal-as-reference-substrate.md` | 697 | — |
| `docs/obsidian/02-anthropic-vacancies/143-6-four-deployment-domains.md` | 697 | — |
| `docs/obsidian/02-anthropic-vacancies/159-5-economic-model.md` | 697 | — |
| `docs/obsidian/02-anthropic-vacancies/172-3-what-makes-a-representative-agent.md` | 697 | — |
| `docs/02-anthropic-vacancies/254-1-why-the-binary-view-is-incomplete.md` | 698 | 2026-04-29 |
| `docs/02-anthropic-vacancies/309-1-the-cowork-discovery-and-why-it-changes-everythi.md` | 698 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/157-3-why-existing-solutions-fail.md` | 699 | — |
| `docs/obsidian/02-anthropic-vacancies/238-7-области-применения.md` | 700 | — |
| `docs/obsidian/02-anthropic-vacancies/310-2-what-cowork-provides-that-ingit-doesn-t-need-to-.md` | 700 | — |
| `docs/02-anthropic-vacancies/312-4-the-symbiotic-architecture.md` | 707 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/142-5-pattern-library-as-bridge-between-triangles.md` | 708 | — |
| `docs/obsidian/02-anthropic-vacancies/295-конкретный-случай-перед-нами.md` | 712 | — |
| `docs/02-anthropic-vacancies/334-8-импликации-для-nautilus-и-okwf.md` | 713 | 2026-04-29 |
| `docs/02-anthropic-vacancies/236-5-экономика-тиражирования-по-профессии.md` | 714 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/309-1-the-cowork-discovery-and-why-it-changes-everythi.md` | 715 | — |
| `docs/obsidian/02-anthropic-vacancies/254-1-why-the-binary-view-is-incomplete.md` | 719 | — |
| `docs/obsidian/02-anthropic-vacancies/312-4-the-symbiotic-architecture.md` | 719 | — |
| `docs/02-anthropic-vacancies/336-10-стратегическое-позиционирование.md` | 721 | 2026-04-29 |
| `docs/02-anthropic-vacancies/330-4-симбиотическая-архитектура.md` | 726 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/236-5-экономика-тиражирования-по-профессии.md` | 729 | — |
| `docs/01-svyazi/01-executive-summary.md` | 731 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/334-8-импликации-для-nautilus-и-okwf.md` | 731 | — |
| `docs/obsidian/02-anthropic-vacancies/336-10-стратегическое-позиционирование.md` | 732 | — |
| `docs/01-svyazi/12-roadmap.md` | 733 | 2026-04-29 |
| `docs/02-anthropic-vacancies/316-8-implications-for-nautilus-and-okwf.md` | 736 | 2026-04-29 |
| `docs/02-anthropic-vacancies/218-7-application-domains.md` | 743 | 2026-04-29 |
| `docs/obsidian/01-svyazi/12-roadmap.md` | 743 | — |
| `docs/obsidian/02-anthropic-vacancies/330-4-симбиотическая-архитектура.md` | 743 | — |
| `docs/obsidian/01-svyazi/01-executive-summary.md` | 744 | — |
| `docs/01-svyazi/11-integration-contracts.md` | 745 | 2026-04-29 |
| `docs/02-anthropic-vacancies/258-5-configuration-how-principals-build-their-ensembl.md` | 745 | 2026-04-29 |
| `docs/02-anthropic-vacancies/145-8-call-to-action.md` | 746 | 2026-04-29 |
| `docs/02-anthropic-vacancies/233-2-что-делает-агента-профессиональным-коллегой.md` | 749 | 2026-04-29 |
...
| `docs/02-anthropic-vacancies/262-9-integration-with-okwf-infrastructure.md` | 750 | 2026-04-29 |
| `docs/02-anthropic-vacancies/191-1-синдром-золушки-почему-качество-остаётся-невидим.md` | 751 | 2026-04-29 |
| `docs/02-anthropic-vacancies/240-9-связь-с-другими-типами-агентов.md` | 751 | 2026-04-29 |
| `docs/02-anthropic-vacancies/216-5-the-economics-of-profession-wide-replication.md` | 753 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/316-8-implications-for-nautilus-and-okwf.md` | 754 | — |
| `docs/02-anthropic-vacancies/139-2-the-double-triangle-architecture.md` | 755 | 2026-04-29 |
| `docs/obsidian/01-svyazi/11-integration-contracts.md` | 756 | — |
| `docs/01-svyazi/09-architectural-gaps.md` | 757 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/218-7-application-domains.md` | 758 | — |
| `docs/obsidian/02-anthropic-vacancies/318-10-strategic-positioning.md` | 760 | — |
| `docs/obsidian/02-anthropic-vacancies/258-5-configuration-how-principals-build-their-ensembl.md` | 762 | — |
| `docs/obsidian/02-anthropic-vacancies/145-8-call-to-action.md` | 764 | — |
| `docs/obsidian/02-anthropic-vacancies/233-2-что-делает-агента-профессиональным-коллегой.md` | 765 | — |
| `docs/03-technology-combinations/02-knowledge-graphs.md` | 766 | 2026-04-29 |
| `docs/obsidian/01-svyazi/09-architectural-gaps.md` | 768 | — |
| `docs/obsidian/02-anthropic-vacancies/191-1-синдром-золушки-почему-качество-остаётся-невидим.md` | 768 | — |
| `docs/obsidian/02-anthropic-vacancies/139-2-the-double-triangle-architecture.md` | 769 | — |
| `docs/obsidian/02-anthropic-vacancies/240-9-связь-с-другими-типами-агентов.md` | 769 | — |
| `docs/obsidian/02-anthropic-vacancies/262-9-integration-with-okwf-infrastructure.md` | 769 | — |
| `docs/obsidian/02-anthropic-vacancies/216-5-the-economics-of-profession-wide-replication.md` | 771 | — |
| `docs/02-anthropic-vacancies/328-2-что-cowork-обеспечивает-что-ingit-не-нужно-строи.md` | 774 | 2026-04-29 |
| `docs/02-anthropic-vacancies/144-7-open-questions.md` | 777 | 2026-04-29 |
| `docs/obsidian/03-technology-combinations/02-knowledge-graphs.md` | 779 | — |
| `docs/02-anthropic-vacancies/234-3-эмпирический-кейс-обучай.md` | 782 | 2026-04-29 |
| `docs/02-anthropic-vacancies/263-10-risks-specific-to-composite-architectures.md` | 788 | 2026-04-29 |
| `docs/02-anthropic-vacancies/260-7-economics-of-combinatorial-replication.md` | 790 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/144-7-open-questions.md` | 792 | — |
| `docs/obsidian/02-anthropic-vacancies/328-2-что-cowork-обеспечивает-что-ingit-не-нужно-строи.md` | 795 | — |
| `docs/obsidian/02-anthropic-vacancies/234-3-эмпирический-кейс-обучай.md` | 798 | — |
| `docs/obsidian/02-anthropic-vacancies/263-10-risks-specific-to-composite-architectures.md` | 802 | — |
| `docs/02-anthropic-vacancies/257-4-the-sub-agent-registry.md` | 803 | 2026-04-29 |
| `docs/02-anthropic-vacancies/259-6-coordination-and-disagreement-resolution.md` | 804 | 2026-04-29 |
| `docs/02-anthropic-vacancies/67-о-проекте.md` | 804 | 2026-04-29 |
| `docs/02-anthropic-vacancies/331-5-четыре-пути-интеграции-в-порядке-доступности.md` | 807 | 2026-04-29 |
| `docs/02-anthropic-vacancies/313-5-four-integration-paths-in-order-of-accessibility.md` | 810 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/260-7-economics-of-combinatorial-replication.md` | 811 | — |
| `docs/obsidian/02-anthropic-vacancies/257-4-the-sub-agent-registry.md` | 815 | — |
| `docs/01-svyazi/06-security-privacy.md` | 821 | 2026-04-29 |
| `docs/02-anthropic-vacancies/72-расписание-фазы-3.md` | 821 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/259-6-coordination-and-disagreement-resolution.md` | 821 | — |
| `docs/obsidian/02-anthropic-vacancies/67-о-проекте.md` | 821 | — |
| `docs/02-anthropic-vacancies/235-4-архитектура-профессиональных-коллег-агентов.md` | 823 | 2026-04-29 |
| `docs/01-svyazi/13-contacts.md` | 827 | 2026-04-29 |
| `docs/02-anthropic-vacancies/170-1-the-cinderella-syndrome-why-quality-stays-invisi.md` | 828 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/331-5-четыре-пути-интеграции-в-порядке-доступности.md` | 828 | — |
| `docs/obsidian/01-svyazi/06-security-privacy.md` | 832 | — |
| `docs/obsidian/02-anthropic-vacancies/313-5-four-integration-paths-in-order-of-accessibility.md` | 834 | — |
| `docs/obsidian/01-svyazi/13-contacts.md` | 837 | — |
| `docs/obsidian/02-anthropic-vacancies/72-расписание-фазы-3.md` | 838 | — |
| `docs/obsidian/02-anthropic-vacancies/235-4-архитектура-профессиональных-коллег-агентов.md` | 839 | — |
| `docs/02-anthropic-vacancies/255-2-the-twenty-one-teachers-pattern.md` | 844 | 2026-04-29 |
| `docs/02-anthropic-vacancies/213-2-what-makes-a-professional-colleague-agent.md` | 845 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/170-1-the-cinderella-syndrome-why-quality-stays-invisi.md` | 846 | — |
| `docs/02-anthropic-vacancies/214-3-empirical-case-study-обучай.md` | 855 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/255-2-the-twenty-one-teachers-pattern.md` | 857 | — |
| `docs/04-ai-collaborations/12-дорожная-карта-прототипа-следующей-итерации.md` | 862 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/213-2-what-makes-a-professional-colleague-agent.md` | 862 | — |
| `docs/03-technology-combinations/05-benchmarks.md` | 863 | 2026-04-29 |
| `docs/02-anthropic-vacancies/311-3-what-ingit-provides-that-cowork-lacks.md` | 867 | 2026-04-29 |
| `docs/02-anthropic-vacancies/140-3-three-inter-layer-protocols.md` | 868 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/214-3-empirical-case-study-обучай.md` | 872 | — |
| `docs/obsidian/03-technology-combinations/05-benchmarks.md` | 874 | — |
| `docs/obsidian/04-ai-collaborations/12-дорожная-карта-прототипа-следующей-итерации.md` | 875 | — |
| `docs/02-anthropic-vacancies/68-about.md` | 880 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/140-3-three-inter-layer-protocols.md` | 880 | — |
| `docs/obsidian/02-anthropic-vacancies/311-3-what-ingit-provides-that-cowork-lacks.md` | 882 | — |
| `docs/02-anthropic-vacancies/232-1-типология-из-пяти-типов-агентов-на-стороне-принц.md` | 885 | 2026-04-29 |
| `docs/02-anthropic-vacancies/329-3-что-ingit-обеспечивает-чего-cowork-не-хватает.md` | 888 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/68-about.md` | 898 | — |
| `docs/02-anthropic-vacancies/192-2-исторические-прецеденты-агенты-как-цивилизационн.md` | 900 | 2026-04-29 |
| `docs/02-anthropic-vacancies/215-4-architecture-of-professional-colleague-agents.md` | 901 | 2026-04-29 |
| `docs/04-ai-collaborations/09-архитектурные-зазоры-которые-важнее-новых-инструме.md` | 901 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/232-1-типология-из-пяти-типов-агентов-на-стороне-принц.md` | 904 | — |
| `docs/obsidian/02-anthropic-vacancies/329-3-что-ingit-обеспечивает-чего-cowork-не-хватает.md` | 904 | — |
| `docs/obsidian/04-ai-collaborations/09-архитектурные-зазоры-которые-важнее-новых-инструме.md` | 915 | — |
| `docs/01-svyazi/10-second-order-ensembles.md` | 916 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/192-2-исторические-прецеденты-агенты-как-цивилизационн.md` | 919 | — |
| `docs/obsidian/02-anthropic-vacancies/215-4-architecture-of-professional-colleague-agents.md` | 919 | — |
| `docs/04-ai-collaborations/11-интеграционный-контракт-который-стоит-зафиксироват.md` | 928 | 2026-04-29 |
| `docs/obsidian/01-svyazi/10-second-order-ensembles.md` | 928 | — |
| `docs/02-anthropic-vacancies/212-1-the-five-type-typology-of-principal-side-agents.md` | 930 | 2026-04-29 |
| `docs/obsidian/04-ai-collaborations/11-интеграционный-контракт-который-стоит-зафиксироват.md` | 942 | — |
| `docs/02-anthropic-vacancies/256-3-what-makes-a-composite-skills-agent.md` | 946 | 2026-04-29 |
| `docs/02-anthropic-vacancies/104-appendix-c-references.md` | 947 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/212-1-the-five-type-typology-of-principal-side-agents.md` | 951 | — |
| `docs/04-ai-collaborations/13-контактная-стратегия-и-узкие-вопросы-для-авторов.md` | 956 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/256-3-what-makes-a-composite-skills-agent.md` | 961 | — |
| `docs/04-ai-collaborations/06-безопасность-приватность-и-бюджетный-роутинг.md` | 966 | 2026-04-29 |
| `docs/02-anthropic-vacancies/164-10-appendices.md` | 970 | 2026-04-29 |
| `docs/obsidian/04-ai-collaborations/13-контактная-стратегия-и-узкие-вопросы-для-авторов.md` | 971 | — |
| `docs/obsidian/02-anthropic-vacancies/104-appendix-c-references.md` | 972 | — |
| `docs/02-anthropic-vacancies/171-2-historical-precedents-agents-as-civilizational-i.md` | 973 | 2026-04-29 |
| `docs/02-anthropic-vacancies/239-8-пилотное-предложение-sgb-колega-адвокат.md` | 974 | 2026-04-29 |
| `docs/02-anthropic-vacancies/219-8-pilot-proposal-sgb-advocate-colleague.md` | 978 | 2026-04-29 |
| `docs/obsidian/04-ai-collaborations/06-безопасность-приватность-и-бюджетный-роутинг.md` | 979 | — |
| `docs/obsidian/02-anthropic-vacancies/164-10-appendices.md` | 988 | — |
| `docs/obsidian/02-anthropic-vacancies/171-2-historical-precedents-agents-as-civilizational-i.md` | 992 | — |
| `docs/obsidian/02-anthropic-vacancies/239-8-пилотное-предложение-sgb-колega-адвокат.md` | 995 | — |
| `docs/obsidian/02-anthropic-vacancies/219-8-pilot-proposal-sgb-advocate-colleague.md` | 998 | — |
| `docs/02-anthropic-vacancies/158-4-proposed-infrastructure.md` | 1001 | 2026-04-29 |
| `docs/02-anthropic-vacancies/261-8-seven-domains-of-application.md` | 1014 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/158-4-proposed-infrastructure.md` | 1020 | — |
| `docs/obsidian/02-anthropic-vacancies/261-8-seven-domains-of-application.md` | 1027 | — |
| `docs/04-ai-collaborations/10-новые-ансамбли-следующего-шага.md` | 1062 | 2026-04-29 |
| `docs/obsidian/04-ai-collaborations/10-новые-ансамбли-следующего-шага.md` | 1074 | — |
| `docs/02-anthropic-vacancies/288-appendix-position-in-series-visualization.md` | 1078 | 2026-04-29 |
| `docs/01-svyazi/07-mvp-planning.md` | 1083 | 2026-04-29 |
| `docs/obsidian/01-svyazi/07-mvp-planning.md` | 1094 | — |
| `docs/obsidian/02-anthropic-vacancies/288-appendix-position-in-series-visualization.md` | 1101 | — |
| `docs/02-anthropic-vacancies/237-6-риски-специфичные-для-этой-категории.md` | 1125 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/237-6-риски-специфичные-для-этой-категории.md` | 1143 | — |
| `docs/02-anthropic-vacancies/217-6-risks-specific-to-this-category.md` | 1209 | 2026-04-29 |
| `docs/04-ai-collaborations/05-план-прототипа-и-возможные-контакты.md` | 1212 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/217-6-risks-specific-to-this-category.md` | 1223 | — |
| `docs/obsidian/04-ai-collaborations/05-план-прототипа-и-возможные-контакты.md` | 1225 | — |
| `docs/01-svyazi/04-ensembles-overview.md` | 1274 | 2026-04-29 |
| `docs/obsidian/01-svyazi/04-ensembles-overview.md` | 1285 | — |
| `docs/02-anthropic-vacancies/122-глоссарий.md` | 1302 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/122-глоссарий.md` | 1319 | — |
| `docs/01-svyazi/03-component-catalog.md` | 1395 | 2026-04-29 |
| `docs/obsidian/01-svyazi/03-component-catalog.md` | 1406 | — |
| `docs/04-ai-collaborations/04-приоритетные-ансамбли.md` | 1418 | 2026-04-29 |
| `docs/obsidian/04-ai-collaborations/04-приоритетные-ансамбли.md` | 1428 | — |
| `docs/02-anthropic-vacancies/364-final-note-ты-experiment.md` | 1459 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/364-final-note-ты-experiment.md` | 1472 | — |
| `docs/02-anthropic-vacancies/173-4-ten-domains-of-application.md` | 1549 | 2026-04-29 |
| `docs/04-ai-collaborations/03-карта-найденных-проектов-и-паттернов.md` | 1553 | 2026-04-29 |
| `docs/obsidian/04-ai-collaborations/03-карта-найденных-проектов-и-паттернов.md` | 1566 | — |
| `docs/obsidian/02-anthropic-vacancies/173-4-ten-domains-of-application.md` | 1568 | — |
| `docs/02-anthropic-vacancies/323-appendix-c-sample-ingit-mcp-server-tool-specificat.md` | 1570 | 2026-04-29 |
| `docs/02-anthropic-vacancies/194-4-десять-областей-применения.md` | 1582 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/323-appendix-c-sample-ingit-mcp-server-tool-specificat.md` | 1586 | — |
| `docs/obsidian/02-anthropic-vacancies/194-4-десять-областей-применения.md` | 1598 | — |
| `docs/02-anthropic-vacancies/228-appendix-c-quick-start-architecture-for-sgb-advoca.md` | 1730 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/228-appendix-c-quick-start-architecture-for-sgb-advoca.md` | 1746 | — |
| `docs/02-anthropic-vacancies/186-appendix-c-sample-use-cases-in-detail.md` | 2024 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/186-appendix-c-sample-use-cases-in-detail.md` | 2051 | — |
| `docs/02-anthropic-vacancies/123-portal-mcp-py.md` | 2316 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/123-portal-mcp-py.md` | 2333 | — |
| `docs/02-anthropic-vacancies/02-общий-план-развития-nautilus-portal-protocol.md` | 3181 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/02-общий-план-развития-nautilus-portal-protocol.md` | 3213 | — |
| `docs/04-ai-collaborations/14-ограничения-лицензии-и-что-пока-лучше-не-склеивать.md` | 3362 | 2026-04-29 |
| `docs/obsidian/04-ai-collaborations/14-ограничения-лицензии-и-что-пока-лучше-не-склеивать.md` | 3378 | — |
| `docs/02-anthropic-vacancies/248-приложение-c-архитектура-быстрого-старта-для-sgb-а.md` | 3425 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/248-приложение-c-архитектура-быстрого-старта-для-sgb-а.md` | 3449 | — |
| `docs/02-anthropic-vacancies/366-технический-stack-svyazi-2-0-foundation.md` | 3835 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/366-технический-stack-svyazi-2-0-foundation.md` | 3848 | — |
| `docs/02-anthropic-vacancies/272-appendix-d-connection-diagram.md` | 3851 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/272-appendix-d-connection-diagram.md` | 3875 | — |
| `docs/02-anthropic-vacancies/207-приложение-c-образцы-случаев-использования-в-детал.md` | 4049 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/207-приложение-c-образцы-случаев-использования-в-детал.md` | 4070 | — |
| `docs/02-anthropic-vacancies/365-развёрнутый-анализ-внуковой-комбинации.md` | 4385 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/365-развёрнутый-анализ-внуковой-комбинации.md` | 4397 | — |
| `docs/02-anthropic-vacancies/343-lorenzo-catalyst-agent-глубокая-проработка-специфи.md` | 5807 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/343-lorenzo-catalyst-agent-глубокая-проработка-специфи.md` | 5824 | — |
| `docs/02-anthropic-vacancies/303-приложение-визуализация-позиции-в-серии.md` | 7108 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/303-приложение-визуализация-позиции-в-серии.md` | 7121 | — |
| `docs/02-anthropic-vacancies/150-appendix-c-version-history.md` | 8397 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/150-appendix-c-version-history.md` | 8409 | — |
| `docs/02-anthropic-vacancies/00-intro.md` | 8884 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/00-intro.md` | 8893 | — |
| `docs/02-anthropic-vacancies/165-closing.md` | 9251 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/165-closing.md` | 9260 | — |
| `docs/02-anthropic-vacancies/69-section.md` | 9520 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/69-section.md` | 9545 | — |
| `docs/02-anthropic-vacancies/342-что-такое-вариант-c-concept-document-для-anthropic.md` | 11237 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/342-что-такое-вариант-c-concept-document-для-anthropic.md` | 11256 | — |
| `docs/04-ai-collaborations/00-intro.md` | 11445 | 2026-04-29 |
| `docs/obsidian/04-ai-collaborations/00-intro.md` | 11454 | — |
| `docs/02-anthropic-vacancies/133-обратная-связь.md` | 16959 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/133-обратная-связь.md` | 16969 | — |
| `docs/02-anthropic-vacancies/01-интегральный-анализ-профиля-svend4.md` | 19103 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/01-интегральный-анализ-профиля-svend4.md` | 19115 | — |
| `docs/02-anthropic-vacancies/341-приложение-c-образец-спецификаций-инструментов-ing.md` | 20414 | 2026-04-29 |
| `docs/obsidian/02-anthropic-vacancies/341-приложение-c-образец-спецификаций-инструментов-ing.md` | 20430 | — |


### 127. Без метаданных (нет summary или тегов) — 93 файлов
...
### 128. Короткие (< 100 слов, заготовки) — 38 файлов
...
### 129. Сводная таблица по разделам
...
| `v1.1` | us-philosophy.md) - [PORTAL-PROTOCOL.md v1.1](73-portal-protocol-md-v1-1.md) - [README-MCP.md— инструкци | `docs/02-anthropic-vacancies/03-portal-protocol-md.md` |
| `v0.2.0` | ormat](47-native-format.md) - [Planned (v0.2.0)](132-planned-v0-2-0.md) - [README.md](65-readme-md.md) - [ | `docs/02-anthropic-vacancies/04-abstract.md` |
...
| `v1.1` | l-protocol-md.md) - [PORTAL-PROTOCOL.md v1.1](73-portal-protocol-md-v1-1.md) - [README-MCP.md— инструкци | `docs/02-anthropic-vacancies/05-0-status-of-this-document.md` |
...
| `v0.2.0` | ormat](37-native-format.md) - [Planned (v0.2.0)](132-planned-v0-2-0.md) - [Вакансии Anthropic — Анализ по | `docs/02-anthropic-vacancies/09-4-passport-passport-md.md` |
...
| `v1.1` | -b-change-log.md) - [PORTAL-PROTOCOL.md v1.1](73-portal-protocol-md-v1-1.md) - [README-MCP.md— инструкци | `docs/02-anthropic-vacancies/105-review-methodology-md.md` |
...
### 142. Топ уникальных слов по темам
...
### 144. 📝 Изменённые файлы (333)
_Файл: `docs/VERSION_DIFF.md` | 4 колонок, 333 строк_

| Файл | Δ слов | Добавленные темы | Удалённые темы |
|------|--------|------------------|----------------|
| `docs/TABLES.md` | +29596 | 04-ai-collaborations (38 таблиц), 05-habr-projects (6 таблиц), 1. Профиль +208 | 04-ai-collaborations (23 таблиц), 1. Авторы и коллаборации, 1. Карта найденных проектов и паттернов +35 |
| `docs/TIMELINE.md` | -2304 | 2020 (3 упоминаний), 2021 (1 упоминаний), 2022 (5 упоминаний) +8 | Версия (394), Год (27), Длительность (95) +6 |
| `docs/ACTION_ITEMS.md` | +1057 | ⚠️ Риски (312), ✅ Решения и рекомендации (153), ➡️ Следующие шаги (97) +3 | Содержание, ⚠️ Риски (183), ✅ Решения и рекомендации (94) +4 |
| `docs/QA.md` | -933 | — | Содержание |
| `docs/CONCEPTS.md` | -799 | Щ | — |
| `docs/02-anthropic-vacancies/README.md` | +798 | — | — |
| `docs/CHANGELOG.md` | +707 | (1 коммитов), 2026-04-29 (48 коммитов), 🐛 Исправления +1 | 2026-04-29 (10 коммитов) |
| `docs/README.md` | +606 | docs, Подразделы, Содержание | Документация Lorenzo, Навигация |
| `docs/SEARCH.md` | +533 | — | — |
| `docs/READING_ORDER.md` | -450 | — | — |
| `docs/CLUSTERS.md` | +443 | Contents, Связанные документы | — |
| `docs/TAGS.md` | -425 | #anthropic (137 файлов), #architecture (74 файлов), #collaboration (79 файлов) +9 | #anthropic (79 файлов), #architecture (205 файлов), #collaboration (155 файлов) +9 |
| `docs/LINKS.md` | +317 | — | — |
| `docs/SITEMAP.md` | +306 | autofilled, contacts, templates | — |
| `docs/04-ai-collaborations/README.md` | -240 | — | — |
| `docs/02-anthropic-vacancies/316-8-implications-for-nautilus-and-okwf.md` | +230 | Contents, Связанные документы, Содержание +1 | — |
| `docs/02-anthropic-vacancies/177-8-risks-and-mitigations.md` | +217 | Contents, Связанные документы, Содержание +1 | — |
| `docs/01-svyazi/README.md` | -213 | — | — |
| `docs/BROKEN_LINKS.md` | +209 | Внешние URL (188 уникальных) | Внешние URL (113 уникальных) |
| `docs/02-anthropic-vacancies/264-11-open-questions.md` | +203 | Contents, Связанные документы, Содержание +1 | — |
| `docs/02-anthropic-vacancies/163-9-call-for-partnership.md` | +191 | Contents, Связанные документы, Содержание +1 | — |
| `docs/02-anthropic-vacancies/317-9-risks-and-open-questions.md` | +183 | Contents, Связанные документы, Содержание +1 | — |
| `docs/02-anthropic-vacancies/312-4-the-symbiotic-architecture.md` | +182 | Contents, Связанные документы, Содержание +1 | — |
| `docs/02-anthropic-vacancies/175-6-ethical-framework.md` | +165 | Contents, Связанные документы, Содержание +1 | — |
| `docs/02-anthropic-vacancies/314-6-refined-ingit-scope-with-cowork-in-mind.md` | +162 | Contents, Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/178-9-phased-rollout-strategy.md` | +160 | Contents, Связанные документы, Содержание +1 | — |
| `docs/02-anthropic-vacancies/279-existing-approximations.md` | +159 | Contents, Связанные документы, Содержание +1 | — |
| `docs/02-anthropic-vacancies/208-professional-colleague-agents-md.md` | +158 | Связанные документы, Упоминается в | — |
| `docs/01-svyazi/01-executive-summary.md` | +157 | Contents, Связанные документы, Содержание +1 | — |
| `docs/02-anthropic-vacancies/249-composite-skills-agent-md.md` | +152 | Связанные документы, Упоминается в | — |
| `docs/04-ai-collaborations/01-executive-summary.md` | +151 | Связанные документы, Содержание, Статус +1 | — |
| `docs/02-anthropic-vacancies/151-open-knowledge-work-foundation-md.md` | +149 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/166-representative-agent-layer-md.md` | +149 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/134-the-double-triangle-architecture-md.md` | +148 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/304-ingit-as-cowork-native-workspace-substrate-md.md` | +144 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/268-references.md` | +143 | Contents, Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/315-7-practical-first-steps-this-month.md` | +143 | Contents, Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/138-1-why-single-triangle-models-are-incomplete.md` | +142 | Contents, Связанные документы, Содержание +1 | — |
| `docs/02-anthropic-vacancies/273-infrastructure-for-ai-collaborative-intellectual-w.md` | +142 | Связанные документы, Упоминается в | — |
| `docs/04-ai-collaborations/00-intro.md` | +137 | Связанные документы, Содержание, Статус +1 | — |
| `docs/02-anthropic-vacancies/159-5-economic-model.md` | +135 | Contents, Связанные документы, Содержание +1 | — |
| `docs/02-anthropic-vacancies/31-content-overview.md` | +131 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/12-content-overview.md` | +123 | Связанные документы, Упоминается в | — |
| `docs/WORD_CLOUD.md` | +123 | Связанные документы | — |
| `docs/05-habr-projects/memory/ngt-memory.md` | +120 | Связанные документы, Статус, Упоминается в | — |
| `docs/02-anthropic-vacancies/160-6-governance-and-ethics.md` | +119 | Contents, Связанные документы, Содержание +1 | — |
| `docs/02-anthropic-vacancies/305-a-practical-path-to-layer-b-through-symbiotic-inte.md` | +119 | Связанные документы, Упоминается в | — |
| `docs/DECISIONS.md` | +119 | Архитектура (21), Лицензия (8), Общее (145) +2 | Архитектура (18), Лицензия (4), Общее (98) +2 |
| `docs/02-anthropic-vacancies/221-10-open-questions.md` | +118 | Contents, Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/323-appendix-c-sample-ingit-mcp-server-tool-specificat.md` | +118 | Связанные документы, Содержание, Упоминается в | — |
| `docs/02-anthropic-vacancies/13-angle-perspective.md` | +116 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/228-appendix-c-quick-start-architecture-for-sgb-advoca.md` | +116 | Связанные документы, Содержание, Упоминается в | — |
| `docs/02-anthropic-vacancies/265-12-call-for-collaboration.md` | +116 | Contents, Связанные документы, Упоминается в | — |
| `docs/01-svyazi/07-mvp-planning.md` | +115 | Связанные документы, Содержание, Упоминается в | — |
| `docs/01-svyazi/13-contacts.md` | +114 | Связанные документы, Содержание, Упоминается в | — |
| `docs/02-anthropic-vacancies/167-ai-mediated-representation-for-underrepresented-ex.md` | +112 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/287-references.md` | +112 | Contents, Связанные документы, Упоминается в | — |
| `docs/01-svyazi/03-component-catalog.md` | +111 | Связанные документы, Содержание, Упоминается в | — |
| `docs/02-anthropic-vacancies/288-appendix-position-in-series-visualization.md` | +111 | Связанные документы, Содержание, Упоминается в | — |
| `docs/02-anthropic-vacancies/78-3-registry-nautilus-json.md` | +111 | Contents, Связанные документы, Содержание +1 | — |
| `docs/WORD_FREQ.md` | +111 | 01-svyazi (9,295 слов), 02-anthropic-vacancies (172,965 слов), 03-technology-combinations (1,980 слов) +7 | 01-svyazi (7,088 слов), 02-anthropic-vacancies (131,004 слов), 03-technology-combinations (1,657 слов) +3 |
| `docs/05-habr-projects/knowledge/wikontic.md` | +110 | Связанные документы, Статус, Упоминается в | — |
| `docs/02-anthropic-vacancies/222-11-call-for-collaboration.md` | +109 | Contents, Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/83-8-q6-space-normative.md` | +109 | Contents, Связанные документы, Упоминается в | — |
| `docs/05-habr-projects/memory/yodoca.md` | +109 | Связанные документы, Статус, Упоминается в | — |
| `docs/05-habr-projects/memory/memnet.md` | +107 | Связанные документы, Статус, Упоминается в | — |
| `docs/02-anthropic-vacancies/225-references.md` | +106 | Contents, Связанные документы, Упоминается в | — |
| `docs/SIMILAR.md` | +106 | Contents, Связанные документы, Упоминается в | — |
| `docs/01-svyazi/11-integration-contracts.md` | +104 | Связанные документы, Содержание, Упоминается в | — |
| `docs/02-anthropic-vacancies/176-7-governance-and-oversight.md` | +103 | Contents, Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/226-appendix-a-comparative-table-five-agent-types.md` | +103 | Связанные документы, Упоминается в | — |
| `docs/01-svyazi/14-limitations.md` | +100 | Связанные документы, Содержание, Упоминается в | — |
| `docs/02-anthropic-vacancies/184-appendix-a-connection-to-companion-papers.md` | +99 | Связанные документы, Упоминается в | — |
| `docs/COMPARE.md` | -99 | Изменившиеся файлы (343) — топ по Δ слов, Новые файлы (180) | Изменившиеся файлы (83) — топ по Δ слов, Новые файлы (151) |
| `docs/01-svyazi/09-architectural-gaps.md` | +97 | Связанные документы, Содержание, Упоминается в | — |
| `docs/01-svyazi/12-roadmap.md` | +97 | Связанные документы, Содержание, Упоминается в | — |
| `docs/02-anthropic-vacancies/251-ai-support-through-configurable-specialist-ensembl.md` | +96 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/311-3-what-ingit-provides-that-cowork-lacks.md` | +95 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/313-5-four-integration-paths-in-order-of-accessibility.md` | +95 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/146-acknowledgments.md` | +94 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/274-the-missing-middle-layer-between-chat-and-code.md` | +92 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/310-2-what-cowork-provides-that-ingit-doesn-t-need-to-.md` | +90 | Связанные документы, Упоминается в | — |
| `docs/01-svyazi/10-second-order-ensembles.md` | +89 | Связанные документы, Содержание, Упоминается в | — |
| `docs/02-anthropic-vacancies/135-a-formal-model-for-human-ai-collaboration-in-distr.md` | +89 | Связанные документы, Упоминается в | — |
| `docs/01-svyazi/06-security-privacy.md` | +88 | Связанные документы, Содержание, Упоминается в | — |
| `docs/02-anthropic-vacancies/152-ai-coordinated-infrastructure-for-distributed-expe.md` | +88 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/280-the-specific-case-in-front-of-us.md` | +88 | Связанные документы, Упоминается в | — |
| `docs/05-habr-projects/02-collaboration-partners.md` | +88 | Связанные документы, Статус, Упоминается в | — |
| `docs/02-anthropic-vacancies/213-2-what-makes-a-professional-colleague-agent.md` | +87 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/147-references.md` | +86 | Contents, Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/211-table-of-contents.md` | +86 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/284-practical-recommendations-for-the-current-project.md` | +86 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/308-table-of-contents.md` | +86 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/73-portal-protocol-md-v1-1.md` | +86 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/306-with-anthropic-s-cowork-platform.md` | +85 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/309-1-the-cowork-discovery-and-why-it-changes-everythi.md` | +85 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/64-for-the-curious-philosophy.md` | +85 | Связанные документы, Содержание, Упоминается в | — |
| `docs/02-anthropic-vacancies/137-table-of-contents.md` | +84 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/215-4-architecture-of-professional-colleague-agents.md` | +83 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/216-5-the-economics-of-profession-wide-replication.md` | +83 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/269-appendix-a-the-six-type-taxonomy-updated.md` | +83 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/89-14-sdk-contract-informative.md` | +83 | Contents, Связанные документы, Упоминается в | — |
| `docs/NARRATIVE.md` | +82 | — | — |
| `docs/02-anthropic-vacancies/209-a-typology-of-ai-agents-on-the-principal-side-and-.md` | +81 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/217-6-risks-specific-to-this-category.md` | +81 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/220-9-relationship-to-other-agent-types.md` | +81 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/182-acknowledgments.md` | +80 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/227-appendix-b-decision-framework-when-to-build-type-1.md` | +80 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/286-acknowledgments.md` | +80 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/18-6-adapter-interface.md` | +79 | Contents, Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/319-acknowledgments.md` | +79 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/34-appendix-b-change-log.md` | +79 | Связанные документы, Содержание, Упоминается в | — |
| `docs/01-svyazi/04-ensembles-overview.md` | +78 | Связанные документы, Содержание, Упоминается в | — |
| `docs/02-anthropic-vacancies/03-portal-protocol-md.md` | +78 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/219-8-pilot-proposal-sgb-advocate-colleague.md` | +78 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/260-7-economics-of-combinatorial-replication.md` | +78 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/277-what-s-missing-layer-b.md` | +78 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/28-appendix-a-minimal-working-example.md` | +78 | Contents, Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/283-what-this-document-doesn-t-solve.md` | +78 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/307-abstract.md` | +78 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/87-12-onboarding-paths-normative.md` | +78 | Contents, Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/98-appendix-a-minimal-working-example.md` | +78 | Contents, Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/123-portal-mcp-py.md` | +77 | Связанные документы, Содержание, Упоминается в | — |
| `docs/02-anthropic-vacancies/223-12-closing.md` | +77 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/258-5-configuration-how-principals-build-their-ensembl.md` | +77 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/183-references.md` | +76 | Contents, Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/276-the-two-layer-stack-as-it-exists.md` | +76 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/212-1-the-five-type-typology-of-principal-side-agents.md` | +75 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/150-appendix-c-version-history.md` | +74 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/179-10-open-questions.md` | +74 | Contents, Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/261-8-seven-domains-of-application.md` | +74 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/262-9-integration-with-okwf-infrastructure.md` | +74 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/52-author-contact.md` | +74 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/153-executive-summary.md` | +73 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/180-11-call-for-collaboration.md` | +73 | Contents, Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/272-appendix-d-connection-diagram.md` | +73 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/06-1-introduction.md` | +72 | Contents, Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/171-2-historical-precedents-agents-as-civilizational-i.md` | +72 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/254-1-why-the-binary-view-is-incomplete.md` | +72 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/259-6-coordination-and-disagreement-resolution.md` | +72 | Связанные документы, Упоминается в | — |
| `docs/01-svyazi/08-conclusions.md` | +71 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/255-2-the-twenty-one-teachers-pattern.md` | +71 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/92-17-versioning-policy.md` | +71 | Contents, Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/136-abstract.md` | +70 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/271-appendix-c-configuration-template-example.md` | +70 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/282-what-industry-will-likely-build.md` | +70 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/86-11-relevance-ranking.md` | +70 | Contents, Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/224-acknowledgments.md` | +69 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/24-12-versioning-policy.md` | +69 | Contents, Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/148-appendix-a-glossary.md` | +68 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/253-table-of-contents.md` | +68 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/318-10-strategic-positioning.md` | +68 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/79-4-passport-passport-md.md` | +68 | Contents, Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/84-9-consensus-algorithm.md` | +68 | Contents, Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/103-appendix-b-change-log.md` | +67 | Contents, Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/185-appendix-b-domain-comparison-matrix.md` | +67 | Упоминается в | — |
| `docs/05-habr-projects/QA.md` | -67 | Как CardIndex хранит и версионирует карточки?, Как работает AgentFS и что такое .agentos?, Что такое knowledge-space и для кого он предназначен? | Как CardIndex[^cardindex] хранит и версионирует карточки?, Как работает AgentFS[^agentfs] и что такое .agentos?, Что такое knowledge-space[^knowledge-space] и для кого он предназначен? |
| `docs/02-anthropic-vacancies/04-abstract.md` | +66 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/144-7-open-questions.md` | +66 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/172-3-what-makes-a-representative-agent.md` | +66 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/181-12-closing.md` | +66 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/65-readme-md.md` | +66 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/81-6-adapter-interface.md` | +66 | Contents, Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/88-13-rest-api-contract-normative-for-portals.md` | +66 | Contents, Связанные документы, Упоминается в | — |
| `docs/05-habr-projects/memory/README.md` | -66 | — | — |
| `docs/02-anthropic-vacancies/09-4-passport-passport-md.md` | +65 | Contents, Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/218-7-application-domains.md` | +64 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/256-3-what-makes-a-composite-skills-agent.md` | +64 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/54-for-the-curious-philosophy.md` | +64 | Связанные документы, Упоминается в | — |
| `docs/MISSING.md` | -64 | — | — |
| `docs/02-anthropic-vacancies/155-1-problem-statement.md` | +63 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/17-5-compatibility-levels.md` | +63 | Contents, Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/186-appendix-c-sample-use-cases-in-detail.md` | +63 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/80-5-compatibility-levels.md` | +63 | Contents, Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/139-2-the-double-triangle-architecture.md` | +62 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/270-appendix-b-sub-agent-registry-schema-sketch.md` | +62 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/164-10-appendices.md` | +61 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/321-appendix-a-decision-tree-for-ingit-adopters.md` | +61 | Связанные документы, Упоминается в | — |
| `docs/CONTACTS.md` | +61 | — | — |
| `docs/02-anthropic-vacancies/210-abstract.md` | +60 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/263-10-risks-specific-to-composite-architectures.md` | +60 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/275-why-this-document-exists.md` | +60 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/322-appendix-b-comparison-matrix.md` | +60 | Связанные документы, Упоминается в | — |
| `docs/05-habr-projects/01-synthesis.md` | +60 | Связанные документы, Статус, Упоминается в | — |
| `docs/02-anthropic-vacancies/21-9-query-flow.md` | +59 | Contents, Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/08-3-registry-nautilus-json.md` | +58 | Contents, Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/132-planned-v0-2-0.md` | +58 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/140-3-three-inter-layer-protocols.md` | +58 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/142-5-pattern-library-as-bridge-between-triangles.md` | +58 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/143-6-four-deployment-domains.md` | +58 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/22-10-queryresult-structure.md` | +56 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/257-4-the-sub-agent-registry.md` | +56 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/281-the-recursive-insight.md` | +56 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/285-closing.md` | +56 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/40-bridges.md` | +55 | Contents, Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/60-bridges.md` | +55 | Contents, Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/85-10-query-flow.md` | +55 | Contents, Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/95-20-adr-002-q6-as-first-class-protocol-concept.md` | +55 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/252-abstract.md` | +54 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/50-bridges.md` | +54 | Contents, Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/174-5-architectural-specification.md` | +53 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/267-acknowledgments.md` | +53 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/320-references.md` | +53 | Contents, Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/90-15-security-considerations.md` | +53 | Contents, Связанные документы, Упоминается в | — |
| `docs/autofilled/components/.md` | +53 | Связанные документы | — |
| `docs/02-anthropic-vacancies/154-table-of-contents.md` | +52 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/161-7-phased-rollout-plan.md` | +52 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/37-native-format.md` | +52 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/96-21-adr-003-five-onboarding-paths-as-equal-rank.md` | +52 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/38-content-overview.md` | +51 | Связанные документы, Упоминается в | — |
| `docs/autofilled/components/cowork.md` | +51 | Связанные документы | — |
| `docs/autofilled/components/ingit.md` | +51 | Связанные документы | — |
| `docs/autofilled/components/lorenzo.md` | +51 | Связанные документы | — |
| `docs/autofilled/components/nautilus.md` | +51 | Связанные документы | — |
| `docs/autofilled/components/sgb.md` | +51 | Связанные документы | — |
| `docs/autofilled/components/svend4.md` | +51 | Связанные документы | — |
| `docs/autofilled/components/svyazi.md` | +51 | Связанные документы | — |
| `docs/02-anthropic-vacancies/104-appendix-c-references.md` | +50 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/105-review-methodology-md.md` | +50 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/42-author-contact.md` | +50 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/44-for-the-curious-philosophy.md` | +50 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/69-section.md` | +50 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/16-history.md` | +49 | Упоминается в | — |
| `docs/02-anthropic-vacancies/23-11-security-considerations.md` | +49 | Contents, Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/26-14-adr-001-federation-over-merging.md` | +49 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/82-7-portalentry-structure.md` | +49 | Contents, Связанные документы, Упоминается в | — |
| `docs/DIGEST.md` | +49 | — | — |
| `docs/METRICS.md` | +49 | Документы, требующие улучшения (16) | Документы, требующие улучшения (6) |
| `docs/02-anthropic-vacancies/141-4-nautilus-portal-as-reference-substrate.md` | +48 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/145-8-call-to-action.md` | +48 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/266-13-closing.md` | +48 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/43-history.md` | +48 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/91-16-mcp-extension-informative.md` | +48 | Связанные документы, Упоминается в | — |
| `docs/03-technology-combinations/02-knowledge-graphs.md` | +48 | Связанные документы, Упоминается в | — |
| `docs/autofilled/research-summary.md` | +48 | Contents, Связанные документы | — |
| `docs/02-anthropic-vacancies/168-abstract.md` | +47 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/169-table-of-contents.md` | +46 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/25-13-reference-implementation.md` | +46 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/41-compatibility-level.md` | +46 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/93-18-reference-implementation.md` | +46 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/59-angle-perspective.md` | +45 | Связанные документы, Упоминается в | — |
| `docs/DUPLICATES.md` | -45 | 100% — `docs/autofilled/components/spbmolot.md` vs `docs/autofilled/components/svend4.md`, Точные дубли (одинаковое содержимое) | — |
| `docs/02-anthropic-vacancies/56-essence.md` | +44 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/62-author-contact.md` | +44 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/74-abstract.md` | +44 | Связанные документы, Упоминается в | — |
| `docs/GLOSSARY.md` | -44 | — | — |
| `docs/02-anthropic-vacancies/53-history.md` | +43 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/63-history.md` | +43 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/05-0-status-of-this-document.md` | +42 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/149-appendix-b-summary-of-contributions.md` | +42 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/278-why-this-hasn-t-been-built.md` | +42 | Связанные документы, Упоминается в | — |
| `docs/templates/ensemble.md` | -42 | — | — |
| `docs/01-svyazi/02-methodology.md` | +41 | Contents, Связанные документы, Упоминается в | — |
| `docs/03-technology-combinations/03-local-first.md` | +41 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/20-8-consensus-algorithm.md` | +40 | Contents, Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/35-passports-info1-md.md` | +40 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/36-essence.md` | +40 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/48-content-overview.md` | +40 | Связанные документы, Упоминается в | — |
| `docs/05-habr-projects/README.md` | -40 | — | — |
| `docs/05-habr-projects/knowledge/README.md` | -40 | — | — |
| `docs/ABBREVIATIONS.md` | +40 | — | — |
| `docs/02-anthropic-vacancies/19-7-portalentry-structure.md` | +39 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/94-19-adr-001-federation-over-merging.md` | +39 | Связанные документы, Упоминается в | — |
| `docs/AUTOFILLED.md` | +39 | Связанные документы | — |
| `docs/02-anthropic-vacancies/27-15-glossary-of-examples.md` | +38 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/45-passports-pro2-md.md` | +38 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/46-essence.md` | +38 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/55-passports-meta-md.md` | +38 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/97-22-glossary-of-reference-examples.md` | +38 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/158-4-proposed-infrastructure.md` | +37 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/68-about.md` | +37 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/47-native-format.md` | +36 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/49-angle-perspective.md` | +36 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/75-0-status-of-this-document.md` | +36 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/QA.md` | -36 | — | — |
| `docs/autofilled/components/kksudo.md` | +36 | Связанные документы | — |
| `docs/autofilled/components/spbmolot.md` | +36 | Связанные документы | — |
| `docs/02-anthropic-vacancies/156-2-target-populations.md` | +35 | Связанные документы, Упоминается в | — |
| `docs/03-technology-combinations/README.md` | -35 | — | — |
| `docs/02-anthropic-vacancies/07-2-terminology.md` | +34 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/39-angle-perspective.md` | +34 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/77-2-terminology.md` | +34 | Связанные документы, Упоминается в | — |
| `docs/04-ai-collaborations/QA.md` | -34 | Как CardIndex хранит и версионирует карточки?, Как работает AgentFS и что такое .agentos?, Как реализован forensic RAG с доказуемостью? +1 | Как CardIndex[^cardindex] хранит и версионирует карточки?, Как работает AgentFS[^agentfs] и что такое .agentos?, Как реализован forensic RAG[^rag] с доказуемостью? +1 |
| `docs/PRIORITIES.md` | -33 | autofilled, components, contacts +2 | Содержание |
| `docs/SEE_ALSO.md` | +33 | — | — |
| `docs/COMPLEXITY.md` | -31 | — | — |
| `docs/02-anthropic-vacancies/57-native-format.md` | +30 | Связанные документы, Упоминается в | — |
| `docs/QUESTIONS.md` | +29 | Mvp/сроки (14), Интеграция (11), Команда (24) +3 | Mvp/сроки (12), Интеграция (9), Команда (23) +3 |
| `docs/02-anthropic-vacancies/00-intro.md` | +28 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/51-compatibility-level.md` | +28 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/61-compatibility-level.md` | +28 | Связанные документы, Упоминается в | — |
| `docs/ENTITIES.md` | -28 | — | — |
| `docs/02-anthropic-vacancies/170-1-the-cinderella-syndrome-why-quality-stays-invisi.md` | +27 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/76-1-introduction.md` | +27 | Contents, Связанные документы, Упоминается в | — |
| `docs/03-technology-combinations/05-benchmarks.md` | +27 | Связанные документы, Упоминается в | — |
| `docs/DENSITY.md` | -26 | — | — |
| `docs/PROGRESS.md` | -26 | Метрики качества, Приоритет 1: kksudo (AgentFS, 13 упоминаний), Приоритет 2: spbmolot (NGT Memory, 12 упоминаний) +3 | Ближайшие задачи (открытые чеклисты), Чеклисты по фазам |
| `docs/STATS.md` | -26 | — | — |
| `docs/03-technology-combinations/QA.md` | -25 | — | — |
| `docs/02-anthropic-vacancies/106-tl-dr.md` | +24 | Связанные документы, Упоминается в | — |
| `docs/BACKLINKS.md` | +24 | — | — |
| `docs/CONSISTENCY.md` | +24 | `Auto AI Router` → должно быть `Auto AI Router`, `Evidence Envelope` → должно быть `Evidence Envelope`, `CardIndex` → должно быть `CardIndex` +1 | — |
| `docs/03-technology-combinations/01-agent-routing.md` | +23 | Связанные документы, Упоминается в | — |
| `docs/FOOTNOTES.md` | +23 | — | — |
| `docs/GRAPH.md` | -21 | — | — |
| `docs/MINDMAP.md` | -21 | — | — |
| `docs/02-anthropic-vacancies/165-closing.md` | +20 | Связанные документы, Упоминается в | — |
| `docs/REPORT.md` | -20 | — | — |
| `docs/02-anthropic-vacancies/58-content-overview.md` | +19 | Связанные документы, Упоминается в | — |
| `docs/VALIDATION.md` | -19 | — | — |
| `docs/CROSSREFS.md` | -18 | — | — |
| `docs/CODE_BLOCKS.md` | +17 | markdown (8), Архитектурная схема, Диаграмма +9 | markdown (5), 🐍 Python (18), 💻 Bash / Shell (19) +3 |
| `docs/02-anthropic-vacancies/157-3-why-existing-solutions-fail.md` | +16 | Связанные документы, Упоминается в | — |
| `docs/AUTHORS.md` | -16 | — | — |
| `docs/FAQ.md` | +15 | Что это такое? | — |
| `docs/02-anthropic-vacancies/162-8-risk-analysis.md` | +10 | Связанные документы, Упоминается в | — |
| `docs/02-anthropic-vacancies/173-4-ten-domains-of-application.md` | -10 | Упоминается в | — |
| `docs/templates/project-component.md` | -10 | — | — |
| `docs/HEATMAP.md` | -9 | — | — |
| `docs/NETWORK.md` | -9 | — | — |
| `docs/COST.md` | -8 | — | — |
| `docs/HEALTH.md` | -8 | Общий балл: **90/100** 🟢 | Общий балл: **75/100** 🟡 |
| `docs/SCORING.md` | +8 | Итог: **154/164** (93%) — 🟢 GO, Приоритетные действия (2 незакрытых), Риски — 16/26 (61%) 🟠 НЕ ГОТОВ | Итог: **159/164** (96%) — 🟢 GO, Приоритетные действия (1 незакрытых), Риски — 21/26 (80%) 🟡 УСЛОВНО GO |
| `docs/ORPHANS.md` | -7 | autofilled (1 изолированных) | — |
| `docs/SENTIMENT.md` | -7 | — | — |
| `docs/01-svyazi/QA.md` | -6 | Как CardIndex хранит и версионирует карточки?, Как работает AgentFS и что такое .agentos?, Как реализован forensic RAG с доказуемостью? +1 | Как реализован forensic RAG[^rag] с доказуемостью? |
| `docs/templates/research-note.md` | +5 | — | — |
| `docs/03-technology-combinations/04-sozialrecht-domain.md` | +4 | Упоминается в | — |
| `docs/templates/decision-record.md` | -4 | — | — |
| `docs/templates/README.md` | +2 | — | — |
| `docs/templates/contact-outreach.md` | -2 | — | — |
| `docs/KPI.md` | +1 | Версия (214), Время (161), Количество (134) +3 | Версия (201), Время (146), Количество (45) +3 |
| `docs/ALERTS.md` | 0 | — | — |


### 145. Корпусная статистика
...
### 146. Топ файлов по богатству словаря (STTR)
...
### 147. Файлы с бедным словарём (требуют доработки)
