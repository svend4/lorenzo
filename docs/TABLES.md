...
| **ADR** | "ADR-004: Temporal Metadata as First-Class Concept" | 66 |
| **AGENTS** | типология + готовая к развёртыванию категория Type 1 | 13 |
| **AI** | это инфраструктурный слой для AI-managed virtual companies | 2218 |
| **AIRI** | серьёзная research лаборатория (Артём Шелманов и команда) | 17 |
| **ANP** | Agent Network Protocol | 5 |
| **API** ⭐ | Application Programming Interface — интерфейс программирования приложений | 255 |
| **BSL** ⭐ | Business Source License — бизнес-лицензия с открытым кодом | 75 |
| **CAMEL** | это другая значимая open-source framework, и сравнение их с Hermes будет показательным | 175 |
| **CI/CD** ⭐ | Continuous Integration / Continuous Deployment | 10 |
| **CLI** ⭐ | Command Line Interface — интерфейс командной строки | 56 |
| **CRDT** ⭐ | Conflict-free Replicated Data Type — структура данных без конфликтов слияния | 60 |
| **DAO** | результат смешанный | 3 |
| **EMEA** | RU/DE/EN на рабочем уровне, базирование в Германии, понимание европейского регуляторного контекста (что прямо читается ч | 27 |
| **ERROR** | MCP SDK not installed | 3 |
| **FAQ** ⭐ | Frequently Asked Questions — часто задаваемые вопросы | 40 |
| **FDE** | это исполнительская роль на чужую продуктовую повестку | 13 |
| **FRE** | 70-100 лёгкий, 50-70 средний, 30-50 сложный, <30 очень сложный | 14 |
| **GDPR** ⭐ | General Data Protection Regulation — европейский регламент защиты данных | 52 |
| **GG** | они публичные) | 2 |
| **GUI** | -3 months effort | 15 |
| **HEAD** | 7 commits) | 6 |
| **HMP** | на когнитивной устойчивости и этике | 87 |
| **ID** | sgb:XII:90:4 (SGB XII, § 90, Abs | 7 |
| **II** | The Double-Triangle Architecture — formal описание дуальной структуры с вашей метафорой звезды Давида | 22 |
| **III** | Protocols Between Layers — три протокола с examples | 17 |
| **INPUT** | - Bescheid text (decoded by agent) | 2 |
| **IP** | AI-платформа, заказчик, сами фрилансеры? Сегодняшние legal frameworks не умеют отвечать на этот вопрос дёшево | 7 |
| **IV** | Nautilus Portal as Reference Implementation — как existing work serves как substrate | 19 |
| **IX** | 102 , sgg:86b:2 ), на прецеденты | 42 |
| **JWT** ⭐ | JSON Web Token — токен аутентификации | 4 |
| **KPI** | сколько полезных коллабораций, проектов, выступлений, mentorship‑пар или hiring‑контактов возникло из рекомендаций систе | 57 |
| **KSV** | потому что у них нет точных русских эквивалентов в контексте немецкой социально-правовой системы | 30 |
| **LAYER** | функциональная категория Type 4 | 46 |
| **LCI** | Lyapunov Coherence Index, target π | 23 |
| **LLM** ⭐ | Large Language Model — большая языковая модель | 322 |
| **LOC** | продублирована с разными строками в разных частях | 49 |
| **MCP** ⭐ | Model Context Protocol — протокол контекста для AI-инструментов | 770 |
| **MIT** ⭐ | Massachusetts Institute of Technology License — разрешительная лицензия | 266 |
| **ML** | несколько моделей → voting/averaging | 57 |
| **MMORPG** | это общее пространство , в котором вы видите аватары коллег, можете подойти к ним, стоять рядом, работать вместе в одной | 42 |
| **MRR** | это уже leverage для любого следующего шага, включая разговор с Anthropic Institute о grant/partnership | 4 |
| **MUST** | - Возвращать пустой список, если ничего не найдено (не `None`, не exception) | 77 |
| **MVP** ⭐ | Minimum Viable Product — минимально жизнеспособный продукт | 219 |
| **NDA** | intermediate view (placeholder'ы, но с consistent identifiers для longitudinal анализа) | 2 |
| **NGT** | граф памяти](#глава-11-ngt-граф-памяти) | 267 |
| **NLP** ⭐ | Natural Language Processing — обработка естественного языка | 1 |
| **NPP** | **федеративная модель**, где каждый | 82 |
| **OASIS** | до 1M agents simulation) | 4 |
| **ODT** | не только текст | 2 |
| **OKWF** | конкретная архитектура](#применение-к-okwf-конкретная-архитектура) | 278 |
| **OPTIONAL** | ключевые слова | 10 |
| **OS** | неуточнено | 134 |
| **OSS** ⭐ | Open Source Software — программное обеспечение с открытым кодом | 230 |
| **OUTPUT** | - Draft Widerspruch (DOCX format) | 2 |
| **P2P** ⭐ | Peer-to-Peer — децентрализованная сеть | 15 |
| **PARC** | research center, became iconic несмотря на parent brand decline OpenAI — research org становящаяся product company, name | 3 |
| **PII** ⭐ | Personally Identifiable Information — персональные данные | 48 |
| **PROTOCOL** | иначе future разработчики будут gадать | 193 |
| **PURE** | LLM-based User Profile Management for Recommender System» | 6 |
| **QA** | демон-критик (adversarial, rigorous) | 199 |
| **RAG** ⭐ | Retrieval-Augmented Generation — генерация с поиском по базе знаний | 394 |
| **README** | 550+ строк production-качества: установка, конфигурация для всех 6 платформ (включая детализацию /etc/fstab для CIFS, AD | 500 |
| **REQUIRED** | откуда пришло | 23 |
| **ROI** | 10 sec queries vs 2 hour manual search | 17 |
| **SDK** ⭐ | Software Development Kit — набор инструментов разработчика | 50 |
| **SENTINEL** | неуточнено; LiteLLM — MIT вне enterprise‑директорий; Auto AI Router — Apache 2 | 177 |
| **SF** | DC, Canberra) | 20 |
| **SGB** ⭐ | Sozialgesetzbuch — Социальный кодекс Германии | 342 |
| **SHOULD** | - Поддерживать case-insensitive matching для текстовых запросов | 37 |
| **SWE** | в Sales/Finance/Marketing/Legal зарплаты ниже и сильно варьируются по локации | 6 |
| **TF-IDF** ⭐ | Term Frequency–Inverse Document Frequency — метрика важности термина | 15 |
| **TODO** ⭐ | To Do — задача к выполнению | 4 |
| **TSU** | физика, MoME — математика; ZINC — software, гибридная архитектура — алгоритм; RISC-V — кремний, privacy — право; TinyML  | 10 |
| **TVCP** | Terminal Video Communication Platform, терминал видео коммуникация платформа, игры») — это необычное : Go + template + M | 2 |
| **UI** | -2 months effort | 63 |
| **URL** | я разберусь с любым вариантом именования | 72 |
| **VERIFY** | 6782 vs 6600] как метку | 2 |
| **VI** | Deployment Paths — humanities, project management, OSS, general | 4 |
| **VII** | Open Questions — governance, consent, economics, scale | 4 |
| **VIII** | Call to Action — что делать researchers, practitioners, founders | 3 |
| **VPS** | cron каждое утро обходит сайты Sozialgericht/BSG/KSV, генерирует Stellungnahme-черновики, обновляет статусы Aktenzeichen | 11 |
| **XII** | legally binding reference с нормативной силой | 40 |
| **YAML** ⭐ | YAML Ain't Markup Language — формат конфигурационных файлов | 109 |
| **ZINC** | - Ночью агент крутит эксперименты с промптами | 27 |
...
|-------------|------------|
| **AI** | 2218 — _это инфраструктурный слой для AI-managed virtual companies_ |
| **MCP** | 770 — _Model Context Protocol — протокол контекста для AI-инструмен_ |
| **README** | 500 — _550+ строк production-качества: установка, конфигурация для _ |
| **RAG** | 394 — _Retrieval-Augmented Generation — генерация с поиском по базе_ |
| **SGB** | 342 — _Sozialgesetzbuch — Социальный кодекс Германии_ |
| **LLM** | 322 — _Large Language Model — большая языковая модель_ |
| **OKWF** | 278 — _конкретная архитектура](#применение-к-okwf-конкретная-архите_ |
| **NGT** | 267 — _граф памяти](#глава-11-ngt-граф-памяти)_ |
| **MIT** | 266 — _Massachusetts Institute of Technology License — разрешительн_ |
| **API** | 255 — _Application Programming Interface — интерфейс программирован_ |
| **OSS** | 230 — _Open Source Software — программное обеспечение с открытым ко_ |
| **MVP** | 219 — _Minimum Viable Product — минимально жизнеспособный продукт_ |
| **QA** | 199 — _демон-критик (adversarial, rigorous)_ |
| **PROTOCOL** | 193 — _иначе future разработчики будут gадать_ |
| **SENTINEL** | 177 — _неуточнено; LiteLLM — MIT вне enterprise‑директорий; Auto AI_ |
...
|-----|--------|----------------|-------|
| `https://github.com/svend4/nautilus/issues` | 16 | ⭐⭐⭐⭐⭐ | `github.com` |
...
| `https://github.com/svend4/info7` | 3 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/svend4/info40` | 3 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/tagir_analyzes` | 3 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/Sonia_Black` | 3 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/spbmolot` | 3 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/Cutcode` | 3 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/VladSpace` | 3 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/andrey_chuyan` | 3 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/nlaik` | 3 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/AnastasiyaW` | 3 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/Dmitriila` | 3 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/VitalyOborin` | 3 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/Antipozitive` | 3 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/MiXaiLL76` | 3 | ⭐⭐⭐⭐⭐ | `github.com` |
| `https://github.com/zodigancode` | 3 | ⭐⭐⭐⭐⭐ | `github.com` |
...
### 13. Изменившиеся файлы (170) — топ по Δ слов
_Файл: `docs/COMPARE.md` | 4 колонок, 30 строк_

| Файл | Было | Стало | Δ |
|------|------|-------|---|
| `TABLES.md` | 15654 | 45249 | +29595 |
| `README.md` | 3693 | 2125 | -1568 |
| `CHANGELOG.md` | 197 | 888 | +691 |
| `ACTION_ITEMS.md` | 5816 | 6465 | +649 |
| `SEARCH.md` | 3524 | 4085 | +561 |
| `QA.md` | 1521 | 986 | -535 |
| `README.md` | 54 | 588 | +534 |
| `WORD_FREQ.md` | 1262 | 1791 | +529 |
| `README.md` | 345 | 102 | -243 |
| `BROKEN_LINKS.md` | 438 | 676 | +238 |
| `README.md` | 330 | 113 | -217 |
| `TIMELINE.md` | 4005 | 4211 | +206 |
| `DUPLICATES.md` | 115 | 282 | +167 |
| `RISK_REGISTER.md` | 785 | 944 | +159 |
| `DECISIONS.md` | 1773 | 1921 | +148 |
| `CODE_BLOCKS.md` | 3530 | 3658 | +128 |
| `METRICS.md` | 345 | 465 | +120 |
| `PRIORITIES.md` | 1046 | 1151 | +105 |
| `INDEX.md` | 514 | 616 | +102 |
| `TECH_RADAR.md` | 522 | 612 | +90 |
| `CONCEPTS.md` | 11313 | 11402 | +89 |
| `COST.md` | 615 | 697 | +82 |
| `SITEMAP.md` | 1449 | 1522 | +73 |
| `QA.md` | 292 | 226 | -66 |
| `COMPONENT_MATRIX.md` | 822 | 887 | +65 |
| `CONTACTS.md` | 448 | 512 | +64 |
| `LINKS.md` | 647 | 709 | +62 |
| `SCHEDULE.md` | 271 | 332 | +61 |
| `ONBOARDING.md` | 460 | 520 | +60 |
| `yodoca.md` | 154 | 212 | +58 |
...
_Файл: `docs/CONSISTENCY.md` | 4 колонок, 7 строк_
...
|-------|--------|------|-------------------|---------------|
| **AnastasiyaW** | knowledge-space, mclaude | knowledge/orchestration | 28 | Держать operational benchmark/gotcha cards в одной базе с reference cards или отдельным слоем? |
| **Antipozitive** | MemNet | memory | 14 | — |
| **Cutcode** | AIF Handoff | orchestration | 31 | — |
| **Dmitriila** | SENTINEL | security | 26 | — |
| **MiXaiLL76** | Auto AI Router | security | 15 | — |
| **Sonia_Black** | knowledge-space | knowledge | 12 | — |
| **VitalyOborin** | Yodoca | memory | 22 | Что сильнее влияет на качество памяти: отдельный consolidator, decay или строгая типизация записей? |
| **VladSpace** | Graph RAG | rag | 30 | — |
| **andrey_chuyan** | Svyazi | ingestion/CardIndex | 11 | Стоит ли расширять CardIndex до person/project/episode/evidence или лучше держать разные индексы? |
| **kksudo** | AgentFS | knowledge/filesystem | 38 | Что лучше класть в .agentos, а что выносить в machine-only state вне vault conventions? |
| **lee-to** | AI Factory | orchestration | 8 | — |
| **nlaik** | LiteParse / research-docs | rag | 14 | — |
| **spbmolot** | NGT Memory | memory | 39 | Где проходит практическая граница между полезной ассоциацией и ложной ко-активацией тем для community discovery? |
| **tagir_analyzes** | Legal RAG | rag | 9 | — |
| **zodigancode** | Rufler | orchestration | 16 | — |


### 24. GitHub репозитории
_Файл: `docs/CONTACTS.md` | 2 колонок, 38 строк_
...
| `github.com/github.com/svend4/data70` | 4 |
| `github.com/github.com/svend4/info1` | 10 |
| `github.com/github.com/svend4/info40` | 4 |
| `github.com/github.com/svend4/info7` | 4 |
| `github.com/github.com/svend4/ingit` | 12 |
| `github.com/github.com/svend4/meta` | 9 |
| `github.com/github.com/svend4/n` | 2 |
| `github.com/github.com/svend4/nautilu` | 2 |
| `github.com/github.com/svend4/nautilus` | 39 |
...
|---|-------|--------|------|-----------|--------|------|
| 1 | **spbmolot** | NGT Memory | memory | 39 | 👁 Изучили | 128 |
| 2 | **kksudo** | AgentFS | knowledge/filesystem | 38 | 👁 Изучили | 125 |
| 3 | **Cutcode** | AIF Handoff | orchestration | 31 | ⬜ Не начато | 97 |
| 4 | **VladSpace** | Graph RAG | rag | 30 | ⬜ Не начато | 94 |
| 5 | **AnastasiyaW** | knowledge-space, mclaude | knowledge/orchestration | 28 | ⬜ Не начато | 90 |
| 6 | **Dmitriila** | SENTINEL | security | 26 | ⬜ Не начато | 80 |
| 7 | **VitalyOborin** | Yodoca | memory | 22 | ⬜ Не начато | 72 |
| 8 | **zodigancode** | Rufler | orchestration | 16 | ⬜ Не начато | 52 |
| 9 | **Antipozitive** | MemNet | memory | 14 | ⬜ Не начато | 48 |
| 10 | **MiXaiLL76** | Auto AI Router | security | 15 | ⬜ Не начато | 47 |
| 11 | **nlaik** | LiteParse / research-docs | rag | 14 | ⬜ Не начато | 46 |
| 12 | **Sonia_Black** | knowledge-space | knowledge | 12 | ⬜ Не начато | 42 |
| 13 | **andrey_chuyan** | Svyazi | ingestion/CardIndex | 11 | ⬜ Не начато | 35 |
| 14 | **tagir_analyzes** | Legal RAG | rag | 9 | ⬜ Не начато | 31 |
...
| `RFC` | 13 | `docs/02-anthropic-vacancies/` |
...
| `URL` | 10 | `docs/02-anthropic-vacancies/` |
...
| `OpenClaw` | 7 | `docs/02-anthropic-vacancies/` |
| `WebSocket` | 6 | `docs/04-ai-collaborations/` |
| `CRM` | 6 | `docs/04-ai-collaborations/` |
| `HTTP` | 6 | `docs/02-anthropic-vacancies/` |
| `DeepSeek` | 6 | `docs/03-technology-combinations/` |
| `RDF` | 6 | `docs/02-anthropic-vacancies/` |
| `ChatDev` | 6 | `docs/02-anthropic-vacancies/` |
| `DeepMind` | 6 | `docs/02-anthropic-vacancies/` |
| `AutoAdapter` | 6 | `docs/02-anthropic-vacancies/` |
...
_Файл: `docs/COST.md` | 3 колонок, 14 строк_
...
| `02-anthropic-vacancies` | 355 | 🟢 351/355 | 🟢 341/355 | 🔴 102/355 | 🟢 324/355 | 🔴 0/355 | 🔴 0/355 |
...
### 33. Файлы с низким покрытием (< 3 признаков) — 30 файлов
_Файл: `docs/COVERAGE.md` | 8 колонок, 30 строк_
...
| `docs/02-anthropic-vacancies/197-7-управление-и-надзор.md` | 337 | ✅ | ✅ | ⬜ | ⬜ | ⬜ | ⬜ |
...
| `docs/02-anthropic-vacancies/349-твоя-личность.md` | 196 | ✅ | ✅ | ⬜ | ⬜ | ⬜ | ⬜ |
| `docs/02-anthropic-vacancies/359-твои-anti-patterns.md` | 122 | ✅ | ✅ | ⬜ | ⬜ | ⬜ | ⬜ |
...
### 40. История коммитов (последние 15)
...
### 41. Текущее состояние репозитория
...
### 48. Ко-встречаемость проектов (топ пары)
...
### 53. Числовые значения (‰)
_Файл: `docs/HEATMAP.md` | 6 колонок, 12 строк_

| Тема | svyazi | anthropic- | technology | ai-collabo | habr-proje |
|------|------------|------------|------------|------------|------------|
| **Память/Knowledge** | 26.6 | 3.2 | 15.4 | 16.9 | 14.7 |
| **Агент/Оркестр** | 25.0 | 12.8 | 25.2 | 20.5 | 9.3 |
| **Безопасность** | 7.8 | 0.4 | 0.4 | 4.3 | 0.1 |
...
| **Habr/Проекты** | 8.6 | 0.5 | 8.5 | 10.8 | 15.1 |
...
### 60. Топ биграмм (устойчивые словосочетания)
...
| **30** | с обратных ссылок **Файлов с входящими ссылками:** 530 ## Топ-30 самых цитируемы | `BACKLINKS` |
| **20** | ь документы](#рекомендуется-создать-документы) - [Детали по топ-20 пробелам](#де | `CONTENT_GAPS` |
| **15** | 78% \| 78% \| \| **root** \| 59 \| 15.2 \| 1.2 \| 64% \| 65% \| ## Топ-15 лучших | `METRICS` |
...
### 70. Индекс ссылок
_Файл: `docs/LINKS.md` | 2 колонок, 191 строк_
...
| https://github.com/Antipozitive` | 1 |
| https://github.com/Cutcode | 4 |
| https://github.com/Cutcode` | 1 |
| https://github.com/Dmitriila | 4 |
| https://github.com/Dmitriila` | 1 |
| https://github.com/MiXaiLL76 | 4 |
| https://github.com/MiXaiLL76` | 1 |
| https://github.com/Sonia_Black | 4 |
| https://github.com/Sonia_Black` | 1 |
...
| https://habr.com/ru/articles/1006622/ | 5 |
...
### 71. Качество по разделам
_Файл: `docs/METRICS.md` | 6 колонок, 6 строк_

| Раздел | Балл | Ссылок/1K слов | Код-блоков/1K | % с summary | % с тегами |
|--------|------|----------------|--------------|-------------|------------|
| **01-svyazi** | 67 | 19.5 | 0.5 | 100% | 100% |
| **02-anthropic-vacancies** | 73 | 29.7 | 1.0 | 99% | 96% |
| **03-technology-combinations** | 67 | 34.1 | 0.0 | 100% | 86% |
| **04-ai-collaborations** | 76 | 18.1 | 0.0 | 94% | 94% |
| **05-habr-projects** | 64 | 46.1 | 0.0 | 78% | 78% |
| **root** | 59 | 15.2 | 1.2 | 64% | 65% |


### 72. Топ-15 лучших документов
...
### 73. Документы, требующие улучшения (18)
...
### 75. Карта пробелов знаний
_Файл: `docs/MISSING.md` | 6 колонок, 25 строк_

| Статус | Тема / Проект | Файлов | Слов | Минимум | Примеры файлов |
|--------|---------------|--------|------|---------|----------------|
| ✅ | **Svyazi** | 135 | 104549 | ≥5ф/2000сл | `CROSSREFS.md`, `README.md` |
| ✅ | **local-first** | 82 | 40115 | ≥2ф/300сл | `CONTACTS.md`, `PARAGRAPH_QUALITY.md` |
| ✅ | **CardIndex** | 72 | 64065 | ≥3ф/500сл | `CROSSREFS.md`, `CONTACTS.md` |
| ✅ | **Yodoca** | 69 | 60969 | ≥2ф/300сл | `CROSSREFS.md`, `CONTACTS.md` |
| ✅ | **AgentFS** | 63 | 47389 | ≥3ф/500сл | `CROSSREFS.md`, `CONTACTS.md` |
| ✅ | **self-improvement** | 62 | 10313 | ≥1ф/100сл | `CONTACTS.md`, `PARAGRAPH_QUALITY.md` |
| ✅ | **knowledge-space** | 54 | 40093 | ≥3ф/500сл | `CROSSREFS.md`, `CONTACTS.md` |
| ✅ | **AI Factory** | 50 | 38945 | ≥2ф/200сл | `CROSSREFS.md`, `CONTACTS.md` |
| ✅ | **NGT Memory** | 49 | 54347 | ≥2ф/300сл | `CROSSREFS.md`, `CONTACTS.md` |
| ✅ | **LiteParse** | 49 | 36198 | ≥2ф/300сл | `CROSSREFS.md`, `CONTACTS.md` |
| ✅ | **SENTINEL** | 49 | 38674 | ≥2ф/200сл | `CROSSREFS.md`, `CONTACTS.md` |
| ✅ | **Rufler** | 48 | 32850 | ≥2ф/200сл | `CROSSREFS.md`, `CONTACTS.md` |
| ✅ | **mclaude** | 47 | 35391 | ≥2ф/200сл | `CROSSREFS.md`, `CONTACTS.md` |
| ✅ | **AutoResearch** | 29 | 23839 | ≥1ф/100сл | `CROSSREFS.md`, `NAMED_ENTITIES.md` |
| ✅ | **Evidence Envelope** | 24 | 9227 | ≥2ф/200сл | `QA.md`, `TABLES.md` |
| ✅ | **CRDT** | 21 | 16563 | ≥1ф/100сл | `TABLES.md`, `COMPONENT_MATRIX.md` |
| ✅ | **Sozialrecht** | 20 | 29417 | ≥1ф/200сл | `PARAGRAPH_QUALITY.md`, `LLM_SUMMARIES.md` |
| ✅ | **Card Envelope** | 15 | 7636 | ≥2ф/200сл | `QA.md`, `TABLES.md` |
| ✅ | **Memory Write Policy** | 11 | 6575 | ≥2ф/200сл | `TABLES.md`, `MINDMAP.md` |
| ✅ | **Skill Policy** | 11 | 3722 | ≥1ф/100сл | `QA.md`, `TABLES.md` |
| ✅ | **Review Record** | 11 | 6227 | ≥1ф/100сл | `QA.md`, `TABLES.md` |
| ✅ | **бюджетный роутинг** | 11 | 13846 | ≥2ф/300сл | `QA.md`, `TABLES.md` |
| ✅ | **privacy by design** | 11 | 11117 | ≥1ф/100сл | `TABLES.md`, `MISSING.md` |
| ✅ | **лицензия BSL** | 3 | 1336 | ≥1ф/50сл | `TABLES.md`, `MISSING.md` |
...
| Сущность | Файлов | Тип |
|----------|--------|-----|
| `anthropic` | 381 | people |
| `claude` | 151 | people |
| `svend4` | 91 | people |
| `kksudo` | 31 | people |
| `spbmolot` | 31 | people |
| `anastasiyaw` | 19 | people |
| `vitalyoborin` | 18 | people |
| `andrey_chuyan` | 9 | people |
| `settings` | 4 | people |
| `anthropics` | 4 | people |
| `camel-ai` | 3 | people |
| `vuguzum` | 2 | people |
...
| Сущность | Файлов | Тип |
|----------|--------|-----|
| `nautilus` | 153 | projects |
| `svyazi` | 120 | projects |
| `GitHub` | 119 | projects |
| `ngt` | 69 | projects |
| `CardIndex` | 67 | projects |
| `yodoca` | 64 | projects |
| `agentfs` | 60 | projects |
| `knowledge-space` | 49 | projects |
| `LiteParse` | 44 | projects |
| `obsidian` | 38 | projects |
| `lorenzo` | 36 | projects |
| `notion` | 33 | projects |
| `AutoResearch` | 24 | projects |
| `PortalEntry` | 23 | projects |
| `MemNet` | 20 | projects |
| `wikontic` | 20 | projects |
| `gpt` | 18 | projects |
| `VladSpace` | 10 | projects |
| `gemini` | 10 | projects |
| `ingit` | 10 | projects |
...
| **Svyazi** ↔ **Rufler** | 44 |
| **Svyazi** ↔ **mclaude** | 44 |
| **NGT** ↔ **knowledge-space** | 44 |
| **Svyazi** ↔ **SENTINEL** | 43 |
| **AgentFS** ↔ **AI Factory** | 43 |


### 82. Центральность узлов (влиятельность)
...
| **NGT** | 681 | 📦 Проект |
| **Yodoca** | 631 | 📦 Проект |
| **CardIndex** | 609 | 📦 Проект |
| **AgentFS** | 602 | 📦 Проект |
| **knowledge-space** | 516 | 📦 Проект |
| **AI Factory** | 501 | 📦 Проект |
| **LiteParse** | 500 | 📦 Проект |
| **Rufler** | 491 | 📦 Проект |
| **SENTINEL** | 479 | 📦 Проект |
| **mclaude** | 474 | 📦 Проект |
| **Андрей (kksudo)** | 356 | 👤 Автор |
| **Lorenzo (svend4)** | 336 | 👤 Автор |
| **Виталий (spbmolot)** | 330 | 👤 Автор |
| **MemNet** | 316 | 📦 Проект |
| **Cowork** | 311 | 📦 Проект |
| **Lorenzo** | 302 | 📦 Проект |
| **ingit** | 298 | 📦 Проект |
...
### 86. Топ-20 по объёму (важные и изолированные)
...
| Качество доков (METRICS) | 70.1/100 | 🟡 |
| Go/No-Go (SCORING) | 93.0/100 | 🟡 |


### 90. Все документы
_Файл: `docs/READABILITY.md` | 6 колонок, 516 строк_
...
| `docs/02-anthropic-vacancies/README.md` | ~13 мин | 3273 | 📙 Долго |
...
| `docs/TIMELINE.md` | ~8 мин | 1771 | 📙 Долго |
| `docs/SITEMAP.md` | ~7 мин | 1867 | 📘 Средне |
| `docs/02-anthropic-vacancies/186-appendix-c-sample-use-cases-in-detail.md` | ~7 мин | 1846 | 📘 Средне |
| `docs/DECISIONS.md` | ~7 мин | 1576 | 📘 Средне |
...
| `docs/CONTRADICTIONS.md` | ~6 мин | 1445 | 📘 Средне |
...
| `docs/READABILITY.md` | ~5 мин | 1118 | 📘 Средне |
...
| `docs/ABBREVIATIONS.md` | ~3 мин | 820 | 📘 Средне |
...
| `docs/NARRATIVE.md` | ~3 мин | 687 | 📘 Средне |
...
| `docs/README.md` | ~2 мин | 593 | 📗 Быстро |
...
| `docs/ONBOARDING.md` | ~2 мин | 256 | 📗 Быстро |
...
| `docs/WORD_FREQ.md` | ~1 мин | 418 | 📗 Быстро |
...
| `docs/BROKEN_LINKS.md` | ~1 мин | 310 | 📗 Быстро |
| `docs/NAMED_ENTITIES.md` | ~1 мин | 341 | 📗 Быстро |
| `docs/PRIORITIES.md` | ~1 мин | 358 | 📗 Быстро |
...
| `docs/CONTACT_PRIORITY.md` | ~1 мин | 149 | 📗 Быстро |
...
| `docs/04-ai-collaborations/README.md` | ~1 мин | 156 | 📗 Быстро |
...
| `docs/DIGEST_WEEKLY.md` | ~1 мин | 55 | 📗 Быстро |
| `docs/ENTITIES.md` | ~1 мин | 164 | 📗 Быстро |
| `docs/GLOSSARY.md` | ~1 мин | 79 | 📗 Быстро |
| `docs/HEALTH.md` | ~1 мин | 63 | 📗 Быстро |
...
| `docs/SENTIMENT.md` | ~1 мин | 108 | 📗 Быстро |
...
| `docs/VALIDATION.md` | ~1 мин | 170 | 📗 Быстро |
...
| `docs/templates/research-note.md` | ~1 мин | 54 | 📗 Быстро |
...
### 95. Топ навигационных документов
...
### 97. Упоминания рисков в документах
...
### 106. Самые оптимистичные документы
...
### 107. Самые скептичные / риск-ориентированные
_Файл: `docs/SENTIMENT.md` | 3 колонок, 10 строк_
...
### 110. Мета-документы
_Файл: `docs/SITEMAP.md` | 3 колонок, 95 строк_

| Документ | Описание | Слов |
|----------|----------|------|
| [ABBREVIATIONS.md](docs/ABBREVIATIONS.md) | — | 1402 |
| [ACTION_ITEMS.md](docs/ACTION_ITEMS.md) | Задачи и риски (490) | 6465 |
| [ALERTS.md](docs/ALERTS.md) | — | 79 |
| [AUTHORS.md](docs/AUTHORS.md) | Авторы и контакты | 158 |
| [AUTOFILLED.md](docs/AUTOFILLED.md) | — | 102 |
| [BACKLINKS.md](docs/BACKLINKS.md) | — | 339 |
| [BROKEN_LINKS.md](docs/BROKEN_LINKS.md) | Сломанные ссылки (26) | 676 |
...
| [CODE_BLOCKS.md](docs/CODE_BLOCKS.md) | — | 3658 |
...
| [CONCEPTS.md](docs/CONCEPTS.md) | Глоссарий понятий (888) | 11402 |
| [CONCEPT_GRAPH.md](docs/CONCEPT_GRAPH.md) | — | 683 |
| [CONSISTENCY.md](docs/CONSISTENCY.md) | — | 248 |
| [CONTACTS.md](docs/CONTACTS.md) | Контакты (15 авторов) | 512 |
| [CONTACT_PRIORITY.md](docs/CONTACT_PRIORITY.md) | — | 413 |
| [CONTENT_GAPS.md](docs/CONTENT_GAPS.md) | — | 886 |
| [CONTRADICTIONS.md](docs/CONTRADICTIONS.md) | — | 2026 |
| [COST.md](docs/COST.md) | — | 697 |
| [COVERAGE.md](docs/COVERAGE.md) | — | 987 |
| [CROSSREFS.md](docs/CROSSREFS.md) | Перекрёстные ссылки проектов | 653 |
| [DECISIONS.md](docs/DECISIONS.md) | Ключевые решения (150) | 1921 |
...
| [DIGEST_WEEKLY.md](docs/DIGEST_WEEKLY.md) | — | 251 |
| [DUPLICATES.md](docs/DUPLICATES.md) | — | 282 |
| [ENTITIES.md](docs/ENTITIES.md) | Именованные сущности | 729 |
| [FAQ.md](docs/FAQ.md) | — | 836 |
...
| [HEALTH.md](docs/HEALTH.md) | Дашборд здоровья (75/100) | 181 |
| [HEATMAP.md](docs/HEATMAP.md) | — | 536 |
| [INDEX.md](docs/INDEX.md) | — | 616 |
| [KEYWORD_INDEX.md](docs/KEYWORD_INDEX.md) | — | 1034 |
| [KPI.md](docs/KPI.md) | Числовые KPI (737 показателей) | 2368 |
| [KPI_HISTORY.md](docs/KPI_HISTORY.md) | — | 106 |
| [LINKS.md](docs/LINKS.md) | Внешние ссылки | 709 |
...
| [NAMED_ENTITIES.md](docs/NAMED_ENTITIES.md) | — | 1567 |
| [NARRATIVE.md](docs/NARRATIVE.md) | — | 1019 |
| [NETWORK.md](docs/NETWORK.md) | — | 415 |
| [ONBOARDING.md](docs/ONBOARDING.md) | — | 520 |
| [ORPHANS.md](docs/ORPHANS.md) | — | 97 |
| [PARAGRAPH_QUALITY.md](docs/PARAGRAPH_QUALITY.md) | — | 6062 |
| [PRIORITIES.md](docs/PRIORITIES.md) | Приоритеты (TF-IDF) | 1151 |
...
| [QA.md](docs/QA.md) | Вопросы и ответы | 986 |
| [QUESTIONS.md](docs/QUESTIONS.md) | Открытые вопросы (484) | 1623 |
| [READABILITY.md](docs/READABILITY.md) | — | 7876 |
| [READING_ORDER.md](docs/READING_ORDER.md) | Рекомендуемый порядок чтения | 5947 |
| [README.md](docs/01-svyazi/README.md) | Главная страница и навигация | 113 |
| [README.md](docs/02-anthropic-vacancies/README.md) | Главная страница и навигация | 2125 |
| [README.md](docs/03-technology-combinations/README.md) | Главная страница и навигация | 49 |
| [README.md](docs/04-ai-collaborations/README.md) | Главная страница и навигация | 102 |
| [README.md](docs/05-habr-projects/README.md) | Главная страница и навигация | 38 |
| [README.md](docs/05-habr-projects/knowledge/README.md) | Главная страница и навигация | 13 |
| [README.md](docs/05-habr-projects/memory/README.md) | Главная страница и навигация | 25 |
| [README.md](docs/README.md) | Главная страница и навигация | 588 |
| [README.md](docs/autofilled/README.md) | Главная страница и навигация | 21 |
| [README.md](docs/autofilled/components/README.md) | Главная страница и навигация | 56 |
| [README.md](docs/badges/README.md) | Главная страница и навигация | 44 |
| [README.md](docs/contacts/README.md) | Главная страница и навигация | 183 |
...
| [SCORING.md](docs/SCORING.md) | — | 371 |
| [SEARCH.md](docs/SEARCH.md) | Поисковый индекс | 4085 |
| [SEE_ALSO.md](docs/SEE_ALSO.md) | — | 217 |
| [SENTIMENT.md](docs/SENTIMENT.md) | — | 393 |
| [SIMILAR.md](docs/SIMILAR.md) | Похожие документы (937 пар) | 327 |
| [SPELLCHECK.md](docs/SPELLCHECK.md) | — | 129 |
| [STALENESS.md](docs/STALENESS.md) | — | 432 |
| [STATS.md](docs/STATS.md) | Детальная статистика | 494 |
| [TABLES.md](docs/TABLES.md) | — | 45249 |
| [TAGS.md](docs/TAGS.md) | Теги (316 файлов, 12 тем) | 600 |
| [TECH_RADAR.md](docs/TECH_RADAR.md) | — | 612 |
| [TIMELINE.md](docs/TIMELINE.md) | Временная шкала (800 маркеров) | 4211 |
| [VALIDATION.md](docs/VALIDATION.md) | — | 395 |
| [VOCABULARY.md](docs/VOCABULARY.md) | — | 965 |
| [WORD_CLOUD.md](docs/WORD_CLOUD.md) | — | 194 |
| [WORD_FREQ.md](docs/WORD_FREQ.md) | Частотный анализ слов | 1791 |
...
### 121. 🤖 Авто-импортированные файлы (391)
...
### 122. Без метаданных (нет summary или тегов) — 81 файлов
...
### 123. Короткие (< 100 слов, заготовки) — 64 файлов
...
### 124. Сводная таблица по разделам
...
| `2026 год` | tes / / `2026/04/25` / 7 / dates / / `в 2026 году` / 6 / dates / / `март 2026` / 6 / dates / / `апреля 2026` | `docs/NAMED_ENTITIES.md` |
...
| `STATS.md` | 0.860 | 0.843 | 88% | 0.935 | 108 |
...
| `DECISIONS.md` | 0.831 | 0.567 | 72% | 0.861 | 1591 |
...
### 141. Файлы с бедным словарём (требуют доработки)
...
| `CROSSREFS.md` | 0.331 | 🔴 Очень бедный | 824 |
| `CITATION_INDEX.md` | 0.333 | 🔴 Очень бедный | 449 |
...
| `READABILITY.md` | 0.364 | 🔴 Очень бедный | 4488 |
| `BACKLINKS.md` | 0.370 | 🔴 Очень бедный | 182 |
| `304-ingit-as-cowork-native-workspace-substrate-md.md` | 0.370 | 🔴 Очень бедный | 136 |
| `CLUSTERS.md` | 0.372 | 🔴 Очень бедный | 2430 |
| `SITEMAP.md` | 0.372 | 🔴 Очень бедный | 1891 |
| `PARAGRAPH_QUALITY.md` | 0.377 | 🔴 Очень бедный | 4932 |
| `TAGS.md` | 0.378 | 🔴 Очень бедный | 1058 |
| `VALIDATION.md` | 0.380 | 🔴 Очень бедный | 504 |
