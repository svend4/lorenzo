...
> [!NOTE]
> Документ `QA` создаётся автоматически. Запустите скрипт для обновления.

<!-- alert-added -->
<!-- tags: qa, docs, analysis -->


<!-- summary -->
> Автоматически сформированный документ: `QA`.
...
```bash
# Вариант 2
python scripts/improve_qa.py --section 01-svyazi
```
