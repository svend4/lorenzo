...
<!-- summary -->
> _Извлечено: **3624** числовых показателей из документов_
...
| **355** | 171 ## Кластер 1 — концептов, поиска, репозитория, через (355 файлов) - `docs/01 | `CLUSTERS` |
| **345** | оё-происхождение.md` — _346-твоё-происхождение_ - _...и ещё 345 файлов_ ## Класт | `CLUSTERS` |
| **98** | щё 345 файлов_ ## Кластер 2 — turn, view, svyazi, agentfs (98 файлов) - `docs/01 | `CLUSTERS` |
