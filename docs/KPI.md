...
<!-- summary -->
> _Извлечено: **3509** числовых показателей из документов_
**Проекты:** Svyazi, AgentFS, MemNet, Auto AI Router, Whisper
...
| **354** | 167 ## Кластер 1 — концептов, репозитория, поиска, через (354 файлов) - `docs/01 | `CLUSTERS` |
| **344** | оё-происхождение.md` — _346-твоё-происхождение_ - _...и ещё 344 файлов_ ## Класт | `CLUSTERS` |
| **103** | щё 344 файлов_ ## Кластер 2 — turn, view, svyazi, agentfs (103 файлов) - `docs/0 | `CLUSTERS` |
| **93** | -executive-summary.md` — _01-executive-summary_ - _...и ещё 93 файлов_ ## Класте | `CLUSTERS` |
| **90** | ещё 93 файлов_ ## Кластер 3 — cowork, ingit, project, mcp (90 файлов) - `docs/02 | `CLUSTERS` |
...
| **30** | i, MemNet --- **Файлов с входящими ссылками:** 2715 ## Топ-30 самых цитируемых д | `BACKLINKS` |
...
| **15** | же (14 сл., строка 217) ### `WORD_FREQ.md` (2 из 27) - ## Топ-15 слов по раздела | `EMPTY_SECTIONS` |
