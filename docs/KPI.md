...
<!-- summary -->
> _Извлечено: **3629** числовых показателей из документов_
...
| **356** | 172 ## Кластер 1 — концептов, поиска, репозитория, через (356 файлов) - `docs/01 | `CLUSTERS` |
| **346** | оё-происхождение.md` — _346-твоё-происхождение_ - _...и ещё 346 файлов_ ## Класт | `CLUSTERS` |
| **98** | щё 346 файлов_ ## Кластер 2 — turn, view, svyazi, agentfs (98 файлов) - `docs/01 | `CLUSTERS` |
| **88** | -executive-summary.md` — _01-executive-summary_ - _...и ещё 88 файлов_ ## Класте | `CLUSTERS` |
| **91** | ещё 88 файлов_ ## Кластер 3 — cowork, ingit, project, mcp (91 файлов) - `docs/02 | `CLUSTERS` |
| **81** | 21-appendix-a-decision-tree-for-ingit-adopters_ - _...и ещё 81 файлов_ ## Класте | `CLUSTERS` |
...
| **30** | обратных ссылок **Файлов с входящими ссылками:** 2730 ## Топ-30 самых цитируемых | `BACKLINKS` |
