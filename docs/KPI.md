...
<!-- summary -->
> _Извлечено: **3511** числовых показателей из документов_
...
| **356** | 166 ## Кластер 1 — концептов, репозитория, поиска, через (356 файлов) - `docs/01 | `CLUSTERS` |
| **346** | оё-происхождение.md` — _346-твоё-происхождение_ - _...и ещё 346 файлов_ ## Класт | `CLUSTERS` |
| **101** | щё 346 файлов_ ## Кластер 2 — turn, view, svyazi, agentfs (101 файлов) - `docs/0 | `CLUSTERS` |
| **91** | -executive-summary.md` — _01-executive-summary_ - _...и ещё 91 файлов_ ## Класте | `CLUSTERS` |
| **90** | ещё 91 файлов_ ## Кластер 3 — cowork, ingit, project, mcp (90 файлов) - `docs/02 | `CLUSTERS` |
...
| **30** | обратных ссылок **Файлов с входящими ссылками:** 2731 ## Топ-30 самых цитируемых | `BACKLINKS` |
