...
<!-- summary -->
> _Извлечено: **3639** числовых показателей из документов_
...
| **354** | 170 ## Кластер 1 — концептов, поиска, репозитория, через (354 файлов) - `docs/01 | `CLUSTERS` |
| **344** | оё-происхождение.md` — _346-твоё-происхождение_ - _...и ещё 344 файлов_ ## Класт | `CLUSTERS` |
| **98** | щё 344 файлов_ ## Кластер 2 — turn, view, svyazi, agentfs (98 файлов) - `docs/01 | `CLUSTERS` |
| **88** | -executive-summary.md` — _01-executive-summary_ - _...и ещё 88 файлов_ ## Класте | `CLUSTERS` |
| **90** | ещё 88 файлов_ ## Кластер 3 — cowork, ingit, project, mcp (90 файлов) - `docs/02 | `CLUSTERS` |
