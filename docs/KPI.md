...
- [Количество (550)](#количество-550)
- [Проценты (384)](#проценты-384)
- [Время (557)](#время-557)
- [Стоимость (934)](#стоимость-934)
- [Размер (64)](#размер-64)
- [Версия (788)](#версия-788)
- [Рейтинг (100)](#рейтинг-100)
- [Этап (176)](#этап-176)
...
_Извлечено: **3553** числовых показателей из документов_
...
| **17** | hm, update methodology `a5de89d7` _→ CHANGELOG_AUTO_ - (17 файлов) _→ CLUSTERS_  | `ACTION_ITEMS` |
...
| **370** | 165 ## Кластер 1 — концептов, поиска, репозитория, через (370 файлов) - `docs/01 | `CLUSTERS` |
| **360** | -решает.md` — _298-что-этот-документ-не-решает_ - _...и ещё 360 файлов_ ## Класт | `CLUSTERS` |
| **106** | щё 360 файлов_ ## Кластер 2 — turn, view, svyazi, agentfs (106 файлов) - `docs/0 | `CLUSTERS` |
| **96** | -executive-summary.md` — _01-executive-summary_ - _...и ещё 96 файлов_ ## Класте | `CLUSTERS` |
| **86** | ещё 96 файлов_ ## Кластер 3 — cowork, ingit, project, mcp (86 файлов) - `docs/02 | `CLUSTERS` |
| **76** | 21-appendix-a-decision-tree-for-ingit-adopters_ - _...и ещё 76 файлов_ ## Класте | `CLUSTERS` |
| **66** | ов_ ## Кластер 4 — agent, principal, professional, agents (66 файлов) - `docs/02 | `CLUSTERS` |
| _...ещё 530_ | | |
...
| **30** | обратных ссылок **Файлов с входящими ссылками:** 2716 ## Топ-30 самых цитируемых | `BACKLINKS` |
| **3** | найден в docs/contacts/ --- ## Следующие шаги 1. Изучить топ-3 кандидата и выбра | `COLLAB_SUGGESTIONS` |
| **20** | # Содержание - Рекомендуется создать документы - Детали по топ-20 пробелам - `MH | `CONTENT_GAPS` |
| **40** | жание - Contents - Матрица сходства секций - Граф связей - Топ-40 кросс-секционн | `CROSS_SECTION` |
| **15** | обно (0 сл., строка 82) ### `WORD_FREQ.md` (2 из 26) - ## Топ-15 слов по раздела | `EMPTY_SECTIONS` |
| **50** | > > PRIORITIES — раздел документации проекта Lorenzo. - Топ-50 самых важных файл | `OUTLINE` |
