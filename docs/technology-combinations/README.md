...
<!-- summary -->
> Кто ссылается на этот документ (9): README (сходство 0.99) README (сходство 0.35) Рекомендуется читать перед погружением в детали. Комбинации технологий: исследовательские отчёты о синергии инструментов для Knowledge OS.
...
Содержимое разделено на тематические подпапки.
...
Паттерн **«скромные родители → мощные дети»** — ни один компонент по отдельности не революционен, но в нужной комбинации они дают свойства, которых нет ни у одного SaaS. См. [synthesis-tables/01-08-summary.md](synthesis-tables/01-08-summary.md).
