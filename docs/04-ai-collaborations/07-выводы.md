...
> 🏷️ **Ключевые слова:** `svyazi`, `summary`, `executive`, `проект`, `first`, `cardindex`, `agentfs`, `rufler`
>
...
**Проекты:** Svyazi[^svyazi], CardIndex[^cardindex], AgentFS[^agentfs], mclaude, AI Factory, Rufler[^rufler], [LiteParse](../01-svyazi/01-executive-summary.md), Yodoca[^yodoca]
