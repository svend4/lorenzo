...
> 🏷️ **Ключевые слова:** `svyazi`, `memory`, `проект`, `search`, `review`, `который`, `agentfs`, `knowledge`
>
...
<!-- summary -->
> После первичного обзора видно, что дефицит уже не в наличии компонентов, а в **стыках между ними**. Svyazi[^svyazi] хорошо закрывает ingest и нормализацию; AgentFS[^agentfs] даёт
...
После первичного обзора видно, что дефицит уже не в наличии компонентов, а в **стыках между ними**. Svyazi хорошо закрывает ingest и нормализацию; AgentFS даёт
.agentos
...
- [09 Architectural Gaps](../01-svyazi/09-architectural-gaps.md) _60%_
- [07 Mvp Planning](../01-svyazi/07-mvp-planning.md) _37%_
- [Интеграционный контракт, который стоит зафиксировать сразу](11-интеграционный-контракт-который-стоит-зафиксироват.md) _37%_
- [11 Integration Contracts](../01-svyazi/11-integration-contracts.md) _33%_
