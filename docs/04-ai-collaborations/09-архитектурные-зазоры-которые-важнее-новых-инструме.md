...
**Проекты:** Svyazi, CardIndex[^cardindex], AgentFS, [knowledge-space](../01-svyazi/03-component-catalog.md)[^knowledge-space], mclaude, AI Factory, Rufler[^rufler], LiteParse
...
python scripts/improve_semantic_search.py --query "Архитектурные зазоры которые важнее"
```
