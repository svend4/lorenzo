...
> 🏷️ **Ключевые слова:** `search`, `svyazi`, `memory`, `проект`, `knowledge`, `контакт`, `cardindex`, `agentfs`
>
...
.agentos/
и compile‑to‑runtime политики. citeturn33view4turn27view0 | Комментарии к статье и [GitHub](../01-svyazi/03-component-catalog.md) issues в AgentFS. citeturn33view7turn27view0 | Публичный прямой контакт **не найден**. |
...
python scripts/improve_semantic_search.py --query "План прототипа и возможные контакты"
```
