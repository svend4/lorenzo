...
.agentos/
и compile‑to‑runtime политики. citeturn33view4turn27view0 | Комментарии к статье и [GitHub](../docs/01-svyazi/03-component-catalog.md) issues в AgentFS. citeturn33view7turn27view0 | Публичный прямой контакт **не найден**. |
...
**Похожие документы:**
- [07-mvp-planning](docs/01-[svyazi](../docs/01-svyazi/00-intro-part2.md)/07-mvp-planning.md) (сходство 1.00)
