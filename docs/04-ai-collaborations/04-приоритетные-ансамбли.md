...
mermaid
flowchart LR
    A[Микрофон / встреча / голосовая заметка] --> B[Whisper / Handy / [OpenWhispr](../docs/01-svyazi/03-component-catalog.md) / GigaAM]
...
**Похожие документы:**
- [04-ensembles-overview](docs/01-[svyazi](../docs/01-svyazi/00-intro-part2.md)/04-ensembles-overview.md) (сходство 0.92)
