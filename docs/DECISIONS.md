...
- Svyazi + AgentFS + NGT/Yodoca +… _→ Читать полностью_ --- ## Глава 2: Экосистема проектов > <!-- toc --> - Contents - [Карта найденных проектов и  
  _→ NARRATIVE_
...
```bash
python scripts/improve_semantic_search.py --query "DECISIONS"
```
