...
<!-- summary -->
> `DECISIONS` — раздел документации проекта Lorenzo.


Автоматически извлечено из всех документов: **1358 записей**
...
_...ещё 110 записей в этой категории_
...
- скл]] | 3407 | — | | 42 | 🟡 Средний | Proposal: Knowledge-Space × Mclaude | 267 | — | | 43 | 🟡 Средний | [[prop  
  _→ READING_ORDER_
...
_...ещё 1028 записей в этой категории_
