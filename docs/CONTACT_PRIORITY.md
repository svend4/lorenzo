...
|---|-------|--------|------|-----------|--------|------|
| 1 | **kksudo** | AgentFS | knowledge/filesystem | 186 | 👁 Изучили | 569 |
| 2 | **spbmolot** | NGT Memory | memory | 170 | 👁 Изучили | 521 |
| 3 | **AnastasiyaW** | knowledge-space, mclaude | knowledge/orchestration | 134 | 👁 Изучили | 413 |
| 4 | **VitalyOborin** | Yodoca | memory | 105 | 👁 Изучили | 326 |
| 5 | **VladSpace** | Graph RAG | rag | 102 | ⬜ Не начато | 310 |
| 6 | **zodigancode** | Rufler | orchestration | 94 | 👁 Изучили | 291 |
| 7 | **nlaik** | LiteParse / research-docs | rag | 92 | 👁 Изучили | 285 |
| 8 | **Cutcode** | AIF Handoff | orchestration | 88 | ⬜ Не начато | 268 |
| 9 | **Antipozitive** | MemNet | memory | 85 | 👁 Изучили | 266 |
| 10 | **Dmitriila** | SENTINEL | security | 88 | ⬜ Не начато | 266 |
...
1. **kksudo** (AgentFS, 186 упоминаний) → [открыть контакт](contacts/kksudo.md)
1. **spbmolot** (NGT Memory, 170 упоминаний) → [открыть контакт](contacts/spbmolot.md)
1. **AnastasiyaW** (knowledge-space, mclaude, 134 упоминаний) → [открыть контакт](contacts/anastasiyaw.md)
