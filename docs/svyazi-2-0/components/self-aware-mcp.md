...
- **Maturity:** активный стек инструментов. citeturn20view12turn37search7turn12search2
- **Релевантность к Svyazi‑2.0:** высокая — делает агентный слой контекстным, переносимым и предсказуемым.
...
python scripts/improve_semantic_search.py --query "Self Aware MCP Skills CodeWiki"
```
...
**Похожие документы:**
- [self-aware-mcp](../../obsidian/svyazi-2-0/components/self-aware-mcp.md) (сходство 0.98)
- [rufler](rufler.md) (сходство 0.60)
- [rufler](../../obsidian/svyazi-2-0/components/rufler.md) (сходство 0.59)
