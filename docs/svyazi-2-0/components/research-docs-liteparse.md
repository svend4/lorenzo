...
- **Maturity:** активный OSS. citeturn15search1turn15search5
- **Релевантность к Svyazi‑2.0:** очень высокая — даёт visual grounding, которого Svyazi‑подобным системам обычно не хватает.
...
**Похожие документы:**
- [research-docs-liteparse](../../obsidian/svyazi-2-0/components/research-docs-liteparse.md) (сходство 0.98)
- [yodoca](yodoca.md) (сходство 0.60)
- [mclaude](mclaude.md) (сходство 0.60)
