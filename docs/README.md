...
- [ALERTS.md](ALERTS.md) — Добавлено **72** callout-блоков в документы.
...
- [CHANGELOG.md](CHANGELOG.md) — Всего коммитов: **54**
...
- [COMPARE.md](COMPARE.md) — **Файлов было:** 763  **стало:** 1053
- [COMPLEXITY.md](COMPLEXITY.md) — **Файлов проанализировано:** 1038
...
- [DECISIONS.md](DECISIONS.md) — Автоматически извлечено из всех документов: **451 записей**
...
- [FOOTNOTES.md](FOOTNOTES.md) — **Обновлено файлов:** 4  **Вставлено сносок:** 15
...
- [METHODOLOGY.md](METHODOLOGY.md) — > Принципы: скрипты работают **по вызову**, под контролем человека или Claude.
- [METRICS.md](METRICS.md) — **Файлов:** 1714  **Средний балл:** 69.6/100
...
- [PROTOTYPE_SPEC.md](PROTOTYPE_SPEC.md) — > **Версия:** 1.0 · **Дата:** 2026-05-10 · **Статус:** Draft
...
- [SEE_ALSO.md](SEE_ALSO.md) — **Файлов с блоком See Also:** 514
...
- [STATS.md](STATS.md) — **Разделов:** 11  **Файлов:** 1047  **Слов:** 1,199,279  **Символов:** 10,227,651
...
- [VALIDATION.md](VALIDATION.md) — **Ошибок:** 0  **Предупреждений:** 29  **Пройдено:** 27
