...
| 3 | NGT Memory ассоциативный граф лингвист ngt структура | 8 | ✅ |
| 4 | agent-memory-mcp типизированная SQLite эпизодическая Vi… | 3 | ✅ |
| 5 | MemNet RAG Challenge Docling pdfplumber FAISS memory | 6 | ✅ |
| 6 | Rufler YAML декларативный агент Claude Code токены swar… | 2 | ✅ |
| 7 | knowledge-space карточки MIT граф 785 AnastasiyaW | 4 | ✅ |
| 8 | LiteParse PDF извлечение Evidence nlaik структура докум… | 3 | ✅ |
| 9 | Wikontic семантический граф VitalyOborin kubernetes нор… | 5 | ✅ |
| 10 | Svyazi 2.0 спецификация прототипа Card Envelope Evidenc… | 2 | ✅ |
| 11 | Card Envelope sha256 card_id payload источник интеграци… | 7 | ✅ |
| 12 | BM25 TF-IDF гибридный поиск Retrieval hybrid search pas… | 9 | ✅ |
...
*Сгенерировано: 2026-06-05 18:21*