...
| **kksudo** | AgentFS | knowledge/filesystem | 128 | Что лучше класть в .agentos, а что выносить в machine-only state вне vault conventions? |
| **lee-to** | AI Factory | orchestration | 19 | — |
| **nlaik** | LiteParse / research-docs | rag | 50 | — |
| **spbmolot** | NGT Memory | memory | 129 | Где проходит практическая граница между полезной ассоциацией и ложной ко-активацией тем для community discovery? |
| **tagir_analyzes** | Legal RAG | rag | 33 | — |
| **zodigancode** | Rufler | orchestration | 63 | — |
...
**Похожие документы:**
- [CONTACTS](docs/obsidian/CONTACTS.md) (сходство 0.87)
- [narrow-questions](docs/svyazi-2-0/outreach/narrow-questions.md) (сходство 0.28)
- [CONTACT_PRIORITY](docs/CONTACT_PRIORITY.md) (сходство 0.26)
