...
_Обновлено: 2026-05-29 (improve_progress_sync.py)_
...
|-----------|--------|--------|
| Контакты авторов | ⚠️ 31 файлов, не отправлено | 31 файлов в docs/contacts/ |
| LLM-обогащение | ✅ 49 файлов | pip install anthropic && python scripts/improve_llm_enrich.py |
| Скрипты обработки | ✅ 187 скриптов | 5 LLM-скриптов, MCP=✅ |
| DIGEST.md | ✅ 5 секций | python scripts/improve_llm_summary.py |
| Claude Skills | ✅ 28 скиллов | design-ensemble, dispatch, generate-rfc, compare, write-contact, improve, review-docs, analyze-project, daily-routine, new-research, skill-router, search, synthesize, propose-collaboration, find-cinderella, audit-corpus, plan-mvp, outreach-day, track-decisions, status, summarize, evaluate-skill, review-architecture, find-contradictions, propose-mega-stack, find-gaps, evaluate-tech, weekly-review |
