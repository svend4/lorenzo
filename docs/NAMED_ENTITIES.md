...
| Сущность | Файлов | Тип |
|----------|--------|-----|
| `anthropic` | 736 | people |
| `claude` | 458 | people |
| `svend4` | 193 | people |
| `kksudo` | 77 | people |
| `spbmolot` | 72 | people |
| `anastasiyaw` | 48 | people |
| `vitalyoborin` | 41 | people |
...
| Сущность | Файлов | Тип |
|----------|--------|-----|
| `obsidian` | 775 | projects |
| `nautilus` | 542 | projects |
| `lorenzo` | 511 | projects |
| `svyazi` | 391 | projects |
| `GitHub` | 259 | projects |
| `yodoca` | 159 | projects |
| `ngt` | 139 | projects |
| `CardIndex` | 137 | projects |
| `agentfs` | 120 | projects |
| `knowledge-space` | 111 | projects |
| `memnet` | 109 | projects |
| `LiteParse` | 79 | projects |
| `notion` | 63 | projects |
