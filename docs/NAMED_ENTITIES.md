...
- [👤 People (20)](#people-20)
  - [anthropic (656 файлов)](#anthropic-656-файлов)
  - [claude (451 файлов)](#claude-451-файлов)
  - [svend4 (192 файлов)](#svend4-192-файлов)
  - [kksudo (74 файлов)](#kksudo-74-файлов)
  - [spbmolot (67 файлов)](#spbmolot-67-файлов)
- [📦 Projects (150)](#projects-150)
  - [lorenzo (515 файлов)](#lorenzo-515-файлов)
  - [nautilus (405 файлов)](#nautilus-405-файлов)
  - [svyazi (381 файлов)](#svyazi-381-файлов)
  - [GitHub (254 файлов)](#github-254-файлов)
  - [yodoca (154 файлов)](#yodoca-154-файлов)
- [⚙️ Tech (31)](#tech-31)
  - [mcp (353 файлов)](#mcp-353-файлов)
  - [bm25 (254 файлов)](#bm25-254-файлов)
  - [llm (212 файлов)](#llm-212-файлов)
  - [api (180 файлов)](#api-180-файлов)
  - [rag (165 файлов)](#rag-165-файлов)
- [🏢 Orgs (8)](#orgs-8)
  - [вк (298 файлов)](#вк-298-файлов)
  - [meta (219 файлов)](#meta-219-файлов)
  - [mail (70 файлов)](#mail-70-файлов)
  - [openai (47 файлов)](#openai-47-файлов)
  - [google (38 файлов)](#google-38-файлов)
- [📅 Dates (39)](#dates-39)
  - [2026-04 (84 файлов)](#2026-04-84-файлов)
  - [2026-05 (46 файлов)](#2026-05-46-файлов)
  - [2026-04-29 (44 файлов)](#2026-04-29-44-файлов)
  - [апрель 2026 (17 файлов)](#апрель-2026-17-файлов)
  - [2026-04-19 (17 файлов)](#2026-04-19-17-файлов)
...
> [!NOTE]
> Раздел `NAMED_ENTITIES` формируется автоматически из данных репозитория.

<!-- alert-added -->
<!-- tags: named-entities, docs -->


<!-- summary -->
> `NAMED_ENTITIES` — раздел документации проекта Lorenzo.


_Обновлено: 2026-05-11_

Всего сущностей: **248** (мин. 2 упоминаний)
...
| Сущность | Файлов | Тип |
|----------|--------|-----|
| `anthropic` | 656 | people |
| `claude` | 451 | people |
| `svend4` | 192 | people |
| `kksudo` | 74 | people |
| `spbmolot` | 67 | people |
| `anastasiyaw` | 45 | people |
| `vitalyoborin` | 35 | people |
...
| Сущность | Файлов | Тип |
|----------|--------|-----|
| `lorenzo` | 515 | projects |
| `nautilus` | 405 | projects |
| `svyazi` | 381 | projects |
| `GitHub` | 254 | projects |
| `yodoca` | 154 | projects |
| `ngt` | 138 | projects |
| `CardIndex` | 134 | projects |
| `agentfs` | 118 | projects |
| `knowledge-space` | 110 | projects |
| `memnet` | 103 | projects |
| `obsidian` | 101 | projects |
| `LiteParse` | 75 | projects |
| `notion` | 64 | projects |
| `PortalEntry` | 51 | projects |
| `AutoResearch` | 49 | projects |
| `wikontic` | 49 | projects |
| `gpt` | 41 | projects |
| `AutoGen` | 22 | projects |
