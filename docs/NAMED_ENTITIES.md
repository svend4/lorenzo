...
- [👤 People (20)](#people-20)
  - [`anthropic` (651 файлов)](#anthropic-651-файлов)
  - [`claude` (449 файлов)](#claude-449-файлов)
  - [`svend4` (191 файлов)](#svend4-191-файлов)
  - [`kksudo` (72 файлов)](#kksudo-72-файлов)
  - [`spbmolot` (65 файлов)](#spbmolot-65-файлов)
- [📦 Projects (147)](#projects-147)
  - [`nautilus` (403 файлов)](#nautilus-403-файлов)
  - [`lorenzo` (396 файлов)](#lorenzo-396-файлов)
  - [`svyazi` (323 файлов)](#svyazi-323-файлов)
  - [`GitHub` (253 файлов)](#github-253-файлов)
  - [`yodoca` (153 файлов)](#yodoca-153-файлов)
- [⚙️ Tech (31)](#tech-31)
  - [`mcp` (353 файлов)](#mcp-353-файлов)
  - [`bm25` (257 файлов)](#bm25-257-файлов)
  - [`llm` (210 файлов)](#llm-210-файлов)
  - [`api` (181 файлов)](#api-181-файлов)
  - [`rag` (165 файлов)](#rag-165-файлов)
- [🏢 Orgs (8)](#orgs-8)
  - [`вк` (298 файлов)](#вк-298-файлов)
  - [`meta` (216 файлов)](#meta-216-файлов)
...
- [📅 Dates (43)](#dates-43)
  ...
  - [`2026-05` (45 файлов)](#2026-05-45-файлов)
...
> [!NOTE]
> Раздел `NAMED_ENTITIES` автоматически формируется из данных репозитория.
...
Всего сущностей: **249** (мин. 2 упоминаний)
...
| Сущность | Файлов | Тип |
|----------|--------|-----|
| `anthropic` | 651 | people |
| `claude` | 449 | people |
| `svend4` | 191 | people |
| `kksudo` | 72 | people |
| `spbmolot` | 65 | people |
| `anastasiyaw` | 42 | people |
| `vitalyoborin` | 33 | people |
...
| Сущность | Файлов | Тип |
|----------|--------|-----|
| `nautilus` | 403 | projects |
| `lorenzo` | 396 | projects |
| `svyazi` | 323 | projects |
| `GitHub` | 253 | projects |
| `yodoca` | 153 | projects |
| `ngt` | 136 | projects |
| `CardIndex` | 135 | projects |
| `agentfs` | 117 | projects |
| `knowledge-space` | 107 | projects |
| `MemNet` | 102 | projects |
| `obsidian` | 101 | projects |
| `LiteParse` | 76 | projects |
| `notion` | 64 | projects |
| `PortalEntry` | 50 | projects |
| `AutoResearch` | 49 | projects |
| `wikontic` | 47 | projects |
| `gpt` | 41 | projects |
| `AutoGen` | 22 | projects |
