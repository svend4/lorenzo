...
**Проекты:** Svyazi[^svyazi], [CardIndex](../../01-svyazi/01-executive-summary.md)[^cardindex], Hybrid RAG[^rag], Yodoca[^yodoca], NGT Memory, MemNet, LiteLLM, Auto AI Router
...
## Содержание
  ...
  - [Пара 7. [AutoResearch](../../01-svyazi/01-executive-summary.md) цикл × Распределённый рой](#пара-7-autoresearch-цикл-распределённый-рой)
  ...
  - [Ансамбль 2: «[AutoResearch](../../01-svyazi/01-executive-summary.md) для legal precedent mining»](#ансамбль-2-autoresearch-для-legal-precedent-mining)
...
— Хеббовские/STDP-связи между сущностями → NGT Memory + [MemNet](../../01-svyazi/01-executive-summary.md) (на двух уровнях: приложения и обучаемой архитектуры);
...
3. Autonomous Research Box — связка из ZINC + [AutoResearch](../../01-svyazi/01-executive-summary.md)-loop Карпатого (habr.com/ru/articles/1026922/) + Sequential-протокол Дочкиной (habr.com/ru/articles/1017200/) + Yodoca-consolidator на одной R9700 за $500. Полный «ночной исследовательский отдел», который Карпатый описывает гипотетически, у тебя получается железно — за бюджет средней игровой видеокарты.
