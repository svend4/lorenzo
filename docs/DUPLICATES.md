...
> ```markdown ![docs](badges/docs.svg) ![words](badges/words.svg) ![scripts](badges/scripts.svg) ![health](badges/health.svg) ![go/no-go](badges/scoring.svg) ![license](docs/bad…

> ![docs](badges/docs.svg) — `docs/badges/docs.svg` ![words](badges/words.svg) — `docs/badges/words.svg` ![scripts](badges/scripts.svg) — `docs/badges/scripts.svg` ![health](badges/h…
