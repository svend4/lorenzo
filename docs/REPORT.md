...
База содержит **1193 документов** объёмом **945,266 слов** в **20 секциях**. Здоровье репозитория: **77/100/100**, средний балл документов: **71.3/100/100**, словарное богатство (STTR): **0.675**.
...
- 👤 **claude** (people) — упомянут в 401 файлах
- ⚙️ **mcp** (tech) — упомянут в 299 файлах
- 📦 **svyazi** (projects) — упомянут в 298 файлах
- 🏢 **вк** (orgs) — упомянут в 267 файлах
- 📦 **github** (projects) — упомянут в 237 файлах
- 🏢 **meta** (orgs) — упомянут в 199 файлах
- 👤 **svend4** (people) — упомянут в 198 файлах
