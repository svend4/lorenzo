...
База содержит **1230 документов** объёмом **1,419,179 слов** в **22 секциях**. Здоровье репозитория: **90/100**, средний балл документов: **93.3/100/100**, словарное богатство (STTR): **0.628**.
...
| Секция | Файлов | Слов |
|--------|--------|------|
| **obsidian** | 1221 | 1,267,656 |
| **Anthropic Vacancies** | 357 | 340,633 |
| **nautilus** | 255 | 171,478 |
| **anthropic-vacancies** | 111 | 44,869 |
| **AI Collaborations** | 17 | 27,801 |
| **lorenzo-agent** | 62 | 27,381 |
| **svyazi-2-0** | 60 | 19,500 |
| **habr-unique-projects** | 56 | 18,856 |
| **technology-combinations** | 53 | 18,537 |
| **processing-guide** | 13 | 17,249 |
| **Habr Projects** | 16 | 14,642 |
| **Svyazi 2.0** | 16 | 13,222 |
| **ai-collaborations** | 31 | 11,497 |
| **Templates** | 24 | 7,312 |
| **Contacts** | 17 | 4,969 |
| **Tech Combinations** | 7 | 3,761 |
| **meta-scripting** | 7 | 3,183 |
| **autofilled** | 13 | 2,648 |
| **glossary** | 4 | 2,612 |
| **badges** | 1 | 87 |
...
- 👤 **claude** (people) — упомянут в 450 файлах
- 📦 **lorenzo** (projects) — упомянут в 435 файлах
- 📦 **nautilus** (projects) — упомянут в 402 файлах
- ⚙️ **mcp** (tech) — упомянут в 352 файлах
- 📦 **svyazi** (projects) — упомянут в 333 файлах
- 🏢 **вк** (orgs) — упомянут в 297 файлах
- ⚙️ **bm25** (tech) — упомянут в 255 файлах
- 📦 **github** (projects) — упомянут в 254 файлах
