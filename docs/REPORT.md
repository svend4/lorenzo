...
| Показатель | Значение |
|------------|---------|
| Всего документов | **2500** |
| Всего слов | **2,878,496** |
...
- **1267** ключевых решений → [DECISIONS.md](DECISIONS.md)
- **3639** числовых KPI → [KPI.md](KPI.md)
- **1992** открытых вопросов → [QUESTIONS.md](QUESTIONS.md)
