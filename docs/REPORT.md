...
<!-- summary -->
> Executive Report: Репозиторий Lorenzo — документ базы знаний репозитория Lorenzo.
...
| Всего слов | **2,643,820** |
| Скриптов обработки | **162** |
| Индекс здоровья | **96/100** |
| Проектов в сети | **22** |
| Связей проектов | **190** |
...
- **1293** ключевых решений → [DECISIONS.md](DECISIONS.md)
- **3558** числовых KPI → [KPI.md](KPI.md)
