...
- **326** ключевых решений → [DECISIONS.md](DECISIONS.md)
- **1602** числовых KPI → [KPI.md](KPI.md)
- **946** открытых вопросов → [QUESTIONS.md](QUESTIONS.md)
...
2. ⚠️ Устранить **20 предупреждений** → [VALIDATION.md](VALIDATION.md)
