...
База содержит **1193 документов** объёмом **940,769 слов** в **20 секциях**. Здоровье репозитория: **77/100/100**, средний балл документов: **71.3/100/100**, словарное богатство (STTR): **0.674**.
...
- 👤 **claude** (people) — упомянут в 398 файлах
- 📦 **svyazi** (projects) — упомянут в 296 файлах
- ⚙️ **mcp** (tech) — упомянут в 295 файлах
- 🏢 **вк** (orgs) — упомянут в 266 файлах
- 📦 **github** (projects) — упомянут в 238 файлах
- 🏢 **meta** (orgs) — упомянут в 200 файлах
- 👤 **svend4** (people) — упомянут в 197 файлах
