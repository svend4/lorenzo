...
| Всего слов | **2,878,088** |
| Скриптов обработки | **167** |
...
- **3624** числовых KPI → [KPI.md](KPI.md)
- **1990** открытых вопросов → [QUESTIONS.md](QUESTIONS.md)
...
В репозитории **167 скриптов** для работы с документами:
