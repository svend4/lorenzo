...
База содержит **1194 документов** объёмом **943,302 слов** в **20 секциях**. Здоровье репозитория: **77/100/100**, средний балл документов: **71.2/100/100**, словарное богатство (STTR): **0.675**.
...
- 👤 **anthropic** (people) — упомянут в 745 файлах
- 📦 **nautilus** (projects) — упомянут в 468 файлах
- 👤 **claude** (people) — упомянут в 400 файлах
- ⚙️ **mcp** (tech) — упомянут в 302 файлах
- 📦 **svyazi** (projects) — упомянут в 297 файлах
