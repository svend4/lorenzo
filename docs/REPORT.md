...
База содержит **1190 документов** объёмом **932,309 слов** в **18 секциях**. Здоровье репозитория: **77/100/100**, средний балл документов: **71.3/100/100**, словарное богатство (STTR): **0.674**.
