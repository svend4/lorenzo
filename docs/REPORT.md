...
| Показатель | Значение |
|------------|---------|
| Всего документов | **2606** |
| Всего слов | **2,980,296** |
| Скриптов обработки | **186** |
...
- **1360** ключевых решений → [DECISIONS.md](DECISIONS.md)
...
В репозитории **186 скриптов** для работы с документами:
...
_Отчёт сгенерирован автоматически · 2026-05-14_
