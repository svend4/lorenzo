...
База содержит **1244 документов** объёмом **1,540,028 слов** в **23 секциях**. Здоровье репозитория: **90/100**, средний балл документов: **95.9/100/100**, словарное богатство (STTR): **0.628**.
...
| Секция | Файлов | Слов |
|--------|--------|------|
| **obsidian** | 1238 | 1,495,711 |
| **Anthropic Vacancies** | 357 | 341,828 |
| **nautilus** | 255 | 176,885 |
