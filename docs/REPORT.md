...
| Показатель | Значение |
|------------|---------|
| Всего документов | **2497** |
| Всего слов | **2,932,998** |
...
- **1264** ключевых решений → [DECISIONS.md](DECISIONS.md)
- **3511** числовых KPI → [KPI.md](KPI.md)
- **1973** открытых вопросов → [QUESTIONS.md](QUESTIONS.md)
...
В репозитории **166 скриптов** для работы с документами:
...
_Отчёт сгенерирован автоматически · 2026-05-12_
