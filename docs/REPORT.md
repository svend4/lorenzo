...
База содержит **1194 документов** объёмом **945,935 слов** в **20 секциях**. Здоровье репозитория: **77/100/100**, средний балл документов: **71.3/100/100**, словарное богатство (STTR): **0.676**.
...
- ⚙️ **llm** (tech) — упомянут в 194 файлах
...
- - - - - -  Как реализован forensic RAG с доказуемостью? [[Карта базы знаний Lorenzo](docs/KNOWLEDGE_
