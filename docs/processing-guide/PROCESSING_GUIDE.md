...
<!-- summary -->
> * У LLM нет долгосрочной памяти между сессиями. * SQLite + FTS5 + асинхронные эмбеддинги Не связаны ссылками между собой Не имеют единого формата метаданных
...
- [Обработка больших массивов информации — Часть 1: Обзор и таксономия](#обработка-больших-массивов-информации-часть-1-обзор-и-таксономия)
- [Проблема](#проблема)
...
- [Обработка больших массивов — Часть 2: Извлечение](#обработка-больших-массивов-часть-2-извлечение)
...
- [Обработка больших массивов — Часть 3: Разбивка и чанкинг](#обработка-больших-массивов-часть-3-разбивка-и-чанкинг)
- [Зачем делить?](#зачем-делить)
- [Стратегии разбивки](#стратегии-разбивки)
  - [Стратегия 1: По заголовкам (H2/H3) — реализовано](#стратегия-1-по-заголовкам-h2h3-реализовано)
  - [Стратегия 2: Семантические чанки — реализовано](#стратегия-2-семантические-чанки-реализовано)
  - [Стратегия 3: Разбивка по абзацам (BM25-уровень) — реализовано](#стратегия-3-разбивка-по-абзацам-bm25-уровень-реализовано)
  - [Стратегия 4: Разбивка по теме (TF-IDF рубрикация) — реализовано](#стратегия-4-разбивка-по-теме-tf-idf-рубрикация-реализовано)
  - [Стратегия 5: Слияние коротких файлов по теме — реализовано](#стратегия-5-слияние-коротких-файлов-по-теме-реализовано)
  - [Стратегия 6: Разбивка по языку — реализовано](#стратегия-6-разбивка-по-языку-реализовано)
- [Параметры разбивки: что выбрать](#параметры-разбивки-что-выбрать)
- [Инструмент выбора стратегии: utils_chunker.py](#инструмент-выбора-стратегии-utils_chunkerpy)
- [Следующий шаг](#следующий-шаг)
- [Обработка больших массивов — Часть 4: Структурирование](#обработка-больших-массивов-часть-4-структурирование)
...
- [Следующий шаг](#следующий-шаг)
- [Обработка больших массивов — Часть 5: Анализ и NLP](#обработка-больших-массивов-часть-5-анализ-и-nlp)
...
- [Следующий шаг](#следующий-шаг)
- [Обработка больших массивов — Часть 6: Поиск](#обработка-больших-массивов-часть-6-поиск)
...
- [Следующий шаг](#следующий-шаг)
- [Обработка больших массивов — Часть 7: LLM-обогащение](#обработка-больших-массивов-часть-7-llm-обогащение)
...
- [Следующий шаг](#следующий-шаг)
- [Обработка больших массивов — Часть 8: Экспорт и интеграции](#обработка-больших-массивов-часть-8-экспорт-и-интеграции)
...
- [Следующий шаг](#следующий-шаг)
- [Обработка больших массивов — Часть 9: Автоматизация](#обработка-больших-массивов-часть-9-автоматизация)
...
- [Следующий шаг](#следующий-шаг)
- [Обработка больших массивов — Часть 10: Инновационные подходы](#обработка-больших-массивов-часть-10-инновационные-подходы)
- [Граница между «уже есть» и «ещё нет»](#граница-между-уже-есть-и-ещё-нет)
- [Уровень A: Векторный поиск (следующий шаг)](#уровень-a-векторный-поиск-следующий-шаг)
- [Уровень B: Граф знаний с LLM-NER](#уровень-b-граф-знаний-с-llm-ner)
- [Уровень C: Мультиагентная обработка](#уровень-c-мультиагентная-обработка)
- [Уровень D: Автономный агент-документатор](#уровень-d-автономный-агент-документатор)
- [Уровень E: Инкрементальное обучение базы знаний](#уровень-e-инкрементальное-обучение-базы-знаний)
- [Уровень F: Темпоральное рассуждение](#уровень-f-темпоральное-рассуждение)
- [Уровень G: Голосовой пайплайн (Speech-to-Knowledge)](#уровень-g-голосовой-пайплайн-speech-to-knowledge)
- [Уровень H: Синтез из нескольких репозиториев](#уровень-h-синтез-из-нескольких-репозиториев)
- [Уровень I: Не придуманные подходы](#уровень-i-не-придуманные-подходы)
  - [Живой документ (Living Document)](#живой-документ-living-document)
- [Статус AgentFS](#статус-agentfs)
  - [Граф аргументов (Argument Graph)](#граф-аргументов-argument-graph)
  - [Нейросеть на собственной базе (Domain-Specific Fine-tuning)](#нейросеть-на-собственной-базе-domain-specific-fine-tuning)
  - [Рефлексивный агент (Self-Improving Documentation)](#рефлексивный-агент-self-improving-documentation)
...
1. [Обзор и таксономия](#обработка-больших-массивов-информации-часть-1-обзор-и-таксономия)
2. [Извлечение](#обработка-больших-массивов-часть-2-извлечение)
3. [Чанкинг](#обработка-больших-массивов-часть-3-разбивка-и-чанкинг)
4. [Структурирование](#обработка-больших-массивов-часть-4-структурирование)
5. [Анализ и NLP](#обработка-больших-массивов-часть-5-анализ-и-nlp)
6. [Поиск](#обработка-больших-массивов-часть-6-поиск)
7. [LLM-обогащение](#обработка-больших-массивов-часть-7-llm-обогащение)
8. [Экспорт и интеграции](#обработка-больших-массивов-часть-8-экспорт-и-интеграции)
9. [Автоматизация](#обработка-больших-массивов-часть-9-автоматизация)
10. [Инновационные подходы](#обработка-больших-массивов-часть-10-инновационные-подходы)
