...
<!-- summary -->
> Ключевой документ для понимания архитектуры. Рекомендуется прочитать в первую очередь. Уровни поиска (от простого к сложному) Уровень 2: Поисковый индекс — improve_search_index.py
Уровни поиска (от простого к сложному)
 --
Уровень 2: Поисковый индекс — improve_search_index.py
Строит:   — 1053 документа, 4.5 МБ
Каждая запись:
 --
Уровень 3: BM25 — improve_keyword_index.py
BM25 (Best Match 25) — стандарт информационного поиск
