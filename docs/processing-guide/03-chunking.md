...
<!-- summary -->
> Документ содержит описание рисков и ограничений. Изучите их перед принятием архитектурных решений. : объединяет файлы < 100 слов с соседними : TF-IDF кластеризация → близкие файлы → один файл
 : объединяет файлы < 100 слов с соседними
 : TF-IDF кластеризация → близкие файлы → один файл
 --
...
<!-- tags: rag, ingestion, anthropic, self-improvement, collaboration -->
