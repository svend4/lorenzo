...
<!-- summary -->
> Раздел README формируется автоматически из данных репозитория. README — раздел документации проекта Lorenzo. Кто ссылается на этот документ (20): Материал из базы знаний Svyazi 2.0, раздел «npp-v1-0».
