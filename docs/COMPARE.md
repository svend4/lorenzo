...
**Файлов было:** 282  **стало:** 433  
**Слов было:** 164,782  **стало:** 343,880  **Δ:** +179,098
...
- `docs/02-anthropic-vacancies/109-3-принципы-консолидации-фаза-c.md` (417 слов)
- `docs/02-anthropic-vacancies/110-вопрос-fallback-ratio-как-критический-или-осмыслен.md` (215 слов)
...
- `docs/02-anthropic-vacancies/118-appendix-a-шаблон-для-header-warning.md` (145 слов)
- `docs/02-anthropic-vacancies/119-appendix-b-примеры-расхождений-и-их-разрешения.md` (207 слов)
- `docs/02-anthropic-vacancies/120-главные-технические-риски.md` (74 слов)
- `docs/02-anthropic-vacancies/121-appendix-c-история-изменений-методологии.md` (47 слов)
- `docs/02-anthropic-vacancies/122-глоссарий.md` (1189 слов)
- `docs/02-anthropic-vacancies/124-конфигурация-для-claude-desktop.md` (145 слов)
- `docs/02-anthropic-vacancies/125-readme-mcp-md-инструкция-по-установке.md` (66 слов)
- `docs/02-anthropic-vacancies/126-установка.md` (96 слов)
- `docs/02-anthropic-vacancies/127-подключение-к-claude-desktop.md` (71 слов)
- `docs/02-anthropic-vacancies/128-доступные-инструменты.md` (104 слов)
- `docs/02-anthropic-vacancies/129-примеры-запросов-в-claude.md` (78 слов)
- `docs/02-anthropic-vacancies/130-отладка.md` (123 слов)
- `docs/02-anthropic-vacancies/131-ограничения-текущей-версии-0-1-0-draft.md` (70 слов)
- `docs/02-anthropic-vacancies/133-обратная-связь.md` (16887 слов)
- `docs/02-anthropic-vacancies/187-слой-представительских-агентов-md.md` (18 слов)
- `docs/02-anthropic-vacancies/188-ai-опосредованное-представительство-для-недопредст.md` (74 слов)
- `docs/02-anthropic-vacancies/189-аннотация.md` (254 слов)
- `docs/02-anthropic-vacancies/190-содержание.md` (70 слов)
- `docs/02-anthropic-vacancies/191-1-синдром-золушки-почему-качество-остаётся-невидим.md` (721 слов)
- `docs/02-anthropic-vacancies/192-2-исторические-прецеденты-агенты-как-цивилизационн.md` (861 слов)
- `docs/02-anthropic-vacancies/193-3-что-делает-агента-представительским.md` (553 слов)
- `docs/02-anthropic-vacancies/194-4-десять-областей-применения.md` (1524 слов)
- `docs/02-anthropic-vacancies/195-5-архитектурная-спецификация.md` (553 слов)
- `docs/02-anthropic-vacancies/196-6-этическая-рамка.md` (409 слов)
- `docs/02-anthropic-vacancies/197-7-управление-и-надзор.md` (337 слов)
- `docs/02-anthropic-vacancies/198-8-риски-и-меры-противодействия.md` (448 слов)
_...и ещё 111_

## Удалённые файлы (0)


## Изменившиеся файлы (83) — топ по Δ слов
