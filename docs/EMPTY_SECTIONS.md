...
Файлов с проблемами: **401** | Пустых секций: **1669**
...
### `SCRIPTS_CATALOG.md` (23 из 171)

- ## По группам (0 сл., строка 199)
- ## Подробно (0 сл., строка 434)
- ### `improve_action_items.py` _(группа: extract)_ (10 сл., строка 453)
- ### `improve_changelog_auto.py` _(группа: без группы)_ (14 сл., строка 542)
- ### `improve_complexity.py` _(группа: analysis)_ (13 сл., строка 599)
- _...ещё 18_
...
- ### `knowledgespace` → должно быть `knowledge-space` (8 сл., строка 25)
- ### `knowledge space` → должно быть `knowledge-space` (14 сл., строка 32)
- ### `knowledge_space` → должно быть `knowledge-space` (4 сл., строка 41)
- ### `AI-Factory` → должно быть `AI Factory` (14 сл., строка 46)
- _...ещё 8_
...
- ## 2026-04-29 (86 коммитов) (0 сл., строка 7)
- ## 22 скила  (1 коммитов) (0 сл., строка 179)
- ### 🔧 Обслуживание (9 сл., строка 181)
- ## (1 коммитов) (0 сл., строка 186)
- ### 🔧 Обслуживание (4 сл., строка 188)
