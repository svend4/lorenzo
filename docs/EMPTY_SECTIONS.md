...
Файлов с проблемами: **400** | Пустых секций: **1664**
...
- ### `anthropic` (744 файлов) (13 сл., строка 35)
- ### `claude` (401 файлов) (13 сл., строка 44)
- ### `svend4` (198 файлов) (13 сл., строка 53)
- ### `spbmolot` (44 файлов) (13 сл., строка 62)
- ### `kksudo` (42 файлов) (13 сл., строка 71)
- _...ещё 20_
...
### `SCRIPTS_CATALOG.md` (23 из 170)

- ## По группам (0 сл., строка 199)
- ## Подробно (0 сл., строка 433)
- ### `improve_action_items.py` _(группа: extract)_ (10 сл., строка 452)
- ### `improve_changelog_auto.py` _(группа: без группы)_ (14 сл., строка 541)
- ### `improve_complexity.py` _(группа: analysis)_ (13 сл., строка 598)
- _...ещё 18_

### `mega-stack.md` (18 из 22)

- ## Слои стека (сверху вниз) (0 сл., строка 31)
- ### 1. UI / Client (12 сл., строка 33)
- ### 2. Agent Layer (13 сл., строка 38)
- ### 3. Orchestration (8 сл., строка 43)
- ### 4. RAG / Search (8 сл., строка 47)
- _...ещё 13_

### `protocol-spec.md` (18 из 22)

- ## 1. Introduction (0 сл., строка 31)
- ### 1.1 Motivation (7 сл., строка 33)
- ### 1.2 Scope (5 сл., строка 37)
- ## 3. Registry / Discovery (5 сл., строка 50)
- ## 4. Passport / Identity (2 сл., строка 56)
- _...ещё 13_

### `rfc.md` (18 из 19)

- ## Status of this Document (11 сл., строка 26)
- ## Abstract (6 сл., строка 30)
- ## 1. Introduction (0 сл., строка 34)
- ### 1.1 Motivation (6 сл., строка 36)
- ### 1.2 Scope (7 сл., строка 40)
- _...ещё 13_
...
- ## ID (1 сл., строка 26)
- ## Синергия (0 сл., строка 52)
- ### Что A делает лучше из-за B (5 сл., строка 54)
- ### Что B делает лучше из-за A (2 сл., строка 58)
- ### Что появляется только в комбинации (7 сл., строка 62)
- _...ещё 7_

### `template-of-templates.md` (12 из 15)

- ## Обязательные блоки шаблона (0 сл., строка 29)
- ### 1. Frontmatter (YAML) (0 сл., строка 31)
- ### 2. Заголовок 1-го уровня (0 сл., строка 35)
- ### 3. HTML-комментарии (для совместимости со скриптами) (0 сл., строка 39)
- ### 4. Секции 2-го уровня (`##`) (6 сл., строка 43)
- _...ещё 7_
...
- ## Гипотеза (8 сл., строка 26)
- ## Зачем (7 сл., строка 30)
- ## Метод (0 сл., строка 34)
- ### Условия (6 сл., строка 36)
- ### Метрики успеха (10 сл., строка 41)
- _...ещё 6_
...
- ## Предмет спора (5 сл., строка 52)
- ## Применимые нормы (§§) (13 сл., строка 56)
- ## Аргументы (0 сл., строка 61)
- ### Antragsteller / Kläger (6 сл., строка 63)
- ### Behörde / Beklagte (6 сл., строка 68)
- _...ещё 2_

### `meeting-notes.md` (7 из 10)

- ## Контекст (5 сл., строка 24)
- ## Повестка (9 сл., строка 34)
- ## Обсуждение (0 сл., строка 40)
- ### [Пункт 1] (7 сл., строка 42)
- ### [Пункт 2] (1 сл., строка 46)
- _...ещё 2_
...
- ## Сценарий реализации (8 сл., строка 41)
- ## Митигация (0 сл., строка 56)
- ### Превентивные меры (9 сл., строка 58)
- _...ещё 2_

### `weekly-digest.md` (7 из 10)

- ## TL;DR (5 сл., строка 23)
- ## Что сделано (0 сл., строка 27)
- ### Контент (11 сл., строка 29)
- ### Скрипты / инфраструктура (5 сл., строка 33)
- ### Контакты / коммуникации (7 сл., строка 36)
- _...ещё 2_
...
- ## Вопрос (4 сл., строка 25)
- ## Краткий ответ (10 сл., строка 29)
- ## Подробный ответ (6 сл., строка 33)
- ## Когда это НЕ применимо (6 сл., строка 37)
- ## Связанные вопросы (8 сл., строка 42)
- _...ещё 1_

### `glossary-entry.md` (6 из 7)

- ## Определение (5 сл., строка 25)
- ## Происхождение (5 сл., строка 29)
- ## Синонимы и аббревиатуры (9 сл., строка 33)
- ## Примеры (8 сл., строка 39)
- ## Связанные термины (12 сл., строка 44)
- _...ещё 1_

### `tech-radar-entry.md` (6 из 10)

- ## Quadrant (7 сл., строка 26)
- ## Описание (11 сл., строка 41)
- ## Почему именно этот ring (5 сл., строка 45)
- ## Когда использовать (6 сл., строка 49)
- ## Когда НЕ использовать (6 сл., строка 54)
- _...ещё 1_
...
### `CHANGELOG.md` (5 из 10)

- ## 2026-04-29 (83 коммитов) (0 сл., строка 7)
- ## 22 скила  (1 коммитов) (0 сл., строка 175)
- ### 🔧 Обслуживание (9 сл., строка 177)
- ## (1 коммитов) (0 сл., строка 182)
- ### 🔧 Обслуживание (4 сл., строка 184)

### `contradiction-record.md` (5 из 8)

- ## ID (1 сл., строка 26)
- ## Серьёзность (7 сл., строка 30)
- ## Источник A (12 сл., строка 34)
- ## Источник B (8 сл., строка 42)
- ## В чём противоречие (5 сл., строка 50)
...
- ## Период (11 сл., строка 23)
- ## Сводка (14 сл., строка 28)
- ## Лучшие изменения (14 сл., строка 45)
- ## Регрессии (14 сл., строка 50)
...
- ## Период (6 сл., строка 23)
- ## Что прошло хорошо ✅ (9 сл., строка 29)
- ## Что прошло плохо ❌ (6 сл., строка 35)
- ## Что узнали 💡 (6 сл., строка 40)
...
- ## Markdown сниппеты для README (8 сл., строка 24)
...
- ## Полезные команды (14 сл., строка 179)
