...
- remove 61 broken internal links (dangling #contents anchors + SEARCH.md paths) _a469b340_
  > - Remove `Contents` TOC entries from 44 files where ## Contents heading was stripped
...
[README](README.md) · [GLOSSARY](GLOSSARY.md) · [CONTACTS](CONTACTS.md) · [TIMELINE](TIMELINE.md) · [TAGS](TAGS.md) · [SEARCH](SEARCH.md) · [HEALTH](HEALTH.md)
