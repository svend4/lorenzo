...
### `docs/CONCEPTS.md` (1742 проблем)

_абзац: 819, Оборванный: 644, начала: 274, Дубль: 5_


### `docs/HEADING_AUDIT.md` (1024 проблем)

_абзац: 261, Оборванный: 2, начала: 761_


### `docs/TABLES.md` (908 проблем)

_абзац: 432, начала: 419, Дубль: 34, Оборванный: 14, предложение: 9_


### `docs/EMPTY_SECTIONS.md` (540 проблем)

_абзац: 300, Оборванный: 175, Дубль: 6, начала: 59_
