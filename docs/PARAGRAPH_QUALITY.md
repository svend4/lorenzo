...
### `docs/CONCEPTS.md` (1442 проблем)

_абзац: 698, Оборванный: 535, начала: 205, Дубль: 4_


### `docs/TABLES.md` (1101 проблем)

_абзац: 524, начала: 512, Дубль: 57, Оборванный: 8_


### `docs/CODE_BLOCKS.md` (214 проблем)

_абзац: 107, начала: 100, Дубль: 7_


### `docs/QA.md` (176 проблем)

_абзац: 89, начала: 82, Оборванный: 4, Дубль: 1_


### `docs/QUESTIONS.md` (137 проблем)

_абзац: 57, Оборванный: 65, Дубль: 9, начала: 6_


### `docs/CONTRADICTIONS.md` (124 проблем)

_абзац: 82, Оборванный: 17, Дубль: 25_


### `docs/GITHUB_ISSUES.md` (107 проблем)

_абзац: 10, Оборванный: 41, предложение: 2, начала: 25, Дубль: 29_
...
### `docs/DUPLICATES.md` (90 проблем)

_абзац: 35, Оборванный: 46, начала: 9_
...
_абзац: 4, Оборванный: 60, начала: 7_
...
### `docs/SPELLCHECK.md` (61 проблем)

_абзац: 32, начала: 29_
...
_Оборванный: 12, Дубль: 1, абзац: 7, начала: 8_
...
_Оборванный: 9, Дубль: 2, абзац: 15_
...
### `docs/TAGS.md` (25 проблем)

_абзац: 1, Оборванный: 12, начала: 12_
...
_Оборванный: 10, Дубль: 1, абзац: 13_
...
_Оборванный: 5, Дубль: 2, абзац: 10, начала: 5_
...
### `docs/02-anthropic-vacancies/314-6-refined-ingit-scope-with-cowork-in-mind.md` (22 проблем)

_Оборванный: 9, Дубль: 1, абзац: 12_
...
### `docs/SITEMAP.md` (19 проблем)

_Оборванный: 1, абзац: 9, начала: 9_
...
### `docs/02-anthropic-vacancies/328-2-что-cowork-обеспечивает-что-ingit-не-нужно-строи.md` (18 проблем)

_Оборванный: 8, Дубль: 3, абзац: 7_
...
### `docs/02-anthropic-vacancies/87-12-onboarding-paths-normative.md` (18 проблем)
...
### `docs/NARRATIVE.md` (17 проблем)

_абзац: 3, Оборванный: 12, предложение: 2_
...
### `docs/02-anthropic-vacancies/295-конкретный-случай-перед-нами.md` (16 проблем)

_Оборванный: 5, Дубль: 2, абзац: 5, начала: 4_
...
### `docs/02-anthropic-vacancies/310-2-what-cowork-provides-that-ingit-doesn-t-need-to-.md` (13 проблем)
...
### `docs/02-anthropic-vacancies/26-14-adr-001-federation-over-merging.md` (8 проблем)
...
### `docs/contacts/nlaik.md` (8 проблем)

_абзац: 5, Оборванный: 3_


### `docs/contacts/sonia-black.md` (8 проблем)
...
### `docs/02-anthropic-vacancies/286-acknowledgments.md` (6 проблем)
...
### `docs/DEPENDENCY_MAP.md` (4 проблем)
...
- [Время чтения документов](READING_TIME.md) _42%_
- [Карта происхождения текстов](SOURCE_MAP.md) _33%_
- [Diff базы знаний между версиями](VERSION_DIFF.md) _33%_
- [Рекомендуемый порядок чтения](READING_ORDER.md) _29%_
- [Карта репозитория Lorenzo](SITEMAP.md) _29%_
