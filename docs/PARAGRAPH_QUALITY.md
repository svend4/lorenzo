...
### `docs/CONCEPTS.md` (1740 проблем)

_абзац: 818, Оборванный: 643, начала: 274, Дубль: 5_
...
_абзац: 299, Оборванный: 174, Дубль: 6, начала: 59_


### `docs/SCRIPTS_CATALOG.md` (292 проблем)

_абзац: 250, Оборванный: 42_
...
### `docs/DUPLICATES.md` (124 проблем)

_абзац: 36, Оборванный: 88_
...
_абзац: 2, Оборванный: 12, начала: 12, Дубль: 2_
