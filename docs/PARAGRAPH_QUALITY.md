...
### `docs/CONCEPTS.md` (1681 проблем)

_абзац: 792, Оборванный: 624, начала: 261, Дубль: 4_
...
### `docs/DUPLICATES.md` (132 проблем)

_абзац: 35, Оборванный: 88, начала: 9_
