...
Найдено пробелов: **818** (мин. упоминаний: 3)
...
| `NPP` | 106 | `docs/nautilus/` |
| `GDPR` | 83 | `docs/obsidian/` |
| `MUST` | 83 | `docs/obsidian/` |
| `BSL` | 78 | `docs/obsidian/` |
| `SHOULD` | 61 | `docs/obsidian/` |
| `AIF` | 59 | `docs/obsidian/` |
| `PII` | 47 | `docs/obsidian/` |
| `XII` | 47 | `docs/obsidian/` |
| `PDF` | 43 | `docs/obsidian/` |
| `BSG` | 43 | `docs/obsidian/` |
| `LinkedIn` | 41 | `docs/nautilus/` |
| `URL` | 40 | `docs/obsidian/` |
| `YiJing` | 39 | `docs/obsidian/` |
| `KSV` | 39 | `docs/obsidian/` |
| `MAY` | 37 | `docs/nautilus/` |
| `RLM` | 35 | `docs/obsidian/` |
| `IDF` | 35 | `docs/obsidian/` |
| `HIPAA` | 34 | `docs/obsidian/` |
| `HMP` | 34 | `docs/lorenzo-agent/` |
| `AutoGen` | 31 | `docs/nautilus/` |
| `EIC` | 30 | `docs/nautilus/` |
| `EMEA` | 29 | `docs/anthropic-vacancies/` |
| `LCI` | 28 | `docs/obsidian/` |
| `OpenWhispr` | 27 | `docs/obsidian/` |
| `BaseAdapter` | 26 | `docs/obsidian/` |
| `CodeWiki` | 25 | `docs/obsidian/` |
| `DeepSeek` | 23 | `docs/obsidian/` |
| `III` | 23 | `docs/obsidian/` |
| `RSS` | 23 | `docs/obsidian/` |
| `LangChain` | 23 | `docs/obsidian/` |
| `ChatDev` | 22 | `docs/nautilus/` |
| `AIRI` | 22 | `docs/obsidian/` |
| `TypeScript` | 21 | `docs/obsidian/` |
| `HEALTH` | 21 | `docs/obsidian/` |
| `DeepMind` | 20 | `docs/obsidian/` |
| `DOCX` | 20 | `docs/obsidian/` |
| `FAISS` | 19 | `docs/obsidian/` |
| `CRM` | 19 | `docs/obsidian/` |
| `GPU` | 18 | `docs/obsidian/` |
| `RDF` | 18 | `docs/obsidian/` |
| `IBM` | 18 | `docs/obsidian/` |
| `VPS` | 18 | `docs/obsidian/` |
| `STDP` | 17 | `docs/obsidian/` |
| `HTTP` | 17 | `docs/obsidian/` |
| `ArXiv` | 16 | `docs/lorenzo-agent/` |
| `AutoAdapter` | 16 | `docs/obsidian/` |
| `WebSocket` | 15 | `docs/obsidian/` |
| `DevOps` | 15 | `docs/obsidian/` |
| `SGG` | 15 | `docs/nautilus/` |
