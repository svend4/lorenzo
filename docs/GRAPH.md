...
graph TD
  ...
  knowledge_space -- 72 --> Yodoca
  Yodoca -- 72 --> MemNet
  Rufler -- 69 --> Yodoca
  Yodoca -- 69 --> NGT_Memory
  CardIndex -- 67 --> knowledge_space
  AgentFS -- 67 --> LiteParse
  mclaude -- 66 --> Rufler
  AgentFS -- 65 --> mclaude
  LiteParse -- 65 --> Yodoca
  Svyazi -- 64 --> SENTINEL
  knowledge_space -- 64 --> mclaude
  mclaude -- 64 --> AI_Factory
  CardIndex -- 63 --> LiteParse
  AgentFS -- 63 --> Rufler
  knowledge_space -- 63 --> Rufler
  CardIndex -- 61 --> Rufler
  CardIndex -- 60 --> mclaude
  CardIndex -- 60 --> NGT_Memory
  mclaude -- 60 --> LiteParse
  Svyazi -- 59 --> Auto_AI_Router
  Svyazi -- 59 --> AutoResearch
  AI_Factory -- 59 --> Yodoca
  AgentFS -- 58 --> SENTINEL
  knowledge_space -- 58 --> LiteParse
  ...
  AgentFS -- 45 --> MemNet
  mclaude -- 45 --> MemNet
  Rufler -- 45 --> AutoResearch
  LiteParse -- 45 --> Auto_AI_Router
  ...
  LiteParse -- 44 --> MemNet
  NGT_Memory -- 44 --> Auto_AI_Router
  Svyazi -- 43 --> Hybrid_RAG
  AgentFS -- 43 --> AutoResearch
  mclaude -- 43 --> SENTINEL
  mclaude -- 43 --> AutoResearch
  SENTINEL -- 43 --> LiteLLM
  Svyazi -- 42 --> Yjs
  LiteParse -- 42 --> Hybrid_RAG
  LiteParse -- 42 --> Graph_RAG
  LiteParse -- 42 --> AutoResearch
  Auto_AI_Router -- 42 --> Tool_Search
  Svyazi -- 41 --> Wikontic
  CardIndex -- 41 --> AutoResearch
  ...
  AgentFS -- 39 --> LiteLLM
  knowledge_space -- 39 --> AutoResearch
  ...
  MemNet -- 23 --> Automerge
  AutoResearch -- 23 --> Wikontic
  LiteParse -- 22 --> Wikontic
...
digraph lorenzo {
  ...
  Svyazi -> mclaude [label="85"];
  Svyazi -> AI_Factory [label="72"];
  Svyazi -> Rufler [label="82"];
  Svyazi -> LiteParse [label="78"];
  ...
  knowledge_space -> AutoResearch [label="39"];
  knowledge_space -> Wikontic [label="27"];
  knowledge_space -> Firecrawl [label="18"];
  knowledge_space -> Yjs [label="31"];
  knowledge_space -> Automerge [label="28"];
  mclaude -> AI_Factory [label="64"];
  mclaude -> Rufler [label="66"];
  mclaude -> LiteParse [label="60"];
  mclaude -> Legal_RAG [label="34"];
  mclaude -> Hybrid_RAG [label="33"];
  mclaude -> Graph_RAG [label="32"];
  mclaude -> Yodoca [label="73"];
  mclaude -> NGT_Memory [label="51"];
  mclaude -> MemNet [label="45"];
  mclaude -> SENTINEL [label="43"];
  mclaude -> LiteLLM [label="32"];
  mclaude -> Auto_AI_Router [label="37"];
  mclaude -> Tool_Search [label="31"];
  mclaude -> AutoResearch [label="43"];
  mclaude -> Wikontic [label="19"];
  mclaude -> Firecrawl [label="12"];
  mclaude -> Yjs [label="28"];
  mclaude -> Automerge [label="26"];
  ...
  MemNet -> AutoResearch [label="35"];
  MemNet -> Wikontic [label="31"];
  MemNet -> Firecrawl [label="13"];
  MemNet -> Yjs [label="27"];
  MemNet -> Automerge [label="23"];
  ...
  AutoResearch -> Wikontic [label="23"];
  AutoResearch -> Firecrawl [label="9"];
  AutoResearch -> Yjs [label="29"];
  AutoResearch -> Automerge [label="27"];
  Wikontic -> Firecrawl [label="12"];
  Wikontic -> Yjs [label="18"];
  Wikontic -> Automerge [label="16"];
  Firecrawl -> Yjs [label="9"];
  Firecrawl -> Automerge [label="9"];
  Yjs -> Automerge [label="37"];
}
```
