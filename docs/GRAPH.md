...
graph TD
  ...
  Svyazi -- 125 --> Yodoca
  Svyazi -- 118 --> CardIndex
  Svyazi -- 93 --> MemNet
  Svyazi -- 91 --> AgentFS
  Svyazi -- 85 --> knowledge_space
  Svyazi -- 84 --> mclaude
  CardIndex -- 83 --> Yodoca
  Svyazi -- 82 --> NGT_Memory
  Svyazi -- 81 --> Rufler
  AgentFS -- 80 --> Yodoca
  CardIndex -- 78 --> AgentFS
  Svyazi -- 76 --> LiteParse
  AgentFS -- 74 --> knowledge_space
  ...
  Rufler -- 68 --> Yodoca
  CardIndex -- 65 --> knowledge_space
  AgentFS -- 65 --> LiteParse
  mclaude -- 65 --> Rufler
  Svyazi -- 64 --> SENTINEL
  AgentFS -- 64 --> mclaude
  ...
  knowledge_space -- 32 --> Legal_RAG
  knowledge_space -- 32 --> Hybrid_RAG
  ...
  knowledge_space -- 29 --> Tool_Search
  Rufler -- 29 --> Graph_RAG
  Rufler -- 29 --> Yjs
  LiteParse -- 29 --> Yjs
  MemNet -- 29 --> Wikontic
...
digraph lorenzo {
  ...
  Svyazi -> CardIndex [label="118"];
  Svyazi -> AgentFS [label="91"];
  Svyazi -> knowledge_space [label="85"];
  Svyazi -> mclaude [label="84"];
  Svyazi -> AI_Factory [label="72"];
  Svyazi -> Rufler [label="81"];
  Svyazi -> LiteParse [label="76"];
  ...
  knowledge_space -> LiteParse [label="55"];
  knowledge_space -> Legal_RAG [label="32"];
  knowledge_space -> Hybrid_RAG [label="32"];
  knowledge_space -> Graph_RAG [label="30"];
  knowledge_space -> Yodoca [label="71"];
  knowledge_space -> NGT_Memory [label="54"];
  knowledge_space -> MemNet [label="52"];
  knowledge_space -> SENTINEL [label="43"];
  knowledge_space -> LiteLLM [label="30"];
  knowledge_space -> Auto_AI_Router [label="36"];
  knowledge_space -> Tool_Search [label="29"];
