...
**Релевантность:** `0.608`  **Тип:** `project`  **Состояние:** `raw`  **Связей:** 7
...
**Релевантность:** `0.462`  **Тип:** `project`  **Состояние:** `raw`  **Связей:** 8
...
**Релевантность:** `0.381`  **Тип:** `project`  **Состояние:** `raw`  **Связей:** 6
...
**Релевантность:** `0.354`  **Тип:** `project`  **Состояние:** `raw`  **Связей:** 7
