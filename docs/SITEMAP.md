...
>
> 🎯 **Проблема:** Обновлено: 2026-04-29 Всего файлов: 442 Навигация - Мета-документы(мета-документы) - Svyazi 2.0 — Архитектура системы(01-svyazi) - Вакансии Anthropic — 436 позиций(02-anthropic-vac
> 🔧 **Подход:** Связь с существующими методологиями(docs/02-anthropic-vacancies/112-5-связь-с-существующими-методологиями.md) 263 22 6.
> ✅ **Результат:** ещё 305 файлов Комбинации технологий docs/03-technology-combinations/ — 5 файлов Документ Слов ------------------- 1 Агентные системы и роутинг(docs/03-technology-combinations/01-a
> 🏷️ **Ключевые слова:** `anthropic`, `vacancies`, `svyazi`, `collaborations`, `readme`, `projects`, `навигация`, `вопросы`
>
...
- [Навигация](#навигация)
- [Мета-документы](#мета-документы)
- [Svyazi 2.0 — Архитектура системы](#[svyazi](../docs/01-svyazi/00-intro-part2.md)-20-архитектура-системы)
- [Вакансии Anthropic — 436 позиций](#вакансии-anthropic-436-позиций)
- [Комбинации технологий](#комбинации-технологий)
- [AI Коллаборации — ансамбли проектов](#ai-коллаборации-ансамбли-проектов)
- [Хабр-проекты — память и граф](#хабр-проекты-память-и-граф)
...
- [Мета-документы](#мета-документы)
- [Svyazi 2.0 — Архитектура системы](#01-[svyazi](../docs/01-svyazi/00-intro-part2.md))
...
_`docs/01-[svyazi](../docs/01-svyazi/00-intro-part2.md)/` — 14 файлов_
