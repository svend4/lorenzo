...
<!-- summary -->
> Документ создан на основе исследования. Ссылки ведут на связанные материалы. Кто ссылается на этот документ (12) _Компонент экосистемы Svyazi 2.0_ Материал из базы знаний Svyazi 2.0, раздел «SGB».
