...
- исчезают**  
  _→ CONCEPTS_
- и открытые вопросы](#8-ограничения-и-открытые-вопросы) - [8.1. Trade-offs](#81-trade-offs) - [8.2. Открытые вопросы](#82-открытые-вопросы) - [8.  
  _→ DUPLICATES_
- (6 сл., строка 37)  
  _→ EMPTY_SECTIONS_
...
- N приоритетными контактами. |  
  _→ REGISTRY_
- авторами компонентов → [CONTACTS.md](CONTACTS.md)  
  _→ REPORT_
