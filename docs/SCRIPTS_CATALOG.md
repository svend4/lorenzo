...
- [Подробно](#подробно)
  ...
  - [`improve_ann_index.py` _(группа: без группы)_](#improve_ann_indexpy-_группа-без-группы_)
  ...
  - [`improve_collab_finder.py` _(группа: без группы)_](#improve_collab_finderpy-_группа-без-группы_)
  ...
  - [`improve_embedding_index.py` _(группа: без группы)_](#improve_embedding_indexpy-_группа-без-группы_)
  ...
  - [`improve_precision_eval.py` _(группа: без группы)_](#improve_precision_evalpy-_группа-без-группы_)
  ...
  - [`improve_quality_patch.py` _(группа: meta)_](#improve_quality_patchpy-_группа-meta_)
  ...
  - [`improve_semantic_search.py` _(группа: без группы)_](#improve_semantic_searchpy-_группа-без-группы_)
  - [`improve_sentiment.py` _(группа: analysis)_](#improve_sentimentpy-_группа-analysis_)
  - [`improve_sentinel_check.py` _(группа: quality)_](#improve_sentinel_checkpy-_группа-quality_)
