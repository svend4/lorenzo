...
| `2024 год` | 00-intro_ - 2019 года, после изменений 2024 года применяется иначе»); _→ 00-intro_ - Tree for InGit Ado | `docs/ACTION_ITEMS.md` |
| `2026 год` | es / / `апреля 2026` / 7 / dates / / `в 2026 году` / 6 / dates / / `2026/04/25` / 6 / dates / / `март 2026` | `docs/NAMED_ENTITIES.md` |
...
| `Q2 2024` | tes / / `февраль 2026` / 3 / dates / / `Q2 2024` / 3 / dates / / `февраля 2026` / 3 / dates / / `2025-11-12 | `docs/obsidian/NAMED_ENTITIES.md` |
| `Q2 2024` | tes / / `декабрь 2024` / 3 / dates / / `Q2 2024` / 3 / dates / / `2025-11-12` / 3 / dates / / `февраля 2026 | `docs/obsidian/TABLES.md` |
| `Q1 2026` | on, SQLite, MCP, BM25 - **Даты:** 2024, Q1 2026, апрель 2026 - **URL:** github.com/…, habr.com/… ```bash p | `docs/processing-guide/05-analysis.md` |
| `Q1 2026` | on, SQLite, MCP, BM25 - **Даты:** 2024, Q1 2026, апрель 2026 - **URL:** github.com/…, habr.com/… ```bash p | `docs/processing-guide/PROCESSING_GUIDE.md` |
