...
- 📌 **2021** · _70. К_  
  Корпус Файл: docs/KNOWLEDGEMAP.md 2 колонок, 4 строк Параметр Значение -------------------- Документов 1184 Слов 911,267  
  `TABLES.md`
...
- 🔔 **2024** · _Глоссарий понятий_  
  Определения извлечены автоматически из документов. Извлечено понятий: 1059 (из 2081 совпадений) A a coherent composite a  
  `CONCEPTS.md`
...
- 🔔 **2024** · _79. К_  
  Количество (244) Файл: docs/KPI.md 3 колонок, 8 строк Значение Контекст Источник ----------------------------- 80 y‑слое  
  `TABLES.md`
...
- 📌 **2024-01-01** · _193. Т_  
  Точная дата (2041) Файл: docs/TIMELINE.md 3 колонок, 3 строк Маркер Контекст Файл ------------------------ Q2 2024 / dat  
  `TABLES.md`
