...
**Похожие документы:**
- [VOCABULARY](docs/obsidian/VOCABULARY.md) (сходство 0.44)
- [134-the-double-triangle-architecture-md](docs/02-anthropic-vacancies/134-the-double-triangle-architecture-md.md) (сходство 0.19)
- [344-системный-промпт-для-lorenzo-project](docs/02-anthropic-vacancies/344-системный-промпт-для-lorenzo-project.md) (сходство 0.18)
