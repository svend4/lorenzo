...
См. [[19-adr-001-federation-over-merging|`npp-v1-1/19-adr-001-federation-over-merging.md`]] для архитектурного обоснования.

## Связь с остальным монорепозиторием

- **Q6-гиперкуб / MoME** упоминается во многих местах: [[concepts|`../glossary/concepts.md`]], [[2-tsu-mome|`../habr-unique-projects/hardware-pairs/2-tsu-mome.md`]], [[3-zinc-hybrid-arch|`../habr-unique-projects/hardware-pairs/3-zinc-hybrid-arch.md`]].
...
**Похожие документы:**
- [[355-существующие-документы-dhlab-твой-context]] (сходство 0.14)
- [[355-существующие-документы-dhlab-твой-context]] (сходство 0.14)
- [[306-with-anthropic-s-cowork-platform]] (сходство 0.14)
