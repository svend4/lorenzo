...
- [05-habr-projects (6 таблиц)](#05-habr-projects-6-таблиц)
  ...
  - [5. Статус](#5-статус)
  - [6. Статус](#6-статус)
- [ai-collaborations (13 таблиц)](#ai-collaborations-13-таблиц)
  - [1. Roadmap на 6–12 месяцев](#1-roadmap-на-612-месяцев)
  - [2. Дерево метрик Svyazi 2.0](#2-дерево-метрик-svyazi-20)
  - [3. Прямые аналоги Svyazi](#3-прямые-аналоги-svyazi)
  - [4. Память для агентов](#4-память-для-агентов)
  - [5. Hardware-near (нейроморфы, термодинамика, in-memory)](#5-hardware-near-нейроморфы-термодинамика-in-memory)
  - [6. Workflow / агентные оркестраторы](#6-workflow-агентные-оркестраторы)
  - [7. Document parsing / RAG](#7-document-parsing-rag)
  - [8. Adversarial / multi-IDE / code review](#8-adversarial-multi-ide-code-review)
  - [9. Voice / транскрипция](#9-voice-транскрипция)
  - [10. Browser agents / scraping](#10-browser-agents-scraping)
  - [11. Tmux village / multi-agent teams](#11-tmux-village-multi-agent-teams)
  - [12. Self-improvement / nightly research](#12-self-improvement-nightly-research)
  - [13. Прочее (data sources, tools, philosophy)](#13-прочее-data-sources-tools-philosophy)
- [anthropic-vacancies (2 таблиц)](#anthropic-vacancies-2-таблиц)
  - [1. Распределение по кластерам](#1-распределение-по-кластерам)
  - [2. profile-mapping/ — маппинг профиля svend4 на роли Anthropic](#2-profile-mapping-маппинг-профиля-svend4-на-роли-anthropic)
...
- [glossary (2 таблиц)](#glossary-2-таблиц)
  - [1. Авторы — алфавитный список](#1-авторы-алфавитный-список)
  - [2. Ключевые понятия и паттерны](#2-ключевые-понятия-и-паттерны)
- [habr-unique-projects (1 таблиц)](#habr-unique-projects-1-таблиц)
  - [1. Подпапки](#1-подпапки)
- [lorenzo-agent (1 таблиц)](#lorenzo-agent-1-таблиц)
  - [1. Что такое «внуковая» комбинация — operationalized Lorenzo](#1-что-такое-внуковая-комбинация-operationalized-lorenzo)
- [nautilus (21 таблиц)](#nautilus-21-таблиц)
  - [1. Подпапки](#1-подпапки)
  - [2. community-discussions/ — обсуждения и реакции вокруг DHLab с](#2-community-discussions-обсуждения-и-реакции-вокруг-dhlab-с)
  - [3. Appendix B: Domain Comparison Matrix](#3-appendix-b-domain-comparison-matrix)
  - [4. Структурное сравнение: код vs гуманитарные документы](#4-структурное-сравнение-код-vs-гуманитарные-документы)
  - [5. Паспорт: /](#5-паспорт)
  - [6. 8.3. Q6 Mapping Rules](#6-83-q6-mapping-rules)
  - [7. 12.6. Path Selection Guidance](#7-126-path-selection-guidance)
  - [8. 13.1. Required Endpoints](#8-131-required-endpoints)
  - [9. 13.1. Required Endpoints](#9-131-required-endpoints)
  - [10. 18.1. Current Reference Implementation Metrics](#10-181-current-reference-implementation-metrics)
  - [11. Паспорт: owner/my-notes](#11-паспорт-ownermy-notes)
  - [12. 5.2. Three-Year Pilot Budget (Estimated)](#12-52-three-year-pilot-budget-estimated)
  - [13. Appendix A: Comparison Matrix Against Existing Solutions](#13-appendix-a-comparison-matrix-against-existing-solutions)
  - [14. 1.7. Why This Distinction Matters](#14-17-why-this-distinction-matters)
  - [15. 3.3. Deployment Trajectory](#15-33-deployment-trajectory)
  - [16. 1.7. Почему это различение важно](#16-17-почему-это-различение-важно)
  - [17. 3.3. Траектория развёртывания](#17-33-траектория-развёртывания)
  - [18. Appendix B: Domain Comparison Matrix](#18-appendix-b-domain-comparison-matrix)
  - [19. Приложение B: Матрица Сравнения Областей](#19-приложение-b-матрица-сравнения-областей)
  - [20. 2.3. Артефакты каждой фазы](#20-23-артефакты-каждой-фазы)
  - [21. 8.1. Trade-offs](#21-81-trade-offs)
- [root (223 таблиц)](#root-223-таблиц)
  ...
  - [11. Содержание](#11-содержание)
  - [12. Паспорт: /](#12-паспорт)
  - [13. Паспорт: /](#13-паспорт)
  - [14. Паспорт: /](#14-паспорт)
  - [15. Изменившиеся файлы (69) — топ по Δ слов](#15-изменившиеся-файлы-69-топ-по-δ-слов)
  - [16. Распределение сложности](#16-распределение-сложности)
  - [17. Самые сложные документы](#17-самые-сложные-документы)
  - [18. Самые простые документы](#18-самые-простые-документы)
  - [19. Матрица возможностей](#19-матрица-возможностей)
  - [20. Покрытие возможностей](#20-покрытие-возможностей)
  - [21. Каталог компонентов](#21-каталог-компонентов)
  - [22. Рекомендуемые ансамбли](#22-рекомендуемые-ансамбли)
  - [23. Топ концептов по связям](#23-топ-концептов-по-связям)
  - [24. Согласованность терминов](#24-согласованность-терминов)
  - [25. Ключевые авторы проектов](#25-ключевые-авторы-проектов)
  - [26. GitHub репозитории](#26-github-репозитории)
  - [27. Топ авторов по приоритету](#27-топ-авторов-по-приоритету)
  - [28. Рекомендуется создать документы](#28-рекомендуется-создать-документы)
  - [29. Итого](#29-итого)
  - [30. По компонентам](#30-по-компонентам)
  - [31. По ролям](#31-по-ролям)
  - [32. Сценарии](#32-сценарии)
  - [33. Временные оценки из документов](#33-временные-оценки-из-документов)
  - [34. Сводка по секциям](#34-сводка-по-секциям)
  - [35. Файлы с низким покрытием (< 3 признаков) — 22 файлов](#35-файлы-с-низким-покрытием-3-признаков-22-файлов)
  - [36. Матрица сходства секций](#36-матрица-сходства-секций)
  - [37. Топ-40 кросс-секционных концептов](#37-топ-40-кросс-секционных-концептов)
  - [38. Детальная карта концептов](#38-детальная-карта-концептов)
  - [39. Карта плотности тем](#39-карта-плотности-тем)
  - [40. Наиболее раскрытые темы](#40-наиболее-раскрытые-темы)
  - [41. Где сосредоточена каждая тема](#41-где-сосредоточена-каждая-тема)
  - [42. Python-зависимости](#42-python-зависимости)
  - [43. OSS-проекты (Svyazi 2.0)](#43-oss-проекты-svyazi-20)
  - [44. Зависимости](#44-зависимости)
  - [45. История коммитов (последние 15)](#45-история-коммитов-последние-15)
  - [46. Текущее состояние репозитория](#46-текущее-состояние-репозитория)
  - [47. Сводка](#47-сводка)
  - [48. Активность по секциям](#48-активность-по-секциям)
  - [49. Итого](#49-итого)
  - [50. Файлы с ≥50% пустых секций (приоритет)](#50-файлы-с-50-пустых-секций-приоритет)
  - [51. Люди и авторы (7)](#51-люди-и-авторы-7)
  - [52. Проекты (22)](#52-проекты-22)
  - [53. Организации (9)](#53-организации-9)
  - [54. Технологии и стандарты (24)](#54-технологии-и-стандарты-24)
  - [55. GitHub репозитории (15)](#55-github-репозитории-15)
  - [56. Ко-встречаемость проектов (топ пары)](#56-ко-встречаемость-проектов-топ-пары)
  - [57. Словарь сносок](#57-словарь-сносок)
  - [58. Топ совместных упоминаний](#58-топ-совместных-упоминаний)
  - [59. Типы проблем](#59-типы-проблем)
  - [60. Метрики](#60-метрики)
  - [61. Структура репозитория](#61-структура-репозитория)
  - [62. Числовые значения (‰)](#62-числовые-значения)
  - [63. Концентрация тем](#63-концентрация-тем)
  - [64. Метрики репозитория](#64-метрики-репозитория)
  - [65. Аналитика и отчёты](#65-аналитика-и-отчёты)
  - [66. Ключевые документы](#66-ключевые-документы)
  - [67. LLM-обогащение (Ступень 3)](#67-llm-обогащение-ступень-3)
  - [68. Топ слов по охвату файлов](#68-топ-слов-по-охвату-файлов)
  - [69. Топ биграмм (устойчивые словосочетания)](#69-топ-биграмм-устойчивые-словосочетания)
  - [70. Корпус](#70-корпус)
  - [71. Метрики качества](#71-метрики-качества)
  - [72. По секциям](#72-по-секциям)
  - [73. Ключевые концепты](#73-ключевые-концепты)
  - [74. Топ сущностей](#74-топ-сущностей)
  - [75. Количество (242)](#75-количество-242)
  - [76. Количество (242)](#76-количество-242)
  - [77. Количество (242)](#77-количество-242)
  - [78. Количество (242)](#78-количество-242)
  - [79. Количество (242)](#79-количество-242)
  - [80. Количество (242)](#80-количество-242)
  - [81. Количество (242)](#81-количество-242)
  - [82. Количество (242)](#82-количество-242)
  - [83. Текущие метрики](#83-текущие-метрики)
  - [84. Распределение](#84-распределение)
  - [85. Файлы с неожиданным языком](#85-файлы-с-неожиданным-языком)
  - [86. Смешанные файлы (MIX)](#86-смешанные-файлы-mix)
  - [87. По секциям](#87-по-секциям)
  - [88. Индекс ссылок](#88-индекс-ссылок)
  - [89. По серверам](#89-по-серверам)
  - [90. Топ-15 инструментов (с латентностью)](#90-топ-15-инструментов-с-латентностью)
  - [91. Латентность по серверам](#91-латентность-по-серверам)
  - [92. Качество по разделам](#92-качество-по-разделам)
  - [93. Топ-15 лучших документов](#93-топ-15-лучших-документов)
  - [94. Документы, требующие улучшения (18)](#94-документы-требующие-улучшения-18)
  - [95. Легенда](#95-легенда)
  - [96. Карта пробелов знаний](#96-карта-пробелов-знаний)
  - [97. 👤 People (20)](#97-people-20)
  - [98. 👤 People (20)](#98-people-20)
  - [99. 👤 People (20)](#99-people-20)
  - [100. 👤 People (20)](#100-people-20)
  - [101. 👤 People (20)](#101-people-20)
  - [102. Топ-20 ко-упоминаемых пар](#102-топ-20-ко-упоминаемых-пар)
  - [103. Центральность узлов (влиятельность)](#103-центральность-узлов-влиятельность)
  - [104. Структура документации](#104-структура-документации)
  - [105. Ключевые документы](#105-ключевые-документы)
  - [106. Архитектура компонентов](#106-архитектура-компонентов)
  - [107. Топ-20 по объёму (важные и изолированные)](#107-топ-20-по-объёму-важные-и-изолированные)
  - [108. Типы проблем](#108-типы-проблем)
  - [109. Корпусная статистика](#109-корпусная-статистика)
  - [110. Топ файлов по доле пассива](#110-топ-файлов-по-доле-пассива)
  - [111. Состояние компонентов](#111-состояние-компонентов)
  - [112. Метрики качества](#112-метрики-качества)
  - [113. Все документы](#113-все-документы)
  - [114. Список чтения](#114-список-чтения)
  - [115. Содержание](#115-содержание)
  - [116. Все документы](#116-все-документы)
  - [117. Сводка](#117-сводка)
  - [118. Скрипты по группам](#118-скрипты-по-группам)
  - [119. Шаблоны](#119-шаблоны)
  - [120. Скилы](#120-скилы)
  - [121. MCP-серверы](#121-mcp-серверы)
  - [122. Манифесты задач](#122-манифесты-задач)
  - [123. Контакты](#123-контакты)
  - [124. Общая статистика](#124-общая-статистика)
  - [125. По секциям](#125-по-секциям)
  - [126. Ключевые проекты](#126-ключевые-проекты)
  - [127. Рекомендуемое чтение](#127-рекомендуемое-чтение)
  - [128. Реестр](#128-реестр)
  - [129. Упоминания рисков в документах](#129-упоминания-рисков-в-документах)
  - [130. Итоговая статистика](#130-итоговая-статистика)
  - [131. Ключевые вехи](#131-ключевые-вехи)
  - [132. Документация — 48/48 (100%) 🟢 GO](#132-документация-4848-100-go)
  - [133. Документация — 48/48 (100%) 🟢 GO](#133-документация-4848-100-go)
  - [134. Документация — 48/48 (100%) 🟢 GO](#134-документация-4848-100-go)
  - [135. Документация — 48/48 (100%) 🟢 GO](#135-документация-4848-100-go)
  - [136. Документация — 48/48 (100%) 🟢 GO](#136-документация-4848-100-go)
  - [137. analysis (9)](#137-analysis-9)
  - [138. analysis (9)](#138-analysis-9)
  - [139. analysis (9)](#139-analysis-9)
  - [140. analysis (9)](#140-analysis-9)
  - [141. analysis (9)](#141-analysis-9)
  - [142. analysis (9)](#142-analysis-9)
  - [143. analysis (9)](#143-analysis-9)
  - [144. analysis (9)](#144-analysis-9)
  - [145. analysis (9)](#145-analysis-9)
  - [146. analysis (9)](#146-analysis-9)
  - [147. analysis (9)](#147-analysis-9)
  - [148. analysis (9)](#148-analysis-9)
  - [149. analysis (9)](#149-analysis-9)
  - [150. analysis (9)](#150-analysis-9)
  - [151. analysis (9)](#151-analysis-9)
  - [152. analysis (9)](#152-analysis-9)
  - [153. Результаты поиска](#153-результаты-поиска)
  - [154. Тональность по разделам](#154-тональность-по-разделам)
  - [155. Самые оптимистичные документы](#155-самые-оптимистичные-документы)
  - [156. Самые скептичные / риск-ориентированные](#156-самые-скептичные-риск-ориентированные)
  - [157. Распределение тональности](#157-распределение-тональности)
  - [158. Топ-20 самых похожих пар](#158-топ-20-самых-похожих-пар)
  - [159. Мета-документы](#159-мета-документы)
  - [160. Svyazi 2.0 — Архитектура системы](#160-svyazi-20-архитектура-системы)
  - [161. Svyazi 2.0 — Архитектура системы](#161-svyazi-20-архитектура-системы)
  - [162. Svyazi 2.0 — Архитектура системы](#162-svyazi-20-архитектура-системы)
  - [163. Svyazi 2.0 — Архитектура системы](#163-svyazi-20-архитектура-системы)
  - [164. Svyazi 2.0 — Архитектура системы](#164-svyazi-20-архитектура-системы)
  - [165. Svyazi 2.0 — Архитектура системы](#165-svyazi-20-архитектура-системы)
  - [166. Svyazi 2.0 — Архитектура системы](#166-svyazi-20-архитектура-системы)
  - [167. Svyazi 2.0 — Архитектура системы](#167-svyazi-20-архитектура-системы)
  - [168. Svyazi 2.0 — Архитектура системы](#168-svyazi-20-архитектура-системы)
  - [169. Svyazi 2.0 — Архитектура системы](#169-svyazi-20-архитектура-системы)
  - [170. Svyazi 2.0 — Архитектура системы](#170-svyazi-20-архитектура-системы)
  - [171. Svyazi 2.0 — Архитектура системы](#171-svyazi-20-архитектура-системы)
  - [172. Svyazi 2.0 — Архитектура системы](#172-svyazi-20-архитектура-системы)
  - [173. Svyazi 2.0 — Архитектура системы](#173-svyazi-20-архитектура-системы)
  - [174. Svyazi 2.0 — Архитектура системы](#174-svyazi-20-архитектура-системы)
  - [175. Svyazi 2.0 — Архитектура системы](#175-svyazi-20-архитектура-системы)
  - [176. Категории](#176-категории)
  - [177. Авторы](#177-авторы)
  - [178. 🤖 Авто-импортированные файлы (846)](#178-авто-импортированные-файлы-846)
  - [179. Без метаданных (нет summary или тегов) — 170 файлов](#179-без-метаданных-нет-summary-или-тегов-170-файлов)
  - [180. Короткие (< 100 слов, заготовки) — 89 файлов](#180-короткие-100-слов-заготовки-89-файлов)
  - [181. Сводная таблица по разделам](#181-сводная-таблица-по-разделам)
  - [182. Топ-20 файлов по объёму](#182-топ-20-файлов-по-объёму)
  - [183. lorenzo-contacts (1)](#183-lorenzo-contacts-1)
  - [184. lorenzo-contacts (1)](#184-lorenzo-contacts-1)
  - [185. lorenzo-contacts (1)](#185-lorenzo-contacts-1)
  - [186. lorenzo-contacts (1)](#186-lorenzo-contacts-1)
  - [187. 🟢 ADOPT](#187-adopt)
  - [188. 🟢 ADOPT](#188-adopt)
  - [189. 🟢 ADOPT](#189-adopt)
  - [190. 🟢 ADOPT](#190-adopt)
  - [191. Точная дата (2041)](#191-точная-дата-2041)
  - [192. Точная дата (2041)](#192-точная-дата-2041)
  - [193. Точная дата (2041)](#193-точная-дата-2041)
  - [194. Точная дата (2041)](#194-точная-дата-2041)
  - [195. Точная дата (2041)](#195-точная-дата-2041)
  - [196. Точная дата (2041)](#196-точная-дата-2041)
  - [197. Точная дата (2041)](#197-точная-дата-2041)
  - [198. Точная дата (2041)](#198-точная-дата-2041)
  - [199. Сводка](#199-сводка)
  - [200. 📝 Изменённые файлы (69)](#200-изменённые-файлы-69)
  - [201. Корпусная статистика](#201-корпусная-статистика)
  - [202. Топ файлов по богатству словаря (STTR)](#202-топ-файлов-по-богатству-словаря-sttr)
  - [203. Файлы с бедным словарём (требуют доработки)](#203-файлы-с-бедным-словарём-требуют-доработки)
  - [204. Топ-20 слов](#204-топ-20-слов)
  - [205. Глобальный топ-50 слов](#205-глобальный-топ-50-слов)
  - [206. 01-svyazi (9,321 слов)](#206-01-svyazi-9321-слов)
  - [207. 01-svyazi (9,321 слов)](#207-01-svyazi-9321-слов)
  - [208. 01-svyazi (9,321 слов)](#208-01-svyazi-9321-слов)
  - [209. 01-svyazi (9,321 слов)](#209-01-svyazi-9321-слов)
  - [210. 01-svyazi (9,321 слов)](#210-01-svyazi-9321-слов)
  - [211. 01-svyazi (9,321 слов)](#211-01-svyazi-9321-слов)
  - [212. 01-svyazi (9,321 слов)](#212-01-svyazi-9321-слов)
  - [213. 01-svyazi (9,321 слов)](#213-01-svyazi-9321-слов)
  - [214. 01-svyazi (9,321 слов)](#214-01-svyazi-9321-слов)
  - [215. 01-svyazi (9,321 слов)](#215-01-svyazi-9321-слов)
  - [216. 01-svyazi (9,321 слов)](#216-01-svyazi-9321-слов)
  - [217. 01-svyazi (9,321 слов)](#217-01-svyazi-9321-слов)
  - [218. 01-svyazi (9,321 слов)](#218-01-svyazi-9321-слов)
  - [219. 01-svyazi (9,321 слов)](#219-01-svyazi-9321-слов)
  - [220. 01-svyazi (9,321 слов)](#220-01-svyazi-9321-слов)
  - [221. 01-svyazi (9,321 слов)](#221-01-svyazi-9321-слов)
  - [222. 01-svyazi (9,321 слов)](#222-01-svyazi-9321-слов)
  - [223. 01-svyazi (9,321 слов)](#223-01-svyazi-9321-слов)
- [svyazi-2-0 (12 таблиц)](#svyazi-2-0-12-таблиц)
  - [1. Подпапки](#1-подпапки)
  - [2. Сводная таблица зазоров](#2-сводная-таблица-зазоров)
  - [3. Интеграционная спецификация (минимум для MVP)](#3-интеграционная-спецификация-минимум-для-mvp)
  - [4. Развилки в коротком виде](#4-развилки-в-коротком-виде)
  - [5. Первые контакты](#5-первые-контакты)
  - [6. Адресные вопросы](#6-адресные-вопросы)
  - [7. Карта найденных проектов и паттернов](#7-карта-найденных-проектов-и-паттернов)
  - [8. Минимальная сборка прототипа](#8-минимальная-сборка-прототипа)
  - [9. Ключевые риски и как их закрывать](#9-ключевые-риски-и-как-их-закрывать)
  - [10. Сводная таблица](#10-сводная-таблица)
  - [11. Практичный бюджетный роутинг моделей](#11-практичный-бюджетный-роутинг-моделей)
  - [12. Что стоит зафиксировать как default policy](#12-что-стоит-зафиксировать-как-default-policy)
- [technology-combinations (13 таблиц)](#technology-combinations-13-таблиц)
  - [1. Подпапки](#1-подпапки)
  - [2. Комбинация 8: Conductor × adversarial-review × Auto AI Route](#2-комбинация-8-conductor-adversarial-review-auto-ai-route)
  - [3. Комбинация 14: local-first Agent Development Environment](#3-комбинация-14-local-first-agent-development-environment)
  - [4. Комбинация 19: Multi-Agent Observability Platform](#4-комбинация-19-multi-agent-observability-platform)
  - [5. Комбинация 24: MEGA-INTEGRATION: Full Stack](#5-комбинация-24-mega-integration-full-stack)
  - [6. Комбинация 30: MEGA-STACK 3.0 with DSL & AST](#6-комбинация-30-mega-stack-30-with-dsl-ast)
  - [7. Комбинация 35: MEGA-STACK 4.0 with Event Sourcing & Consensu](#7-комбинация-35-mega-stack-40-with-event-sourcing-consensu)
  - [8. Сводная таблица 1–8](#8-сводная-таблица-18)
  - [9. Сводная таблица 9–14 (Extended)](#9-сводная-таблица-914-extended)
  - [10. Сводная таблица 15–19 (Extended)](#10-сводная-таблица-1519-extended)
  - [11. Сводная таблица 20–24 (Final 1–24)](#11-сводная-таблица-2024-final-124)
  - [12. Сводная таблица 25–30 (Complete 1–30)](#12-сводная-таблица-2530-complete-130)
  - [13. Сводная таблица 31–35 (Complete 1–35)](#13-сводная-таблица-3135-complete-135)
- [templates (41 таблиц)](#templates-41-таблиц)
  - [1. Скилы агента](#1-скилы-агента)
  - [2. Tools (плагины)](#2-tools-плагины)
  - [3. Память](#3-память)
  - [4. Decision boundary](#4-decision-boundary)
  - [5. Профиль](#5-профиль)
  - [6. Рассмотренные варианты](#6-рассмотренные-варианты)
  - [7. Компоненты](#7-компоненты)
  - [8. Журнал](#8-журнал)
  - [9. История обновлений](#9-история-обновлений)
  - [10. Детальные метрики](#10-детальные-метрики)
  - [11. Идентификация](#11-идентификация)
  - [12. Стороны](#12-стороны)
  - [13. Хронология](#13-хронология)
  - [14. Прецеденты](#14-прецеденты)
  - [15. Участники](#15-участники)
  - [16. 1. UI / Client](#16-1-ui-client)
  - [17. 2. Agent Layer](#17-2-agent-layer)
  - [18. 3. Orchestration](#18-3-orchestration)
  - [19. 4. RAG / Search](#19-4-rag-search)
  - [20. Cross-layer контракты](#20-cross-layer-контракты)
  - [21. Стоимость](#21-стоимость)
  - [22. Риски и митигации](#22-риски-и-митигации)
  - [23. Альтернативные стеки](#23-альтернативные-стеки)
  - [24. Статус](#24-статус)
  - [25. 2. Terminology](#25-2-terminology)
  - [26. 5. Compatibility Levels](#26-5-compatibility-levels)
  - [27. Appendix B. Change Log](#27-appendix-b-change-log)
  - [28. Состав](#28-состав)
  - [29. Риски](#29-риски)
  - [30. Финансовая оценка](#30-финансовая-оценка)
  - [31. Метрики периода](#31-метрики-периода)
  - [32. 1.3 Terminology](#32-13-terminology)
  - [33. Appendix A. Change Log](#33-appendix-a-change-log)
  - [34. Оценка](#34-оценка)
  - [35. История](#35-история)
  - [36. Компонент A](#36-компонент-a)
  - [37. Компонент A](#37-компонент-a)
  - [38. Ring](#38-ring)
  - [39. Альтернативы](#39-альтернативы)
  - [40. История перемещений](#40-история-перемещений)
  - [41. Метрики недели](#41-метрики-недели)
...
| **knowledge-space** | `knowledge-space` | `knowledge-space` | 2 |
...
| **self-improvement** | `self-improvement` | `self-improvement` | 155 |
