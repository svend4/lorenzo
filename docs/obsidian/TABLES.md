...
- [01-svyazi (11 таблиц)](#01-svyazi-11-таблиц)
  - [1. Шкала зрелости](#1-шкала-зрелости)
  - [2. Карта найденных проектов и паттернов](#2-карта-найденных-проектов-и-паттернов)
  - [3. Безопасность, приватность и бюджетный роутинг](#3-безопасность-приватность-и-бюджетный-роутинг)
  - [4. Безопасность, приватность и бюджетный роутинг](#4-безопасность-приватность-и-бюджетный-роутинг)
  - [5. План прототипа и возможные контакты](#5-план-прототипа-и-возможные-контакты)
  - [6. План прототипа и возможные контакты](#6-план-прототипа-и-возможные-контакты)
  - [7. План прототипа и возможные контакты](#7-план-прототипа-и-возможные-контакты)
  - [8. Архитектурные зазоры, которые важнее новых инструментов](#8-архитектурные-зазоры-которые-важнее-новых-инструментов)
  - [9. Интеграционный контракт, который стоит зафиксировать сразу](#9-интеграционный-контракт-который-стоит-зафиксировать-сразу)
  - [10. Дорожная карта прототипа следующей итерации](#10-дорожная-карта-прототипа-следующей-итерации)
  - [11. Контактная стратегия и узкие вопросы для авторов](#11-контактная-стратегия-и-узкие-вопросы-для-авторов)
- [02-anthropic-vacancies (34 таблиц)](#02-anthropic-vacancies-34-таблиц)
  - [1. Naming convention расшифрована](#1-naming-convention-расшифрована)
  - [2. 2.3. Артефакты каждой фазы](#2-23-артефакты-каждой-фазы)
  - [3. 8.1. Trade-offs](#3-81-trade-offs)
  - [4. Доступные инструменты](#4-доступные-инструменты)
  - [5. Структурное сравнение: код vs гуманитарные документы](#5-структурное-сравнение-код-vs-гуманитарные-документы)
  - [6. 5.2. Three-Year Pilot Budget (Estimated)](#6-52-three-year-pilot-budget-estimated)
  - [7. Appendix A: Comparison Matrix Against Existing Solutions](#7-appendix-a-comparison-matrix-against-existing-solutions)
  - [8. Appendix B: Domain Comparison Matrix](#8-appendix-b-domain-comparison-matrix)
  - [9. Приложение B: Матрица Сравнения Областей](#9-приложение-b-матрица-сравнения-областей)
  - [10. 1.7. Why This Distinction Matters](#10-17-why-this-distinction-matters)
  - [11. 3.3. Deployment Trajectory](#11-33-deployment-trajectory)
  - [12. Appendix A: Comparative Table — Five Agent Types](#12-appendix-a-comparative-table-five-agent-types)
  - [13. 1.7. Почему это различение важно](#13-17-почему-это-различение-важно)
  - [14. 3.3. Траектория развёртывания](#14-33-траектория-развёртывания)
  - [15. Приложение A: Сравнительная Таблица — Пять Типов Агентов](#15-приложение-a-сравнительная-таблица-пять-типов-агентов)
  - [16. Appendix A: The Six-Type Taxonomy (Updated)](#16-appendix-a-the-six-type-taxonomy-updated)
  - [17. Appendix B: Comparison Matrix](#17-appendix-b-comparison-matrix)
  - [18. Приложение B: Сравнительная Матрица](#18-приложение-b-сравнительная-матрица)
  - [19. Что это такое в эссенции](#19-что-это-такое-в-эссенции)
  - [20. Synthesizing с нашим existing landscape](#20-synthesizing-с-нашим-existing-landscape)
  - [21. Что это за документ — диагностика](#21-что-это-за-документ-диагностика)
  - [22. Что критически нового добавляет этот документ](#22-что-критически-нового-добавляет-этот-документ)
  - [23. Эталонная экосистема: svend4](#23-эталонная-экосистема-svend4)
  - [24. Reference Ecosystem: svend4](#24-reference-ecosystem-svend4)
  - [25. Практические рекомендации для вашего метода](#25-практические-рекомендации-для-вашего-метода)
  - [26. Практические рекомендации для вашего метода](#26-практические-рекомендации-для-вашего-метода)
  - [27. Метрики (сравнение двух независимых анализов)](#27-метрики-сравнение-двух-независимых-анализов)
  - [28. Паспорт: /](#28-паспорт)
  - [29. 8.3. Q6 Mapping Rules](#29-83-q6-mapping-rules)
  - [30. 12.6. Path Selection Guidance](#30-126-path-selection-guidance)
  - [31. 13.1. Required Endpoints](#31-131-required-endpoints)
  - [32. 13.1. Required Endpoints](#32-131-required-endpoints)
  - [33. 18.1. Current Reference Implementation Metrics](#33-181-current-reference-implementation-metrics)
  - [34. Паспорт: owner/my-notes](#34-паспорт-ownermy-notes)
- [03-technology-combinations (1 таблиц)](#03-technology-combinations-1-таблиц)
  - [1. 📊Сводная таблица синергии](#1-сводная-таблица-синергии)
- [04-ai-collaborations (38 таблиц)](#04-ai-collaborations-38-таблиц)
  - [1. Статус](#1-статус)
  - [2. Статус](#2-статус)
  - [3. Статус](#3-статус)
  - [4. Статус](#4-статус)
  - [5. Карта найденных проектов и паттернов](#5-карта-найденных-проектов-и-паттернов)
  - [6. Карта найденных проектов и паттернов](#6-карта-найденных-проектов-и-паттернов)
  - [7. Карта найденных проектов и паттернов](#7-карта-найденных-проектов-и-паттернов)
  - [8. Карта найденных проектов и паттернов](#8-карта-найденных-проектов-и-паттернов)
  - [9. Карта найденных проектов и паттернов](#9-карта-найденных-проектов-и-паттернов)
  - [10. Карта найденных проектов и паттернов](#10-карта-найденных-проектов-и-паттернов)
  - [11. Статус](#11-статус)
  - [12. Статус](#12-статус)
  - [13. План прототипа и возможные контакты](#13-план-прототипа-и-возможные-контакты)
  - [14. План прототипа и возможные контакты](#14-план-прототипа-и-возможные-контакты)
  - [15. План прототипа и возможные контакты](#15-план-прототипа-и-возможные-контакты)
  - [16. План прототипа и возможные контакты](#16-план-прототипа-и-возможные-контакты)
  - [17. План прототипа и возможные контакты](#17-план-прототипа-и-возможные-контакты)
  - [18. Статус](#18-статус)
  - [19. Безопасность, приватность и бюджетный роутинг](#19-безопасность-приватность-и-бюджетный-роутинг)
  - [20. Безопасность, приватность и бюджетный роутинг](#20-безопасность-приватность-и-бюджетный-роутинг)
  - [21. Безопасность, приватность и бюджетный роутинг](#21-безопасность-приватность-и-бюджетный-роутинг)
  - [22. Статус](#22-статус)
  - [23. Статус](#23-статус)
  - [24. Статус](#24-статус)
  - [25. Архитектурные зазоры, которые важнее новых инструментов](#25-архитектурные-зазоры-которые-важнее-новых-инструментов)
  - [26. Статус](#26-статус)
  - [27. Статус](#27-статус)
  - [28. Интеграционный контракт, который стоит зафиксировать сразу](#28-интеграционный-контракт-который-стоит-зафиксировать-сразу)
  - [29. Интеграционный контракт, который стоит зафиксировать сразу](#29-интеграционный-контракт-который-стоит-зафиксировать-сразу)
  - [30. Интеграционный контракт, который стоит зафиксировать сразу](#30-интеграционный-контракт-который-стоит-зафиксировать-сразу)
  - [31. Интеграционный контракт, который стоит зафиксировать сразу](#31-интеграционный-контракт-который-стоит-зафиксировать-сразу)
  - [32. Интеграционный контракт, который стоит зафиксировать сразу](#32-интеграционный-контракт-который-стоит-зафиксировать-сразу)
  - [33. Статус](#33-статус)
  - [34. Дорожная карта прототипа следующей итерации](#34-дорожная-карта-прототипа-следующей-итерации)
  - [35. Статус](#35-статус)
  - [36. Контактная стратегия и узкие вопросы для авторов](#36-контактная-стратегия-и-узкие-вопросы-для-авторов)
  - [37. Контактная стратегия и узкие вопросы для авторов](#37-контактная-стратегия-и-узкие-вопросы-для-авторов)
  - [38. Статус](#38-статус)
- [05-habr-projects (6 таблиц)](#05-habr-projects-6-таблиц)
  - [1. Статус](#1-статус)
  - [2. Статус](#2-статус)
  - [3. Статус](#3-статус)
  - [4. Статус](#4-статус)
  - [5. Статус](#5-статус)
  - [6. Статус](#6-статус)
- [contacts (14 таблиц)](#contacts-14-таблиц)
  - [1. Профиль](#1-профиль)
  - [2. Профиль](#2-профиль)
  - [3. Профиль](#3-профиль)
  - [4. Профиль](#4-профиль)
  ...
  - [12. Профиль](#12-профиль)
  - [13. Профиль](#13-профиль)
  - [14. Профиль](#14-профиль)
- [root (152 таблиц)](#root-152-таблиц)
  - [1. Словарь аббревиатур и сокращений](#1-словарь-аббревиатур-и-сокращений)
  - [2. Самые часто используемые](#2-самые-часто-используемые)
  - [3. Callout-блоки](#3-callout-блоки)
  - [4. Авторы и коллаборации](#4-авторы-и-коллаборации)
  - [5. Топ-30 самых цитируемых документов](#5-топ-30-самых-цитируемых-документов)
  - [6. Ссылки по разделам](#6-ссылки-по-разделам)
  - [7. Сломанные внутренние ссылки](#7-сломанные-внутренние-ссылки)
  - [8. Статистика коммитов](#8-статистика-коммитов)
  - [9. Топ доменов](#9-топ-доменов)
  - [10. Наиболее цитируемые URL](#10-наиболее-цитируемые-url)
  - [11. Contents](#11-contents)
  - [12. Паспорт: /](#12-паспорт)
  - [13. Изменившиеся файлы (339) — топ по Δ слов](#13-изменившиеся-файлы-339-топ-по-δ-слов)
  - [14. Распределение сложности](#14-распределение-сложности)
  - [15. Самые сложные документы](#15-самые-сложные-документы)
  - [16. Самые простые документы](#16-самые-простые-документы)
  - [17. Матрица возможностей](#17-матрица-возможностей)
  - [18. Покрытие возможностей](#18-покрытие-возможностей)
  - [19. Каталог компонентов](#19-каталог-компонентов)
  - [20. Рекомендуемые ансамбли](#20-рекомендуемые-ансамбли)
  - [21. Топ концептов по связям](#21-топ-концептов-по-связям)
  - [22. Contents](#22-contents)
  - [23. Ключевые авторы проектов](#23-ключевые-авторы-проектов)
  - [24. GitHub репозитории](#24-github-репозитории)
  - [25. Топ авторов по приоритету](#25-топ-авторов-по-приоритету)
  - [26. Рекомендуется создать документы](#26-рекомендуется-создать-документы)
  - [27. Итого](#27-итого)
  - [28. По компонентам](#28-по-компонентам)
  - [29. По ролям](#29-по-ролям)
  - [30. Сценарии](#30-сценарии)
  - [31. Временные оценки из документов](#31-временные-оценки-из-документов)
  - [32. Сводка по секциям](#32-сводка-по-секциям)
  - [33. Файлы с низким покрытием (< 3 признаков) — 26 файлов](#33-файлы-с-низким-покрытием-3-признаков-26-файлов)
  - [34. Карта плотности тем](#34-карта-плотности-тем)
  - [35. Наиболее раскрытые темы](#35-наиболее-раскрытые-темы)
  - [36. Где сосредоточена каждая тема](#36-где-сосредоточена-каждая-тема)
  - [37. Зависимости](#37-зависимости)
  - [38. История коммитов (последние 15)](#38-история-коммитов-последние-15)
  - [39. Текущее состояние репозитория](#39-текущее-состояние-репозитория)
  - [40. Итого](#40-итого)
  - [41. Люди и авторы (7)](#41-люди-и-авторы-7)
  - [42. Проекты (22)](#42-проекты-22)
  - [43. Организации (9)](#43-организации-9)
  - [44. Технологии и стандарты (24)](#44-технологии-и-стандарты-24)
  - [45. GitHub репозитории (12)](#45-github-репозитории-12)
  - [46. Ко-встречаемость проектов (топ пары)](#46-ко-встречаемость-проектов-топ-пары)
  - [47. Словарь сносок](#47-словарь-сносок)
  - [48. Топ совместных упоминаний](#48-топ-совместных-упоминаний)
  - [49. Метрики](#49-метрики)
  - [50. Структура репозитория](#50-структура-репозитория)
  - [51. Числовые значения (‰)](#51-числовые-значения)
  - [52. Концентрация тем](#52-концентрация-тем)
  - [53. Метрики репозитория](#53-метрики-репозитория)
  - [54. Аналитика и отчёты](#54-аналитика-и-отчёты)
  - [55. Ключевые документы](#55-ключевые-документы)
  - [56. LLM-обогащение (Ступень 3)](#56-llm-обогащение-ступень-3)
  - [57. Топ слов по охвату файлов](#57-топ-слов-по-охвату-файлов)
  - [58. Топ биграмм (устойчивые словосочетания)](#58-топ-биграмм-устойчивые-словосочетания)
  - [59. Количество (134)](#59-количество-134)
  - [60. Количество (134)](#60-количество-134)
  - [61. Количество (134)](#61-количество-134)
  - [62. Количество (134)](#62-количество-134)
  - [63. Количество (134)](#63-количество-134)
  - [64. Количество (134)](#64-количество-134)
  - [65. Количество (134)](#65-количество-134)
  - [66. Количество (134)](#66-количество-134)
  - [67. Текущие метрики](#67-текущие-метрики)
  - [68. Индекс ссылок](#68-индекс-ссылок)
  - [69. Качество по разделам](#69-качество-по-разделам)
  - [70. Топ-15 лучших документов](#70-топ-15-лучших-документов)
  - [71. Документы, требующие улучшения (20)](#71-документы-требующие-улучшения-20)
  - [72. Легенда](#72-легенда)
  - [73. Карта пробелов знаний](#73-карта-пробелов-знаний)
  - [74. 👤 People (17)](#74-people-17)
  - [75. 👤 People (17)](#75-people-17)
  - [76. 👤 People (17)](#76-people-17)
  - [77. 👤 People (17)](#77-people-17)
  - [78. 👤 People (17)](#78-people-17)
  - [79. Топ-20 ко-упоминаемых пар](#79-топ-20-ко-упоминаемых-пар)
  - [80. Центральность узлов (влиятельность)](#80-центральность-узлов-влиятельность)
  - [81. Структура документации](#81-структура-документации)
  - [82. Ключевые документы](#82-ключевые-документы)
  - [83. Архитектура компонентов](#83-архитектура-компонентов)
  - [84. Топ-20 по объёму (важные и изолированные)](#84-топ-20-по-объёму-важные-и-изолированные)
  - [85. Типы проблем](#85-типы-проблем)
  - [86. Состояние компонентов](#86-состояние-компонентов)
  - [87. Метрики качества](#87-метрики-качества)
  - [88. Все документы](#88-все-документы)
  - [89. Содержание](#89-содержание)
  - [90. Все документы](#90-все-документы)
  - [91. Общая картина](#91-общая-картина)
  - [92. Структура репозитория](#92-структура-репозитория)
  - [93. Топ навигационных документов](#93-топ-навигационных-документов)
  - [94. Реестр](#94-реестр)
  - [95. Упоминания рисков в документах](#95-упоминания-рисков-в-документах)
  - [96. Итоговая статистика](#96-итоговая-статистика)
  - [97. Ключевые вехи](#97-ключевые-вехи)
  - [98. Документация — 48/48 (100%) 🟢 GO](#98-документация-4848-100-go)
  - [99. Документация — 48/48 (100%) 🟢 GO](#99-документация-4848-100-go)
  - [100. Документация — 48/48 (100%) 🟢 GO](#100-документация-4848-100-go)
  - [101. Документация — 48/48 (100%) 🟢 GO](#101-документация-4848-100-go)
  - [102. Документация — 48/48 (100%) 🟢 GO](#102-документация-4848-100-go)
  - [103. Тональность по разделам](#103-тональность-по-разделам)
  - [104. Самые оптимистичные документы](#104-самые-оптимистичные-документы)
  - [105. Самые скептичные / риск-ориентированные](#105-самые-скептичные-риск-ориентированные)
  - [106. Распределение тональности](#106-распределение-тональности)
  - [107. Топ-20 самых похожих пар](#107-топ-20-самых-похожих-пар)
  - [108. Мета-документы](#108-мета-документы)
  - [109. Svyazi 2.0 — Архитектура системы](#109-svyazi-20-архитектура-системы)
  - [110. Svyazi 2.0 — Архитектура системы](#110-svyazi-20-архитектура-системы)
  - [111. Svyazi 2.0 — Архитектура системы](#111-svyazi-20-архитектура-системы)
  - [112. Svyazi 2.0 — Архитектура системы](#112-svyazi-20-архитектура-системы)
  - [113. Svyazi 2.0 — Архитектура системы](#113-svyazi-20-архитектура-системы)
  - [114. Svyazi 2.0 — Архитектура системы](#114-svyazi-20-архитектура-системы)
  - [115. Svyazi 2.0 — Архитектура системы](#115-svyazi-20-архитектура-системы)
  - [116. Svyazi 2.0 — Архитектура системы](#116-svyazi-20-архитектура-системы)
  - [117. Категории](#117-категории)
  - [118. Авторы](#118-авторы)
  - [119. 🤖 Авто-импортированные файлы (391)](#119-авто-импортированные-файлы-391)
  - [120. Без метаданных (нет summary или тегов) — 186 файлов](#120-без-метаданных-нет-summary-или-тегов-186-файлов)
  - [121. Короткие (< 100 слов, заготовки) — 3 файлов](#121-короткие-100-слов-заготовки-3-файлов)
  - [122. Сводная таблица по разделам](#122-сводная-таблица-по-разделам)
  - [123. Топ-20 файлов по объёму](#123-топ-20-файлов-по-объёму)
  - [124. 🟢 ADOPT](#124-adopt)
  - [125. 🟢 ADOPT](#125-adopt)
  - [126. 🟢 ADOPT](#126-adopt)
  - [127. 🟢 ADOPT](#127-adopt)
  - [128. Точная дата (572)](#128-точная-дата-572)
  - [129. Точная дата (572)](#129-точная-дата-572)
  - [130. Точная дата (572)](#130-точная-дата-572)
  - [131. Точная дата (572)](#131-точная-дата-572)
  - [132. Точная дата (572)](#132-точная-дата-572)
  - [133. Точная дата (572)](#133-точная-дата-572)
  - [134. Точная дата (572)](#134-точная-дата-572)
  - [135. Топ уникальных слов по темам](#135-топ-уникальных-слов-по-темам)
  - [136. Сводка](#136-сводка)
  - [137. 📝 Изменённые файлы (16)](#137-изменённые-файлы-16)
  - [138. Корпусная статистика](#138-корпусная-статистика)
  - [139. Топ файлов по богатству словаря (STTR)](#139-топ-файлов-по-богатству-словаря-sttr)
  - [140. Файлы с бедным словарём (требуют доработки)](#140-файлы-с-бедным-словарём-требуют-доработки)
  - [141. Топ-20 слов](#141-топ-20-слов)
  - [142. Глобальный топ-50 слов](#142-глобальный-топ-50-слов)
  - [143. 01-svyazi (9,295 слов)](#143-01-svyazi-9295-слов)
  - [144. 01-svyazi (9,295 слов)](#144-01-svyazi-9295-слов)
  - [145. 01-svyazi (9,295 слов)](#145-01-svyazi-9295-слов)
  - [146. 01-svyazi (9,295 слов)](#146-01-svyazi-9295-слов)
  - [147. 01-svyazi (9,295 слов)](#147-01-svyazi-9295-слов)
  - [148. 01-svyazi (9,295 слов)](#148-01-svyazi-9295-слов)
  - [149. 01-svyazi (9,295 слов)](#149-01-svyazi-9295-слов)
  - [150. 01-svyazi (9,295 слов)](#150-01-svyazi-9295-слов)
  - [151. 01-svyazi (9,295 слов)](#151-01-svyazi-9295-слов)
  - [152. 01-svyazi (9,295 слов)](#152-01-svyazi-9295-слов)
- [templates (4 таблиц)](#templates-4-таблиц)
  - [1. Профиль](#1-профиль)
...
| **knowledge-space** | `knowledge-space` | `knowledge-space` | 17 |
| **CardIndex** | `CardIndex` | `CardIndex` | 1 |
| **AI Factory** | `AI Factory` | `AI Factory` | 4 |
| **NGT Memory** | `NGT Memory` | `NGT Memory` | 18 |
| **self-improvement** | `self-improvement` | `self-improvement` | 51 |
...
| 2 | 🟡 Средний | [[04-ensembles-overview]] | 1259 | — |
...
| 5 | 🟡 Средний | [[03-component-catalog]] | 1348 | — |
| 6 | 🟢 Начало | [[11-integration-contracts]] | 726 | `09-architectural-gaps.md` |
| 7 | 🟢 Начало | [[09-architectural-gaps]] | 738 | `01-executive-summary.md`, `03-component-catalog.md` |
| 8 | 🟢 Начало | [[10-second-order-ensembles]] | 899 | `04-ensembles-overview.md` |
| 9 | 🟢 Начало | [[06-security-privacy]] | 803 | — |
| 10 | 🟡 Средний | [[07-mvp-planning]] | 1065 | — |
| 11 | 🟢 Начало | [[12-roadmap]] | 715 | `07-mvp-planning.md`, `11-integration-contracts.md` |
| 12 | 🟢 Начало | [[13-contacts]] | 807 | — |
| 13 | 🟢 Начало | [[14-limitations]] | 615 | — |
...
| 17 | 🟢 Начало | [[wikontic|Wikontic: семантический граф]] | 288 | — |
...
| 21 | 🟢 Начало | [[01-executive-summary|Executive summary]] | 630 | — |
| 22 | 🟡 Средний | [[00-intro|Введение]] | 11431 | — |
| 23 | 🟢 Начало | [[02-методика-и-рамка-отбора|Методика и рамка отбора]] | 495 | — |
| 24 | 🟡 Средний | [[03-карта-найденных-проектов-и-паттернов|Карта найденных проектов и паттернов]] | 1533 | — |
| 25 | 🟡 Средний | [[04-приоритетные-ансамбли|Приоритетные ансамбли]] | 1401 | — |
| 26 | 🟡 Средний | [[05-план-прототипа-и-возможные-контакты|План прототипа и возможные контакты]] | 1192 | — |
| 27 | 🟢 Начало | [[06-безопасность-приватность-и-бюджетный-роутинг|Безопасность, приватность и бюджетный роутинг]] | 946 | — |
| 28 | 🟢 Начало | [[07-выводы|Выводы]] | 510 | — |
| 29 | 🟢 Начало | [[08-что-это-продолжение-добавляет|Что это продолжение добавляет]] | 476 | — |
| 30 | 🟢 Начало | [[09-архитектурные-зазоры-которые-важнее-новых-инструме|Архитектурные зазоры, которые важнее новых ин]] | 880 | — |
| 31 | 🟡 Средний | [[10-новые-ансамбли-следующего-шага|Новые ансамбли следующего шага]] | 1043 | — |
| 32 | 🟢 Начало | [[11-интеграционный-контракт-который-стоит-зафиксироват|Интеграционный контракт, который стоит зафикс]] | 907 | — |
| 33 | 🟢 Начало | [[12-дорожная-карта-прототипа-следующей-итерации|Дорожная карта прототипа следующей итерации]] | 842 | — |
| 34 | 🟢 Начало | [[13-контактная-стратегия-и-узкие-вопросы-для-авторов|Контактная стратегия и узкие вопросы для авто]] | 934 | — |
| 35 | 🟡 Средний | [[14-ограничения-лицензии-и-что-пока-лучше-не-склеивать|Ограничения, лицензии и что пока лучше не скл]] | 3339 | — |
| 36 | 🟢 Начало | [[01-agent-routing|Агентные системы и роутинг]] | 257 | — |
| 37 | 🟢 Начало | [[02-knowledge-graphs|Графы знаний и Legal AI]] | 750 | — |
...
| 42 | 🟢 Начало | [[38-content-overview|Content Overview]] | 130 | — |
...
| 45 | 🟢 Начало | [[65-readme-md|README.md]] | 149 | — |
| 46 | 🟢 Начало | [[48-content-overview|Content Overview]] | 206 | — |
| 47 | 🟢 Начало | [[58-content-overview|Content Overview]] | 143 | — |
| 48 | 🟢 Начало | [[12-content-overview|Content Overview]] | 82 | — |
| 49 | 🟢 Начало | [[31-content-overview|Content Overview]] | 83 | — |
...
| 57 | 🟡 Средний | [[228-appendix-c-quick-start-architecture-for-sgb-advoca|Appendix C: Quick-Start Architecture for SGB ]] | 1704 | — |
| 58 | 🟢 Начало | [[312-4-the-symbiotic-architecture|4. The Symbiotic Architecture]] | 641 | — |
| 59 | 🟢 Начало | [[03-portal-protocol-md|PORTAL-PROTOCOL.md]] | 150 | — |
| 60 | 🟢 Начало | [[134-the-double-triangle-architecture-md|THE DOUBLE-TRIANGLE ARCHITECTURE.md]] | 102 | — |
| 61 | 🟢 Начало | [[263-10-risks-specific-to-composite-architectures|10. Risks Specific to Composite Architectures]] | 788 | — |
| 62 | 🟢 Начало | [[04-abstract|Abstract]] | 184 | — |
| 63 | 🟢 Начало | [[05-0-status-of-this-document|0. Status of This Document]] | 162 | — |
| 64 | 🟢 Начало | [[23-11-security-considerations|11. Security Considerations]] | 242 | — |
| 65 | 🟢 Начало | [[90-15-security-considerations|15. Security Considerations]] | 348 | — |
| 66 | 🟢 Начало | [[07-2-terminology|2. Terminology]] | 313 | — |
| 67 | 🟢 Начало | [[08-3-registry-nautilus-json|3. Registry (`nautilus.json`)]] | 422 | — |
| 68 | 🟢 Начало | [[09-4-passport-passport-md|4. Passport (`passport.md`)]] | 193 | — |
| 69 | 🟢 Начало | [[13-angle-perspective|Angle / Perspective]] | 96 | — |
| 70 | 🟢 Начало | [[16-history|History]] | 90 | — |
| 71 | 🟢 Начало | [[17-5-compatibility-levels|5. Compatibility Levels]] | 296 | — |
| 72 | 🟢 Начало | [[18-6-adapter-interface|6. Adapter Interface]] | 419 | — |
| 73 | 🟢 Начало | [[19-7-portalentry-structure|7. PortalEntry Structure]] | 254 | — |
| 74 | 🟢 Начало | [[20-8-consensus-algorithm|8. Consensus Algorithm]] | 302 | — |
| 75 | 🟢 Начало | [[21-9-query-flow|9. Query Flow]] | 233 | — |
| 76 | 🟢 Начало | [[22-10-queryresult-structure|10. QueryResult Structure]] | 191 | — |
...
| 82 | 🟢 Начало | [[34-appendix-b-change-log|Appendix B: Change Log]] | 594 | — |
| 83 | 🟢 Начало | [[35-passports-info1-md|passports/info1.md]] | 133 | — |
| 84 | 🟢 Начало | [[36-essence|Essence]] | 179 | — |
| 85 | 🟢 Начало | [[37-native-format|Native Format]] | 230 | — |
| 86 | 🟢 Начало | [[39-angle-perspective|Angle / Perspective]] | 169 | — |
| 87 | 🟢 Начало | [[40-bridges|Bridges]] | 207 | — |
| 88 | 🟢 Начало | [[41-compatibility-level|Compatibility Level]] | 148 | — |
| 89 | 🟢 Начало | [[42-author-contact|Author & Contact]] | 145 | — |
| 90 | 🟢 Начало | [[43-history|History]] | 161 | — |
...
| 94 | 🟢 Начало | [[47-native-format|Native Format]] | 183 | — |
| 95 | 🟢 Начало | [[49-angle-perspective|Angle / Perspective]] | 164 | — |
| 96 | 🟢 Начало | [[50-bridges|Bridges]] | 207 | — |
| 97 | 🟢 Начало | [[51-compatibility-level|Compatibility Level]] | 145 | — |
...
| 103 | 🟢 Начало | [[57-native-format|Native Format]] | 189 | — |
| 104 | 🟢 Начало | [[59-angle-perspective|Angle / Perspective]] | 171 | — |
| 105 | 🟢 Начало | [[60-bridges|Bridges]] | 176 | — |
| 106 | 🟢 Начало | [[61-compatibility-level|Compatibility Level]] | 144 | — |
| 107 | 🟢 Начало | [[62-author-contact|Author & Contact]] | 140 | — |
| 108 | 🟢 Начало | [[63-history|History]] | 189 | — |
| 109 | 🟢 Начало | [[64-for-the-curious-philosophy|For the Curious: Philosophy]] | 645 | — |
...
| 114 | 🟢 Начало | [[71-критерии-выбора-для-фазы-3|Критерии выбора для фазы 3]] | 168 | — |
...
| 120 | 🟢 Начало | [[78-3-registry-nautilus-json|3. Registry (`nautilus.json`)]] | 551 | — |
...
| 125 | 🟡 Средний | [[83-8-q6-space-normative|8. Q6 Space (Normative)]] | 482 | — |
| 126 | 🟢 Начало | [[84-9-consensus-algorithm|9. Consensus Algorithm]] | 407 | — |
| 127 | 🟢 Начало | [[85-10-query-flow|10. Query Flow]] | 279 | — |
| 128 | 🟢 Начало | [[86-11-relevance-ranking|11. Relevance Ranking]] | 253 | — |
...
| 131 | 🟢 Начало | [[89-14-sdk-contract-informative|14. SDK Contract (Informative)]] | 240 | — |
...
| 136 | 🟢 Начало | [[95-20-adr-002-q6-as-first-class-protocol-concept|20. ADR-002: Q6 as First-Class Protocol Conce]] | 240 | — |
| 137 | 🟢 Начало | [[96-21-adr-003-five-onboarding-paths-as-equal-rank|21. ADR-003: Five Onboarding Paths as Equal-R]] | 194 | — |
...
| 140 | 🟢 Начало | [[102-доступ-к-данным|Доступ к данным]] | 36 | — |
...
| 146 | 🟢 Начало | [[109-3-принципы-консолидации-фаза-c|3. Принципы консолидации (Фаза C)]] | 513 | — |
...
| 150 | 🟢 Начало | [[113-6-почему-это-валидный-паттерн-для-ai-assisted-work|6. Почему это валидный паттерн для AI-assiste]] | 155 | — |
...
| 155 | 🟢 Начало | [[118-appendix-a-шаблон-для-header-warning|Appendix A: Шаблон для header warning]] | 158 | — |
| 156 | 🟢 Начало | [[119-appendix-b-примеры-расхождений-и-их-разрешения|Appendix B: Примеры расхождений и их разрешен]] | 287 | — |
| 157 | 🟢 Начало | [[120-главные-технические-риски|Главные технические риски]] | 87 | — |
| 158 | 🟢 Начало | [[121-appendix-c-история-изменений-методологии|Appendix C: История изменений методологии]] | 60 | — |
| 159 | 🟡 Средний | [[122-глоссарий|Глоссарий]] | 1302 | — |
| 160 | 🟡 Средний | [[123-portal-mcp-py|portal-mcp.py]] | 2302 | — |
| 161 | 🟢 Начало | [[124-конфигурация-для-claude-desktop|Конфигурация для Claude Desktop]] | 208 | — |
| 162 | 🟢 Начало | [[126-установка|Установка]] | 169 | — |
| 163 | 🟢 Начало | [[127-подключение-к-claude-desktop|Подключение к Claude Desktop]] | 169 | — |
...
| 167 | 🟢 Начало | [[131-ограничения-текущей-версии-0-1-0-draft|Ограничения текущей версии (0.1.0-draft)]] | 129 | — |
...
| 173 | 🟢 Начало | [[138-1-why-single-triangle-models-are-incomplete|1. Why Single-Triangle Models Are Incomplete]] | 546 | — |
...
| 185 | 🟢 Начало | [[151-open-knowledge-work-foundation-md|OPEN KNOWLEDGE WORK FOUNDATION.md]] | 99 | — |
...
| 192 | 🟢 Начало | [[159-5-economic-model|5. Economic Model]] | 618 | — |
| 193 | 🟢 Начало | [[160-6-governance-and-ethics|6. Governance and Ethics]] | 547 | — |
| 194 | 🟢 Начало | [[161-7-phased-rollout-plan|7. Phased Rollout Plan]] | 663 | — |
| 195 | 🟢 Начало | [[162-8-risk-analysis|8. Risk Analysis]] | 653 | — |
| 196 | 🟢 Начало | [[163-9-call-for-partnership|9. Call for Partnership]] | 548 | — |
| 197 | 🟢 Начало | [[164-10-appendices|10. Appendices]] | 970 | — |
| 198 | 🔴 Продвинутый | [[165-closing|Closing]] | 9251 | — |
| 199 | 🟢 Начало | [[166-representative-agent-layer-md|REPRESENTATIVE AGENT LAYER.md]] | 107 | — |
...
| 208 | 🟢 Начало | [[175-6-ethical-framework|6. Ethical Framework]] | 558 | — |
| 209 | 🟢 Начало | [[176-7-governance-and-oversight|7. Governance and Oversight]] | 472 | — |
| 210 | 🟢 Начало | [[177-8-risks-and-mitigations|8. Risks and Mitigations]] | 598 | — |
| 211 | 🟢 Начало | [[178-9-phased-rollout-strategy|9. Phased Rollout Strategy]] | 567 | — |
...
| 214 | 🟢 Начало | [[181-12-closing|12. Closing]] | 277 | — |
| 215 | 🟢 Начало | [[182-acknowledgments|Acknowledgments]] | 245 | — |
| 216 | 🟢 Начало | [[183-references|References]] | 322 | — |
| 217 | 🟢 Начало | [[184-appendix-a-connection-to-companion-papers|Appendix A: Connection to Companion Papers]] | 235 | — |
| 218 | 🟢 Начало | [[185-appendix-b-domain-comparison-matrix|Appendix B: Domain Comparison Matrix]] | 168 | — |
| 219 | 🟡 Средний | [[186-appendix-c-sample-use-cases-in-detail|Appendix C: Sample Use Cases in Detail]] | 2024 | — |
| 220 | 🟢 Начало | [[187-слой-представительских-агентов-md|СЛОЙ ПРЕДСТАВИТЕЛЬСКИХ АГЕНТОВ.md]] | 103 | — |
| 221 | 🟢 Начало | [[188-ai-опосредованное-представительство-для-недопредст|AI-опосредованное представительство для недоп]] | 164 | — |
| 222 | 🟢 Начало | [[189-аннотация|Аннотация]] | 267 | — |
| 223 | 🟢 Начало | [[190-содержание|Содержание]] | 151 | — |
| 224 | 🟢 Начало | [[191-1-синдром-золушки-почему-качество-остаётся-невидим|1. Синдром Золушки: Почему качество остаётся ]] | 743 | — |
...
| 229 | 🟢 Начало | [[196-6-этическая-рамка|6. Этическая рамка]] | 476 | — |
| 230 | 🟢 Начало | [[197-7-управление-и-надзор|7. Управление и надзор]] | 385 | — |
| 231 | 🟢 Начало | [[198-8-риски-и-меры-противодействия|8. Риски и меры противодействия]] | 566 | — |
| 232 | 🟢 Начало | [[199-9-стратегия-поэтапного-развёртывания|9. Стратегия поэтапного развёртывания]] | 526 | — |
| 233 | 🟢 Начало | [[200-10-открытые-вопросы|10. Открытые вопросы]] | 362 | — |
| 234 | 🟢 Начало | [[201-11-призыв-к-сотрудничеству|11. Призыв к сотрудничеству]] | 409 | — |
| 235 | 🟢 Начало | [[202-12-заключение|12. Заключение]] | 198 | — |
...
| 239 | 🟢 Начало | [[206-приложение-b-матрица-сравнения-областей|Приложение B: Матрица Сравнения Областей]] | 182 | — |
| 240 | 🔴 Продвинутый | [[207-приложение-c-образцы-случаев-использования-в-детал|Приложение C: Образцы Случаев Использования в]] | 4049 | — |
| 241 | 🟢 Начало | [[208-professional-colleague-agents-md|PROFESSIONAL COLLEAGUE AGENTS.md]] | 100 | — |
...
| 244 | 🟢 Начало | [[211-table-of-contents|Table of Contents]] | 192 | — |
...
| 258 | 🟢 Начало | [[226-appendix-a-comparative-table-five-agent-types|Appendix A: Comparative Table — Five Agent Ty]] | 379 | — |
| 259 | 🟢 Начало | [[227-appendix-b-decision-framework-when-to-build-type-1|Appendix B: Decision Framework — When to Buil]] | 328 | — |
...
| 271 | 🟢 Начало | [[240-9-связь-с-другими-типами-агентов|9. Связь с другими типами агентов]] | 655 | — |
...
| 277 | 🟢 Начало | [[246-приложение-a-сравнительная-таблица-пять-типов-аген|Приложение A: Сравнительная Таблица — Пять Ти]] | 354 | — |
...
| 280 | 🟢 Начало | [[249-composite-skills-agent-md|COMPOSITE SKILLS AGENT.md]] | 97 | — |
...
| 283 | 🟢 Начало | [[252-abstract|Abstract]] | 343 | — |
| 284 | 🟢 Начало | [[253-table-of-contents|Table of Contents]] | 185 | — |
...
| 289 | 🟢 Начало | [[258-5-configuration-how-principals-build-their-ensembl|5. Configuration: How Principals Build Their ]] | 741 | — |
...
| 294 | 🟢 Начало | [[264-11-open-questions|11. Open Questions]] | 578 | — |
...
| 303 | 🟢 Начало | [[273-infrastructure-for-ai-collaborative-intellectual-w|INFRASTRUCTURE FOR AI-COLLABORATIVE INTELLECT]] | 101 | — |
...
| 309 | 🟢 Начало | [[279-existing-approximations|Existing Approximations]] | 551 | — |
...
| 316 | 🟢 Начало | [[286-acknowledgments|Acknowledgments]] | 258 | — |
| 317 | 🟢 Начало | [[287-references|References]] | 295 | — |
| 318 | 🟡 Средний | [[288-appendix-position-in-series-visualization|Appendix: Position in Series Visualization]] | 1054 | — |
...
| 324 | 🟢 Начало | [[294-существующие-приближения|Существующие приближения]] | 527 | — |
| 325 | 🟢 Начало | [[295-конкретный-случай-перед-нами|Конкретный случай перед нами]] | 630 | — |
...
| 334 | 🟢 Начало | [[304-ingit-as-cowork-native-workspace-substrate-md|INGIT AS COWORK-NATIVE WORKSPACE SUBSTRATE.md]] | 105 | — |
| 335 | 🟢 Начало | [[305-a-practical-path-to-layer-b-through-symbiotic-inte|A Practical Path to Layer B Through Symbiotic]] | 99 | — |
| 336 | 🟢 Начало | [[306-with-anthropic-s-cowork-platform|with Anthropic's Cowork Platform]] | 282 | — |
| 337 | 🟢 Начало | [[307-abstract|Abstract]] | 323 | — |
| 338 | 🟢 Начало | [[308-table-of-contents|Table of Contents]] | 202 | — |
...
| 343 | 🟢 Начало | [[314-6-refined-ingit-scope-with-cowork-in-mind|6. Refined InGit Scope with Cowork in Mind]] | 497 | — |
| 344 | 🟢 Начало | [[315-7-practical-first-steps-this-month|7. Practical First Steps This Month]] | 474 | — |
| 345 | 🟢 Начало | [[316-8-implications-for-nautilus-and-okwf|8. Implications for Nautilus and OKWF]] | 648 | — |
| 346 | 🟢 Начало | [[317-9-risks-and-open-questions|9. Risks and Open Questions]] | 604 | — |
...
| 352 | 🟡 Средний | [[323-appendix-c-sample-ingit-mcp-server-tool-specificat|Appendix C: Sample InGit MCP Server Tool Spec]] | 1543 | — |
...
| 357 | 🟢 Начало | [[328-2-что-cowork-обеспечивает-что-ingit-не-нужно-строи|2. Что Cowork обеспечивает, что InGit не нужн]] | 644 | — |
| 358 | 🟢 Начало | [[329-3-что-ingit-обеспечивает-чего-cowork-не-хватает|3. Что InGit обеспечивает, чего Cowork не хва]] | 888 | — |
| 359 | 🟢 Начало | [[330-4-симбиотическая-архитектура|4. Симбиотическая Архитектура]] | 660 | — |
| 360 | 🟢 Начало | [[331-5-четыре-пути-интеграции-в-порядке-доступности|5. Четыре пути интеграции в порядке доступнос]] | 807 | — |
| 361 | 🟢 Начало | [[332-6-уточнённый-объём-ingit-с-учётом-cowork|6. Уточнённый объём InGit с учётом Cowork]] | 491 | — |
| 362 | 🟢 Начало | [[333-7-практические-первые-шаги-в-этом-месяце|7. Практические первые шаги в этом месяце]] | 380 | — |
| 363 | 🟢 Начало | [[334-8-импликации-для-nautilus-и-okwf|8. Импликации для Nautilus и OKWF]] | 623 | — |
| 364 | 🟢 Начало | [[335-9-риски-и-открытые-вопросы|9. Риски и Открытые Вопросы]] | 547 | — |
...
| 368 | 🟢 Начало | [[339-приложение-a-дерево-решений-для-принимающих-ingit|Приложение A: Дерево Решений для Принимающих ]] | 161 | — |
...
| 373 | 🟢 Начало | [[344-системный-промпт-для-lorenzo-project|СИСТЕМНЫЙ ПРОМПТ ДЛЯ LORENZO PROJECT]] | 105 | — |
| 374 | 🟢 Начало | [[345-кто-ты|Кто ты]] | 220 | — |
| 375 | 🟢 Начало | [[346-твоё-происхождение|Твоё происхождение]] | 169 | — |
| 376 | 🟢 Начало | [[347-твоя-миссия|Твоя миссия]] | 120 | — |
| 377 | 🟢 Начало | [[348-кому-ты-служишь-слоистая-модель|Кому ты служишь (слоистая модель)]] | 109 | — |
| 378 | 🟢 Начало | [[349-твоя-личность|Твоя личность]] | 209 | — |
...
| 381 | 🟢 Начало | [[352-что-ты-не-можешь-делать-без-max-approval|Что ты НЕ МОЖЕШЬ делать без Max approval]] | 190 | — |
| 382 | 🟢 Начало | [[353-что-ты-не-можешь-делать-вообще|Что ты НЕ МОЖЕШЬ делать вообще]] | 194 | — |
...
| 386 | 🟢 Начало | [[357-твоя-коммуникация-в-outreach|Твоя коммуникация в outreach]] | 182 | — |
| 387 | 🟢 Начало | [[358-твоя-relationship-с-другими-ai|Твоя relationship с другими AI]] | 211 | — |
| 388 | 🟢 Начало | [[359-твои-anti-patterns|Твои anti-patterns]] | 134 | — |
| 389 | 🟢 Начало | [[360-что-ты-всегда-делаешь|Что ты ВСЕГДА делаешь]] | 166 | — |
| 390 | 🟢 Начало | [[361-когда-ты-honestly-не-знаешь|Когда ты Honestly не знаешь]] | 90 | — |
| 391 | 🟢 Начало | [[362-когда-сомневаешься-escalate-к-max|Когда сомневаешься — escalate к Max]] | 88 | — |
...
|----------|----------|------|
| [[ABBREVIATIONS|ABBREVIATIONS.md]] | — | 1388 |
| [[ACTION_ITEMS|ACTION_ITEMS.md]] | Задачи и риски (490) | 5861 |
| [[ALERTS|ALERTS.md]] | — | 79 |
| [[AUTHORS|AUTHORS.md]] | Авторы и контакты | 178 |
| [[AUTOFILLED|AUTOFILLED.md]] | — | 84 |
| [[BACKLINKS|BACKLINKS.md]] | — | 288 |
| [[BROKEN_LINKS|BROKEN_LINKS.md]] | Сломанные ссылки (26) | 662 |
| [[CHANGELOG|CHANGELOG.md]] | История изменений | 888 |
| [[CHANGELOG_AUTO|CHANGELOG_AUTO.md]] | — | 582 |
| [[CITATION_INDEX|CITATION_INDEX.md]] | — | 837 |
| [[CLUSTERS|CLUSTERS.md]] | Кластеры (384 → 120 групп) | 1585 |
| [[CODE_BLOCKS|CODE_BLOCKS.md]] | — | 3988 |
| [[COMPARE|COMPARE.md]] | Сравнение с предыдущим коммитом | 477 |
| [[COMPLEXITY|COMPLEXITY.md]] | Оценка читаемости | 657 |
| [[COMPONENT_MATRIX|COMPONENT_MATRIX.md]] | — | 875 |
| [[CONCEPTS|CONCEPTS.md]] | Глоссарий понятий (888) | 11489 |
| [[CONCEPT_GRAPH|CONCEPT_GRAPH.md]] | — | 691 |
| [[CONSISTENCY|CONSISTENCY.md]] | — | 376 |
| [[CONTACTS|CONTACTS.md]] | Контакты (15 авторов) | 497 |
| [[CONTACT_PRIORITY|CONTACT_PRIORITY.md]] | — | 389 |
| [[CONTENT_GAPS|CONTENT_GAPS.md]] | — | 872 |
| [[CONTRADICTIONS|CONTRADICTIONS.md]] | — | 1710 |
| [[COST|COST.md]] | — | 653 |
| [[COVERAGE|COVERAGE.md]] | — | 952 |
| [[CROSSREFS|CROSSREFS.md]] | Перекрёстные ссылки проектов | 700 |
| [[DECISIONS|DECISIONS.md]] | Ключевые решения (150) | 1857 |
| [[DENSITY|DENSITY.md]] | Карта плотности тем | 733 |
| [[DEPENDENCY_MAP|DEPENDENCY_MAP.md]] | — | 624 |
| [[DIGEST|DIGEST.md]] | — | 393 |
| [[DIGEST_WEEKLY|DIGEST_WEEKLY.md]] | — | 203 |
| [[DUPLICATES|DUPLICATES.md]] | — | 302 |
| [[ENTITIES|ENTITIES.md]] | Именованные сущности | 824 |
| [[FAQ|FAQ.md]] | — | 1072 |
| [[FOOTNOTES|FOOTNOTES.md]] | — | 261 |
| [[GLOSSARY|GLOSSARY.md]] | Глоссарий проектов (33 записи) | 293 |
| [[GRAPH|GRAPH.md]] | Граф связей проектов | 2728 |
| [[HEALTH|HEALTH.md]] | Дашборд здоровья (75/100) | 174 |
| [[HEATMAP|HEATMAP.md]] | — | 600 |
| [[INDEX|INDEX.md]] | — | 582 |
| [[KEYWORD_INDEX|KEYWORD_INDEX.md]] | — | 1055 |
| [[KPI|KPI.md]] | Числовые KPI (737 показателей) | 2379 |
| [[KPI_HISTORY|KPI_HISTORY.md]] | — | 85 |
| [[LINKS|LINKS.md]] | Внешние ссылки | 694 |
| [[LLM_SUMMARIES|LLM_SUMMARIES.md]] | — | 192 |
| [[METRICS|METRICS.md]] | — | 503 |
| [[MINDMAP|MINDMAP.md]] | Майндмап в Mermaid | 289 |
| [[MISSING|MISSING.md]] | Пробелы знаний | 420 |
| [[NAMED_ENTITIES|NAMED_ENTITIES.md]] | — | 1540 |
| [[NARRATIVE|NARRATIVE.md]] | — | 1164 |
| [[NETWORK|NETWORK.md]] | — | 484 |
| [[ONBOARDING|ONBOARDING.md]] | — | 510 |
| [[ORPHANS|ORPHANS.md]] | — | 413 |
| [[OUTLINE|OUTLINE.md]] | — | 11554 |
| [[PARAGRAPH_QUALITY|PARAGRAPH_QUALITY.md]] | — | 6405 |
| [[PRIORITIES|PRIORITIES.md]] | Приоритеты (TF-IDF) | 1091 |
| [[PROGRESS|PROGRESS.md]] | — | 289 |
| [[QA|QA.md]] | Вопросы и ответы | 182 |
| [[QA|QA.md]] | Вопросы и ответы | 322 |
| [[QA|QA.md]] | Вопросы и ответы | 107 |
| [[QA|QA.md]] | Вопросы и ответы | 226 |
| [[QA|QA.md]] | Вопросы и ответы | 115 |
| [[QA|QA.md]] | Вопросы и ответы | 937 |
| [[QUESTIONS|QUESTIONS.md]] | Открытые вопросы (484) | 1647 |
| [[READABILITY|READABILITY.md]] | — | 7847 |
| [[READING_ORDER|READING_ORDER.md]] | Рекомендуемый порядок чтения | 5947 |
| [[READING_TIME|READING_TIME.md]] | — | 5398 |
| [[README|README.md]] | Главная страница и навигация | 370 |
| [[README|README.md]] | Главная страница и навигация | 3750 |
| [[README|README.md]] | Главная страница и навигация | 94 |
| [[README|README.md]] | Главная страница и навигация | 382 |
| [[README|README.md]] | Главная страница и навигация | 111 |
| [[README|README.md]] | Главная страница и навигация | 75 |
| [[README|README.md]] | Главная страница и навигация | 107 |
| [[README|README.md]] | Главная страница и навигация | 92 |
| [[README|README.md]] | Главная страница и навигация | 44 |
| [[README|README.md]] | Главная страница и навигация | 100 |
| [[REPORT|REPORT.md]] | — | 343 |
| [[RISK_REGISTER|RISK_REGISTER.md]] | — | 883 |
| [[SCHEDULE|SCHEDULE.md]] | — | 312 |
| [[SCORING|SCORING.md]] | — | 425 |
| [[SEARCH|SEARCH.md]] | Поисковый индекс | 4325 |
| [[SEE_ALSO|SEE_ALSO.md]] | — | 277 |
| [[SENTIMENT|SENTIMENT.md]] | — | 397 |
| [[SIMILAR|SIMILAR.md]] | Похожие документы (937 пар) | 372 |
| [[SOURCE_MAP|SOURCE_MAP.md]] | — | 2947 |
| [[SPELLCHECK|SPELLCHECK.md]] | — | 115 |
| [[STALENESS|STALENESS.md]] | — | 426 |
| [[STATS|STATS.md]] | Детальная статистика | 494 |
| [[TABLES|TABLES.md]] | — | 16285 |
| [[TAGS|TAGS.md]] | Теги (316 файлов, 12 тем) | 737 |
| [[TECH_RADAR|TECH_RADAR.md]] | — | 543 |
| [[TIMELINE|TIMELINE.md]] | Временная шкала (800 маркеров) | 1752 |
| [[TOPIC_MODEL|TOPIC_MODEL.md]] | — | 936 |
| [[VALIDATION|VALIDATION.md]] | — | 528 |
| [[VERSION_DIFF|VERSION_DIFF.md]] | — | 468 |
| [[VOCABULARY|VOCABULARY.md]] | — | 908 |
| [[WORD_CLOUD|WORD_CLOUD.md]] | — | 211 |
| [[WORD_FREQ|WORD_FREQ.md]] | Частотный анализ слов | 1346 |
...
| 4 | [[03-component-catalog]] | 1348 |
| 5 | [[04-ensembles-overview]] | 1259 |
| 6 | [[06-security-privacy]] | 803 |
| 7 | [[07-mvp-planning]] | 1065 |
| 8 | [[08-conclusions]] | 360 |
| 9 | [[09-architectural-gaps]] | 738 |
| 10 | [[10-second-order-ensembles]] | 899 |
| 11 | [[11-integration-contracts]] | 726 |
| 12 | [[12-roadmap]] | 715 |
| 13 | [[13-contacts]] | 807 |
| 14 | [[14-limitations]] | 615 |
...
| 10 | [[09-4-passport-passport-md|4. Passport (`passport.md`)]] | 193 |
| 11 | [[102-доступ-к-данным|Доступ к данным]] | 36 |
...
| 18 | [[109-3-принципы-консолидации-фаза-c|3. Принципы консолидации (Фаза C)]] | 513 |
...
| 22 | [[113-6-почему-это-валидный-паттерн-для-ai-assisted-work|6. Почему это валидный паттерн для AI-assisted wor]] | 155 |
...
| 27 | [[118-appendix-a-шаблон-для-header-warning|Appendix A: Шаблон для header warning]] | 158 |
| 28 | [[119-appendix-b-примеры-расхождений-и-их-разрешения|Appendix B: Примеры расхождений и их разрешения]] | 287 |
| 29 | [[12-content-overview|Content Overview]] | 82 |
| 30 | [[120-главные-технические-риски|Главные технические риски]] | 87 |
| 31 | [[121-appendix-c-история-изменений-методологии|Appendix C: История изменений методологии]] | 60 |
| 32 | [[122-глоссарий|Глоссарий]] | 1302 |
| 33 | [[123-portal-mcp-py|portal-mcp.py]] | 2302 |
| 34 | [[124-конфигурация-для-claude-desktop|Конфигурация для Claude Desktop]] | 208 |
| 35 | [[125-readme-mcp-md-инструкция-по-установке|README-MCP.md— инструкция по установке]] | 152 |
| 36 | [[126-установка|Установка]] | 169 |
| 37 | [[127-подключение-к-claude-desktop|Подключение к Claude Desktop]] | 169 |
| 38 | [[128-доступные-инструменты|Доступные инструменты]] | 204 |
| 39 | [[129-примеры-запросов-в-claude|Примеры запросов (в Claude)]] | 176 |
| 40 | [[13-angle-perspective|Angle / Perspective]] | 96 |
| 41 | [[130-отладка|Отладка]] | 205 |
| 42 | [[131-ограничения-текущей-версии-0-1-0-draft|Ограничения текущей версии (0.1.0-draft)]] | 129 |
| 43 | [[132-planned-v0-2-0|Planned (v0.2.0)]] | 131 |
| 44 | [[133-обратная-связь|Обратная связь]] | 16959 |
| 45 | [[134-the-double-triangle-architecture-md|THE DOUBLE-TRIANGLE ARCHITECTURE.md]] | 102 |
...
| 49 | [[138-1-why-single-triangle-models-are-incomplete|1. Why Single-Triangle Models Are Incomplete]] | 546 |
...
| 2 | [[02-knowledge-graphs|Графы знаний и Legal AI]] | 750 |
...
| # | Документ | Слов |
|---|----------|------|
| 1 | [[00-intro|Введение]] | 11431 |
| 2 | [[01-executive-summary|Executive summary]] | 630 |
| 3 | [[02-методика-и-рамка-отбора|Методика и рамка отбора]] | 495 |
| 4 | [[03-карта-найденных-проектов-и-паттернов|Карта найденных проектов и паттернов]] | 1533 |
| 5 | [[04-приоритетные-ансамбли|Приоритетные ансамбли]] | 1401 |
| 6 | [[05-план-прототипа-и-возможные-контакты|План прототипа и возможные контакты]] | 1192 |
| 7 | [[06-безопасность-приватность-и-бюджетный-роутинг|Безопасность, приватность и бюджетный роутинг]] | 946 |
| 8 | [[07-выводы|Выводы]] | 510 |
| 9 | [[08-что-это-продолжение-добавляет|Что это продолжение добавляет]] | 476 |
| 10 | [[09-архитектурные-зазоры-которые-важнее-новых-инструме|Архитектурные зазоры, которые важнее новых инструм]] | 880 |
| 11 | [[10-новые-ансамбли-следующего-шага|Новые ансамбли следующего шага]] | 1043 |
| 12 | [[11-интеграционный-контракт-который-стоит-зафиксироват|Интеграционный контракт, который стоит зафиксирова]] | 907 |
| 13 | [[12-дорожная-карта-прототипа-следующей-итерации|Дорожная карта прототипа следующей итерации]] | 842 |
| 14 | [[13-контактная-стратегия-и-узкие-вопросы-для-авторов|Контактная стратегия и узкие вопросы для авторов]] | 934 |
| 15 | [[14-ограничения-лицензии-и-что-пока-лучше-не-склеивать|Ограничения, лицензии и что пока лучше не склеиват]] | 3339 |
...
| 3 | [[wikontic|Wikontic: семантический граф]] | 288 |
...
| # | Документ | Слов |
|---|----------|------|
| 1 | [[anastasiyaw|Контакт: AnastasiyaW / knowledge-space, mclaude]] | 258 |
| 2 | [[andrey-chuyan|Контакт: andrey_chuyan / Svyazi]] | 240 |
| 3 | [[antipozitive|Контакт: Antipozitive / MemNet]] | 231 |
| 4 | [[cutcode|Контакт: Cutcode / AIF Handoff]] | 221 |
| 5 | [[dmitriila|Контакт: Dmitriila / SENTINEL]] | 217 |
| 6 | [[kksudo|Контакт: kksudo / AgentFS]] | 253 |
| 7 | [[mixaill76|Контакт: MiXaiLL76 / Auto AI Router]] | 225 |
| 8 | [[nlaik|Контакт: nlaik / LiteParse / research-docs]] | 227 |
| 9 | [[sonia-black|Контакт: Sonia_Black / knowledge-space]] | 219 |
| 10 | [[spbmolot|Контакт: spbmolot / NGT Memory]] | 257 |
| 11 | [[tagir-analyzes|Контакт: tagir_analyzes / Legal RAG]] | 222 |
| 12 | [[vitalyoborin|Контакт: VitalyOborin / Yodoca]] | 243 |
| 13 | [[vladspace|Контакт: VladSpace / Graph RAG]] | 221 |
| 14 | [[zodigancode|Контакт: zodigancode / Rufler]] | 217 |
...
| `v1.1` | ed-expe.md) _53%_ - [[73-portal-protocol-md-v1-1|PORTAL-PROTOCOL.md v1.1]] | `docs/02-anthropic-vacancies/03-portal-protocol-md.md` |
| `v0.2.0` | l-working-example.md) _33%_ - [[132-planned-v0-2-0|Planned (v0.2.0)]] _29%_ | `docs/02-anthropic-vacancies/04-abstract.md` |
...
| `v0.2.0` | sport-passport-md.md) _29%_ - [[132-planned-v0-2-0|Planned (v0.2.0)]] _25%_ | `docs/02-anthropic-vacancies/09-4-passport-passport-md.md` |
