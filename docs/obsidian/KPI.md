...
_Извлечено: **3523** числовых показателей из документов_
...
| **357** | 168 ## Кластер 1 — концептов, репозитория, поиска, через (357 файлов) - `docs/01 | `CLUSTERS` |
| **347** | оё-происхождение.md` — _346-твоё-происхождение_ - _...и ещё 347 файлов_ ## Класт | `CLUSTERS` |
| **101** | щё 347 файлов_ ## Кластер 2 — turn, view, svyazi, agentfs (101 файлов) - `docs/0 | `CLUSTERS` |
