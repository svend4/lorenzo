...
_Извлечено: **3742** числовых показателей из документов_
...
| **436** | ed --- # Вакансии Anthropic — Анализ по кластерам Анализ 436 вакансий Anthropic  | `README` |
...
| **348** | 185 ## Кластер 1 — концептов, репозитория, поиска, через (348 файлов) - `docs/01 | `CLUSTERS` |
| **338** | оё-происхождение.md` — _346-твоё-происхождение_ - _...и ещё 338 файлов_ ## Класт | `CLUSTERS` |
| **96** | щё 338 файлов_ ## Кластер 2 — turn, view, agentfs, svyazi (96 файлов) - `docs/01 | `CLUSTERS` |
| **86** | етные-ансамбли.md` — _04-приоритетные-ансамбли_ - _...и ещё 86 файлов_ ## Класте | `CLUSTERS` |
| **84** | ещё 86 файлов_ ## Кластер 3 — cowork, ingit, project, mcp (84 файлов) - `docs/02 | `CLUSTERS` |
| **74** | ndix-c-sample-ingit-mcp-server-tool-specificat_ - _...и ещё 74 файлов_ ## Класте | `CLUSTERS` |
| **60** | ect-analogues.md` — _01-three-direct-analogues_ - _...и ещё 60 файлов_ ## Класте | `CLUSTERS` |
| **64** | ещё 60 файлов_ ## Кластер 5 — turn, view, citeturn, cite (64 файлов) - `docs/01- | `CLUSTERS` |
| **54** | OPIC_MODEL_ - `docs/WORD_FREQ.md` — _WORD_FREQ_ - _...и ещё 54 файлов_ ## Класте | `CLUSTERS` |
| **63** | us-of-this-document, portal-protocol-md, versioning-policy (63 файлов) - `docs/0 | `CLUSTERS` |
| _...ещё 502_ | | |
...
| **420** | о не требует GPU: `paraphrase-multilingual-MiniLM-L12-v2` (~420MB, CPU) даёт кос | `DEVELOPMENT_PLAN` |
...
| **4.5** | ндекс — improve_search_index.py Строит: — 1053 документа, 4.5 МБ Каждая запись:  | `06-search` |
...
| **30** | обратных ссылок **Файлов с входящими ссылками:** 2837 ## Топ-30 самых цитируемых | `BACKLINKS` |
...
| **50** | тить promoter на 1632 картах \| 30 мин \| \| Review + одобрить топ-50 карточек \ | `DEVELOPMENT_PLAN` |
