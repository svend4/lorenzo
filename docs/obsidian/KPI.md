...
<!-- summary -->
> title: "Числовые KPI и метрики"
**Проекты:** Svyazi, Auto AI Router, Whisper
...
- [Количество (134)](#количество-134)
- [Проценты (79)](#проценты-79)
- [Время (161)](#время-161)
- [Стоимость (237)](#стоимость-237)
- [Размер (16)](#размер-16)
- [Версия (214)](#версия-214)
- [Рейтинг (23)](#рейтинг-23)
- [Этап (29)](#этап-29)

---

<!-- tags: memory, rag, ingestion, local-first, architecture, roadmap, anthropic, self-improvement, collaboration -->
