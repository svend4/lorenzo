...
_Извлечено: **3488** числовых показателей из документов_
...
| **356** | 167 ## Кластер 1 — концептов, репозитория, поиска, через (356 файлов) - `docs/01 | `CLUSTERS` |
| **346** | оё-происхождение.md` — _346-твоё-происхождение_ - _...и ещё 346 файлов_ ## Класт | `CLUSTERS` |
| **102** | щё 346 файлов_ ## Кластер 2 — turn, view, svyazi, agentfs (102 файлов) - `docs/0 | `CLUSTERS` |
| **92** | -executive-summary.md` — _01-executive-summary_ - _...и ещё 92 файлов_ ## Класте | `CLUSTERS` |
| **90** | ещё 92 файлов_ ## Кластер 3 — cowork, ingit, project, mcp (90 файлов) - `docs/02 | `CLUSTERS` |
...
| **53** | oordinated-infrastructure-for-distributed-expe_ - _...и ещё 53 файлов_ ## Класте | `CLUSTERS` |
| _...ещё 488_ | | |
...
| **30** | MemNet --- **Файлов с входящими ссылками:** 2715 ## Топ-30 самых цитируемых доку | `BACKLINKS` |
