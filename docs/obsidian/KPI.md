...
| **347** | 186 ## Кластер 1 — концептов, репозитория, поиска, через (347 файлов) - `docs/01 | `CLUSTERS` |
| **337** | оё-происхождение.md` — _346-твоё-происхождение_ - _...и ещё 337 файлов_ ## Класт | `CLUSTERS` |
| **95** | щё 337 файлов_ ## Кластер 2 — turn, view, agentfs, svyazi (95 файлов) - `docs/01 | `CLUSTERS` |
| **85** | етные-ансамбли.md` — _04-приоритетные-ансамбли_ - _...и ещё 85 файлов_ ## Класте | `CLUSTERS` |
| **84** | ещё 85 файлов_ ## Кластер 3 — cowork, ingit, project, mcp (84 файлов) - `docs/02 | `CLUSTERS` |
| **74** | ndix-c-sample-ingit-mcp-server-tool-specificat_ - _...и ещё 74 файлов_ ## Класте | `CLUSTERS` |
| **71** | ещё 74 файлов_ ## Кластер 4 — com, https, articles, habr (71 файлов) - `docs/05- | `CLUSTERS` |
| **61** | ect-analogues.md` — _01-three-direct-analogues_ - _...и ещё 61 файлов_ ## Класте | `CLUSTERS` |
| **64** | ещё 61 файлов_ ## Кластер 5 — turn, view, citeturn, cite (64 файлов) - `docs/01- | `CLUSTERS` |
...
| **30** | обратных ссылок **Файлов с входящими ссылками:** 2831 ## Топ-30 самых цитируемых | `BACKLINKS` |
