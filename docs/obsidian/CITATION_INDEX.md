...
- [Детали топ-10](#детали-топ-10)
  ...
  - [`https://habr.com/ru/articles/495554/`](#httpshabrcomruarticles495554)
...
Уникальных URL: **138** | Отфильтровано (≥1): **138**
...
Цитируется в 25 файлах, авторитетность: 5
...
### `https://habr.com/ru/articles/495554/`
