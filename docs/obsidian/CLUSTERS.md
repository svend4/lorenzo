...
- `docs/02-anthropic-vacancies/327-1-открытие-cowork-и-почему-это-меняет-всё.md` — _327-1-открытие-cowork-и-почему-это-меняет-всё_
- `docs/02-anthropic-vacancies/328-2-что-cowork-обеспечивает-что-ingit-не-нужно-строи.md` — _328-2-что-cowork-обеспечивает-что-ingit-не-нужно-строи_
- `docs/02-anthropic-vacancies/329-3-что-ingit-обеспечивает-чего-cowork-не-хватает.md` — _329-3-что-ingit-обеспечивает-чего-cowork-не-хватает_
- _...и ещё 64 файлов_
...
- `docs/FAQ.md` — _FAQ_
- `docs/LLM_SUMMARIES.md` — _LLM_SUMMARIES_
- _...и ещё 60 файлов_
...
- `docs/02-anthropic-vacancies/214-3-empirical-case-study-обучай.md` — _214-3-empirical-case-study-обучай_
- `docs/02-anthropic-vacancies/215-4-architecture-of-professional-colleague-agents.md` — _215-4-architecture-of-professional-colleague-agents_
- _...и ещё 41 файлов_
...
## Кластер 9 — compatibility-level, passport, appendix-a-minimal-working-example, level (42 файлов)
...
## Кластер 10 — essence, angle-perspective, angle, perspective (41 файлов)

- `docs/02-anthropic-vacancies/12-content-overview.md` — _12-content-overview_
...
## Кластер 11 — com, https, habr, articles (40 файлов)
...
- `docs/ai-collaborations/candidates/02-related-projects-context.md` — _02-related-projects-context_
...
- `docs/habr-unique-projects/deep-pairs/1-llm-gateway.md` — _1-llm-gateway_
- _...и ещё 30 файлов_

## Кластер 12 — acknowledgments, references, document, ai-support-through-configurable-specialist-ensembl (37 файлов)
...
## Кластер 13 — work, infrastructure, foundation, contributor (34 файлов)
...
- `docs/nautilus/community-discussions/agent-changes-reality/01-response-en.md` — _01-response-en_
- `docs/nautilus/community-discussions/habr-article-1-reaction/01-claude-response.md` — _01-claude-response_
- _...и ещё 24 файлов_

## Кластер 14 — docs, anthropic-vacancies, благодарности, слов (33 файлов)
...
## Кластер 15 — document, what, layer, documents (31 файлов)
...
## Кластер 16 — profile-mapping, initial-analysis, engineer, svend (30 файлов)
...
## Кластер 17 — nautilus, reference-implementation, draft, npp-v (25 файлов)
...
- `docs/nautilus/npp-v1-0/00-abstract-status.md` — _00-abstract-status_
- `docs/nautilus/npp-v1-0/13-reference-implementation.md` — _13-reference-implementation_
- `docs/nautilus/npp-v1-0/17-appendix-b-change-log.md` — _17-appendix-b-change-log_
- _...и ещё 15 файлов_

## Кластер 18 — принципала, агента, агент, агентов (21 файлов)
...
- `docs/nautilus/community-discussions/habr-article-2-reaction/01-response.md` — _01-response_
...
## Кластер 19 — professional, agent, mitigation, colleague (20 файлов)
...
- `docs/nautilus/composite-skills-agents/09-okwf-integration.md` — _09-okwf-integration_
- `docs/nautilus/ingit-cowork-en/09-risks-open-questions.md` — _09-risks-open-questions_
- `docs/nautilus/professional-colleague-agents-en/03-empirical-case-obuchay.md` — _03-empirical-case-obuchay_
- `docs/nautilus/professional-colleague-agents-en/04-architecture.md` — _04-architecture_
- _...и ещё 10 файлов_

## Кластер 20 — adr-, federation-over-merging, introduction, federation (18 файлов)
...
- `docs/nautilus/npp-v1-0/01-introduction.md` — _01-introduction_
- `docs/nautilus/npp-v1-0/14-adr-001-federation-over-merging.md` — _14-adr-001-federation-over-merging_
- _...и ещё 8 файлов_

## Кластер 21 — portal, query, consensus, repos (17 файлов)
...
- `docs/nautilus/npp-v1-0/10-query-result.md` — _10-query-result_
- `docs/nautilus/npp-v1-0/16-appendix-a-minimal-working-example.md` — _16-appendix-a-minimal-working-example_
- _...и ещё 7 файлов_

## Кластер 22 — clusters, затравку, dnews, product-management-support-ops (17 файлов)

- `docs/anthropic-vacancies/clusters/01-ai-research-engineering.md` — _01-ai-research-engineering_
- `docs/anthropic-vacancies/clusters/02-sales.md` — _02-sales_
- `docs/anthropic-vacancies/clusters/03-finance.md` — _03-finance_
- `docs/anthropic-vacancies/clusters/04-security.md` — _04-security_
- `docs/anthropic-vacancies/clusters/05-marketing-brand.md` — _05-marketing-brand_
- `docs/anthropic-vacancies/clusters/06-engineering-design-product.md` — _06-engineering-design-product_
- `docs/anthropic-vacancies/clusters/07-software-engineering-infrastructure.md` — _07-software-engineering-infrastructure_
- `docs/anthropic-vacancies/clusters/08-safeguards-trust-safety.md` — _08-safeguards-trust-safety_
- `docs/anthropic-vacancies/clusters/09-product-management-support-ops.md` — _09-product-management-support-ops_
- `docs/anthropic-vacancies/clusters/10-compute.md` — _10-compute_
- _...и ещё 7 файлов_

## Кластер 23 — yodoca, wikontic, memory, ngt (16 файлов)
...
- `docs/habr-unique-projects/final-ensembles/4-summary-authors.md` — _4-summary-authors_
- `docs/habr-unique-projects/key-findings/01-yodoca.md` — _01-yodoca_
- _...и ещё 6 файлов_

## Кластер 24 — technology-combinations, articles, local-first, router (15 файлов)
...
- `docs/technology-combinations/combinations/01-pravilnaya-agentskaya-arkhitektura-svyazi-pattern.md` — _01-pravilnaya-agentskaya-arkhitektura-svyazi-pattern_
- `docs/technology-combinations/combinations/02-multiagentnyy-khaos-reshenie-auto-ai-router.md` — _02-multiagentnyy-khaos-reshenie-auto-ai-router_
- _...и ещё 5 файлов_

## Кластер 25 — appendix-a-шаблон-для-header-warning, приложение-a-дерево-решений-для-принимающих-ingit, доступ-к-данным, appendix-c-история-изменений-методологии (14 файлов)

- `docs/02-anthropic-vacancies/102-доступ-к-данным.md` — _102-доступ-к-данным_
- `docs/02-anthropic-vacancies/121-appendix-c-история-изменений-методологии.md` — _121-appendix-c-история-изменений-методологии_
- `docs/02-anthropic-vacancies/185-appendix-b-domain-comparison-matrix.md` — _185-appendix-b-domain-comparison-matrix_
- `docs/02-anthropic-vacancies/339-приложение-a-дерево-решений-для-принимающих-ingit.md` — _339-приложение-a-дерево-решений-для-принимающих-ingit_
- `docs/lorenzo-agent/04-komu-ty-sluzhish.md` — _04-komu-ty-sluzhish_
- `docs/obsidian/02-anthropic-vacancies/102-доступ-к-данным.md` — _102-доступ-к-данным_
- `docs/obsidian/02-anthropic-vacancies/118-appendix-a-шаблон-для-header-warning.md` — _118-appendix-a-шаблон-для-header-warning_
- `docs/obsidian/02-anthropic-vacancies/120-главные-технические-риски.md` — _120-главные-технические-риски_
- `docs/obsidian/02-anthropic-vacancies/121-appendix-c-история-изменений-методологии.md` — _121-appendix-c-история-изменений-методологии_
- `docs/obsidian/02-anthropic-vacancies/339-приложение-a-дерево-решений-для-принимающих-ingit.md` — _339-приложение-a-дерево-решений-для-принимающих-ingit_
- _...и ещё 4 файлов_

## Кластер 26 — фазы, зачем-две-версии-параллельно, формальный-workflow, вариант (14 файлов)
...
- `docs/nautilus/review-methodology/00-tldr.md` — _00-tldr_
...
## Кластер 27 — конкретный-случай-перед-нами, существующие-приближения, шаг, двухслойный-стек-как-он-существует (14 файлов)
...
- `docs/nautilus/infrastructure-layer-b-ru/10-rekomendatsii.md` — _10-rekomendatsii_
- `docs/obsidian/02-anthropic-vacancies/291-двухслойный-стек-как-он-существует.md` — _291-двухслойный-стек-как-он-существует_
- _...и ещё 4 файлов_

## Кластер 28 — vladspace, контакт, contacts, профиль (14 файлов)

- `docs/AUTHORS.md` — _AUTHORS_
- `docs/SIMILAR.md` — _SIMILAR_
...
- `docs/contacts/mixaill76.md` — _mixaill76_
- `docs/contacts/sonia-black.md` — _sonia-black_
- `docs/contacts/tagir-analyzes.md` — _tagir-analyzes_
- `docs/obsidian/AUTHORS.md` — _AUTHORS_
- `docs/obsidian/contacts/antipozitive.md` — _antipozitive_
- _...и ещё 4 файлов_

## Кластер 29 — improve, docs, scripts, add (14 файлов)

- `docs/CHANGELOG.md` — _CHANGELOG_
- `docs/CHANGELOG_AUTO.md` — _CHANGELOG_AUTO_
- `docs/DEPENDENCY_MAP.md` — _DEPENDENCY_MAP_
- `docs/DIGEST_WEEKLY.md` — _DIGEST_WEEKLY_
- `docs/KNOWLEDGE_MAP.md` — _KNOWLEDGE_MAP_
- `docs/PROGRESS.md` — _PROGRESS_
- `docs/obsidian/CHANGELOG.md` — _CHANGELOG_
- `docs/obsidian/CHANGELOG_AUTO.md` — _CHANGELOG_AUTO_
- `docs/obsidian/COVERAGE.md` — _COVERAGE_
- `docs/obsidian/DEPENDENCY_MAP.md` — _DEPENDENCY_MAP_
- _...и ещё 4 файлов_

## Кластер 30 — ai-managed-virtual-company, ai-managed, virtual, найму (14 файлов)
...
- `docs/anthropic-vacancies/ai-managed-virtual-company/04-what-to-do.md` — _04-what-to-do_
...
- `docs/anthropic-vacancies/ai-managed-virtual-company/08-pluses-of-model.md` — _08-pluses-of-model_
- `docs/anthropic-vacancies/ai-managed-virtual-company/09-minuses-and-risks.md` — _09-minuses-and-risks_
- `docs/anthropic-vacancies/ai-managed-virtual-company/10-three-entry-points.md` — _10-three-entry-points_
- _...и ещё 4 файлов_
