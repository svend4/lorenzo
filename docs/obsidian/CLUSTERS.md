...
- `docs/LINK_PREVIEW.md` — _LINK_PREVIEW_
...
## Кластер 6 — author-contact, status-of-this-document, portal-protocol-md, versioning-policy (63 файлов)
...
## Кластер 7 — agent, principal, professional, agents (63 файлов)
...
## Кластер 8 — table-of-contents, double-triangle, table, triangle (60 файлов)
...
## Кластер 9 — acknowledgments, references, a-typology-of-ai-agents-on-the-principal-side-and-, document (54 файлов)
...
## Кластер 12 — lorenzo, level-, direction, outreach (49 файлов)
...
## Кластер 16 — info, camel, engineer, svend (36 файлов)
...
## Кластер 17 — str, consensus, query-flow, portal (35 файлов)
...
## Кластер 18 — passport, registry, repo, purpose (32 файлов)
...
## Кластер 19 — essence, angle-perspective, representative-agent-layer-md, angle (32 файлов)
...
## Кластер 20 — adr-, federation-over-merging, introduction, terminology (31 файлов)
...
## Кластер 21 — sdk, reference-implementation, nautilus, references (31 файлов)
...
## Кластер 22 — professional, colleague, practitioner, practitioners (30 файлов)
...
## Кластер 23 — legal, extended, комбинирование, технологий (29 файлов)
...
- `docs/obsidian/technology-combinations/mega-stacks/01-legal-ai-stack.md` — _01-legal-ai-stack_
- `docs/obsidian/technology-combinations/mega-stacks/02-ultimate-legal-ai.md` — _02-ultimate-legal-ai_
- _...и ещё 19 файлов_

## Кластер 24 — принципала, агента, агент, тип (27 файлов)
...
## Кластер 25 — есть, virtual, company, current-implementations (26 файлов)
...
- `docs/HOT_CARDS.md` — _HOT_CARDS_
- `docs/KNOWLEDGE_SNAPSHOT.md` — _KNOWLEDGE_SNAPSHOT_
- `docs/PROMOTE_LOG.md` — _PROMOTE_LOG_
- `docs/STALENESS.md` — _STALENESS_
- `docs/VERSION_DIFF.md` — _VERSION_DIFF_
- `docs/autofilled/research-summary.md` — _research-summary_
