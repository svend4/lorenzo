...
## Кластер 9 — acknowledgments, references, a-typology-of-ai-agents-on-the-principal-side-and-, ai-support-through-configurable-specialist-ensembl (55 файлов)
...
## Кластер 10 — work, infrastructure, okwf, foundation (48 файлов)
...
## Кластер 11 — lorenzo, level-, outreach, direction (48 файлов)
...
- `docs/lorenzo-agent/12-workflow.md` — _12-workflow_
...
## Кластер 12 — docs, проблем, слов, anthropic-vacancies (43 файлов)
...
## Кластер 13 — document, what, documents, layer (39 файлов)
...
- `docs/nautilus/infrastructure-layer-b-en/01-missing-middle-layer.md` — _01-missing-middle-layer_
- _...и ещё 29 файлов_

## Кластер 14 — info, camel, engineer, svend (37 файлов)
...
## Кластер 15 — essence, angle-perspective, angle, representative-agent-layer-md (32 файлов)
...
## Кластер 16 — пара, совместной, уникальных, хабре (32 файлов)
...
- `docs/habr-unique-projects/hardware-pairs/1-neuromorphic-ssm.md` — _1-neuromorphic-ssm_
- `docs/habr-unique-projects/hardware-pairs/2-tsu-mome.md` — _2-tsu-mome_
- `docs/habr-unique-projects/hardware-pairs/3-zinc-hybrid-arch.md` — _3-zinc-hybrid-arch_
- _...и ещё 22 файлов_
...
## Кластер 18 — str, portal, consensus, adapter (30 файлов)
...
## Кластер 19 — wikontic, yodoca, memory, ngt (30 файлов)
...
- `docs/ai-collaborations/candidates/03-synthesis-hebbian-collaboration-graph.md` — _03-synthesis-hebbian-collaboration-graph_
- `docs/contacts/spbmolot.md` — _spbmolot_
- `docs/contacts/vitalyoborin.md` — _vitalyoborin_
- _...и ещё 20 файлов_

## Кластер 20 — passport, json, fields, repo (29 файлов)
...
- `docs/02-anthropic-vacancies/87-12-onboarding-paths-normative.md` — _87-12-onboarding-paths-normative_
- `docs/CODE_BLOCKS.md` — _CODE_BLOCKS_
- `docs/nautilus/npp-v1-0/02-terminology.md` — _02-terminology_
- _...и ещё 19 файлов_

## Кластер 21 — nautilus, sdk, fallback, appendix-b-change-log (29 файлов)
...
## Кластер 22 — legal, dsl, pydantic, crawl (26 файлов)

- `docs/obsidian/technology-combinations/combinations/14-local-first-agent-development-environment.md` — _14-local-first-agent-development-environment_
...
- `docs/obsidian/technology-combinations/combinations/25-legal-dsl-code-transpiler.md` — _25-legal-dsl-code-transpiler_
- `docs/obsidian/technology-combinations/combinations/28-pydantic-enforced-legal-workflows.md` — _28-pydantic-enforced-legal-workflows_
- `docs/obsidian/technology-combinations/combinations/30-mega-stack-3-0-with-dsl-ast.md` — _30-mega-stack-3-0-with-dsl-ast_
- `docs/obsidian/technology-combinations/combinations/32-consensus-based-multi-agent-coordination.md` — _32-consensus-based-multi-agent-coordination_
- _...и ещё 16 файлов_

## Кластер 23 — принципала, агента, тип, агент (25 файлов)
...
## Кластер 24 — colleague, professional, agent, practitioners (24 файлов)
...
## Кластер 25 — virtual, ai-managed, company, найму (24 файлов)
...
## Кластер 26 — code, legal, комбинация, комбинирование (21 файлов)

- `docs/obsidian/technology-combinations/combinations/05-sourcecraft-cli-claude-code-sequential-protokol-dochkinoy.md` — _05-sourcecraft-cli-claude-code-sequential-protokol-dochkinoy_
- `docs/obsidian/technology-combinations/combinations/06-openclaude-utyokshiy-claude-code-zinc-inference-engine-mome-.md` — _06-openclaude-utyokshiy-claude-code-zinc-inference-engine-mome-_
...
- `docs/obsidian/technology-combinations/combinations/09-agent-orchestration-stack.md` — _09-agent-orchestration-stack_
- `docs/obsidian/technology-combinations/combinations/11-hybrid-crdt-sql-database.md` — _11-hybrid-crdt-sql-database_
- `docs/obsidian/technology-combinations/combinations/16-adversarial-multi-agent-code-review.md` — _16-adversarial-multi-agent-code-review_
...
- `docs/obsidian/technology-combinations/combinations/23-security-first-code-review-pipeline.md` — _23-security-first-code-review-pipeline_
...
## Кластер 27 — двухслойный-стек-как-он-существует, конкретный-случай-перед-нами, что-отсутствует-слой-b, практические-рекомендации-для-текущего-проекта (20 файлов)
...
## Кластер 28 — благодарности, ingit-как-cowork-интегрированная-подложка-рабочего, профессиональные-коллеги-агенты, ingit (19 файлов)
...
## Кластер 29 — вопросы, открытые, открытые-вопросы, агенты (17 файлов)

- `docs/02-anthropic-vacancies/200-10-открытые-вопросы.md` — _200-10-открытые-вопросы_
- `docs/02-anthropic-vacancies/241-10-открытые-вопросы.md` — _241-10-открытые-вопросы_
- `docs/FAQ.md` — _FAQ_
- `docs/QUESTIONS.md` — _QUESTIONS_
- `docs/nautilus/professional-colleague-agents-ru/10-otkrytye-voprosy.md` — _10-otkrytye-voprosy_
- `docs/nautilus/representative-agent-layer-ru/10-otkrytye-voprosy.md` — _10-otkrytye-voprosy_
- `docs/nautilus/review-methodology/09-limitations-open-questions.md` — _09-limitations-open-questions_
- `docs/obsidian/02-anthropic-vacancies/115-8-ограничения-и-открытые-вопросы.md` — _115-8-ограничения-и-открытые-вопросы_
- `docs/obsidian/02-anthropic-vacancies/200-10-открытые-вопросы.md` — _200-10-открытые-вопросы_
- `docs/obsidian/02-anthropic-vacancies/241-10-открытые-вопросы.md` — _241-10-открытые-вопросы_
- _...и ещё 7 файлов_

## Кластер 30 — configuration, sub-agents, sub-agent, risk (17 файлов)

- `docs/02-anthropic-vacancies/263-10-risks-specific-to-composite-architectures.md` — _263-10-risks-specific-to-composite-architectures_
- `docs/02-anthropic-vacancies/271-appendix-c-configuration-template-example.md` — _271-appendix-c-configuration-template-example_
- `docs/nautilus/composite-skills-agents/04-sub-agent-registry.md` — _04-sub-agent-registry_
- `docs/nautilus/composite-skills-agents/05-configuration-ensembles.md` — _05-configuration-ensembles_
- `docs/nautilus/composite-skills-agents/09-okwf-integration.md` — _09-okwf-integration_
- `docs/nautilus/composite-skills-agents/10-risks.md` — _10-risks_
- `docs/nautilus/composite-skills-agents/11-open-questions.md` — _11-open-questions_
- `docs/nautilus/okwf-concept/08-risk-analysis.md` — _08-risk-analysis_
- `docs/obsidian/02-anthropic-vacancies/162-8-risk-analysis.md` — _162-8-risk-analysis_
- `docs/obsidian/02-anthropic-vacancies/263-10-risks-specific-to-composite-architectures.md` — _263-10-risks-specific-to-composite-architectures_
- _...и ещё 7 файлов_
