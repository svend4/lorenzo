...
graph LR
    ...
    01_svyazi -- 8% --> 02_anthropic_vacancies
    01_svyazi -- 13% --> 03_technology_combinations
    01_svyazi -- 95% --> 04_ai_collaborations
    01_svyazi -- 16% --> 05_habr_projects
    01_svyazi -- 19% --> ai_collaborations
    01_svyazi -- 8% --> autofilled
    01_svyazi -- 6% --> contacts
    01_svyazi -- 15% --> glossary
    01_svyazi -- 8% --> habr_unique_projects
    01_svyazi -- 6% --> nautilus
    01_svyazi -- 30% --> obsidian
    01_svyazi -- 80% --> svyazi_2_0
    01_svyazi -- 6% --> technology_combinations
    02_anthropic_vacancies -- 22% --> 03_technology_combinations
    02_anthropic_vacancies -- 14% --> 04_ai_collaborations
    02_anthropic_vacancies -- 20% --> 05_habr_projects
    02_anthropic_vacancies -- 22% --> ai_collaborations
    02_anthropic_vacancies -- 49% --> anthropic_vacancies
    02_anthropic_vacancies -- 25% --> autofilled
    02_anthropic_vacancies -- 6% --> contacts
    02_anthropic_vacancies -- 13% --> glossary
    02_anthropic_vacancies -- 20% --> habr_unique_projects
    02_anthropic_vacancies -- 43% --> lorenzo_agent
    02_anthropic_vacancies -- 81% --> nautilus
    02_anthropic_vacancies -- 84% --> obsidian
    02_anthropic_vacancies -- 11% --> svyazi_2_0
    02_anthropic_vacancies -- 15% --> technology_combinations
    03_technology_combinations -- 23% --> 04_ai_collaborations
    03_technology_combinations -- 36% --> 05_habr_projects
    03_technology_combinations -- 27% --> ai_collaborations
    03_technology_combinations -- 13% --> anthropic_vacancies
    03_technology_combinations -- 12% --> autofilled
    03_technology_combinations -- 6% --> contacts
    03_technology_combinations -- 30% --> glossary
    03_technology_combinations -- 24% --> habr_unique_projects
    03_technology_combinations -- 15% --> lorenzo_agent
    03_technology_combinations -- 19% --> nautilus
    03_technology_combinations -- 29% --> obsidian
    03_technology_combinations -- 16% --> svyazi_2_0
    03_technology_combinations -- 44% --> technology_combinations
    04_ai_collaborations -- 37% --> 05_habr_projects
    04_ai_collaborations -- 31% --> ai_collaborations
    04_ai_collaborations -- 8% --> anthropic_vacancies
    04_ai_collaborations -- 12% --> autofilled
    04_ai_collaborations -- 9% --> contacts
    04_ai_collaborations -- 22% --> glossary
    04_ai_collaborations -- 19% --> habr_unique_projects
    04_ai_collaborations -- 8% --> lorenzo_agent
    04_ai_collaborations -- 12% --> nautilus
    04_ai_collaborations -- 36% --> obsidian
    04_ai_collaborations -- 79% --> svyazi_2_0
    04_ai_collaborations -- 11% --> technology_combinations
    05_habr_projects -- 34% --> ai_collaborations
    05_habr_projects -- 14% --> anthropic_vacancies
    05_habr_projects -- 12% --> autofilled
    05_habr_projects -- 11% --> contacts
    05_habr_projects -- 26% --> glossary
    05_habr_projects -- 43% --> habr_unique_projects
    05_habr_projects -- 10% --> lorenzo_agent
    05_habr_projects -- 18% --> nautilus
    05_habr_projects -- 29% --> obsidian
    05_habr_projects -- 19% --> svyazi_2_0
    05_habr_projects -- 17% --> technology_combinations
    ai_collaborations -- 22% --> anthropic_vacancies
    ai_collaborations -- 12% --> autofilled
    ai_collaborations -- 9% --> contacts
    ai_collaborations -- 41% --> glossary
    ai_collaborations -- 41% --> habr_unique_projects
    ai_collaborations -- 24% --> lorenzo_agent
    ai_collaborations -- 29% --> nautilus
    ai_collaborations -- 35% --> obsidian
    ai_collaborations -- 26% --> svyazi_2_0
    ai_collaborations -- 25% --> technology_combinations
    anthropic_vacancies -- 11% --> autofilled
    anthropic_vacancies -- 10% --> glossary
    anthropic_vacancies -- 27% --> habr_unique_projects
    anthropic_vacancies -- 40% --> lorenzo_agent
    anthropic_vacancies -- 60% --> nautilus
    anthropic_vacancies -- 65% --> obsidian
    anthropic_vacancies -- 8% --> svyazi_2_0
    anthropic_vacancies -- 15% --> technology_combinations
    autofilled -- 18% --> contacts
    autofilled -- 22% --> glossary
    autofilled -- 10% --> habr_unique_projects
    autofilled -- 28% --> lorenzo_agent
    autofilled -- 21% --> nautilus
    autofilled -- 28% --> obsidian
    autofilled -- 18% --> svyazi_2_0
    autofilled -- 6% --> technology_combinations
    contacts -- 10% --> glossary
    contacts -- 7% --> habr_unique_projects
    contacts -- 11% --> obsidian
    contacts -- 10% --> svyazi_2_0
    glossary -- 49% --> habr_unique_projects
    glossary -- 10% --> lorenzo_agent
    glossary -- 11% --> nautilus
    glossary -- 24% --> obsidian
    glossary -- 29% --> svyazi_2_0
    glossary -- 45% --> technology_combinations
    habr_unique_projects -- 22% --> lorenzo_agent
    habr_unique_projects -- 29% --> nautilus
    habr_unique_projects -- 32% --> obsidian
    habr_unique_projects -- 14% --> svyazi_2_0
    habr_unique_projects -- 24% --> technology_combinations
    lorenzo_agent -- 45% --> nautilus
    lorenzo_agent -- 50% --> obsidian
    lorenzo_agent -- 8% --> svyazi_2_0
    lorenzo_agent -- 18% --> technology_combinations
    nautilus -- 81% --> obsidian
    nautilus -- 10% --> svyazi_2_0
    nautilus -- 21% --> technology_combinations
    obsidian -- 32% --> svyazi_2_0
    obsidian -- 26% --> technology_combinations
    svyazi_2_0 -- 10% --> technology_combinations
```
