...
<!-- summary -->
> Документ содержит описание рисков и ограничений. Изучите их перед принятием архитектурных решений. Фаза | Артефакт | Место хранения | Финальность | A | | ветка | нет, промежуточное |
 Фаза | Артефакт | Место хранения | Финальность |
 ------|----------|----------------|-------------|
 A |   | ветка   | нет, промежуточное |
 B |   | ветка   | нет, промежуточное |
 Merge |   с header warning + параллельными бло
