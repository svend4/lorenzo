...
<!-- summary -->
> Ключевой документ для понимания архитектуры. Рекомендуется прочитать в первую очередь. → 3 старших бита, остальные биты по категории | нативные Q6-координаты (Q6 — первичный концепт pro2) |
 Format | Правило |
 --------|---------|
 |   → 3 старших бита, остальные биты по категории |
 | нативные Q6-координаты (Q6 — первичный концепт pro2) |
 |   (гексаграмма 1 →  , 64 →  ) |
 |   |
Формат доп
