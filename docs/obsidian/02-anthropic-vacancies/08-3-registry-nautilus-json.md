...
**Похожие документы:**
- [[78-3-registry-nautilus-json]] (сходство 0.52)
...
- [[78-3-registry-nautilus-json|3. Registry (`nautilus.json`)]] _66%_
- [[79-4-passport-passport-md|4. Passport (`passport.md`)]] _37%_
- [[82-7-portalentry-structure|7. PortalEntry Structure]] _33%_
...
- [[18-6-adapter-interface|6. Adapter Interface]] _25%_
