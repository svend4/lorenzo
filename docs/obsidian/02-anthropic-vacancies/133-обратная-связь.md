...
```
[2026-04-19 14:30:00,123] INFO [[memnet|nautilus]]-mcp: Warming up portal...
[2026-04-19 14:30:00,200] INFO [[memnet|nautilus]]-mcp: Initializing NautilusPortal...
[2026-04-19 14:30:01,500] INFO [[memnet|nautilus]]-mcp: Portal initialized: 7 adapters loaded
[2026-04-19 14:30:01,501] INFO [[memnet|nautilus]]-mcp: Starting Nautilus MCP server on stdio
```
...
class LegalPortalEntry(PortalEntry):
    # Всё из [[01-интегральный-анализ-профиля-svend4|PortalEntry]] (id, title, source, format_type, content, links, is_fallback)
...
```
legal-[[memnet|nautilus]]/                       ← отдельный приватный репо
├── legal-[[memnet|nautilus]].json               ← приватный registry
├── legal-portal.py                   ← fork svend4/nautilus/portal.py
├── legal-portal-mcp.py               ← fork portal-mcp.py, с auth
├── adapters/
│   ├── base.py                       ← тот же [[01-интегральный-анализ-профиля-svend4|BaseAdapter]]
...
[[01-интегральный-анализ-профиля-svend4|PortalEntry]](
    ...
    metadata={
        ...
        "public_pattern_refs": [[memnet|
            "[nautilus]]-legal:pattern:eingliederungshilfe_denial",
            "[[memnet|nautilus]]-legal:pattern:persoenliches_budget_refusal",
            "[[memnet|nautilus]]-legal:norm:sgb_xii_90",
            "[[memnet|nautilus]]-legal:precedent:anonymized_2024_similar_case"
        ]
    }
)
```
...
```
svend4/
├── [[memnet|nautilus]]-legal/              ← PUBLIC repo
│   ├── README.md
│   ├── PORTAL-PROTOCOL-LEGAL.md ← extension spec
│   ├── legal-portal.py          ← fork of portal.py
│   ├── legal-[[memnet|nautilus]].json      ← public registry
│   │
│   ├── adapters/
...
│
├── cases-private/               ← PRIVATE repo (не публикуется на [[03-component-catalog|GitHub]] 
│   │                               вообще, либо [[03-component-catalog|GitHub]] Enterprise 
...
│
└── [[memnet|nautilus]]/                    ← PUBLIC (уже существует)
    ├── [текущее содержимое]
```
