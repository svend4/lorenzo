...
|--------|------|--------|------|
| [[README|`docs/01-svyazi/`]] | Архитектура Svyazi 2.0 | 16 | 11,578 |
| [[README|`docs/02-anthropic-vacancies/`]] | Вакансии Anthropic | 357 | 319,964 |
| [[README|`docs/03-technology-combinations/`]] | Комбинации технологий | 7 | 3,159 |
| [[README|`docs/04-ai-collaborations/`]] | AI-коллаборации | 17 | 26,574 |
| [[README|`docs/05-habr-projects/`]] | Хабр-проекты | 10 | 9,335 |
