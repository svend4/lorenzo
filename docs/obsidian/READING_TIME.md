...
- [Самые длинные документы (25)](#самые-длинные-документы-25)
...
Документов: **510** | Слов всего: **375,912** | Время чтения всей базы: **31ч 1мин**
...
## Самые длинные документы (25)

- `docs/TABLES.md` — ~1ч 46мин, 24513 слов
- `docs/02-anthropic-vacancies/01-интегральный-анализ-профиля-svend4.md` — ~1ч 31мин, 17180 слов
- `docs/OUTLINE.md` — ~1ч 27мин, 20244 слов
- `docs/PARAGRAPH_QUALITY.md` — ~55 мин, 12538 слов
- `docs/04-ai-collaborations/00-intro.md` — ~49 мин, 10581 слов
- `docs/CODE_BLOCKS.md` — ~42 мин, 425 слов
- `docs/02-anthropic-vacancies/342-что-такое-вариант-c-concept-document-для-anthropic.md` — ~42 мин, 9261 слов
- `docs/02-anthropic-vacancies/00-intro.md` — ~36 мин, 7760 слов
- `docs/CONCEPTS.md` — ~35 мин, 8422 слов
- `docs/05-habr-projects/memory/memnet.md` — ~31 мин, 6691 слов

## По категориям

- 📗 Быстро: 376 документов
- 📘 Средне: 106 документов
- 📕 Очень долго: 20 документов
- 📙 Долго: 8 документов
