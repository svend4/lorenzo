...
Документов: **1113** | Слов всего: **681,470** | Время чтения всей базы: **56ч 20мин**
...
| `docs/ACTION_ITEMS.md` | ~27 мин | 6001 | 📕 Очень долго |
| `docs/EMPTY_SECTIONS.md` | ~26 мин | 5592 | 📕 Очень долго |
...
| `docs/DUPLICATES.md` | ~9 мин | 2105 | 📙 Долго |
...
| `docs/CHANGELOG.md` | ~5 мин | 1325 | 📘 Средне |
...
| `docs/README.md` | ~3 мин | 804 | 📘 Средне |
...
| `docs/VERSION_DIFF.md` | ~1 мин | 229 | 📗 Быстро |
...
| `docs/DIGEST_AUTO.md` | ~1 мин | 233 | 📗 Быстро |
