...
- **13-contacts** → `13-контактная-стратегия-и-узкие-вопросы-для-авторов`, `narrow-questions`, `07-mvp-planning`, `QUESTIONS`
- **14-limitations** → `do-not-glue`, `conclusions`, `14-ограничения-лицензии-и-что-пока-лучше-не-склеивать`, `license-tree`
- **QA** → `CONTACTS`, `integration-spec`, `gaps`, `09-архитектурные-зазоры-которые-важнее-новых-инструме`
- **README** → `research-summary`
- **00-intro** → `TABLES`, `14-ограничения-лицензии-и-что-пока-лучше-не-склеивать`, `01-интегральный-анализ-профиля-svend4`, `CONCEPTS`
- **01-интегральный-анализ-профиля-svend4** → `00-question-innovations-transitions`, `CONCEPTS`, `TABLES`, `00-intro`
- **02-общий-план-развития-nautilus-portal-protocol** → `34-appendix-b-change-log`, `122-глоссарий`, `22-glossary`, `133-обратная-связь`
...
- **04-abstract** → `74-abstract`, `00-abstract-status`, `42-author-contact`, `98-appendix-a-minimal-working-example`
...
- **08-3-registry-nautilus-json** → `78-3-registry-nautilus-json`, `03-registry`, `82-7-portalentry-structure`, `19-7-portalentry-structure`
