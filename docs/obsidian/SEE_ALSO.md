...
- **QA** → `09-architectural-gaps`, `09-архитектурные-зазоры-которые-важнее-новых-инструме`, `CONTACTS`, `11-integration-contracts`
- **README** → `ensemble`, `research-summary`, `research-note`, `project-component`
...
- **102-доступ-к-данным** → `339-приложение-a-дерево-решений-для-принимающих-ingit`, `348-кому-ты-служишь-слоистая-модель`, `118-appendix-a-шаблон-для-header-warning`, `121-appendix-c-история-изменений-методологии`
