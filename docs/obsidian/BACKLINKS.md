...
|----------|----------------|-------------------|
| `READABILITY` | 736 | `00-intro-part2.md`, `02-methodology.md`, `06-security-privacy.md`, `QA.md` +732 |
| `READING_TIME` | 708 | `02-methodology.md`, `06-security-privacy.md`, `QA.md`, `110-вопрос-fallback-ratio-как-критический-или-осмыслен.md` +704 |
| `SEARCH` | 699 | `02-methodology.md`, `06-security-privacy.md`, `QA.md`, `110-вопрос-fallback-ratio-как-критический-или-осмыслен.md` +695 |
| `OUTLINE` | 696 | `00-intro-part2.md`, `02-methodology.md`, `06-security-privacy.md`, `08-conclusions.md` +692 |
| `TABLES` | 482 | `00-intro-part2.md`, `03-component-catalog.md`, `06-security-privacy.md`, `QA.md` +478 |
...
| **.claude** | 28 | 0 |
| **01-svyazi** | 383 | 183 |
| **02-anthropic-vacancies** | 7110 | 4972 |
