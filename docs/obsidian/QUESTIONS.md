...
Всего: **2542** | Файлов: **1238**

_Извлечено автоматически из всех документов: **1042** вопросов_
...
- docs/02-anthropic-vacancies/365-развёрнутый-анализ-внуковой-    неуточнено   Лицензия неизвестна — требует уточнения [19. Что это такое в эссенции]
- docs/obsidian/02-anthropic-vacancies/365-развёрнутый-анализ-    неуточнено   Лицензия неизвестна — требует уточнения [26. Приложение A: Сравнительная Таблица — Пять Типов Агентов]
- docs/02-anthropic-vacancies/365-развёрнутый-анализ-внуковой-    неуточнено   Лицензия неизвестна — требует уточнения [19. Что это такое в эссенции]
...
- - №3: Health Score 82/100 — это хорошо, но неясно по какому алгоритму . [⚠️ Риски (1328)]
...
- ### Q&A: 02-anthropic-vacancies     !NOTE - Какие 5 архитектурных зазоров выделены в исследовании? [Что это такое?]
- - Что входит в интеграционный контракт между слоями? [Q&A: 02-anthropic-vacan]
- - Какие кластеры найма выделены у Anthropic? [Q&A: 02-anthropic-vacancies > > !NOTE - Какие 5 архитектурны]
- - Какие роли наиболее релевантны для профиля svend4? [Q&A: 02-anthropic-vacancies > > !NOTE - Какие 5 архитектурны]
- - Кто ключевые авторы проектов для контакта? [Q&A: 02-anthropic-vacancies > > !NOTE - Какие 5 архитектурны]
- _...ещё 83_

### `EMPTY_SECTIONS.md` (66)
...
- ## Какие роли наиболее релевантны для профиля svend4? [Какие кластеры найма выделен]
- ## Каковы этапы MVP и их оценка по времени? [Какие роли наиболее реле]
- ## Что входит в первую итерацию прототипа? [Каковы этап]
- ## Кто ключевые авторы проектов для контакта? [Что входит в]
- _...ещё 12_
...
- ## Какова разница между эпизодической и семантической памятью? [Как происходит консолидация и забывание в па]
- ## Кто ключевые авторы проектов для контакта? [Какова разница между эпизодической и семантической пам]
- ## Какие вопросы лучше задавать авторам при первом контакте? [Кто ключевые]
- _...ещё 12_
...
- -   Почему это важно   Снижение риска [⚠️ Риски (1328)]
- _...ещё 11_
...
- ## Кто ключевые авторы проектов для контакта? [Как CardIndex хранит и версион]
...
- 119   🟢 Начало    Зачем две версии параллельно (02-anthropic-vacancies/70-зачем-две-версии-параллельно.md)   332   — [Рекомендуемый порядок чтения]
- Почему это валидный паттерн для AI-assiste (02-anthropic-vacancies/113-6-почему-это-валидный-паттерн-для-ai-assisted-work.md)   322   — [Рекомендуемый порядок чтения]
...
### `SIMILAR_PASSAGES.md` (10)

- Риск Почему это важно Снижение риска --- --- --- Schema drift и самовольная “оптимизация” структуры моделью На extraction‑этапе сильная модель может н [13. Сходство: 1.0 (100%)]
- Риск Почему это важно Снижение риска --- --- --- Schema drift и самовольная “оптимизация” структуры моделью На extraction‑этапе сильная модель может н [13. Сходство: 1.0 (100%)]
- Риск Почему это важно Снижение риска --- --- --- Schema drift и самовольная “оптимизация” структуры моделью На extraction‑этапе сильная модель может н [13. Сходство: 1.0 (100%)]
- Риск Почему это важно Снижение риска --- --- --- Schema drift и самовольная “оптимизация” структуры моделью На extraction‑этапе сильная модель может н [13. Сходство: 1.0 (100%)]
- Риск Почему это важно Снижение риска --- --- --- Schema drift и самовольная “оптимизация” структуры моделью На extraction‑этапе сильная модель может н [13. Сходство: 1.0 (100%)]
...
- ## Как происходит консолидация и забывание в памяти агентов? [Какие системы памяти описаны в этом разделе?]
- ## Какова разница между эпизодической и семантической памятью? [Как происходит консолидация и забывание в памяти агенто]
- ## Что такое handoff и locks в агентных системах? [Как организована многоагент]
- ## Как работает spec-driven подход в AI Factory? [Что такое handoff и locks в агентных систе]
- _...ещё 5_
...
- ## Что такое Evidence Envelope и зачем он нужен? [Как реализован for]
- ## Какие RAG-подходы сравниваются в документах? [Что такое Evidence]
- ## Как работает AgentFS и что такое .agentos? [Какие RAG-подходы]
- ## Что такое knowledge-space и для кого он предназначен? [Как работает]
- _...ещё 3_
...
- AnastasiyaW     knowledge-space, mclaude   knowledge/orchestration   126   Держать operational benchmark/gotcha cards в одной базе с reference cards и [Ключевые проекты]
- VitalyOborin     Yodoca   memory   102   Что сильнее влияет на качество памяти: отдельный consolidator, decay или строгая типизация записей? [Ключевые проекты]
...
- ## Какие роли наиболее релевантны для профиля svend4? [Какие кластеры найма выделены у Anthropic?]
- ## Какие 5 архитектурных зазоров выделены в исследовании? [Какие роли наиболее релевантны для профиля svend4?]
- ## Что входит в интеграционный контракт между слоями? [Какие 5 архитектурных зазор]
- ## Кто ключевые авторы проектов для контакта? [Что входит в интеграцион]
- _...ещё 1_
...
- AnastasiyaW     knowledge-space, mclaude   knowledge/orchestration   126   Держать operational benchmark/gotcha cards в одной базе с reference cards и [Ключевые авторы проектов]
- VitalyOborin     Yodoca   memory   102   Что сильнее влияет на качество памяти: отдельный consolidator, decay или строгая типизация записей? [Ключевые авторы проектов]
- andrey chuyan     Svyazi   ingestion/CardIndex   31   Стоит ли расширять CardIndex до person/project/episode/evidence или лучше держать разные индексы [Ключевые авторы проектов]
- kksudo     AgentFS   knowledge/filesystem   189   Что лучше класть в .agentos, а что выносить в machine-only state вне vault conventions? [Ключевые авторы проектов]
- spbmolot     NGT Memory   memory   167   Где проходит практическая граница между полезной ассоциацией и ложной ко-активацией тем для community discove [Ключевые авторы проектов]

### `VERSION_DIFF.md` (5)

- docs/05-habr-projects/QA.md    -100   Как реализован forensic RAG с доказуемостью?, Какие RAG-подходы сравниваются в документах?, Что такое Evidence E [📝 Изменённые файлы (471)]
- docs/01-svyazi/QA.md    -75   Как CardIndex хранит и версионирует карточки?, Как работает AgentFS и что такое .agentos?, Что такое knowledge-space и д [📝 Изменённые файлы (471)]
- docs/anthropic-vacancies/QA.md    -44   Какие 5 архитектурных зазоров выделены в исследовании?, Какие вопросы лучше задавать авторам при первом контак [📝 Изменённые файлы (471)]
- docs/obsidian/05-habr-projects/QA.md    -35   Как реализован forensic RAG с доказуемостью?, Какие RAG-подходы сравниваются в документах?, Что такое Ev [📝 Изменённые файлы (471)]
- docs/obsidian/01-svyazi/QA.md    -9   Как CardIndex хранит и версионирует карточки?, Как работает AgentFS и что такое .agentos?, Что такое knowledge-s [📝 Изменённые файлы (471)]
...
- ## Какова политика доступа по умолчанию (tool classes)? [Какие инструменты обеспечи]
- ## Как организован бюджетный роутинг между моделями? [Какова политика доступа по]
- ## Какие 5 архитектурных зазоров выделены в исследовании? [Как организован бюджетн]
- ## Что входит в интеграционный контракт между слоями? [Какие 5 архитектурных зазоро]
...
- Сходство   Файл A   Файл B    ---------- -------- --------    1.000    02-why-document-exists.md     01-missing-middle-layer.md      1.000    svyazi.m [100% — `docs/DIGEST.md` vs `docs/obsidian/DIGEST.md`]
- -  02-why-document-exists.md  ↔  01-missing-middle-layer.md  (1.000) -  svyazi.md  ↔  svend4.md  (1.000) -  svyazi.md  ↔  sgb.md  (1.000) -  svyazi.md [100]
- Как LiteParse обрабатывает таблицы с объединёнными или перенесёнными ячейками? [100% — `docs/le]

### `KPI.md` (3)

- 440     я-связь  - blog post на тему «Почему в компании №1 на рынке 440 вакансий не закр    ACTION ITEMS [Количество (507)]
- 2     адаптер для нового репо без задавания вопросов автору? [Этап (144)]
- 3     озвращает non-empty результат с consensus-информацией? [Этап (144)]
...
- ## Как происходит консолидация и забывание в памяти агентов? [Какие системы памяти описаны в этом разделе?]
- ## Какова разница между эпизодической и семантической памятью? [Как происходит консолидация и забывание]
...
### `329-3-что-ingit-обеспечивает-чего-cowork-не-хватает.md` (2)
...
- Один абзац: что это, для кого, почему существует. [Связанные документы]
...
- ## Кластер 29 — фазы, применения, формальный-workflow, зачем-две-версии-параллельно (16 файлов) [Кластер 28 — заключение, аннотация, благодарности, агентов (]
...
- TODO   ⭐   To Do — задача к выполнению   49 [107. Словарь аббревиатур и сокращений]
...
- Все документы - 2025-Q3 ⬜ Прототип ансамбля (Svyazi + CardIndex) ⬜ Планируется 180. [2025 (51 упоминаний)]
- Все документы - ...ещё 11 SCHEDULE.md (7) - 2025-Q1 ⬜ Написать авторам AgentFS, Yodoca, NGT ⬜ Планируется Ключевые вехи [2025 (51 упоминаний)]
...
- TODO   ⭐   To Do — задача к выполнению   41 [Словарь аббревиатур и сокращений]
...
- Может быть efficient но также может быть manipulated. [⚠️ Риски (1328)]
- - Возможно engaged в его own vision, не interested в applied domain [⚠️ Риски (1328)]
- - Working at Яндекс, может быть constraints на external collaboration [⚠️ Риски (1328)]
- - Если они see, что Lorenzo сам lists them as «collaborators» до того, как они agreed, может быть perception of presumption. [⚠️ Риски (1328)]
...
- 4-6     ner (может быть Anthropic или Mistral). [Время (551)]

### `READING_ORDER.md` (1)

- 333   🟢 Начало    Что промышленность вероятно построит (02-anthropic-vacancies/297-что-промышленность-вероятно-построит.md)   377   — [Рекомендуемый порядок чтения]
