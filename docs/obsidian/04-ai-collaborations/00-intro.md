...
Родители:
SENTINEL[^sentinel] + Shield/Guards + Prompt Worms + OpenClaw risk cases + Claude permissions/Tool Search.
...
- [[memnet|MemNet: исследовательская память]] _42%_
- [[02-knowledge-graphs|Графы знаний и Legal AI]] _21%_
- [[14-ограничения-лицензии-и-что-пока-лучше-не-склеивать|Ограничения, лицензии и что пока лучше не склеивать]] _21%_
- [[03-component-catalog|03 Component Catalog]] _17%_
