...
- [По файлам](#по-файлам)
  - [`docs/CONCEPTS.md` (1688 проблем)](#docsconceptsmd-1688-проблем)
  - [`docs/HEADING_AUDIT.md` (1023 проблем)](#docsheading_auditmd-1023-проблем)
  - [`docs/TABLES.md` (910 проблем)](#docstablesmd-910-проблем)
  - [`docs/EMPTY_SECTIONS.md` (539 проблем)](#docsempty_sectionsmd-539-проблем)
  - [`docs/SCRIPTS_CATALOG.md` (294 проблем)](#docsscripts_catalogmd-294-проблем)
  - [`docs/CODE_BLOCKS.md` (220 проблем)](#docscode_blocksmd-220-проблем)
  ...
  - [`docs/DECISIONS.md` (76 проблем)](#docsdecisionsmd-76-проблем)
  ...
  - [`docs/GITHUB_ISSUES.md` (71 проблем)](#docsgithub_issuesmd-71-проблем)
  ...
  - [`docs/SPELLCHECK.md` (57 проблем)](#docsspellcheckmd-57-проблем)
  ...
  - [`docs/TAGS.md` (27 проблем)](#docstagsmd-27-проблем)
  ...
  - [`docs/CONSISTENCY.md` (22 проблем)](#docsconsistencymd-22-проблем)
  ...
  - [`docs/ACTION_ITEMS.md` (12 проблем)](#docsaction_itemsmd-12-проблем)
  ...
  - [`docs/CHANGELOG.md` (11 проблем)](#docschangelogmd-11-проблем)
  ...
  - [`docs/contacts/spbmolot.md` (10 проблем)](#docscontactsspbmolotmd-10-проблем)
  ...
  - [`docs/contacts/anastasiyaw.md` (9 проблем)](#docscontactsanastasiyawmd-9-проблем)
  - [`docs/contacts/cutcode.md` (9 проблем)](#docscontactscutcodemd-9-проблем)
  - [`docs/contacts/dmitriila.md` (9 проблем)](#docscontactsdmitriilamd-9-проблем)
  - [`docs/contacts/kksudo.md` (9 проблем)](#docscontactskksudomd-9-проблем)
  - [`docs/contacts/mixaill76.md` (9 проблем)](#docscontactsmixaill76md-9-проблем)
  - [`docs/contacts/tagir-analyzes.md` (9 проблем)](#docscontactstagir-analyzesmd-9-проблем)
  - [`docs/contacts/vladspace.md` (9 проблем)](#docscontactsvladspacemd-9-проблем)
  - [`docs/contacts/zodigancode.md` (9 проблем)](#docscontactszodigancodemd-9-проблем)
  ...
  - [`docs/CONCEPT_GRAPH.md` (4 проблем)](#docsconcept_graphmd-4-проблем)
  ...
  - [`docs/SKILL_DASHBOARD.md` (4 проблем)](#docsskill_dashboardmd-4-проблем)
  - [`docs/VOCABULARY.md` (4 проблем)](#docsvocabularymd-4-проблем)
...
### `docs/CONCEPTS.md` (1688 проблем)

_абзац: 795, Оборванный: 628, начала: 261, Дубль: 4_


### `docs/HEADING_AUDIT.md` (1023 проблем)
...
### `docs/EMPTY_SECTIONS.md` (539 проблем)

_абзац: 299, Оборванный: 175, Дубль: 6, начала: 59_


### `docs/SCRIPTS_CATALOG.md` (294 проблем)

_Оборванный: 44, абзац: 250_


### `docs/CODE_BLOCKS.md` (220 проблем)
...
### `docs/GITHUB_ISSUES.md` (71 проблем)
...
### `docs/contacts/spbmolot.md` (10 проблем)
...
### `docs/contacts/anastasiyaw.md` (9 проблем)

_Оборванный: 4, абзац: 5_


### `docs/contacts/cutcode.md` (9 проблем)

_Оборванный: 3, абзац: 6_


### `docs/contacts/dmitriila.md` (9 проблем)

_Оборванный: 3, абзац: 6_


### `docs/contacts/kksudo.md` (9 проблем)

_Оборванный: 4, абзац: 5_


### `docs/contacts/mixaill76.md` (9 проблем)

_Оборванный: 3, абзац: 6_


### `docs/contacts/tagir-analyzes.md` (9 проблем)

_Оборванный: 3, абзац: 6_


### `docs/contacts/vladspace.md` (9 проблем)

_Оборванный: 3, абзац: 6_


### `docs/contacts/zodigancode.md` (9 проблем)
...
### `docs/SKILL_DASHBOARD.md` (4 проблем)
