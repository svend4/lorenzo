...
- [📊 Диаграммы Mermaid (10)](#диаграммы-mermaid-10)
...
### Архитектурная схема
_`docs/templates/ensemble.md` | 3 строк_
...
_...и ещё 12 блоков этого языка_
...
_...и ещё 136 блоков этого языка_
