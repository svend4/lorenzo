...
_...и ещё 37 блоков этого языка_
...
_...и ещё 49 блоков этого языка_
...
_...и ещё 310 блоков этого языка_
...
### Appendix A: Шаблон для header warning
_`docs/nautilus/review-methodology/12-appendix-a-header-warning.md` | 16 строк_
...
_...и ещё 10 блоков этого языка_
