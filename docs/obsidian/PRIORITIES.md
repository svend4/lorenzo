...
|---|------|-------|------|-----------------|
| 1 | `docs/TABLES.md` | **1362.42** | 351475 | agent, Svyazi, memory, rag, MIT |
| 2 | `docs/obsidian/TABLES.md` | **1141.51** | 351477 | agent, Svyazi, memory, rag, MIT |
| 3 | `docs/OUTLINE.md` | **282.04** | 47467 | agent, Svyazi, memory, security, rag |
| 4 | `docs/PARAGRAPH_QUALITY.md` | **278.62** | 22488 | agent, Svyazi, memory, rag, security |
| 5 | `docs/obsidian/PARAGRAPH_QUALITY.md` | **278.51** | 22498 | agent, Svyazi, memory, rag, security |
| 6 | `docs/obsidian/OUTLINE.md` | **208.95** | 47482 | agent, Svyazi, memory, rag, security |
| 7 | `docs/HEADING_AUDIT.md` | **177.71** | 13488 | agent, Svyazi, memory, security, MIT |
| 8 | `docs/obsidian/HEADING_AUDIT.md` | **177.71** | 13491 | agent, Svyazi, memory, security, MIT |
| 9 | `docs/READABILITY.md` | **143.22** | 37383 | agent, Svyazi, memory, security, rag |
| 10 | `docs/READING_TIME.md` | **140.24** | 27197 | agent, Svyazi, memory, security, rag |
| 11 | `docs/CONCEPTS.md` | **106.36** | 15171 | agent, Svyazi, memory, MIT, LiteParse |
| 12 | `docs/EMPTY_SECTIONS.md` | **103.81** | 44436 | agent, rag, memory, security, Svyazi |
| 13 | `docs/obsidian/EMPTY_SECTIONS.md` | **103.44** | 44446 | agent, rag, memory, security, Svyazi |
| 14 | `docs/SITEMAP.md` | **98.8** | 9605 | agent, Svyazi, memory, rag, security |
| 15 | `docs/VERSION_DIFF.md` | **85.76** | 20626 | agent, Svyazi, memory, security, MIT |
| 16 | `docs/obsidian/VERSION_DIFF.md` | **84.55** | 20639 | agent, Svyazi, memory, security, MIT |
...
| 20 | `docs/obsidian/CONCEPTS.md` | **70.15** | 15096 | agent, memory, MIT, Svyazi, rag |
| 21 | `docs/glossary/components-by-name.md` | **67.91** | 1207 | Svyazi, agent, memory, rag, Yodoca |
...
| 28 | `docs/SOURCE_MAP.md` | **54.71** | 12466 | agent, Svyazi, security, MIT, memory |
| 29 | `docs/obsidian/SOURCE_MAP.md` | **54.71** | 12477 | agent, Svyazi, security, MIT, memory |
| 30 | `docs/CONSISTENCY.md` | **54.17** | 1032 | memory, local-first, evidence, knowledge-space, CardIndex |
| 31 | `docs/obsidian/CONSISTENCY.md` | **54.06** | 1046 | memory, local-first, evidence, knowledge-space, CardIndex |
| 32 | `docs/CROSS_SECTION.md` | **53.67** | 4218 | Svyazi, agent, memory |
| 33 | `docs/obsidian/CROSS_SECTION.md` | **53.65** | 4228 | Svyazi, agent, memory |
...
| 35 | `docs/ACTION_ITEMS.md` | **51.98** | 9489 | MIT, agent, Svyazi, security, MVP |
| 36 | `docs/obsidian/SITEMAP.md` | **51.79** | 9616 | agent, Svyazi, memory, rag, Yodoca |
| 37 | `docs/obsidian/ACTION_ITEMS.md` | **50.99** | 9491 | MIT, agent, Svyazi, security, MVP |
| 38 | `docs/02-anthropic-vacancies/365-развёрнутый-анализ-внуковой-комбинации.md` | **46.66** | 4550 | agent, MIT, Svyazi, rag, mclaude |
| 39 | `docs/PROTOTYPE_SPEC.md` | **44.71** | 1676 | Yodoca, Svyazi, agent, memory, AgentFS |
| 40 | `docs/CODE_BLOCKS.md` | **44.51** | 5973 | agent, Svyazi, MIT, rag, Rufler |
| 41 | `docs/obsidian/PROTOTYPE_SPEC.md` | **43.72** | 1689 | Yodoca, agent, Svyazi, memory, AgentFS |
| 42 | `docs/obsidian/CODE_BLOCKS.md` | **43.36** | 5972 | agent, Svyazi, MIT, Rufler, rag |
...
| 48 | `docs/SEE_ALSO.md` | **37.39** | 273 | Svyazi, MVP, MIT, security, roadmap |
| 49 | `docs/05-habr-projects/memory/memnet.md` | **37.29** | 7346 | локальн, Svyazi, memory, rag, Yodoca |
| 50 | `docs/NAMED_ENTITIES.md` | **37.14** | 1877 | Svyazi, MVP, Yodoca, rag, security |
...
| Файл | Score |
|------|-------|
| `docs/TABLES.md` | 1362.42 |
| `docs/OUTLINE.md` | 282.04 |
| `docs/PARAGRAPH_QUALITY.md` | 278.62 |
| `docs/HEADING_AUDIT.md` | 177.71 |
| `docs/READABILITY.md` | 143.22 |
...
| Файл | Score |
|------|-------|
| `docs/obsidian/TABLES.md` | 1141.51 |
| `docs/obsidian/PARAGRAPH_QUALITY.md` | 278.51 |
| `docs/obsidian/OUTLINE.md` | 208.95 |
| `docs/obsidian/HEADING_AUDIT.md` | 177.71 |
| `docs/obsidian/EMPTY_SECTIONS.md` | 103.44 |
...
| `docs/templates/project-component.md` | 1.64 |
