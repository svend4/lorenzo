---
title: "Матрица компонентов Svyazi 2.0"
tags:
  - general
date: 2026-04-29
---
...
- [[NARRATIVE|Нарратив проекта Lorenzo]] _25%_
- [[PRIORITIES|Приоритеты файлов]] _25%_
- [[05-план-прототипа-и-возможные-контакты|План прототипа и возможные контакты]] _21%_
- [[DENSITY|Карта плотности тем]] _21%_
- [[GRAPH|Граф связей проектов]] _21%_
- [[07-mvp-planning|07 Mvp Planning]] _17%_
- [[04-приоритетные-ансамбли|Приоритетные ансамбли]] _17%_
- [[13-контактная-стратегия-и-узкие-вопросы-для-авторов|Контактная стратегия и узкие вопросы для авторов]] _17%_
## Связанные документы

- [[07-mvp-planning|07 Mvp Planning]] _17%_
- [[10-second-order-ensembles|10 Second Order Ensembles]] _17%_
- [[05-план-прототипа-и-возможные-контакты|План прототипа и возможные контакты]] _17%_
- [[10-новые-ансамбли-следующего-шага|Новые ансамбли следующего шага]] _17%_
- [[NETWORK|Сеть проектов и авторов]] _17%_
...
**Похожие документы:**
- [[COMPONENT_MATRIX]] (сходство 0.80)
- [[ONBOARDING]] (сходство 0.27)
- [[ONBOARDING]] (сходство 0.26)
