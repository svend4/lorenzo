...
Автоматически извлечено из всех документов: **1257 записей**
...
- как… > Я собираю Svyazi 2.0 — локальную community intelligence platform, которая строит граф знаний из текстов, документов и профилей людей. В слой памяти я рассматривал несколько подходов (Yodoca, a  
  _→ DUPLICATES_
...
- критических** | **0** | ## PII и секреты ✅ PII и секреты не найдены. ## Небезопасный код ✅ Небезопасных паттернов в скриптах не найдено. ## Файлы credentials ✅ Credential-файлы в репозитории н  
  _→ SENTINEL_
...
- склеивать](svyazi-2-0/limitations/do-not-glue.md)](#что-пока-лучше-не-склеиватьsvyazi-2-0limitationsdo-not-gluemd) - [[do-not-glue|[Лицензионные развилки]] > - Оркестрация — выбрать один spine(#оркестрация-выбрать-один-spine) - Contents - Оркестрация  
  _→ OUTLINE_
...
- склеивать](#ограничения-лицензии-и-что-пока-лучше-не-склеивать) - Похожие документы - Использование - [[ACTION_ITEMS|Смотрит  
  _→ 14-limitations_
...
_...ещё 1000 записей в этой категории_
