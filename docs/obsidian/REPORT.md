...
База содержит **1244 документов** объёмом **1,532,508 слов** в **23 секциях**. Здоровье репозитория: **90/100**, средний балл документов: **95.9/100/100**, словарное богатство (STTR): **0.628**.
