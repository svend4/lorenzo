...
База содержит **1244 документов** объёмом **1,475,994 слов** в **23 секциях**. Здоровье репозитория: **90/100**, средний балл документов: **100.0/100/100**, словарное богатство (STTR): **0.628**.
...
| Секция | Файлов | Слов |
|--------|--------|------|
| **obsidian** | 1238 | 1,438,686 |
| **Anthropic Vacancies** | 357 | 341,414 |
| **nautilus** | 255 | 170,297 |
| **anthropic-vacancies** | 111 | 44,236 |
| **AI Collaborations** | 17 | 27,880 |
| **lorenzo-agent** | 62 | 27,123 |
| **svyazi-2-0** | 60 | 19,000 |
| **habr-unique-projects** | 56 | 18,430 |
| **technology-combinations** | 53 | 18,344 |
| **processing-guide** | 13 | 17,221 |
| **Habr Projects** | 16 | 14,703 |
| **Svyazi 2.0** | 16 | 13,298 |
| **ai-collaborations** | 31 | 11,331 |
| **Templates** | 24 | 7,438 |
| **Contacts** | 17 | 4,938 |
| **Tech Combinations** | 7 | 3,779 |
| **letters** | 10 | 3,134 |
| **meta-scripting** | 7 | 3,121 |
| **autofilled** | 13 | 2,612 |
| **glossary** | 4 | 2,559 |
| **badges** | 1 | 122 |
...
**Похожие документы:**
- [REPORT](../REPORT.md) (сходство 0.95)
- [CONTACTS](CONTACTS.md) (сходство 0.24)
- [CONTACTS](../CONTACTS.md) (сходство 0.23)
