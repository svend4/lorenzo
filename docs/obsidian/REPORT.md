...
- **206** ключевых решений → [[DECISIONS|DECISIONS.md]]
- **893** числовых KPI → [[KPI|KPI.md]]
- **518** открытых вопросов → [[QUESTIONS|QUESTIONS.md]]
- **20** похожих пар документов → [[SIMILAR|SIMILAR.md]]
...
2. ⚠️ Устранить **17 предупреждений** → [[VALIDATION|VALIDATION.md]]
