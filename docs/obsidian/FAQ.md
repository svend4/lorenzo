...
- [Архитектура](#архитектура)
  ...
  - [Содержание - Contents - Что это такое?](#содержание---contents---что-это-такое)
  - [Contents - Что это такое?](#contents---что-это-такое)
...
_Извлечено: 256 вопросов и ответов_
...
### Contents - Что это такое?

- Первые 30 минут - Структура документации - Ключевые документы - Скрипты автоматизации - Архитектура компонентов - Как внести вклад - Контакты > [!NOTE] > Раздел `ONBOARDING` формируется автоматически из данных репозитория. <!-- alert-added --> <!-- tags: onboarding, docs --> <!-- summary --> > `ONBOARDING` — раздел документации проекта Lorenzo. _Руководство для новых участников проекта._
