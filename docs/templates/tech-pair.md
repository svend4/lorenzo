...
<!-- summary -->
> Не «хорошо работают вместе».] Что B делает лучше из-за A Что появляется только в комбинации [Эмерджентное свойство — почему пара важнее суммы.] [Что может пойти плохо при объединении.
