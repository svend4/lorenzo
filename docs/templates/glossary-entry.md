...
<!-- summary -->
> [Термин A] — [как связан] [Термин B] — [как связан] Где упоминается в монорепо _Создано: 2026-04-29_ Документ индексирован в базе знаний репоз Заполните поля согласно инструкции.
Связанные термины
 [Термин A] — [как связан]
 [Термин B] — [как связан]
...
Смотрите также
  Документ индексирован в базе знаний репоз
