...
<!-- summary -->
> Документ содержит описание рисков и ограничений. Изучите их перед принятием архитектурных решений. Способ A: По шаблону (без LLM) Способ B: По задаче с LLM
 --
...
- [Откуда берутся паттерны](#откуда-берутся-паттерны)
- [Шесть базовых паттернов](#шесть-базовых-паттернов)
- [Три способа синтеза](#три-способа-синтеза)
  - [Способ A: По шаблону (без LLM)](#способ-a-по-шаблону-без-llm)
  - [Способ B: По задаче с LLM](#способ-b-по-задаче-с-llm)
  - [Способ C: Расширение существующего](#способ-c-расширение-существующего)
- [Защита от плохого кода](#защита-от-плохого-кода)
- [Петля самообогащения (осторожно)](#петля-самообогащения-осторожно)
