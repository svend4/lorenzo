...
<!-- summary -->
> Документ создан на основе исследования. Ссылки ведут на связанные материалы. Что значит «обогатить скрипт» Уровень 1: Docstring (без LLM) Уровень 2: Типизация (без LLM)
