...
- [Что извлекается из каждого скрипта](#что-извлекается-из-каждого-скрипта)
- [Алгоритм определения риска](#алгоритм-определения-риска)
- [Пример выходного каталога (фрагмент)](#пример-выходного-каталога-фрагмент)
- [Что каталог даёт на практике](#что-каталог-даёт-на-практике)
...
<!-- summary -->
> Документ содержит описание рисков и ограничений. Изучите их перед принятием архитектурных решений. Кто ссылается на этот документ (11): Скрипт читает все 155 скриптов и строит живой каталог.
Смотрите также
 04-enrichment
 01-concept
 05-synthesis
