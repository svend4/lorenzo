...
<!-- summary -->
> Документ содержит описание рисков и ограничений. Изучите их перед принятием архитектурных решений. Примеры запросов (в Claude) Кто ссылается на этот документ (10)
