...
**Choose Type 1 (Professional Colleague Agent) when:**
...
**Choose Type 0 (Personal AI Assistant) when:**
...
**Choose Type 2 (Institutional Agent) when:**
...
**Choose Type 3 (Employee Agent) when:**
...
**Choose Type 4 (Representative Agent) when:**
...
- [Appendix A: The Six-Type Taxonomy (Updated)](docs/02-anthropic-vacancies/269-appendix-a-the-six-type-taxonomy-updated.md) _66%_
- [Appendix A: Comparative Table — Five Agent Types](docs/02-anthropic-vacancies/226-appendix-a-comparative-table-five-agent-types.md) _37%_
