...
<!-- summary -->
> [!NOTE]
> Документ создан на основе исследования. Ссылки ведут на связанные материалы. Проверить логи Claude Desktop: Проверить логи Claude Desktop: macOS: ~/Library/Logs/Claude/mcp*.log
> Документ создан на основе исследования. Ссылки ведут на связанные материалы.
