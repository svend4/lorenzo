...
<!-- summary -->
> Документ создан на основе исследования. Ссылки ведут на связанные материалы. Кто ссылается на этот документ (8) Биективное соответствие (см. Это единственный formal mapping в экосистеме, реализованный через
