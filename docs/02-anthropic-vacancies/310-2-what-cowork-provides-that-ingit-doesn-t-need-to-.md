...
- [2. What Cowork Provides That InGit Doesn't Need to Build](#2-what-cowork-provides-that-[ingit](306-with-anthropic-s-cowork-platform.md)-doesnt-need-to-build)
  ...
  - [2.8. What This Removes from InGit Roadmap](#28-what-this-removes-from-[ingit](306-with-anthropic-s-cowork-platform.md)-roadmap)
