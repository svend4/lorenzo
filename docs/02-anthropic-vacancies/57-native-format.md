...
<!-- summary -->
> [!NOTE]
> Документ создан на основе исследования. Ссылки ведут на связанные материалы. Варианты интерпретации (выберите/дополните): Вариант A — CA-rule first:*
> Документ создан на основе исследования. Ссылки ведут на связанные материалы.
...
- [Compatibility Level](51-compatibility-level.md) _42%_
- [Angle / Perspective](49-angle-perspective.md) _37%_
- [Bridges](60-bridges.md) _37%_
- [Native Format](47-native-format.md) _33%_
