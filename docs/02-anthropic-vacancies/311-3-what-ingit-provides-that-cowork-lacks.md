...
- [3. What InGit Provides That Cowork Lacks](#3-what-[ingit](306-with-anthropic-s-cowork-platform.md)-provides-that-cowork-lacks)
...
- Import from [GitHub](../01-svyazi/03-component-catalog.md) Issues + Wiki
