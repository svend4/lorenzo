...
- svend4 (2026). *Review Methodology v1.0*.
- svend4 (2026). *Double-Triangle Architecture v1.0*.
- svend4 (2026). *Open Knowledge Work Foundation Concept 
  Document v1.0*.
- svend4 (2026). *Representative Agent Layer v1.0*.
...
- [The Missing Middle Layer Between Chat and Code](274-the-missing-middle-layer-between-chat-and-code.md) _33%_
