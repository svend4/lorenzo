...
> **Абстракт** (авто)
>
> 🎯 **Проблема:** Мой takeaway: ключ в Протоколе 3 — Node'ы не ждут повелений сверху, assistant'ы sами poll meta-agent for needed context.
> 🔧 **Подход:** Я — в какой-то мере — писал все предыдущие артефакты этой сессии (PORTAL-PROTOCOL, REVIEWMETHODOLOGY, humanities extension) к этому моменту осознания .
> ✅ **Результат:** Протокол 2: Meta-Agent → Human (верхний треугольник) Meta-agent ставит задачи Node, Node возвращает результаты.
> 🏷️ **Ключевые слова:** `nautilus`, `agent`, `assistant`, `legal`, `pattern`, `давида`, `private`, `portal`
>
...
- [Обратная связь](#обратная-связь)
  ...
  - [9. Практический roadmap для humanities-extension Nautilus](#9-практический-roadmap-для-humanities-extension-[nautilus](../docs/05-habr-projects/memory/memnet.md))
  ...
  - [Формализация звезды Давида в терминах Nautilus](#формализация-звезды-давида-в-терминах-[nautilus](../docs/05-habr-projects/memory/memnet.md))
  - [Как Nautilus уже обслуживает эту архитектуру](#как-[nautilus](../docs/05-habr-projects/memory/memnet.md)-уже-обслуживает-эту-архитектуру)
...
```
[2026-04-19 14:30:00,123] INFO [nautilus](../docs/05-habr-projects/memory/memnet.md)-mcp: Warming up portal...
[2026-04-19 14:30:00,200] INFO [nautilus](../docs/05-habr-projects/memory/memnet.md)-mcp: Initializing NautilusPortal...
[2026-04-19 14:30:01,500] INFO [nautilus](../docs/05-habr-projects/memory/memnet.md)-mcp: Portal initialized: 7 adapters loaded
[2026-04-19 14:30:01,501] INFO [nautilus](../docs/05-habr-projects/memory/memnet.md)-mcp: Starting Nautilus MCP server on stdio
```
...
class LegalPortalEntry(PortalEntry):
    # Всё из [PortalEntry](../docs/02-anthropic-vacancies/01-интегральный-анализ-профиля-svend4.md) (id, title, source, format_type, content, links, is_fallback)
...
```
legal-[nautilus](../docs/05-habr-projects/memory/memnet.md)/                       ← отдельный приватный репо
├── legal-[nautilus](../docs/05-habr-projects/memory/memnet.md).json               ← приватный registry
├── legal-portal.py                   ← fork svend4/nautilus/portal.py
├── legal-portal-mcp.py               ← fork portal-mcp.py, с auth
├── adapters/
│   ├── base.py                       ← тот же [BaseAdapter](../docs/02-anthropic-vacancies/01-интегральный-анализ-профиля-svend4.md)
...
[PortalEntry](../docs/02-anthropic-vacancies/01-интегральный-анализ-профиля-svend4.md)(
    ...
    metadata={
        ...
        "public_pattern_refs": [
            "[nautilus](../docs/05-habr-projects/memory/memnet.md)-legal:pattern:eingliederungshilfe_denial",
            "[nautilus](../docs/05-habr-projects/memory/memnet.md)-legal:pattern:persoenliches_budget_refusal",
            "[nautilus](../docs/05-habr-projects/memory/memnet.md)-legal:norm:sgb_xii_90",
            "[nautilus](../docs/05-habr-projects/memory/memnet.md)-legal:precedent:anonymized_2024_similar_case"
        ]
    }
)
```
...
```
svend4/
├── [nautilus](../docs/05-habr-projects/memory/memnet.md)-legal/              ← PUBLIC repo
│   ├── README.md
│   ├── PORTAL-PROTOCOL-LEGAL.md ← extension spec
│   ├── legal-portal.py          ← fork of portal.py
│   ├── legal-[nautilus](../docs/05-habr-projects/memory/memnet.md).json      ← public registry
│   │
│   ├── adapters/
...
│
├── cases-private/               ← PRIVATE repo (не публикуется на [GitHub](../docs/01-svyazi/03-component-catalog.md) 
│   │                               вообще, либо [GitHub](../docs/01-svyazi/03-component-catalog.md) Enterprise 
...
│
└── [nautilus](../docs/05-habr-projects/memory/memnet.md)/                    ← PUBLIC (уже существует)
    ├── [текущее содержимое]
```
...
{
  "mcpServers": {
    "[nautilus](../docs/05-habr-projects/memory/memnet.md)-legal-public": {
      "command": "python3",
...
```json
{
  ...
  "inherits_from": [
    {
      "source": "public:[nautilus](../docs/05-habr-projects/memory/memnet.md)-legal",
      "patterns": [
...
- [Приложение C: Образцы Случаев Использования в Деталях](207-приложение-c-образцы-случаев-использования-в-детал.md)
## Упоминается в
