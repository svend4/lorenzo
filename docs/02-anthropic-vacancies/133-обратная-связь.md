...
<!-- summary -->
> Issues: [github.com/svend4/nautilus/issues](https://github.com/svend4/nautilus/issues) 🎯 Проблема: Мой takeaway: ключ в Протоколе 3 — Node'ы не ждут повелений сверху, assistant'ы sами poll meta-agent for needed context.
...
```
[2026-04-19 14:30:00,123] INFO [nautilus](../05-habr-projects/memory/memnet.md)-mcp: Warming up portal...
[2026-04-19 14:30:00,200] INFO [nautilus](../05-habr-projects/memory/memnet.md)-mcp: Initializing NautilusPortal...
[2026-04-19 14:30:01,500] INFO [nautilus](../05-habr-projects/memory/memnet.md)-mcp: Portal initialized: 7 adapters loaded
[2026-04-19 14:30:01,501] INFO [nautilus](../05-habr-projects/memory/memnet.md)-mcp: Starting Nautilus MCP server on stdio
```
...
class LegalPortalEntry(PortalEntry):
    # Всё из [PortalEntry](01-интегральный-анализ-профиля-svend4.md) (id, title, source, format_type, content, links, is_fallback)
...
```
legal-[nautilus](../05-habr-projects/memory/memnet.md)/                       ← отдельный приватный репо
├── legal-[nautilus](../05-habr-projects/memory/memnet.md).json               ← приватный registry
├── legal-portal.py                   ← fork svend4/nautilus/portal.py
├── legal-portal-mcp.py               ← fork portal-mcp.py, с auth
├── adapters/
│   ├── base.py                       ← тот же [BaseAdapter](01-интегральный-анализ-профиля-svend4.md)
...
[PortalEntry](01-интегральный-анализ-профиля-svend4.md)(
    ...
    metadata={
        ...
        "public_pattern_refs": [
            "[nautilus](../05-habr-projects/memory/memnet.md)-legal:pattern:eingliederungshilfe_denial",
            "[nautilus](../05-habr-projects/memory/memnet.md)-legal:pattern:persoenliches_budget_refusal",
            "[nautilus](../05-habr-projects/memory/memnet.md)-legal:norm:sgb_xii_90",
            "[nautilus](../05-habr-projects/memory/memnet.md)-legal:precedent:anonymized_2024_similar_case"
        ]
    }
)
```
...
```
svend4/
├── [nautilus](../05-habr-projects/memory/memnet.md)-legal/              ← PUBLIC repo
│   ├── README.md
│   ├── PORTAL-PROTOCOL-LEGAL.md ← extension spec
│   ├── legal-portal.py          ← fork of portal.py
│   ├── legal-[nautilus](../05-habr-projects/memory/memnet.md).json      ← public registry
│   │
│   ├── adapters/
...
│
├── cases-private/               ← PRIVATE repo (не публикуется на [GitHub](../01-svyazi/03-component-catalog.md) 
│   │                               вообще, либо [GitHub](../01-svyazi/03-component-catalog.md) Enterprise 
...
│
└── [nautilus](../05-habr-projects/memory/memnet.md)/                    ← PUBLIC (уже существует)
    ├── [текущее содержимое]
```
...
{
  "mcpServers": {
    "[nautilus](../05-habr-projects/memory/memnet.md)-legal-public": {
      "command": "python3",
...
```json
{
  ...
  "inherits_from": [
    {
      "source": "public:[nautilus](../05-habr-projects/memory/memnet.md)-legal",
      "patterns": [
