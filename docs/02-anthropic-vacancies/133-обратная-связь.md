...
- [Обратная связь](#обратная-связь)
  ...
  - [9. Практический roadmap для humanities-extension Nautilus](#9-практический-roadmap-для-humanities-extension-[nautilus](../05-habr-projects/memory/memnet.md))
  ...
  - [Формализация звезды Давида в терминах Nautilus](#формализация-звезды-давида-в-терминах-[nautilus](../05-habr-projects/memory/memnet.md))
  - [Как Nautilus уже обслуживает эту архитектуру](#как-[nautilus](../05-habr-projects/memory/memnet.md)-уже-обслуживает-эту-архитектуру)
