...
- [6. Refined InGit Scope with Cowork in Mind](#6-refined-[ingit](306-with-anthropic-s-cowork-platform.md)-scope-with-cowork-in-mind)
...
**Deliverables**:
- `[ingit](306-with-anthropic-s-cowork-platform.md)-mcp-server` Python package
...
**Deliverables**:
- Migration tools (Notion, Obsidian, [GitHub](../01-svyazi/03-component-catalog.md))
