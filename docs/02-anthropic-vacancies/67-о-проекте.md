...
1. Положите `[nautilus](../05-habr-projects/memory/memnet.md).json` в корень вашего репо:
...
3. Добавьте адаптер в `adapters/my_repo.py`, реализующий 
   `[BaseAdapter](01-интегральный-анализ-профиля-svend4.md)` интерфейс (см. [PORTAL-PROTOCOL.md §6](03-portal-protocol-md.md#6-adapter-interface))

4. Зарегистрируйте репо в `[nautilus](../05-habr-projects/memory/memnet.md).json` корневого портала
...
Детали — в [PORTAL-PROTOCOL.md §5](03-portal-protocol-md.md#5-compatibility-levels).

### Документация

- **[PORTAL-PROTOCOL.md](03-portal-protocol-md.md)** — formal 
