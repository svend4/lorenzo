...
- **tests** ![tests](https://img.shields.io/badge/tests-108--passing-brightgreen)
- **templates** ![templates](https://img.shields.io/badge/templates-23-blue)
- **skills** ![skills](https://img.shields.io/badge/skills-28-blue)
- **mcp-servers** ![mcp_servers](https://img.shields.io/badge/mcp--servers-10-blue)
- **manifests** ![manifests](https://img.shields.io/badge/manifests-13-blue)
- **scripts** ![scripts](https://img.shields.io/badge/scripts-153-blue)
- **health** ![health](https://img.shields.io/badge/health-77/100-green)
