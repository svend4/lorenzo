...
<!-- summary -->
> [!WARNING]
> Документ описывает ограничения, риски или требования безопасности. Читайте внимательно. Этот документ описывает MVP-подход. Начните с него для быстрого прототипа.
...
**Проекты:** Svyazi, mclaude, AI Factory, Rufler[^rufler], NGT[^ngt] Memory, [AutoResearch](01-executive-summary.md), Whisper, Yttri
