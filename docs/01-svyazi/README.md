...
<!-- summary -->
> Раздел архитектуры Svyazi 2.0: компоненты, ансамбли, контракты и дорожная карта локальной платформы коллективного интеллекта. Раздел содержит несколько документов.
