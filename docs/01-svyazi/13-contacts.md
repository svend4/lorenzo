...
**Проекты:** Svyazi, CardIndex[^cardindex], AgentFS[^agentfs], [knowledge-space](03-component-catalog.md)[^knowledge-space], mclaude, AI Factory, Yodoca[^yodoca], NGT[^ngt] Memory
...
## Похожие документы
- [13-контактная-стратегия-и-узкие-вопросы-для-авторов](../04-ai-collaborations/13-контактная-стратегия-и-узкие-вопросы-для-авторов.md) (сходство 1.00)
- [CONTACTS](../CONTACTS.md) (сходство 0.14)
