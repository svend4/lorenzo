...
<!-- summary -->
> Утверждений: **88293** | Противоречий: **9146**
**Проекты:** Svyazi, CardIndex, AgentFS, knowledge-space, Rufler, LiteParse, NGT Memory, MemNet
...
### 2. 🔢 Числовое — 1027724.0 vs 3.0 (уверенность: 0.8)
...
> md com/ru/articles/1027724/ в конце статьи было написано как с помощью этой программы и ИИ нашлись два человека которые вм… B: docs/ai-collaborations/
...
**B:** `docs/DUPLICATES.md`
> md Фаза 2 — Расширение Областей (Годы 3-4) Деятельность: - Добавить области 2 (профессионалы на пенсии) и 8 (студен… B: docs/habr-unique-projects/extr
...
### 11. 🔢 Числовое — 44.0 vs 785.0 (уверенность: 0.8)
...
### 12. 🔢 Числовое — 44.0 vs 3.0 (уверенность: 0.8)
...
### 14. 🔢 Числовое — 4.0 vs 100.0 (уверенность: 0.8)
...
### 15. 🔢 Числовое — 30.0 vs 96.0 (уверенность: 0.8)
...
### 16. 🔢 Числовое — 30.0 vs 74.0 (уверенность: 0.8)
...
### 17. 🔢 Числовое — 10.0 vs 84.0 (уверенность: 0.8)
...
### 19. 🔢 Числовое — 84.0 vs 11.0 (уверенность: 0.8)
...
### 20. 🔢 Числовое — 84.0 vs 785.0 (уверенность: 0.8)
...
### 21. 🔢 Числовое — 11.0 vs 84.0 (уверенность: 0.8)
...
### 22. 🔢 Числовое — 4.0 vs 86.0 (уверенность: 0.8)
...
**B:** `docs/DUPLICATES.md`
> md YAML reviewstate: proposalid: "match20260429001" state: "pendingreview" requiredroles: - "evidencereviewer" - "privacyreviewer… --- 86% — docs/TAGS
...
### 24. 🔢 Числовое — 31.0 vs 3.0 (уверенность: 0.8)
...
### 25. 🔢 Числовое — 5.0 vs 36.0 (уверенность: 0.8)
...
### 26. 🔢 Числовое — 80.0 vs 8.0 (уверенность: 0.8)
...
### 27. 🔢 Числовое — 785.0 vs 26.0 (уверенность: 0.8)
...
### 29. 🔢 Числовое — 2026.0 vs 4.0 (уверенность: 0.8)
...
### 30. 🔢 Числовое — 4.0 vs 11.0 (уверенность: 0.8)
