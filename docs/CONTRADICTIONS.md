...
Утверждений: **81471** | Противоречий: **9640**
...
> md Контекст Автор этой статьи непосредственно вовлечён в немецкое социальное право через текущие разбирательства в … --- 100% — docs/svyazi-2-0/compon
...
**B:** `docs/DUPLICATES.md`
> md Фаза 2 — Расширение Областей (Годы 3-4) Деятельность: - Добавить области 2 (профессионалы на пенсии) и 8 (студен… B: docs/01-svyazi/11-integration-
...
### 10. 🔢 Числовое — 70.0 vs 4.0 (уверенность: 0.8)
...
### 13. 🔢 Числовое — 44.0 vs 239.0 (уверенность: 0.8)
...
### 14. 🔢 Числовое — 3.0 vs 13.0 (уверенность: 0.8)
...
### 15. 🔢 Числовое — 3.0 vs 239.0 (уверенность: 0.8)
...
### 16. 🔢 Числовое — 4.0 vs 100.0 (уверенность: 0.8)
...
### 17. 🔢 Числовое — 30.0 vs 96.0 (уверенность: 0.8)
...
### 18. 🔢 Числовое — 30.0 vs 74.0 (уверенность: 0.8)
