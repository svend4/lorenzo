...
- **11-integration-contracts** → `11-интеграционный-контракт-который-стоит-зафиксироват`, `integration-spec`, `09-architectural-gaps`, `09-архитектурные-зазоры-которые-важнее-новых-инструме`
...
- **QA** → `CONTACTS`, `CROSS_SECTION`, `CONTACT_PRIORITY`, `first-contacts`
...
- **02-общий-план-развития-nautilus-portal-protocol** → `34-appendix-b-change-log`, `67-о-проекте`, `TIMELINE`, `122-глоссарий`
...
- **04-abstract** → `74-abstract`, `125-readme-mcp-md-инструкция-по-установке`, `00-abstract-status`, `65-readme-md`
...
- **07-2-terminology** → `77-2-terminology`, `02-terminology`, `82-7-portalentry-structure`, `80-5-compatibility-levels`
...
- **09-4-passport-passport-md** → `22-10-queryresult-structure`, `41-compatibility-level`, `127-подключение-к-claude-desktop`, `65-readme-md`
...
- **103-appendix-b-change-log** → `22-10-queryresult-structure`, `91-16-mcp-extension-informative`, `41-compatibility-level`, `128-доступные-инструменты`
- **104-appendix-c-references** → `22-glossary`, `122-глоссарий`, `34-appendix-b-change-log`, `64-for-the-curious-philosophy`
- **105-review-methodology-md** → `125-readme-mcp-md-инструкция-по-установке`, `70-зачем-две-версии-параллельно`, `229-профессиональные-коллеги-агенты`, `65-readme-md`
- **106-tl-dr** → `00-tldr`, `70-зачем-две-версии-параллельно`, `71-критерии-выбора-для-фазы-3`, `65-readme-md`
