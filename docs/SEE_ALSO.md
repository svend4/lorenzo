...
- **13-contacts** → `13-контактная-стратегия-и-узкие-вопросы-для-авторов`, `07-mvp-planning`, `05-план-прототипа-и-возможные-контакты`, `09-architectural-gaps`
...
- **02-общий-план-развития-nautilus-portal-protocol** → `34-appendix-b-change-log`, `TIMELINE`, `122-глоссарий`, `133-обратная-связь`
...
- **102-доступ-к-данным** → `339-приложение-a-дерево-решений-для-принимающих-ingit`, `118-appendix-a-шаблон-для-header-warning`, `121-appendix-c-история-изменений-методологии`, `348-кому-ты-служишь-слоистая-модель`
