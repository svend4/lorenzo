...
- **04-abstract** → `74-abstract`, `00-abstract-status`, `98-appendix-a-minimal-working-example`, `28-appendix-a-minimal-working-example`
...
- **07-2-terminology** → `77-2-terminology`, `02-terminology`, `08-3-registry-nautilus-json`, `67-о-проекте`
