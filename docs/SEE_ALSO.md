...
- **02-общий-план-развития-nautilus-portal-protocol** → `TIMELINE`, `34-appendix-b-change-log`, `133-обратная-связь`, `122-глоссарий`
...
- **04-abstract** → `74-abstract`, `98-appendix-a-minimal-working-example`, `28-appendix-a-minimal-working-example`, `105-review-methodology-md`
...
- **08-3-registry-nautilus-json** → `78-3-registry-nautilus-json`, `19-7-portalentry-structure`, `82-7-portalentry-structure`, `07-2-terminology`
...
- **103-appendix-b-change-log** → `22-10-queryresult-structure`, `91-16-mcp-extension-informative`, `28-appendix-a-minimal-working-example`, `89-14-sdk-contract-informative`
...
- **106-tl-dr** → `70-зачем-две-версии-параллельно`, `108-2-формальный-workflow`, `71-критерии-выбора-для-фазы-3`, `28-appendix-a-minimal-working-example`
- **107-1-контекст-и-мотивация** → `115-8-ограничения-и-открытые-вопросы`, `108-2-формальный-workflow`, `116-9-checklist-применения-методологии`, `106-tl-dr`
