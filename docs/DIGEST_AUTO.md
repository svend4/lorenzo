...
> [!NOTE]
> Документ `DIGEST_AUTO` создаётся автоматически.

<!-- alert-added -->
<!-- tags: digest-auto, docs, analysis -->


<!-- summary -->
> Автоматически сформированный документ: `DIGEST_AUTO`.
...
| Слов добавлено | **+1,710,945** |
| Слов удалено | **−915,763** |
...
- [`04-ensembles-overview.md`](01-svyazi/04-ensembles-overview.md)
...
|-------|-----------|---------|
| `anthropic` | +43314 | −30513 |
| `vacancies` | +33176 | −24242 |
| `nautilus` | +23060 | −7611 |
| `obsidian` | +18405 | −7779 |
| `документ` | +15044 | −1907 |
| `agent` | +14708 | −6799 |
