...
> > - - - - -  Как реализован forensic RAG с доказуемостью? Инвертированный индекс ключевых слов(docs/K
...
> > Файлов: 883  Средний пассив: 1.7% (🟢 Активный стиль)
...
> > Файлов: 1118  Токенов: 768,358  Уникальных: 287,660
...
**Итого в секции: 285,404 слов, 91 файлов**
