...
> Автоматически извлечено из всех документов: 395 записей
...
> > - - - - - - - - -  Как реализован forensic RAG с доказуемостью? Карта базы знаний Lorenzo(docs/KNOW
...
> Разделов: 18  Файлов: 1191  Слов: 944,409  Символов: 8,448,352
...
> > Файлов: 1115  Токенов: 766,897  Уникальных: 287,089
...
**Итого в секции: 283,189 слов, 92 файлов**
