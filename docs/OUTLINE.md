...
> Добавлено 48 callout-блоков в документы.
...
> Автоматически извлечено из всех документов: 393 записей
...
> > - - - -  Как реализован forensic RAG с доказуемостью? Карта базы знаний Lorenzo(docs/KNOWLEDGEMAP.
...
> Файлов: 1173  Средний балл: 71.3/100
...
> Найдено: 1 файлов без входящих ссылок из 1049 проверено.
...
> > Файлов: 880  Средний пассив: 1.7% (🟢 Активный стиль)
...
### [REGISTRY — реестр артефактов Lorenzo](docs/REGISTRY.md)
> > !TIP
...
### [Каталог скриптов](docs/SCRIPTS_CATALOG.md)
> > !TIP
...
> > Файлов: 1117  Токенов: 768,175  Уникальных: 286,716
...
**Итого в секции: 280,620 слов, 91 файлов**
...
> > location: "ZoomTelegramDiscordin-person"
...
> > pairtype: "hardwaresoftwaredeephybrid"
...
**Итого в секции: 5,145 слов, 24 файлов**
