...
| `00-question-mountain-to-person.md` | 79% | 21% |
...
| `01-concept.md` | 78% | 22% |
| `10-strategicheskoe-pozitsionirovanie.md` | 78% | 22% |
| `245-ссылки.md` | 77% | 23% |
| `README.md` | 77% | 23% |
...
| `15-self-consolidating-legal-corpus.md` | 26% | 74% |
...
| `7-metaphor.md` | 69% | 31% |
| `README.md` | 31% | 69% |
| `14-local-first-agent-development-environment.md` | 31% | 69% |
| `339-приложение-a-дерево-решений-для-принимающих-ingit.md` | 69% | 31% |
...
| `05-q5-authority-limits.md` | 32% | 68% |
...
| `10-legal-document-intelligence-pipeline.md` | 34% | 66% |
| `06-angel-vs-demon-duality.md` | 66% | 34% |
...
| `13-legal-document-transpiler.md` | 35% | 65% |
| `53-history.md` | 35% | 65% |
| `01-shell-metaphor-two-projections.md` | 65% | 35% |
| `2-autoresearch-legal.md` | 65% | 35% |
| `04-recommendations.md` | 34% | 65% |
| `11-glossary.md` | 35% | 65% |
| `362-когда-сомневаешься-escalate-к-max.md` | 64% | 36% |
| `SCRIPT_EVAL_REPORT.md` | 64% | 36% |
| `anastasiyaw.md` | 64% | 36% |
...
| `13-appendix-b-examples.md` | 64% | 36% |
...
| `12-multi-agent-observability-stack.md` | 37% | 63% |
| `15-19-extended.md` | 37% | 63% |
| `36-essence.md` | 63% | 37% |
| `01-shared-memory-between-agents.md` | 63% | 37% |
...
| `02-related-projects-context.md` | 62% | 38% |
| `source-projects.md` | 38% | 62% |
| `03-pda-llm-as-periphery.md` | 62% | 38% |
| `contradiction-record.md` | 62% | 38% |
| `350-твои-языки-и-культурные-nuances.md` | 62% | 38% |
| `autoresearch-sequential.md` | 62% | 38% |
| `legal-rag.md` | 62% | 38% |
| `03-dsl-ast.md` | 38% | 62% |
| `protocol-spec.md` | 38% | 62% |
...
| `yodoca.md` | 59% | 41% |
| `01-pravilnaya-agentskaya-arkhitektura-svyazi-pattern.md` | 59% | 41% |
| `39-angle-perspective.md` | 41% | 59% |
| `INDEX.md` | 41% | 59% |
| `04-grant-opportunities.md` | 41% | 59% |
| `03-section-3-solution-architecture.md` | 42% | 58% |
| `6-tmux-village-openclaw.md` | 58% | 42% |
| `research-docs-liteparse.md` | 58% | 42% |
| `security-routing-plane.md` | 42% | 58% |
| `127-подключение-к-claude-desktop.md` | 42% | 58% |
| `83-8-q6-space-normative.md` | 42% | 58% |
| `85-10-query-flow.md` | 42% | 58% |
| `02-section-2-beneficial-dimension.md` | 42% | 58% |
...
| `08-personal-multi-agent-hub.md` | 43% | 57% |
| `07-chto-mozhesh.md` | 57% | 43% |
| `03-what-this-gives-technically.md` | 57% | 42% |
...
| `05-analysis.md` | 57% | 43% |
| `09-automation.md` | 57% | 43% |
...
| `12-onboarding-paths.md` | 43% | 57% |
| `21-adr-003-five-onboarding-paths.md` | 43% | 57% |
| `02-extraction.md` | 57% | 43% |
...
| `README.md` | 55% | 45% |
| `default-policy.md` | 55% | 45% |
| `87-12-onboarding-paths-normative.md` | 45% | 55% |
| `KPI.md` | 55% | 45% |
| `2-distributed-agent-workshop.md` | 55% | 45% |
| `02-sales.md` | 55% | 45% |
...
| `19-persistent-character.md` | 55% | 45% |
...
| `C-multi-agent-factory.md` | 46% | 54% |
| `FAQ.md` | 54% | 46% |
...
| `02-level-1-minimal-zero.md` | 54% | 46% |
| `13-reference-implementation.md` | 54% | 46% |
| `01-passive-vs-active-roles.md` | 47% | 53% |
| `README.md` | 53% | 47% |
...
| `01-similarity-1-composite-skills.md` | 51% | 49% |
| `anastasiyaw.md` | 49% | 51% |
| `10-query-result.md` | 51% | 49% |
...
| `executive-summary.md` | 50% | 50% |
| `07-2-terminology.md` | 50% | 50% |
| `EMPTY_SECTIONS.md` | 49% | 50% |
...
|--------|----|----|-----|
| `01-svyazi` | 0 | 0 | 16 |
| `02-anthropic-vacancies` | 51 | 122 | 184 |
