...
- [По файлам](#по-файлам)
  - [`docs/EMPTY_SECTIONS.md` (448 проблем)](#docsempty_sectionsmd-448-проблем)
  - [`docs/QA.md` (179 проблем)](#docsqamd-179-проблем)
  - [`docs/CODE_BLOCKS.md` (127 проблем)](#docscode_blocksmd-127-проблем)
  - [`docs/SPELLCHECK.md` (52 проблем)](#docsspellcheckmd-52-проблем)
  ...
  - [`docs/lorenzo-agent/QA.md` (16 проблем)](#docslorenzo-agentqamd-16-проблем)
  ...
  - [`docs/GITHUB_ISSUES.md` (13 проблем)](#docsgithub_issuesmd-13-проблем)
  ...
  - [`docs/READING_LIST.md` (12 проблем)](#docsreading_listmd-12-проблем)
  - [`docs/letters/QA.md` (12 проблем)](#docslettersqamd-12-проблем)
  ...
  - [`docs/templates/legal-case.md` (8 проблем)](#docstemplateslegal-casemd-8-проблем)
  ...
  - [`docs/03-technology-combinations/QA.md` (7 проблем)](#docs03-technology-combinationsqamd-7-проблем)
  - [`docs/CONSISTENCY.md` (7 проблем)](#docsconsistencymd-7-проблем)
  ...
  - [`docs/templates/meeting-notes.md` (7 проблем)](#docstemplatesmeeting-notesmd-7-проблем)
  - [`docs/templates/weekly-digest.md` (7 проблем)](#docstemplatesweekly-digestmd-7-проблем)
  ...
  - [`docs/02-anthropic-vacancies/211-table-of-contents.md` (6 проблем)](#docs02-anthropic-vacancies211-table-of-contentsmd-6-проблем)
  ...
  - [`docs/02-anthropic-vacancies/308-table-of-contents.md` (6 проблем)](#docs02-anthropic-vacancies308-table-of-contentsmd-6-проблем)
  ...
  - [`docs/templates/faq-entry.md` (6 проблем)](#docstemplatesfaq-entrymd-6-проблем)
  - [`docs/templates/glossary-entry.md` (6 проблем)](#docstemplatesglossary-entrymd-6-проблем)
  - [`docs/templates/prototype-mvp.md` (6 проблем)](#docstemplatesprototype-mvpmd-6-проблем)
  - [`docs/templates/risk-entry.md` (6 проблем)](#docstemplatesrisk-entrymd-6-проблем)
  - [`docs/templates/tech-radar-entry.md` (6 проблем)](#docstemplatestech-radar-entrymd-6-проблем)
  ...
  - [`docs/02-anthropic-vacancies/190-содержание.md` (5 проблем)](#docs02-anthropic-vacancies190-содержаниеmd-5-проблем)
  ...
  - [`docs/02-anthropic-vacancies/326-содержание.md` (5 проблем)](#docs02-anthropic-vacancies326-содержаниеmd-5-проблем)
  ...
  - [`docs/02-anthropic-vacancies/191-1-синдром-золушки-почему-качество-остаётся-невидим.md` (4 проблем)](#docs02-anthropic-vacancies191-1-синдром-золушки-почему-качество-остаётся-невидимmd-4-проблем)
  ...
  - [`docs/LANGUAGE_STATS.md` (4 проблем)](#docslanguage_statsmd-4-проблем)
  ...
  - [`docs/autofilled/components/lorenzo.md` (4 проблем)](#docsautofilledcomponentslorenzomd-4-проблем)
  - [`docs/autofilled/components/nautilus.md` (4 проблем)](#docsautofilledcomponentsnautilusmd-4-проблем)
  - [`docs/autofilled/components/sgb.md` (4 проблем)](#docsautofilledcomponentssgbmd-4-проблем)
  - [`docs/autofilled/components/spbmolot.md` (4 проблем)](#docsautofilledcomponentsspbmolotmd-4-проблем)
  - [`docs/autofilled/components/svend4.md` (4 проблем)](#docsautofilledcomponentssvend4md-4-проблем)
  - [`docs/autofilled/components/svyazi.md` (4 проблем)](#docsautofilledcomponentssvyazimd-4-проблем)
  - [`docs/contacts/vitalysemenov.md` (4 проблем)](#docscontactsvitalysemenovmd-4-проблем)
  ...
  - [`docs/meta-scripting/QA.md` (4 проблем)](#docsmeta-scriptingqamd-4-проблем)
  ...
  - [`docs/technology-combinations/combinations/25-legal-dsl-code-transpiler.md` (4 проблем)](#docstechnology-combinationscombinations25-legal-dsl-code-transpilermd-4-проблем)
  ...
  - [`docs/SIMILAR_PASSAGES.md` (3 проблем)](#docssimilar_passagesmd-3-проблем)
  ...
  - [`docs/lorenzo-agent/00-intro.md` (3 проблем)](#docslorenzo-agent00-intromd-3-проблем)
  ...
  - [`docs/nautilus/npp-v1-1/19-adr-001-federation-over-merging.md` (3 проблем)](#docsnautilusnpp-v1-119-adr-001-federation-over-mergingmd-3-проблем)
  ...
  - [`docs/technology-combinations/combinations/21-legal-corpus-analytics-at-scale.md` (3 проблем)](#docstechnology-combinationscombinations21-legal-corpus-analytics-at-scalemd-3-проблем)
  ...
  - [`docs/ai-collaborations/continuation/02-agentops-trace-envelope.md` (2 проблем)](#docsai-collaborationscontinuation02-agentops-trace-envelopemd-2-проблем)
  ...
  - [`docs/ai-collaborations/ensembles/3-forensic-rag.md` (2 проблем)](#docsai-collaborationsensembles3-forensic-ragmd-2-проблем)
  ...
  - [`docs/anthropic-vacancies/profile-mapping/01-initial-analysis/02-primary-fde.md` (2 проблем)](#docsanthropic-vacanciesprofile-mapping01-initial-analysis02-primary-fdemd-2-проблем)
  ...
  - [`docs/anthropic-vacancies/signals.md` (2 проблем)](#docsanthropic-vacanciessignalsmd-2-проблем)
  - [`docs/autofilled/README.md` (2 проблем)](#docsautofilledreadmemd-2-проблем)
  - [`docs/contacts/QA.md` (2 проблем)](#docscontactsqamd-2-проблем)
  ...
  - [`docs/glossary/concepts.md` (2 проблем)](#docsglossaryconceptsmd-2-проблем)
  - [`docs/habr-unique-projects/analogues/01-three-direct-analogues.md` (2 проблем)](#docshabr-unique-projectsanalogues01-three-direct-analoguesmd-2-проблем)
  - [`docs/habr-unique-projects/analogues/02-related-projects.md` (2 проблем)](#docshabr-unique-projectsanalogues02-related-projectsmd-2-проблем)
  ...
  - [`docs/habr-unique-projects/deep-pairs/3-adversarial-multi-ide.md` (2 проблем)](#docshabr-unique-projectsdeep-pairs3-adversarial-multi-idemd-2-проблем)
  - [`docs/habr-unique-projects/deep-pairs/4-skill-catalogs-subagents.md` (2 проблем)](#docshabr-unique-projectsdeep-pairs4-skill-catalogs-subagentsmd-2-проблем)
  ...
  - [`docs/habr-unique-projects/deep-pairs/8-self-aware-mcp-specs.md` (2 проблем)](#docshabr-unique-projectsdeep-pairs8-self-aware-mcp-specsmd-2-проблем)
  ...
  - [`docs/habr-unique-projects/final-ensembles/4-summary-authors.md` (2 проблем)](#docshabr-unique-projectsfinal-ensembles4-summary-authorsmd-2-проблем)
  - [`docs/habr-unique-projects/hardware-pairs/1-neuromorphic-ssm.md` (2 проблем)](#docshabr-unique-projectshardware-pairs1-neuromorphic-ssmmd-2-проблем)
  - [`docs/habr-unique-projects/hardware-pairs/2-tsu-mome.md` (2 проблем)](#docshabr-unique-projectshardware-pairs2-tsu-momemd-2-проблем)
  - [`docs/habr-unique-projects/hardware-pairs/3-zinc-hybrid-arch.md` (2 проблем)](#docshabr-unique-projectshardware-pairs3-zinc-hybrid-archmd-2-проблем)
  - [`docs/habr-unique-projects/hardware-pairs/4-riscv-privacy.md` (2 проблем)](#docshabr-unique-projectshardware-pairs4-riscv-privacymd-2-проблем)
  - [`docs/habr-unique-projects/hardware-pairs/5-tinyml-mcp-skills.md` (2 проблем)](#docshabr-unique-projectshardware-pairs5-tinyml-mcp-skillsmd-2-проблем)
  ...
  - [`docs/habr-unique-projects/key-findings/01-yodoca.md` (2 проблем)](#docshabr-unique-projectskey-findings01-yodocamd-2-проблем)
  - [`docs/habr-unique-projects/key-findings/02-memnet.md` (2 проблем)](#docshabr-unique-projectskey-findings02-memnetmd-2-проблем)
  - [`docs/habr-unique-projects/key-findings/03-pda-llm-as-periphery.md` (2 проблем)](#docshabr-unique-projectskey-findings03-pda-llm-as-peripherymd-2-проблем)
  - [`docs/habr-unique-projects/key-findings/04-dochkina-sequential.md` (2 проблем)](#docshabr-unique-projectskey-findings04-dochkina-sequentialmd-2-проблем)
  - [`docs/habr-unique-projects/key-findings/05-supplementary-infrastructure.md` (2 проблем)](#docshabr-unique-projectskey-findings05-supplementary-infrastructuremd-2-проблем)
  ...
  - [`docs/svyazi-2-0/architecture/integration-spec.md` (2 проблем)](#docssvyazi-2-0architectureintegration-specmd-2-проблем)
  ...
  - [`docs/svyazi-2-0/ensembles/G-federated-local-graph.md` (2 проблем)](#docssvyazi-2-0ensemblesg-federated-local-graphmd-2-проблем)
  ...
  - [`docs/svyazi-2-0/overview/projects-map.md` (2 проблем)](#docssvyazi-2-0overviewprojects-mapmd-2-проблем)
  ...
  - [`docs/svyazi-2-0/security/default-policy.md` (2 проблем)](#docssvyazi-2-0securitydefault-policymd-2-проблем)
  - [`docs/svyazi-2-0/security/privacy.md` (2 проблем)](#docssvyazi-2-0securityprivacymd-2-проблем)
  - [`docs/technology-combinations/combinations/01-pravilnaya-agentskaya-arkhitektura-svyazi-pattern.md` (2 проблем)](#docstechnology-combinationscombinations01-pravilnaya-agentskaya-arkhitektura-svyazi-patternmd-2-проблем)
  ...
  - [`docs/technology-combinations/combinations/08-conductor-adversarial-review-auto-ai-router.md` (2 проблем)](#docstechnology-combinationscombinations08-conductor-adversarial-review-auto-ai-routermd-2-проблем)
  ...
  - [`docs/technology-combinations/combinations/14-local-first-agent-development-environment.md` (2 проблем)](#docstechnology-combinationscombinations14-local-first-agent-development-environmentmd-2-проблем)
  ...
  - [`docs/technology-combinations/combinations/20-hybrid-olap-oltp-with-real-time-sync.md` (2 проблем)](#docstechnology-combinationscombinations20-hybrid-olap-oltp-with-real-time-syncmd-2-проблем)
  ...
  - [`docs/technology-combinations/combinations/31-event-sourced-legal-document-history.md` (2 проблем)](#docstechnology-combinationscombinations31-event-sourced-legal-document-historymd-2-проблем)
  ...
  - [`docs/technology-combinations/synthesis-tables/01-08-summary.md` (2 проблем)](#docstechnology-combinationssynthesis-tables01-08-summarymd-2-проблем)
  ...
  - [`docs/anthropic-vacancies/QA.md` (1 проблем)](#docsanthropic-vacanciesqamd-1-проблем)
  ...
  - [`docs/letters/README.md` (1 проблем)](#docslettersreadmemd-1-проблем)
  ...
  - [`docs/technology-combinations/mega-stacks/04-event-sourcing-consensus.md` (1 проблем)](#docstechnology-combinationsmega-stacks04-event-sourcing-consensusmd-1-проблем)
...
### `docs/templates/legal-case.md` (8 проблем)
...
### `docs/templates/meeting-notes.md` (7 проблем)

_секция: 7_


### `docs/templates/weekly-digest.md` (7 проблем)
...
### `docs/02-anthropic-vacancies/211-table-of-contents.md` (6 проблем)
...
### `docs/02-anthropic-vacancies/308-table-of-contents.md` (6 проблем)
...
### `docs/templates/faq-entry.md` (6 проблем)

_секция: 6_


### `docs/templates/glossary-entry.md` (6 проблем)

_секция: 6_


### `docs/templates/prototype-mvp.md` (6 проблем)

_секция: 6_


### `docs/templates/risk-entry.md` (6 проблем)

_секция: 6_


### `docs/templates/tech-radar-entry.md` (6 проблем)
...
### `docs/02-anthropic-vacancies/190-содержание.md` (5 проблем)
...
### `docs/02-anthropic-vacancies/326-содержание.md` (5 проблем)
...
### `docs/templates/retrospective.md` (5 проблем)
...
### `docs/02-anthropic-vacancies/191-1-синдром-золушки-почему-качество-остаётся-невидим.md` (4 проблем)
...
### `docs/autofilled/components/.md` (4 проблем)

_секция: 3, заголовок: 1_


### `docs/autofilled/components/cowork.md` (4 проблем)

_секция: 3, заголовок: 1_


### `docs/autofilled/components/ingit.md` (4 проблем)
...
### `docs/autofilled/components/lorenzo.md` (4 проблем)

_секция: 3, заголовок: 1_


### `docs/autofilled/components/nautilus.md` (4 проблем)

_секция: 3, заголовок: 1_


### `docs/autofilled/components/sgb.md` (4 проблем)
...
### `docs/autofilled/components/svend4.md` (4 проблем)

_секция: 3, заголовок: 1_


### `docs/autofilled/components/svyazi.md` (4 проблем)

_секция: 3, заголовок: 1_


### `docs/contacts/vitalysemenov.md` (4 проблем)
...
### `docs/technology-combinations/combinations/25-legal-dsl-code-transpiler.md` (4 проблем)
...
### `docs/INDEX.md` (3 проблем)

_секция: 3_


### `docs/LLM_SUMMARIES.md` (3 проблем)
...
### `docs/SIMILAR_PASSAGES.md` (3 проблем)
...
### `docs/lorenzo-agent/00-intro.md` (3 проблем)
...
### `docs/nautilus/npp-v1-1/19-adr-001-federation-over-merging.md` (3 проблем)
...
### `docs/technology-combinations/combinations/21-legal-corpus-analytics-at-scale.md` (3 проблем)
...
### `docs/templates/project-component.md` (3 проблем)
...
### `docs/ai-collaborations/candidates/01-three-key-candidates.md` (2 проблем)
...
### `docs/ai-collaborations/continuation/02-agentops-trace-envelope.md` (2 проблем)
...
### `docs/ai-collaborations/ensembles/3-forensic-rag.md` (2 проблем)
...
### `docs/anthropic-vacancies/profile-mapping/01-initial-analysis/02-primary-fde.md` (2 проблем)
...
### `docs/anthropic-vacancies/signals.md` (2 проблем)
...
### `docs/glossary/concepts.md` (2 проблем)

_секция: 2_


### `docs/habr-unique-projects/analogues/01-three-direct-analogues.md` (2 проблем)

_секция: 2_


### `docs/habr-unique-projects/analogues/02-related-projects.md` (2 проблем)
...
### `docs/habr-unique-projects/deep-pairs/3-adversarial-multi-ide.md` (2 проблем)

_секция: 2_


### `docs/habr-unique-projects/deep-pairs/4-skill-catalogs-subagents.md` (2 проблем)
...
### `docs/habr-unique-projects/deep-pairs/8-self-aware-mcp-specs.md` (2 проблем)
...
### `docs/habr-unique-projects/final-ensembles/4-summary-authors.md` (2 проблем)

_секция: 2_


### `docs/habr-unique-projects/hardware-pairs/1-neuromorphic-ssm.md` (2 проблем)

_секция: 2_


### `docs/habr-unique-projects/hardware-pairs/2-tsu-mome.md` (2 проблем)

_секция: 2_


### `docs/habr-unique-projects/hardware-pairs/3-zinc-hybrid-arch.md` (2 проблем)

_секция: 2_


### `docs/habr-unique-projects/hardware-pairs/4-riscv-privacy.md` (2 проблем)

_секция: 2_


### `docs/habr-unique-projects/hardware-pairs/5-tinyml-mcp-skills.md` (2 проблем)
...
### `docs/habr-unique-projects/key-findings/01-yodoca.md` (2 проблем)
...
### `docs/habr-unique-projects/key-findings/03-pda-llm-as-periphery.md` (2 проблем)

_секция: 2_


### `docs/habr-unique-projects/key-findings/04-dochkina-sequential.md` (2 проблем)

_секция: 2_


### `docs/habr-unique-projects/key-findings/05-supplementary-infrastructure.md` (2 проблем)
...
### `docs/svyazi-2-0/architecture/evidence-envelope.md` (2 проблем)

_секция: 2_


### `docs/svyazi-2-0/architecture/integration-spec.md` (2 проблем)
...
### `docs/svyazi-2-0/ensembles/G-federated-local-graph.md` (2 проблем)
...
### `docs/svyazi-2-0/overview/projects-map.md` (2 проблем)
...
### `docs/svyazi-2-0/security/default-policy.md` (2 проблем)
...
### `docs/technology-combinations/combinations/01-pravilnaya-agentskaya-arkhitektura-svyazi-pattern.md` (2 проблем)
...
### `docs/technology-combinations/combinations/08-conductor-adversarial-review-auto-ai-router.md` (2 проблем)
...
### `docs/technology-combinations/combinations/14-local-first-agent-development-environment.md` (2 проблем)
...
### `docs/technology-combinations/combinations/20-hybrid-olap-oltp-with-real-time-sync.md` (2 проблем)
...
### `docs/technology-combinations/combinations/31-event-sourced-legal-document-history.md` (2 проблем)
...
### `docs/technology-combinations/synthesis-tables/01-08-summary.md` (2 проблем)
...
### `docs/letters/README.md` (1 проблем)
...
### `docs/technology-combinations/mega-stacks/04-event-sourcing-consensus.md` (1 проблем)
