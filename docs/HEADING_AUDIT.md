...
- [По файлам](#по-файлам)
  - [docs/EMPTY_SECTIONS.md (374 проблем)](#docsempty_sectionsmd-374-проблем)
  - [docs/QA.md (170 проблем)](#docsqamd-170-проблем)
  - [docs/CODE_BLOCKS.md (128 проблем)](#docscode_blocksmd-128-проблем)
  - [docs/SPELLCHECK.md (53 проблем)](#docsspellcheckmd-53-проблем)
  - [docs/TABLES.md (50 проблем)](#docstablesmd-50-проблем)
  ...
  - [docs/05-habr-projects/QA.md (13 проблем)](#docs05-habr-projectsqamd-13-проблем)
  ...
  - [docs/01-svyazi/QA.md (12 проблем)](#docs01-svyaziqamd-12-проблем)
  ...
  - [docs/meta-scripting/QA.md (5 проблем)](#docsmeta-scriptingqamd-5-проблем)
  ...
  - [docs/contacts/QA.md (3 проблем)](#docscontactsqamd-3-проблем)
  ...
  - [docs/anthropic-vacancies/QA.md (2 проблем)](#docsanthropic-vacanciesqamd-2-проблем)
...
Файлов с проблемами: **1198** из 1223

## Типы проблем

| Тип | Кол-во |
|-----|--------|
| 🕳️  Пустая секция | 3570 |
| ♊ Дублирующийся заголовок | 1107 |
| 📏 Длинный заголовок | 4 |
| 🪜 Пропущен уровень | 5 |
| ❌ Несколько H1 | 74 |
...
### `docs/EMPTY_SECTIONS.md` (374 проблем)

_секция: 363, заголовок: 11_


### `docs/QA.md` (170 проблем)

_секция: 147, заголовок: 23_


### `docs/CODE_BLOCKS.md` (128 проблем)

_секция: 108, заголовок: 20_
...
### `docs/TABLES.md` (50 проблем)

_заголовок: 30, секция: 20_
...
### `docs/05-habr-projects/QA.md` (13 проблем)
...
### `docs/anthropic-vacancies/QA.md` (2 проблем)
