...
- [По файлам](#по-файлам)
  - [`docs/EMPTY_SECTIONS.md` (361 проблем)](#docsempty_sectionsmd-361-проблем)
  - [`docs/QA.md` (172 проблем)](#docsqamd-172-проблем)
  - [`docs/CODE_BLOCKS.md` (128 проблем)](#docscode_blocksmd-128-проблем)
  - [`docs/TABLES.md` (53 проблем)](#docstablesmd-53-проблем)
  ...
  - [`docs/02-anthropic-vacancies/QA.md` (24 проблем)](#docs02-anthropic-vacanciesqamd-24-проблем)
  - [`docs/CHANGELOG.md` (22 проблем)](#docschangelogmd-22-проблем)
  - [`docs/processing-guide/QA.md` (20 проблем)](#docsprocessing-guideqamd-20-проблем)
  - [`docs/lorenzo-agent/QA.md` (19 проблем)](#docslorenzo-agentqamd-19-проблем)
  ...
  - [`docs/04-ai-collaborations/QA.md` (16 проблем)](#docs04-ai-collaborationsqamd-16-проблем)
  - [`docs/templates/mega-stack.md` (16 проблем)](#docstemplatesmega-stackmd-16-проблем)
  - [`docs/05-habr-projects/QA.md` (14 проблем)](#docs05-habr-projectsqamd-14-проблем)
  - [`docs/01-svyazi/QA.md` (13 проблем)](#docs01-svyaziqamd-13-проблем)
  ...
  - [`docs/03-technology-combinations/QA.md` (10 проблем)](#docs03-technology-combinationsqamd-10-проблем)
  ...
  - [`docs/SCORING.md` (5 проблем)](#docsscoringmd-5-проблем)
  - [`docs/VALIDATION.md` (5 проблем)](#docsvalidationmd-5-проблем)
  - [`docs/VERSION_DIFF.md` (5 проблем)](#docsversion_diffmd-5-проблем)
  ...
  - [`docs/CONCEPTS.md` (4 проблем)](#docsconceptsmd-4-проблем)
  - [`docs/LLM_SUMMARIES.md` (4 проблем)](#docsllm_summariesmd-4-проблем)
  - [`docs/ORPHANS.md` (4 проблем)](#docsorphansmd-4-проблем)
  - [`docs/READING_ORDER.md` (4 проблем)](#docsreading_ordermd-4-проблем)
  ...
  - [`docs/DENSITY.md` (3 проблем)](#docsdensitymd-3-проблем)
  ...
  - [`docs/TAGS.md` (3 проблем)](#docstagsmd-3-проблем)
  - [`docs/WORD_FREQ.md` (3 проблем)](#docsword_freqmd-3-проблем)
  ...
  - [`docs/anthropic-vacancies/QA.md` (3 проблем)](#docsanthropic-vacanciesqamd-3-проблем)
  ...
  - [`docs/ABBREVIATIONS.md` (2 проблем)](#docsabbreviationsmd-2-проблем)
  - [`docs/ACTION_ITEMS.md` (2 проблем)](#docsaction_itemsmd-2-проблем)
  - [`docs/BACKLINKS.md` (2 проблем)](#docsbacklinksmd-2-проблем)
  ...
  - [`docs/COST.md` (2 проблем)](#docscostmd-2-проблем)
  - [`docs/COVERAGE.md` (2 проблем)](#docscoveragemd-2-проблем)
  - [`docs/CROSSREFS.md` (2 проблем)](#docscrossrefsmd-2-проблем)
  - [`docs/DECISIONS.md` (2 проблем)](#docsdecisionsmd-2-проблем)
  - [`docs/DIGEST.md` (2 проблем)](#docsdigestmd-2-проблем)
  - [`docs/DIGEST_AUTO.md` (2 проблем)](#docsdigest_automd-2-проблем)
  ...
  - [`docs/MISSING.md` (2 проблем)](#docsmissingmd-2-проблем)
  - [`docs/NARRATIVE.md` (2 проблем)](#docsnarrativemd-2-проблем)
  - [`docs/NETWORK.md` (2 проблем)](#docsnetworkmd-2-проблем)
  - [`docs/PASSIVE_VOICE.md` (2 проблем)](#docspassive_voicemd-2-проблем)
  - [`docs/PROGRESS.md` (2 проблем)](#docsprogressmd-2-проблем)
  - [`docs/QUESTIONS.md` (2 проблем)](#docsquestionsmd-2-проблем)
  - [`docs/READABILITY.md` (2 проблем)](#docsreadabilitymd-2-проблем)
  - [`docs/READING_TIME.md` (2 проблем)](#docsreading_timemd-2-проблем)
  - [`docs/REPORT.md` (2 проблем)](#docsreportmd-2-проблем)
  - [`docs/SEARCH_RESULTS.md` (2 проблем)](#docssearch_resultsmd-2-проблем)
  - [`docs/SEE_ALSO.md` (2 проблем)](#docssee_alsomd-2-проблем)
  - [`docs/SENTIMENT.md` (2 проблем)](#docssentimentmd-2-проблем)
...
Файлов с проблемами: **1200** из 1223

## Типы проблем

| Тип | Кол-во |
|-----|--------|
| 🕳️  Пустая секция | 3620 |
...
### `docs/EMPTY_SECTIONS.md` (361 проблем)

_секция: 349, заголовок: 12_


### `docs/QA.md` (172 проблем)

_секция: 148, заголовок: 24_


### `docs/CODE_BLOCKS.md` (128 проблем)

_секция: 109, заголовок: 19_


### `docs/TABLES.md` (53 проблем)

_заголовок: 30, секция: 23_
...
### `docs/02-anthropic-vacancies/QA.md` (24 проблем)

_секция: 24_


### `docs/CHANGELOG.md` (22 проблем)

_секция: 17, заголовок: 5_
...
### `docs/lorenzo-agent/QA.md` (19 проблем)
...
### `docs/04-ai-collaborations/QA.md` (16 проблем)
...
### `docs/05-habr-projects/QA.md` (14 проблем)

_секция: 14_


### `docs/01-svyazi/QA.md` (13 проблем)
...
### `docs/03-technology-combinations/QA.md` (10 проблем)
...
### `docs/VERSION_DIFF.md` (5 проблем)
...
### `docs/READING_ORDER.md` (4 проблем)
...
### `docs/TAGS.md` (3 проблем)

_секция: 3_


### `docs/WORD_FREQ.md` (3 проблем)
...
### `docs/ACTION_ITEMS.md` (2 проблем)
...
### `docs/DECISIONS.md` (2 проблем)

_секция: 2_


### `docs/DIGEST.md` (2 проблем)

_секция: 2_


### `docs/DIGEST_AUTO.md` (2 проблем)
...
### `docs/MISSING.md` (2 проблем)

_секция: 2_


### `docs/NARRATIVE.md` (2 проблем)

_секция: 2_


### `docs/NETWORK.md` (2 проблем)
...
### `docs/PROGRESS.md` (2 проблем)

_секция: 2_


### `docs/QUESTIONS.md` (2 проблем)

_секция: 2_


### `docs/READABILITY.md` (2 проблем)

_секция: 2_


### `docs/READING_TIME.md` (2 проблем)
...
### `docs/SEE_ALSO.md` (2 проблем)

_секция: 2_


### `docs/SENTIMENT.md` (2 проблем)
