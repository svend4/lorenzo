...
SKIP = {
    "BACKLINKS.md", "SITEMAP.md", "CROSSREFS.md", "SIMILAR.md",
    # catalog files are fully regenerated by catalog scripts — don't inject backlinks
    "SCRIPTS_CATALOG.md", "REGISTRY.md", "TASKS_INDEX.md",
}
MARKER = "<!-- backlinks -->"
